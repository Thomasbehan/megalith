...
API documentation and source intelligence through MCP tooling. Megalith's `MegalithSource`
...
**Total: 231 original tools folded in — and vastly expanded since. Megalith today exposes 1,387 actions through 29 namespace-dispatch MCP tools.**
