# Megalith — MegalithConfig Module
...
**Dependencies:** Core, CoreUObject, Engine, MegalithCore, UnrealEd, Json, JsonUtilities

### Classes

| Class | Responsibility |
|-------|---------------|
| `FMegalithConfigModule` | Registers 6 config actions |
| `FMegalithConfigActions` | Static handlers. Helpers: ResolveConfigFilePath, GetConfigHierarchy (5 layers: Base -> Default -> Project -> User -> Saved). Uses GConfig API for reliable resolution |
