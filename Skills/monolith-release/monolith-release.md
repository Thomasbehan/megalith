...
description: Explains the exact process to publish a Monolith plugin release. Use when asked to create a release, make a release, or publish the plugin. Automatically detects the host project's engine version.
---
...
2. **Build Windows Binaries Locally**
   ...
   *What happens:* 
   ...
   - Packages the binaries into \Monolith-v0.22.1-UE<Version>.zip\ and a legacy copy \Monolith-v0.22.1.zip\.
