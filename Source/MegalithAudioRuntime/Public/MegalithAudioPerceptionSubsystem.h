...
#include "MegalithAudioPerceptionSubsystem.generated.h"
...
/**
 * UMegalithAudioPerceptionSubsystem
 *
 * UWorldSubsystem that auto-fires AActor::MakeNoise whenever a UAudioComponent starts playing
 * a USoundBase carrying a UMegalithSoundPerceptionUserData payload.
 *
 ...
 *         UMegalithAudioPerceptionStatics::PlaySoundAndReportNoise as the replacement.
 *
 ...
 */
UCLASS(MinimalAPI)
class UMegalithAudioPerceptionSubsystem : public UWorldSubsystem
{
	GENERATED_BODY()
