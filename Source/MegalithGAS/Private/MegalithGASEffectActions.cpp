...
// LogMegalithGAS defined in MegalithGASModule.cpp
...
/** Load a GE Blueprint from Params (wraps MegalithGAS::LoadGameplayEffectBP). */
bool LoadGEFromParams(
	const TSharedPtr<FJsonObject>& Params,
	UBlueprint*& OutBP,
	UGameplayEffect*& OutGE,
	FString& OutAssetPath,
	FMegalithActionResult& OutError)
{
	FString Error;
	OutAssetPath = Params->GetStringField(TEXT("asset_path"));
	if (OutAssetPath.IsEmpty())
	{
		OutError = FMegalithActionResult::Error(TEXT("Missing required parameter: asset_path"));
		return false;
	}
	if (!MegalithGAS::LoadGameplayEffectBP(OutAssetPath, OutBP, OutGE, Error))
	{
		OutError = FMegalithActionResult::Error(Error);
		return false;
	}
	return true;
}
...
TSharedPtr<FJsonObject> GEComponentToJson(const UGameplayEffectComponent* Comp)
{
	...
	if (const UAssetTagsGameplayEffectComponent* AssetTags = Cast<UAssetTagsGameplayEffectComponent>(Comp))
	{
		...
		Obj->SetField(TEXT("tags"), MegalithGAS::TagContainerToJson(AssetTags->GetConfiguredAssetTagChanges().Added));
	}
	else if (const UTargetTagsGameplayEffectComponent* TargetTags = Cast<UTargetTagsGameplayEffectComponent>(Comp))
	{
		...
		Obj->SetField(TEXT("tags"), MegalithGAS::TagContainerToJson(TargetTags->GetConfiguredTargetTagChanges().Added));
	}
	else if (const UBlockAbilityTagsGameplayEffectComponent* BlockTags = Cast<UBlockAbilityTagsGameplayEffectComponent>(Comp))
	{
		...
		Obj->SetField(TEXT("tags"), MegalithGAS::TagContainerToJson(BlockTags->GetConfiguredBlockedAbilityTagChanges().Added));
	}
	else if (const UTargetTagRequirementsGameplayEffectComponent* TagReqs = Cast<UTargetTagRequirementsGameplayEffectComponent>(Comp))
	{
		...
		Config->SetField(TEXT("application_require_tags"), MegalithGAS::TagContainerToJson(TagReqs->ApplicationTagRequirements.RequireTags));
		Config->SetField(TEXT("application_ignore_tags"), MegalithGAS::TagContainerToJson(TagReqs->ApplicationTagRequirements.IgnoreTags));
		Config->SetField(TEXT("ongoing_require_tags"), MegalithGAS::TagContainerToJson(TagReqs->OngoingTagRequirements.RequireTags));
		Config->SetField(TEXT("ongoing_ignore_tags"), MegalithGAS::TagContainerToJson(TagReqs->OngoingTagRequirements.IgnoreTags));
		Config->SetField(TEXT("removal_require_tags"), MegalithGAS::TagContainerToJson(TagReqs->RemovalTagRequirements.RequireTags));
		Config->SetField(TEXT("removal_ignore_tags"), MegalithGAS::TagContainerToJson(TagReqs->RemovalTagRequirements.IgnoreTags));
...
void FMegalithGASEffectActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("create_gameplay_effect"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateGameplayEffect),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("get_gameplay_effect"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetGameplayEffect),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("list_gameplay_effects"),
		...
		FMegalithActionHandler::CreateStatic(&HandleListGameplayEffects),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("add_modifier"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddModifier),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayEffect Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_modifier"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetModifier),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayEffect Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("remove_modifier"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveModifier),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayEffect Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("list_modifiers"),
		...
		FMegalithActionHandler::CreateStatic(&HandleListModifiers),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayEffect Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("add_ge_component"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddGEComponent),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayEffect Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_ge_component"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetGEComponent),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayEffect Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_effect_stacking"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetEffectStacking),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayEffect Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_duration"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetDuration),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayEffect Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_period"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetPeriod),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayEffect Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("create_effect_from_template"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateEffectFromTemplate),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("build_effect_from_spec"),
		...
		FMegalithActionHandler::CreateStatic(&HandleBuildEffectFromSpec),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("save_path"), TEXT("Asset path for the new GE Blueprint"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("batch_create_effects"),
		...
		FMegalithActionHandler::CreateStatic(&HandleBatchCreateEffects),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("add_execution"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddExecution),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayEffect Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("duplicate_gameplay_effect"),
		...
		FMegalithActionHandler::CreateStatic(&HandleDuplicateGameplayEffect),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("delete_gameplay_effect"),
		...
		FMegalithActionHandler::CreateStatic(&HandleDeleteGameplayEffect),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("validate_effect"),
		...
		FMegalithActionHandler::CreateStatic(&HandleValidateEffect),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayEffect Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("get_effect_interaction_matrix"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetEffectInteractionMatrix),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("remove_ge_component"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveGEComponent),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayEffect Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("get_active_effects"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetActiveEffects),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("get_effect_modifiers_breakdown"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetEffectModifiersBreakdown),
		FParamSchemaBuilder()
			.Required(TEXT("actor"), TEXT("string"), TEXT("Actor label, name, or path in PIE"))
			.Required(TEXT("attribute"), TEXT("string"), TEXT("Attribute as ClassName.PropertyName"))
			.Build());
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("apply_effect"),
		...
		FMegalithActionHandler::CreateStatic(&HandleApplyEffect),
		FParamSchemaBuilder()
			.Required(TEXT("actor"), TEXT("string"), TEXT("Actor label, name, or path in PIE"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("remove_effect"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveEffect),
		FParamSchemaBuilder()
			.Required(TEXT("actor"), TEXT("string"), TEXT("Actor label, name, or path in PIE"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("simulate_effect_stack"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSimulateEffectStack),
		FParamSchemaBuilder()
...
FMegalithActionResult FMegalithGASEffectActions::HandleCreateGameplayEffect(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath;
	FMegalithActionResult Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("save_path"), SavePath, Err)) return Err;

	FString DurationStr;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("duration_policy"), DurationStr, Err)) return Err;
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Invalid save_path: %s"), *SavePath));
	}
	FString AssetName = SavePath.Mid(LastSlash + 1);
	if (AssetName.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("save_path must not end with '/'"));
	}

	// Check for existing asset (AssetRegistry + in-memory multi-tier check)
	FString ExistError;
	if (!MegalithGAS::EnsureAssetPathFree(SavePath, AssetName, ExistError))
	{
		return FMegalithActionResult::Error(ExistError);
	}
	...
	if (!Package)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create package: %s"), *SavePath));
	}
	Package->FullyLoad();
	...
	if (!NewBP)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create GE Blueprint at: %s"), *SavePath));
	}

	// Set DurationPolicy on CDO
	UGameplayEffect* GE_CDO = MegalithGAS::GetBlueprintCDO<UGameplayEffect>(NewBP);
	if (GE_CDO)
	{
...
FMegalithActionResult FMegalithGASEffectActions::HandleGetGameplayEffect(const TSharedPtr<FJsonObject>& Params)
{
	...
	// Gameplay Cues
	{
		...
		for (const FGameplayEffectCue& Cue : GE->GameplayCues)
		{
			...
			CueObj->SetField(TEXT("tags"), MegalithGAS::TagContainerToJson(Cue.GameplayCueTags));
...
FMegalithActionResult FMegalithGASEffectActions::HandleListGameplayEffects(const TSharedPtr<FJsonObject>& Params)
{
	...
	for (const FAssetData& Asset : Assets)
	{
		...
		if (!BP || !MegalithGAS::IsGameplayEffectBlueprint(BP))
		{
			continue;
		}

		UGameplayEffect* GE = MegalithGAS::GetBlueprintCDO<UGameplayEffect>(BP);
		if (!GE)
		{
			continue;
		}
...
FMegalithActionResult FMegalithGASEffectActions::HandleAddModifier(const TSharedPtr<FJsonObject>& Params)
{
	UBlueprint* BP = nullptr;
	UGameplayEffect* GE = nullptr;
	FString AssetPath;
	...
	// Parse attribute
	FString AttrStr;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("attribute"), AttrStr, Err)) return Err;

	FString AttrError;
	FGameplayAttribute Attr = ParseAttribute(AttrStr, AttrError);
	if (!AttrError.IsEmpty())
	{
		return FMegalithActionResult::Error(AttrError);
	}

	// Parse operation
	FString OpStr;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("operation"), OpStr, Err)) return Err;

	EGameplayModOp::Type Op;
	FString OpError;
	if (!ParseModifierOp(OpStr, Op, OpError))
	{
		return FMegalithActionResult::Error(OpError);
	}
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: magnitude (object)"));
	}
	...
	{
		return FMegalithActionResult::Error(MagError);
	}
	...
	TSharedPtr<FJsonObject> Result = MegalithGAS::MakeAssetResult(AssetPath,
...
FMegalithActionResult FMegalithGASEffectActions::HandleSetModifier(const TSharedPtr<FJsonObject>& Params)
{
	UBlueprint* BP = nullptr;
	UGameplayEffect* GE = nullptr;
	FString AssetPath;
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: modifier_index"));
	}
...
FMegalithActionResult FMegalithGASEffectActions::HandleRemoveModifier(const TSharedPtr<FJsonObject>& Params)
{
	UBlueprint* BP = nullptr;
	UGameplayEffect* GE = nullptr;
	FString AssetPath;
	...
	{
		return FMegalithActionResult::Error(TEXT("Either modifier_index or attribute must be specified"));
	}
...
FMegalithActionResult FMegalithGASEffectActions::HandleListModifiers(const TSharedPtr<FJsonObject>& Params)
{
	UBlueprint* BP = nullptr;
	UGameplayEffect* GE = nullptr;
	FString AssetPath;
...
FMegalithActionResult FMegalithGASEffectActions::HandleAddGEComponent(const TSharedPtr<FJsonObject>& Params)
{
	UBlueprint* BP = nullptr;
	UGameplayEffect* GE = nullptr;
	FString AssetPath;
	...
	if (!MegalithGAS::RequireStringParam(Params, TEXT("component_type"), ComponentType, Err)) return Err;
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: config (object)"));
	}
	...
	if (!NewComp)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create component of type: %s"), *ComponentType));
	}
	...
	else if (ComponentType == TEXT("target_tag_requirements"))
	{
		...
		Comp->ApplicationTagRequirements.RequireTags = MegalithGAS::ParseTagContainer(Config, TEXT("application_require_tags"), SkippedAppRequire);
		Comp->ApplicationTagRequirements.IgnoreTags  = MegalithGAS::ParseTagContainer(Config, TEXT("application_ignore_tags"),  SkippedAppIgnore);

		// Ongoing requirements
		Comp->OngoingTagRequirements.RequireTags     = MegalithGAS::ParseTagContainer(Config, TEXT("ongoing_require_tags"),     SkippedOngoingRequire);
		Comp->OngoingTagRequirements.IgnoreTags      = MegalithGAS::ParseTagContainer(Config, TEXT("ongoing_ignore_tags"),      SkippedOngoingIgnore);

		// Removal requirements
		Comp->RemovalTagRequirements.RequireTags     = MegalithGAS::ParseTagContainer(Config, TEXT("removal_require_tags"),     SkippedRemovalRequire);
		Comp->RemovalTagRequirements.IgnoreTags      = MegalithGAS::ParseTagContainer(Config, TEXT("removal_ignore_tags"),      SkippedRemovalIgnore);
	}
...
FMegalithActionResult FMegalithGASEffectActions::HandleSetGEComponent(const TSharedPtr<FJsonObject>& Params)
{
	UBlueprint* BP = nullptr;
	UGameplayEffect* GE = nullptr;
	FString AssetPath;
...
FMegalithActionResult FMegalithGASEffectActions::HandleSetEffectStacking(const TSharedPtr<FJsonObject>& Params)
{
	UBlueprint* BP = nullptr;
	UGameplayEffect* GE = nullptr;
	FString AssetPath;
	...
	if (!MegalithGAS::RequireStringParam(Params, TEXT("stacking_type"), StackTypeStr, Err)) return Err;
	...
	TSharedPtr<FJsonObject> Result = MegalithGAS::MakeAssetResult(AssetPath, TEXT("Stacking configuration updated"));
...
FMegalithActionResult FMegalithGASEffectActions::HandleSetDuration(const TSharedPtr<FJsonObject>& Params)
{
	UBlueprint* BP = nullptr;
	UGameplayEffect* GE = nullptr;
	FString AssetPath;
	...
	TSharedPtr<FJsonObject> Result = MegalithGAS::MakeAssetResult(AssetPath, TEXT("Duration updated"));
	Result->SetStringField(TEXT("duration_policy"), DurationPolicyToString(DurationPolicy));
	if (DurationPolicy == EGameplayEffectDurationType::HasDuration && Params->HasField(TEXT("duration_magnitude")))
	{
...
FMegalithActionResult FMegalithGASEffectActions::HandleSetPeriod(const TSharedPtr<FJsonObject>& Params)
{
	UBlueprint* BP = nullptr;
	UGameplayEffect* GE = nullptr;
	FString AssetPath;
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: period"));
	}
	...
	TSharedPtr<FJsonObject> Result = MegalithGAS::MakeAssetResult(AssetPath, TEXT("Period updated"));
...
namespace
{
	...
	UBlueprint* CreateGEBlueprint(const FString& SavePath, EGameplayEffectDurationType DurationPolicy,
		UGameplayEffect*& OutGE, FMegalithActionResult& OutError)
	{
		int32 LastSlash;
		if (!SavePath.FindLastChar(TEXT('/'), LastSlash))
		{
			OutError = FMegalithActionResult::Error(FString::Printf(TEXT("Invalid save_path: %s"), *SavePath));
			return nullptr;
		}
		FString AssetName = SavePath.Mid(LastSlash + 1);
		if (AssetName.IsEmpty())
		{
			OutError = FMegalithActionResult::Error(TEXT("save_path must not end with '/'"));
			return nullptr;
		}
		...
		if (!MegalithGAS::EnsureAssetPathFree(SavePath, AssetName, ExistError))
		{
			OutError = FMegalithActionResult::Error(ExistError);
			return nullptr;
		}
		...
		if (!Package)
		{
			OutError = FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create package: %s"), *SavePath));
			return nullptr;
		}
		Package->FullyLoad();
		...
		if (!NewBP)
		{
			OutError = FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create GE Blueprint at: %s"), *SavePath));
			return nullptr;
		}

		OutGE = MegalithGAS::GetBlueprintCDO<UGameplayEffect>(NewBP);
		if (OutGE)
		{
...
FMegalithActionResult FMegalithGASEffectActions::HandleCreateEffectFromTemplate(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath, TemplateName;
	FMegalithActionResult Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("save_path"), SavePath, Err)) return Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("template"), TemplateName, Err)) return Err;
	...
	{
		return FMegalithActionResult::Error(TemplateError);
	}
	...
	if (Params->TryGetObjectField(TEXT("overrides"), OverridesPtr) && OverridesPtr && (*OverridesPtr).IsValid())
	{
		...
		{
			TArray<FString> ExtraAssetTags = MegalithGAS::ParseStringArray(*TagsPtr, TEXT("asset_tags"));
			Def.AssetTags.Append(ExtraAssetTags);
			TArray<FString> ExtraTargetTags = MegalithGAS::ParseStringArray(*TagsPtr, TEXT("target_tags"));
	...
	// Create the GE
	UGameplayEffect* GE = nullptr;
	FMegalithActionResult CreateError;
...
FMegalithActionResult FMegalithGASEffectActions::HandleBuildEffectFromSpec(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath;
	FMegalithActionResult Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("save_path"), SavePath, Err)) return Err;
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: spec (object)"));
	}
	...
	{
		return FMegalithActionResult::Error(TEXT("spec.duration_policy is required"));
	}
	...
	TArray<FString> AssetTags = MegalithGAS::ParseStringArray(Spec, TEXT("asset_tags"));
	if (AssetTags.Num() > 0) AddAssetTagsComponent(GE, AssetTags);

	TArray<FString> TargetTags = MegalithGAS::ParseStringArray(Spec, TEXT("target_tags"));
...
FMegalithActionResult FMegalithGASEffectActions::HandleBatchCreateEffects(const TSharedPtr<FJsonObject>& Params)
{
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing or empty required parameter: effects (array)"));
	}
	...
	for (int32 i = 0; i < EffectsArray->Num(); i++)
	{
		...
		FMegalithActionResult EffResult;
...
FMegalithActionResult FMegalithGASEffectActions::HandleAddExecution(const TSharedPtr<FJsonObject>& Params)
{
	UBlueprint* BP = nullptr;
	UGameplayEffect* GE = nullptr;
	FString AssetPath;
	...
	if (!MegalithGAS::RequireStringParam(Params, TEXT("calculation_class"), CalcClassPath, Err)) return Err;
...
FMegalithActionResult FMegalithGASEffectActions::HandleDuplicateGameplayEffect(const TSharedPtr<FJsonObject>& Params)
{
	FString SourcePath, DestPath;
	FMegalithActionResult Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("source_path"), SourcePath, Err)) return Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("dest_path"), DestPath, Err)) return Err;
	...
	FMegalithActionResult CreateErr;
...
FMegalithActionResult FMegalithGASEffectActions::HandleDeleteGameplayEffect(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	FMegalithActionResult Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("asset_path"), AssetPath, Err)) return Err;
...
FMegalithActionResult FMegalithGASEffectActions::HandleValidateEffect(const TSharedPtr<FJsonObject>& Params)
{
	UBlueprint* BP = nullptr;
	UGameplayEffect* GE = nullptr;
	FString AssetPath;
...
FMegalithActionResult FMegalithGASEffectActions::HandleGetEffectInteractionMatrix(const TSharedPtr<FJsonObject>& Params)
{
	...
	else
	{
		...
		for (const FAssetData& Asset : AllBlueprints)
		{
			...
			UBlueprint* BP = Cast<UBlueprint>(Asset.GetAsset());
			if (!BP || !MegalithGAS::IsGameplayEffectBlueprint(BP)) continue;
		...
		for (const UGameplayEffectComponent* Comp : Components)
		{
			...
			if (const UBlockAbilityTagsGameplayEffectComponent* BlockComp = Cast<UBlockAbilityTagsGameplayEffectComponent>(Comp))
			{
				...
				if (BlockTags.Added.Num() > 0)
				{
					...
					Interaction->SetField(TEXT("blocked_tags"), MegalithGAS::TagContainerToJson(BlockTags.Added));
					Interactions.Add(MakeShared<FJsonValueObject>(Interaction));
				}
			}
		}
...
FMegalithActionResult FMegalithGASEffectActions::HandleRemoveGEComponent(const TSharedPtr<FJsonObject>& Params)
{
	UBlueprint* BP = nullptr;
	UGameplayEffect* GE = nullptr;
	FString AssetPath;
	...
	FString TypeStr;
	FMegalithActionResult Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("component_type"), TypeStr, Err)) return Err;
	...
	if (!GEComponentsProp)
	{
		return FMegalithActionResult::Error(TEXT("Failed to find GEComponents property via reflection"));
	}

	FArrayProperty* ArrayProp = CastField<FArrayProperty>(GEComponentsProp);
	if (!ArrayProp)
	{
		return FMegalithActionResult::Error(TEXT("GEComponents is not an array property"));
	}
	...
	if (!bRemoved)
	{
		return FMegalithActionResult::Error(TEXT("Failed to remove component from GEComponents array"));
	}
...
FMegalithActionResult FMegalithGASEffectActions::HandleGetActiveEffects(const TSharedPtr<FJsonObject>& Params)
{
	FString ActorId;
	FMegalithActionResult Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("actor"), ActorId, Err)) return Err;
	...
	UWorld* PIEWorld = MegalithGAS::GetPIEWorld();
	if (!PIEWorld)
	{
		return FMegalithActionResult::Error(TEXT("No PIE world found. Start Play In Editor first."));
	}

	AActor* Actor = MegalithGAS::FindActorInPIE(ActorId);
	if (!Actor)
	{
		return FMegalithActionResult::Error(
	...
	UAbilitySystemComponent* ASC = MegalithGAS::GetASCFromActor(Actor);
	if (!ASC)
	{
		return FMegalithActionResult::Error(
...
FMegalithActionResult FMegalithGASEffectActions::HandleGetEffectModifiersBreakdown(const TSharedPtr<FJsonObject>& Params)
{
...
FMegalithActionResult FMegalithGASEffectActions::HandleApplyEffect(const TSharedPtr<FJsonObject>& Params)
{
	FString ActorId, EffectClassId;
	FMegalithActionResult Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("actor"), ActorId, Err)) return Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("effect_class"), EffectClassId, Err)) return Err;
	...
	{
		return FMegalithActionResult::Error(TEXT("Failed to create GameplayEffect spec"));
	}
	...
	{
		return FMegalithActionResult::Error(TEXT("Failed to apply GameplayEffect (may have been blocked by tag requirements or immunity)"));
	}
...
FMegalithActionResult FMegalithGASEffectActions::HandleRemoveEffect(const TSharedPtr<FJsonObject>& Params)
{
	FString ActorId;
	FMegalithActionResult Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("actor"), ActorId, Err)) return Err;
	...
	{
		return FMegalithActionResult::Error(TEXT("Must provide either 'effect_handle' (int) or 'effect_class' (string)"));
	}
...
FMegalithActionResult FMegalithGASEffectActions::HandleSimulateEffectStack(const TSharedPtr<FJsonObject>& Params)
{
	const TSharedPtr<FJsonObject>* StateObj;
	if (!Params->TryGetObjectField(TEXT("attribute_state"), StateObj) || !StateObj || !(*StateObj).IsValid())
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: attribute_state (object with base_value)"));
	}

	double BaseValue = 0.0;
	if (!(*StateObj)->TryGetNumberField(TEXT("base_value"), BaseValue))
	{
		return FMegalithActionResult::Error(TEXT("attribute_state must contain 'base_value' (number)"));
	}
