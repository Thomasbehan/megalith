 ...
 * Self-registers with FMegalithBulkFillRegistry from FMegalithGASModule::StartupModule.
 *
 ...
 *                `megalith_discover("gas")` action surface stays identical across dev + release builds.
 *
 * Targets in v1:
 ...
 *   {
 *     "target_asset": "/Game/Tests/Megalith/BulkFill/DT_AttrInit200",
 ...
 */
class FMegalithGASBulkFillAdapter
{
public:
	/** Register the adapter pair with FMegalithBulkFillRegistry under namespace "gas". */
	static void Register();

	/** Unregister (called from FMegalithGASModule::ShutdownModule). */
