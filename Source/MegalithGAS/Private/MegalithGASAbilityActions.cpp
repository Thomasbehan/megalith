...
namespace
{
	...
	struct FAbilityCDOContext
	{
		...
		bool Load(const TSharedPtr<FJsonObject>& Params, FMegalithActionResult& OutError)
		{
			FString Error;
			BP = MegalithGAS::LoadBlueprintFromParams(Params, AssetPath, Error);
			if (!BP)
			{
				OutError = FMegalithActionResult::Error(Error);
				return false;
			}
			if (!MegalithGAS::IsAbilityBlueprint(BP))
			{
				OutError = FMegalithActionResult::Error(
					FString::Printf(TEXT("'%s' is not a GameplayAbility Blueprint"), *AssetPath));
				return false;
			}
			CDO = MegalithGAS::GetBlueprintCDO<UGameplayAbility>(BP);
			if (!CDO)
			{
				OutError = FMegalithActionResult::Error(
	...
	{
		return MegalithGAS::TagContainerToJson(Container);
	}
...
void FMegalithGASAbilityActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	Registry.RegisterAction(TEXT("gas"), TEXT("create_ability"),
		TEXT("Create a new GameplayAbility Blueprint asset"),
		FMegalithActionHandler::CreateStatic(&HandleCreateAbility),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("get_ability_info"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetAbilityInfo),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("list_abilities"),
		...
		FMegalithActionHandler::CreateStatic(&HandleListAbilities),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("compile_ability"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCompileAbility),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_ability_tags"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetAbilityTags),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("get_ability_tags"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetAbilityTags),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_ability_policy"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetAbilityPolicy),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_ability_cost"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetAbilityCost),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_ability_cooldown"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetAbilityCooldown),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_ability_triggers"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetAbilityTriggers),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_ability_flags"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetAbilityFlags),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("add_ability_task_node"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddAbilityTaskNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("add_commit_and_end_flow"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddCommitAndEndFlow),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("add_effect_application"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddEffectApplication),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("add_gameplay_cue_node"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddGameplayCueNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("create_ability_from_template"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateAbilityFromTemplate),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("build_ability_from_spec"),
		...
		FMegalithActionHandler::CreateStatic(&HandleBuildAbilityFromSpec),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("save_path"), TEXT("Asset path to save the new ability"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("batch_create_abilities"),
		...
		FMegalithActionHandler::CreateStatic(&HandleBatchCreateAbilities),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("duplicate_ability"),
		...
		FMegalithActionHandler::CreateStatic(&HandleDuplicateAbility),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("list_ability_tasks"),
		...
		FMegalithActionHandler::CreateStatic(&HandleListAbilityTasks),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("get_ability_task_pins"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetAbilityTaskPins),
		FParamSchemaBuilder()
			.Required(TEXT("task_class"), TEXT("string"), TEXT("UAbilityTask subclass name (e.g. UAbilityTask_WaitGameplayEvent)"))
			.Build());
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("wire_ability_task_delegate"),
		...
		FMegalithActionHandler::CreateStatic(&HandleWireAbilityTaskDelegate),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("get_ability_graph_flow"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetAbilityGraphFlow),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("validate_ability"),
		...
		FMegalithActionHandler::CreateStatic(&HandleValidateAbility),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("find_abilities_by_tag"),
		...
		FMegalithActionHandler::CreateStatic(&HandleFindAbilitiesByTag),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("get_ability_tag_matrix"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetAbilityTagMatrix),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("validate_ability_blueprint"),
		...
		FMegalithActionHandler::CreateStatic(&HandleValidateAbilityBlueprint),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("scaffold_custom_ability_task"),
		...
		FMegalithActionHandler::CreateStatic(&HandleScaffoldCustomAbilityTask),
		FParamSchemaBuilder()
...
FMegalithActionResult FMegalithGASAbilityActions::HandleCreateAbility(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath;
	FMegalithActionResult Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("save_path"), SavePath, Err))
	{
		return Err;
	}
	...
	if (ParentClassName.StartsWith(TEXT("/")))
	{
		...
		UObject* Obj = FMegalithAssetUtils::LoadAssetByPath(UBlueprint::StaticClass(), ParentClassName);
...
FMegalithActionResult FMegalithGASAbilityActions::HandleGetAbilityInfo(const TSharedPtr<FJsonObject>& Params)
{
...
FMegalithActionResult FMegalithGASAbilityActions::HandleListAbilities(const TSharedPtr<FJsonObject>& Params)
{
	...
	{
		FilterTag = MegalithGAS::StringToTag(TagFilter);
	}
	...
	for (const FAssetData& AssetData : Assets)
	{
		...
		{
			UGameplayAbility* CDO = MegalithGAS::GetBlueprintCDO<UGameplayAbility>(BP);
...
FMegalithActionResult FMegalithGASAbilityActions::HandleCompileAbility(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FMegalithActionResult Err;
	if (!Ctx.Load(Params, Err))
...
FMegalithActionResult FMegalithGASAbilityActions::HandleSetAbilityTags(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FMegalithActionResult Err;
	if (!Ctx.Load(Params, Err))
	...
	if (!MegalithGAS::RequireStringParam(Params, TEXT("container"), ContainerName, Err))
	{
		return Err;
	}
	...
	FGameplayTagContainer InputTags = MegalithGAS::ParseTagContainer(Params, TEXT("tags"), SkippedTags);
	...
	TSharedPtr<FJsonObject> Result = MegalithGAS::MakeAssetResult(Ctx.AssetPath,
...
FMegalithActionResult FMegalithGASAbilityActions::HandleGetAbilityTags(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FMegalithActionResult Err;
	if (!Ctx.Load(Params, Err))
...
FMegalithActionResult FMegalithGASAbilityActions::HandleSetAbilityPolicy(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FMegalithActionResult Err;
	if (!Ctx.Load(Params, Err))
	...
	if (!bChanged)
	{
		return FMegalithActionResult::Error(TEXT("No policy fields provided. Set at least one of: instancing_policy, net_execution_policy, net_security_policy"));
	}

	Ctx.MarkModified();

	TSharedPtr<FJsonObject> Result = MegalithGAS::MakeAssetResult(Ctx.AssetPath, TEXT("Policies updated"));
	TSharedPtr<FJsonObject> Policies = MakeShared<FJsonObject>();
...
FMegalithActionResult FMegalithGASAbilityActions::HandleSetAbilityCost(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FMegalithActionResult Err;
	if (!Ctx.Load(Params, Err))
	...
	if (!MegalithGAS::RequireStringParam(Params, TEXT("cost_effect_class"), CostClassPath, Err))
	{
		return Err;
	}
	...
	if (CostClassPath.IsEmpty())
	{
		...
		TSharedPtr<FJsonObject> Result = MegalithGAS::MakeAssetResult(Ctx.AssetPath, TEXT("Cost effect cleared"));
		return FMegalithActionResult::Success(Result);
	}
	...
	{
		UObject* Obj = FMegalithAssetUtils::LoadAssetByPath(UBlueprint::StaticClass(), CostClassPath);
...
FMegalithActionResult FMegalithGASAbilityActions::HandleSetAbilityCooldown(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FMegalithActionResult Err;
	if (!Ctx.Load(Params, Err))
	...
	if (!MegalithGAS::RequireStringParam(Params, TEXT("cooldown_effect_class"), CooldownClassPath, Err))
	{
		return Err;
	}
	...
	if (CooldownClassPath.IsEmpty())
	{
		...
		TSharedPtr<FJsonObject> Result = MegalithGAS::MakeAssetResult(Ctx.AssetPath, TEXT("Cooldown effect cleared"));
		return FMegalithActionResult::Success(Result);
	}
	...
	{
		UObject* Obj = FMegalithAssetUtils::LoadAssetByPath(UBlueprint::StaticClass(), CooldownClassPath);
		UBlueprint* GEBP = Cast<UBlueprint>(Obj);
		if (GEBP && GEBP->GeneratedClass)
		{
			GEClass = GEBP->GeneratedClass;
...
FMegalithActionResult FMegalithGASAbilityActions::HandleSetAbilityTriggers(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FMegalithActionResult Err;
	if (!Ctx.Load(Params, Err))
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: triggers (array of {tag, trigger_source})"));
	}
	...
	for (int32 i = 0; i < TriggersArray->Num(); ++i)
	{
		...
		FGameplayTag Tag = MegalithGAS::StringToTag(TagStr);
		if (!Tag.IsValid())
		{
			return FMegalithActionResult::Error(
...
FMegalithActionResult FMegalithGASAbilityActions::HandleSetAbilityFlags(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FMegalithActionResult Err;
	if (!Ctx.Load(Params, Err))
	...
	if (!bChanged)
	{
		return FMegalithActionResult::Error(TEXT("No flag fields provided. Set at least one of: replicate_input_directly, retrigger_instanced_ability, server_respects_remote_ability_cancellation"));
	}

	Ctx.MarkModified();

	TSharedPtr<FJsonObject> Result = MegalithGAS::MakeAssetResult(Ctx.AssetPath, TEXT("Flags updated"));
	TSharedPtr<FJsonObject> Flags = MakeShared<FJsonObject>();
...
FMegalithActionResult FMegalithGASAbilityActions::HandleAddAbilityTaskNode(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FMegalithActionResult Err;
	if (!Ctx.Load(Params, Err))
	...
	if (!MegalithGAS::RequireStringParam(Params, TEXT("task_class"), TaskClassName, Err))
	{
		return Err;
	}
	...
	if (!Graph)
	{
		return FMegalithActionResult::Error(TEXT("No event graph found in ability Blueprint"));
	}
...
FMegalithActionResult FMegalithGASAbilityActions::HandleAddCommitAndEndFlow(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FMegalithActionResult Err;
	if (!Ctx.Load(Params, Err))
	...
	if (!CommitNode)
	{
		return FMegalithActionResult::Error(TEXT("Failed to create CommitAbility node. Function not found on UGameplayAbility."));
	}
...
FMegalithActionResult FMegalithGASAbilityActions::HandleAddEffectApplication(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FMegalithActionResult Err;
	if (!Ctx.Load(Params, Err))
	...
	if (!MegalithGAS::RequireStringParam(Params, TEXT("effect_class"), EffectClassPath, Err))
	{
		return Err;
	}
...
FMegalithActionResult FMegalithGASAbilityActions::HandleAddGameplayCueNode(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FMegalithActionResult Err;
	if (!Ctx.Load(Params, Err))
	...
	FString CueTag;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("cue_tag"), CueTag, Err))
	{
		return Err;
	}

	FString Type;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("type"), Type, Err))
	{
		return Err;
	}
...
FMegalithActionResult FMegalithGASAbilityActions::HandleCreateAbilityFromTemplate(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath;
	FMegalithActionResult Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("save_path"), SavePath, Err))
	...
	if (!MegalithGAS::RequireStringParam(Params, TEXT("template"), TemplateName, Err))
	{
		return Err;
	}
	...
	FMegalithActionResult CreateResult = HandleCreateAbility(CreateParams);
	...
	TSharedPtr<FJsonObject> Result = MegalithGAS::MakeAssetResult(SavePath,
...
FMegalithActionResult FMegalithGASAbilityActions::HandleBuildAbilityFromSpec(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath;
	FMegalithActionResult Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("save_path"), SavePath, Err))
	...
	// Step 2: Set policies
	{
		...
		if (bHasPolicy)
		{
			...
			FMegalithActionResult PolicyResult = HandleSetAbilityPolicy(PolicyParams);
		...
		if (Spec->TryGetObjectField(TEXT("tags"), TagsObj))
		{
			for (const auto& Pair : (*TagsObj)->Values)
			{
				...
				if (Pair.Value->TryGetArray(TagArr) && TagArr->Num() > 0)
				{
					TSharedPtr<FJsonObject> TagParams = MakeShared<FJsonObject>();
					TagParams->SetStringField(TEXT("asset_path"), SavePath);
					TagParams->SetStringField(TEXT("container"), MegalithKeyToString(Pair.Key));
	...
	if (Spec->HasField(TEXT("cost_effect_class")))
	{
		...
		FMegalithActionResult CostResult = HandleSetAbilityCost(CostParams);
	...
	if (Spec->HasField(TEXT("cooldown_effect_class")))
	{
		...
		FMegalithActionResult CDResult = HandleSetAbilityCooldown(CDParams);
	...
	// Step 6: Triggers
	{
		...
		if (Spec->TryGetArrayField(TEXT("triggers"), TriggersArr) && TriggersArr->Num() > 0)
		{
			...
			FMegalithActionResult TrigResult = HandleSetAbilityTriggers(TrigParams);
	...
	// Step 7: Flags
	{
		...
		if (Spec->TryGetObjectField(TEXT("flags"), FlagsObj))
		{
			...
			FMegalithActionResult FlagResult = HandleSetAbilityFlags(FlagParams);
...
FMegalithActionResult FMegalithGASAbilityActions::HandleBatchCreateAbilities(const TSharedPtr<FJsonObject>& Params)
{
	const TArray<TSharedPtr<FJsonValue>>* AbilitiesArr;
	if (!Params->TryGetArrayField(TEXT("abilities"), AbilitiesArr) || AbilitiesArr->Num() == 0)
	{
		return FMegalithActionResult::Error(TEXT("Missing or empty required parameter: abilities (array)"));
	}
	...
	for (int32 i = 0; i < AbilitiesArr->Num(); ++i)
	{
		...
		FMegalithActionResult AbilityResult;
...
FMegalithActionResult FMegalithGASAbilityActions::HandleDuplicateAbility(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	FMegalithActionResult Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("asset_path"), AssetPath, Err))
	{
		return Err;
	}

	FString NewPath;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("new_path"), NewPath, Err))
	{
		return Err;
	}
	...
	{
		FString LoadErr;
		UBlueprint* SourceBP = MegalithGAS::LoadBlueprintFromParams(Params, AssetPath, LoadErr);
		if (!SourceBP)
		{
			return FMegalithActionResult::Error(LoadErr);
		}
		if (!MegalithGAS::IsAbilityBlueprint(SourceBP))
		{
			return FMegalithActionResult::Error(
				FString::Printf(TEXT("'%s' is not a GameplayAbility Blueprint"), *AssetPath));
		}
	...
	{
		UGameplayAbility* DupCDO = MegalithGAS::GetBlueprintCDO<UGameplayAbility>(DupBP);
		if (DupCDO)
		{
			// Build rename map
			...
			{
				RenameMap.Add(MegalithKeyToString(Pair.Key), Pair.Value->AsString());
			}
			...
			for (const FString& ContainerName : AllContainerNames)
			{
				...
				for (auto It = Container->CreateConstIterator(); It; ++It)
				{
					...
					{
						FGameplayTag NewTag = MegalithGAS::StringToTag(*Replacement);
						if (NewTag.IsValid())
						{
	...
	TSharedPtr<FJsonObject> Result = MegalithGAS::MakeAssetResult(NewPath,
...
FMegalithActionResult FMegalithGASAbilityActions::HandleListAbilityTasks(const TSharedPtr<FJsonObject>& Params)
{
...
FMegalithActionResult FMegalithGASAbilityActions::HandleGetAbilityTaskPins(const TSharedPtr<FJsonObject>& Params)
{
	FString TaskClassName;
	FMegalithActionResult Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("task_class"), TaskClassName, Err))
...
FMegalithActionResult FMegalithGASAbilityActions::HandleWireAbilityTaskDelegate(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FMegalithActionResult Err;
	if (!Ctx.Load(Params, Err))
	...
	FString NodeId;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("node_id"), NodeId, Err))
	{
		return Err;
	}

	FString DelegateName;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("delegate_name"), DelegateName, Err))
	{
		return Err;
	}

	FString TargetNodeId;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("target_node_id"), TargetNodeId, Err))
	{
		return Err;
	}
...
FMegalithActionResult FMegalithGASAbilityActions::HandleGetAbilityGraphFlow(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FMegalithActionResult Err;
	if (!Ctx.Load(Params, Err))
	...
	// Build result
	TSharedPtr<FJsonObject> Result = MegalithGAS::MakeAssetResult(Ctx.AssetPath, TEXT("Graph flow analysis complete"));
...
FMegalithActionResult FMegalithGASAbilityActions::HandleValidateAbility(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FMegalithActionResult Err;
	if (!Ctx.Load(Params, Err))
...
FMegalithActionResult FMegalithGASAbilityActions::HandleFindAbilitiesByTag(const TSharedPtr<FJsonObject>& Params)
{
	FString TagStr;
	FMegalithActionResult Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("tag"), TagStr, Err)) return Err;
	...
	for (const FAssetData& Asset : AllBlueprints)
	{
		...
		if (!BP || !MegalithGAS::IsAbilityBlueprint(BP)) continue;
...
FMegalithActionResult FMegalithGASAbilityActions::HandleGetAbilityTagMatrix(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (Params->TryGetArrayField(TEXT("asset_paths"), PathsArray) && PathsArray && PathsArray->Num() > 0)
	{
		for (const auto& Val : *PathsArray)
		{
			...
			UBlueprint* BP = MegalithGAS::LoadBlueprintFromParams(TempParams, OutPath, Error);
			if (BP && MegalithGAS::IsAbilityBlueprint(BP))
			{
				AbilityBPs.Add(BP);
			}
		}
...
FMegalithActionResult FMegalithGASAbilityActions::HandleValidateAbilityBlueprint(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	FMegalithActionResult Err;
	...
	bool bIsAbilityBP = MegalithGAS::IsAbilityBlueprint(BP);
	...
	if (!CDO)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to get CDO for '%s'"), *OutPath));
	}
	...
	bool bValid = (Errors.Num() == 0);
	TSharedPtr<FJsonObject> Result = MegalithGAS::MakeAssetResult(OutPath,
...
FMegalithActionResult FMegalithGASAbilityActions::HandleScaffoldCustomAbilityTask(const TSharedPtr<FJsonObject>& Params)
{
	FString ClassName;
	FMegalithActionResult Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("class_name"), ClassName, Err))
		return Err;
	...
	{
		return FMegalithActionResult::Error(TEXT("At least one delegate is required for a custom ability task."));
	}
	...
	Header += TEXT(" * Auto-generated by MegalithGAS scaffold_custom_ability_task\n");
	Header += TEXT(" */\n");
	Header += TEXT("UCLASS()\n");
