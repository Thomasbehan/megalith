...
void FMegalithGASAttributeActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	Registry.RegisterAction(TEXT("gas"), TEXT("create_attribute_set"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateAttributeSet),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("add_attribute"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddAttribute),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("get_attribute_set"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetAttributeSet),
		FParamSchemaBuilder()
			.Required(TEXT("attribute_set"), TEXT("string"), TEXT("Asset path for Blueprint sets, or class name for C++ sets"))
			.Build());
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_attribute_defaults"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetAttributeDefaults),
		FParamSchemaBuilder()
			.Required(TEXT("attribute_set"), TEXT("string"), TEXT("Asset path for Blueprint sets, or class name for C++ sets"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("list_attribute_sets"),
		...
		FMegalithActionHandler::CreateStatic(&HandleListAttributeSets),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("configure_attribute_clamping"),
		...
		FMegalithActionHandler::CreateStatic(&HandleConfigureAttributeClamping),
		FParamSchemaBuilder()
			.Required(TEXT("attribute_set"), TEXT("string"), TEXT("Asset path for Blueprint sets, or class name for C++ sets"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("configure_meta_attributes"),
		...
		FMegalithActionHandler::CreateStatic(&HandleConfigureMetaAttributes),
		FParamSchemaBuilder()
			.Required(TEXT("attribute_set"), TEXT("string"), TEXT("Asset path for Blueprint sets, or class name for C++ sets"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("create_attribute_set_from_template"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateAttributeSetFromTemplate),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("create_attribute_init_datatable"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateAttributeInitDataTable),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("duplicate_attribute_set"),
		...
		FMegalithActionHandler::CreateStatic(&HandleDuplicateAttributeSet),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("configure_attribute_replication"),
		...
		FMegalithActionHandler::CreateStatic(&HandleConfigureAttributeReplication),
		FParamSchemaBuilder()
			.Required(TEXT("attribute_set"), TEXT("string"), TEXT("Asset path for Blueprint sets, or class name for C++ sets"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("link_datatable_to_asc"),
		...
		FMegalithActionHandler::CreateStatic(&HandleLinkDataTableToASC),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("bulk_edit_attributes"),
		...
		FMegalithActionHandler::CreateStatic(&HandleBulkEditAttributes),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("validate_attribute_set"),
		...
		FMegalithActionHandler::CreateStatic(&HandleValidateAttributeSet),
		FParamSchemaBuilder()
			.Required(TEXT("attribute_set"), TEXT("string"), TEXT("Asset path for Blueprint sets, or class name for C++ sets"))
			.Build());
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("find_attribute_modifiers"),
		...
		FMegalithActionHandler::CreateStatic(&HandleFindAttributeModifiers),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("diff_attribute_sets"),
		...
		FMegalithActionHandler::CreateStatic(&HandleDiffAttributeSets),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("get_attribute_dependency_graph"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetAttributeDependencyGraph),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("remove_attribute"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveAttribute),
		FParamSchemaBuilder()
			.Required(TEXT("attribute_set"), TEXT("string"), TEXT("Asset path for Blueprint sets, or class name for C++ sets"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("get_attribute_value"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetAttributeValue),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_attribute_value"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetAttributeValue),
		FParamSchemaBuilder()
			.Required(TEXT("actor"), TEXT("string"), TEXT("Actor label, name, or path in the PIE world"))
			.Required(TEXT("attribute"), TEXT("string"), TEXT("Attribute as ClassName.PropertyName"))
...
namespace
{
	...
	// GetProjectSourceDir() moved to MegalithGAS::GetProjectSourceDir() in MegalithGASInternal.cpp
		...
		const TArray<TSharedPtr<FJsonValue>>& Attributes)
	{
		...
		FString Header;
		Header += TEXT("// Auto-generated by Megalith GAS tools\n");
	...
	{
		FString Source;
		Source += TEXT("// Auto-generated by Megalith GAS tools\n");
	...
	UBlueprint* LoadAttributeSetBlueprint(const FString& AssetPath, FString& OutError)
	{
		...
		BP = MegalithGAS::LoadBlueprintFromParams(TempParams, Unused, OutError);
		if (!BP)
		{
			return nullptr;
		}
		if (!MegalithGAS::IsAttributeSetBlueprint(BP))
		{
...
FMegalithActionResult FMegalithGASAttributeActions::HandleCreateAttributeSet(const TSharedPtr<FJsonObject>& Params)
{
	...
	{
		return FMegalithActionResult::Error(TEXT("mode must be 'cpp' or 'blueprint'"));
	}
	...
	if (Mode == TEXT("blueprint"))
	{
		...
		FString Error;
		UPackage* Package = MegalithGAS::GetOrCreatePackage(SavePath, Error);
		if (!Package)
		{
		...
		if (!Blueprint)
		{
			return FMegalithActionResult::Error(TEXT("Failed to create GBA AttributeSet Blueprint"));
		}
	...
	FString SourceDir = MegalithGAS::GetProjectSourceDir();
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to write header: %s"), *HeaderPath));
	}

	if (!FFileHelper::SaveStringToFile(SourceContent, *SourcePath, FFileHelper::EEncodingOptions::ForceUTF8WithoutBOM))
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to write source: %s"), *SourcePath));
	}
...
FMegalithActionResult FMegalithGASAttributeActions::HandleAddAttribute(const TSharedPtr<FJsonObject>& Params)
{
	FString AttrSet, AttrName;
	FMegalithActionResult Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("attribute_set"), AttrSet, Err)) return Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("name"), AttrName, Err)) return Err;
	...
	if (LooksLikeBlueprintPath(AttrSet))
	{
		...
		TSharedPtr<FJsonObject> Result = MegalithGAS::MakeAssetResult(AttrSet,
	...
	{
		return FMegalithActionResult::Error(TEXT("Could not find class closing brace in header file"));
	}
...
FMegalithActionResult FMegalithGASAttributeActions::HandleGetAttributeSet(const TSharedPtr<FJsonObject>& Params)
{
	FString AttrSet;
	FMegalithActionResult Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("attribute_set"), AttrSet, Err)) return Err;
	...
	if (!SetClass)
	{
		return FMegalithActionResult::Error(TEXT("Could not resolve AttributeSet class"));
	}
...
FMegalithActionResult FMegalithGASAttributeActions::HandleSetAttributeDefaults(const TSharedPtr<FJsonObject>& Params)
{
	FString AttrSet;
	FMegalithActionResult Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("attribute_set"), AttrSet, Err)) return Err;
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: defaults (object mapping attribute_name to value)"));
	}
	...
	if (LooksLikeBlueprintPath(AttrSet))
	{
		...
		if (!SetClass)
		{
			return FMegalithActionResult::Error(TEXT("Blueprint has no generated class — compile it first"));
		}

		UAttributeSet* CDO = Cast<UAttributeSet>(SetClass->GetDefaultObject());
		if (!CDO)
		{
			return FMegalithActionResult::Error(TEXT("Could not get CDO for AttributeSet"));
		}
		...
		for (const auto& Pair : (*DefaultsObj)->Values)
		{
			...
			// Find the property
			FProperty* Prop = FindAttributeProperty(SetClass, MegalithKeyToString(Pair.Key));
			FStructProperty* StructProp = CastField<FStructProperty>(Prop);
			if (!StructProp || !StructProp->Struct || !StructProp->Struct->IsChildOf(AttrDataStruct))
			{
				NotFound.Add(MegalithKeyToString(Pair.Key));
				continue;
			}
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to write source: %s"), *SourceFilePath));
	}
...
FMegalithActionResult FMegalithGASAttributeActions::HandleListAttributeSets(const TSharedPtr<FJsonObject>& Params)
{
...
FMegalithActionResult FMegalithGASAttributeActions::HandleConfigureAttributeClamping(const TSharedPtr<FJsonObject>& Params)
{
	FString AttrSet;
	FMegalithActionResult Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("attribute_set"), AttrSet, Err)) return Err;
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: clamp_rules (array)"));
	}
...
FMegalithActionResult FMegalithGASAttributeActions::HandleConfigureMetaAttributes(const TSharedPtr<FJsonObject>& Params)
{
	FString AttrSet;
	FMegalithActionResult Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("attribute_set"), AttrSet, Err)) return Err;
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: meta_attributes (array)"));
	}
...
FMegalithActionResult FMegalithGASAttributeActions::HandleCreateAttributeSetFromTemplate(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (Params->TryGetObjectField(TEXT("overrides"), OverridesPtr) && OverridesPtr && (*OverridesPtr).IsValid())
	{
		...
		// Remove attributes
		TArray<FString> RemoveList = MegalithGAS::ParseStringArray(Overrides, TEXT("remove_attributes"));
		if (RemoveList.Num() > 0)
		{
	...
	FMegalithActionResult Result = HandleCreateAttributeSet(CreateParams);
...
FMegalithActionResult FMegalithGASAttributeActions::HandleCreateAttributeInitDataTable(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (!SetClass)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("AttributeSet not found: %s"), *AttrSet));
	}
	...
	if (AttrProps.Num() == 0)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("No FGameplayAttributeData properties found on %s"), *SetClassName));
	}
	...
	if (!RowStruct)
	{
		return FMegalithActionResult::Error(TEXT("Could not find FAttributeMetaData struct — ensure GameplayAbilities module is loaded"));
	}
	...
	if (!DataTable)
	{
		return FMegalithActionResult::Error(TEXT("Failed to create DataTable"));
	}
...
FMegalithActionResult FMegalithGASAttributeActions::HandleDuplicateAttributeSet(const TSharedPtr<FJsonObject>& Params)
{
	FString Source, SavePath;
	FMegalithActionResult Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("source"), Source, Err)) return Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("save_path"), SavePath, Err)) return Err;
	...
	if (bSourceIsBP)
	{
		...
		if (!BP) return FMegalithActionResult::Error(Error);
	...
	if (!SourceClass)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Source AttributeSet not found: %s"), *Source));
	}
	...
	TArray<FString> RemoveList = MegalithGAS::ParseStringArray(Params, TEXT("remove_attributes"));
	if (RemoveList.Num() > 0)
	{
...
FMegalithActionResult FMegalithGASAttributeActions::HandleConfigureAttributeReplication(const TSharedPtr<FJsonObject>& Params)
{
	FString AttrSet;
	FMegalithActionResult Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("attribute_set"), AttrSet, Err)) return Err;
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing or empty required parameter: replication (array)"));
	}
	...
	if (!FFileHelper::LoadFileToString(HeaderContent, *HeaderPath))
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Could not find header: %s"), *HeaderPath));
	}

	FString SourceContent;
	if (!FFileHelper::LoadFileToString(SourceContent, *SourceFilePath))
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Could not find source: %s"), *SourceFilePath));
	}
...
FMegalithActionResult FMegalithGASAttributeActions::HandleLinkDataTableToASC(const TSharedPtr<FJsonObject>& Params)
{
	FString ASCBlueprintPath;
	FMegalithActionResult Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("asc_blueprint"), ASCBlueprintPath, Err)) return Err;
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing or empty required parameter: entries (array of {attribute_set_class, datatable_path})"));
	}
	...
	if (!ASCNode)
	{
		return FMegalithActionResult::Error(TEXT("No AbilitySystemComponent found on this Blueprint"));
	}

	UAbilitySystemComponent* ASCTemplate = Cast<UAbilitySystemComponent>(ASCNode->ComponentTemplate);
	if (!ASCTemplate)
	{
		return FMegalithActionResult::Error(TEXT("ASC node has no valid ComponentTemplate"));
	}
	...
	if (!DefaultDataProp)
	{
		return FMegalithActionResult::Error(TEXT("Could not find DefaultStartingData property on ASC"));
	}
	...
	for (const auto& EntryVal : *EntriesArray)
	{
		...
		// Validate DataTable
		UDataTable* DT = Cast<UDataTable>(FMegalithAssetUtils::LoadAssetByPath(UDataTable::StaticClass(), DTPath));
		if (!DT)
		{
			Warnings.Add(MakeShared<FJsonValueString>(
	...
	TSharedPtr<FJsonObject> Result = MegalithGAS::MakeAssetResult(ASCBlueprintPath,
...
FMegalithActionResult FMegalithGASAttributeActions::HandleBulkEditAttributes(const TSharedPtr<FJsonObject>& Params)
{
	const TArray<TSharedPtr<FJsonValue>>* OpsArray;
	if (!Params->TryGetArrayField(TEXT("operations"), OpsArray) || !OpsArray || OpsArray->Num() == 0)
	{
		return FMegalithActionResult::Error(TEXT("Missing or empty required parameter: operations (array)"));
	}
	...
	for (int32 i = 0; i < OpsArray->Num(); i++)
	{
		...
		FMegalithActionResult OpResult;
...
FMegalithActionResult FMegalithGASAttributeActions::HandleValidateAttributeSet(const TSharedPtr<FJsonObject>& Params)
{
	FString AttrSetId;
	FMegalithActionResult Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("attribute_set"), AttrSetId, Err)) return Err;
...
FMegalithActionResult FMegalithGASAttributeActions::HandleFindAttributeModifiers(const TSharedPtr<FJsonObject>& Params)
{
	FString AttrStr;
	FMegalithActionResult Err;
	...
	for (const FAssetData& Asset : AllBlueprints)
	{
		...
		// Check GE Blueprints
		if (MegalithGAS::IsGameplayEffectBlueprint(BP))
		{
...
FMegalithActionResult FMegalithGASAttributeActions::HandleDiffAttributeSets(const TSharedPtr<FJsonObject>& Params)
{
	FString SetAId, SetBId;
	FMegalithActionResult Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("set_a"), SetAId, Err)) return Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("set_b"), SetBId, Err)) return Err;
	...
	if (!ResolveSet(SetAId, ClassA, NameA, ErrorMsg)) return FMegalithActionResult::Error(ErrorMsg);
	if (!ResolveSet(SetBId, ClassB, NameB, ErrorMsg)) return FMegalithActionResult::Error(ErrorMsg);
...
FMegalithActionResult FMegalithGASAttributeActions::HandleGetAttributeDependencyGraph(const TSharedPtr<FJsonObject>& Params)
{
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing or empty required parameter: attribute_sets (array)"));
	}
...
FMegalithActionResult FMegalithGASAttributeActions::HandleRemoveAttribute(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (bCheckRefs)
	{
		...
		for (const FAssetData& Asset : AllBlueprints)
		{
			...
			if (!RefBP || RefBP == BP || !MegalithGAS::IsGameplayEffectBlueprint(RefBP)) continue;

			UGameplayEffect* GE = MegalithGAS::GetBlueprintCDO<UGameplayEffect>(RefBP);
			if (!GE) continue;
...
// PIE helpers moved to MegalithGAS::GetPIEWorld/FindActorInPIE/GetASCFromActor in MegalithGASInternal.cpp

// ============================================================
//  Phase 4: get_attribute_value
// ============================================================

FMegalithActionResult FMegalithGASAttributeActions::HandleGetAttributeValue(const TSharedPtr<FJsonObject>& Params)
{
...
FMegalithActionResult FMegalithGASAttributeActions::HandleSetAttributeValue(const TSharedPtr<FJsonObject>& Params)
{
	FString ActorId, AttrStr;
	FMegalithActionResult Err;
	if (!MegalithGAS::RequireStringParam(Params, TEXT("actor"), ActorId, Err)) return Err;
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: value (number)"));
	}
