...
// MegalithReflectionIntel — Phases 1–3a of Reflection Intelligence (v0.17.0).
// Hosts:
...
// Plan: Plugins/Megalith/Docs/plans/2026-05-28-reflection-intelligence.md.

using UnrealBuildTool;

public class MegalithReflectionIntel : ModuleRules
{
	public MegalithReflectionIntel(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PrivateDependencyModuleNames.AddRange(new string[]
		{
			...
			// for the UDeveloperSettings-derived UMegalithReflectionIntelSettings.
			"DeveloperSettings",
			"Json",
			"JsonUtilities",
			"Projects",
			...
			"AssetRegistry",
			// Shared-handle fix (2026-05-29): borrow UMegalithSourceSubsystem's
			...
			//   MegalithSource   — UMegalithSourceSubsystem + FMegalithSourceDatabase.
			//   UnrealEd         — GEditor (Editor.h).
			//   EditorSubsystem  — GEditor->GetEditorSubsystem<>(). Dependency
			//                      direction RI -> MegalithSource is non-circular
