...
//   FMegalithActionInfo / FMegalithDispatcherAnnotations in MegalithToolRegistry.h).
...
//
// The handler delegates to FMegalithReflectionIntelModule::ForceRebuildReflectionTables,
...
class MEGALITHREFLECTIONINTEL_API FReflectMaintenanceAdapter
{
public:
...
private:
	...
	static FMegalithActionResult HandleRebuildReflectionIndex(const TSharedPtr<FJsonObject>& Params);
};
