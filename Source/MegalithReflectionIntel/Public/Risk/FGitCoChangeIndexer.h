...
// FMegalithReflectionIntelModule::ResolveGitRepoRoots, which probes the project
...
class MEGALITHREFLECTIONINTEL_API FGitCoChangeIndexer
{
public:
	/**
	 ...
	 *                            FMegalithReflectionIntelModule::ResolveGitRepoRoots
