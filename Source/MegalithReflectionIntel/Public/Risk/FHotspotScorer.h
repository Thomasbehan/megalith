...
// (Phase 2 GitCoChangeIndexer output) and the existing `files` table (Megalith
...
class MEGALITHREFLECTIONINTEL_API FHotspotScorer
{
public:
	/**
...
private:
	...
	{
		int32 ChurnCount = 0;
		int32 ComplexityProxy = 0; // line_count from MegalithSource.files
	};
