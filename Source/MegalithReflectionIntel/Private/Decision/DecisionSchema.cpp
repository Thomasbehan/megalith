...
// extraction logic. Statement strings exposed via namespace MegalithDecisionSchema.

#include "Decision/DecisionSchema.h"

namespace MegalithDecisionSchema
{
	const TCHAR* GetCreateRecordsTableSQL()
	{
		// Table layout — see SPEC_MegalithReflectionIntel.md for column documentation.
