...
// MegalithReflectionIntel query adapters.
//
...
#include "MegalithToolRegistry.h" // FMegalithActionResult (returned by value)

#include <initializer_list>

/**
 * Pagination cursor state shared by all MegalithReflectionIntel query adapters.
...
FMegalithActionResult RIInvalidCursorError(const FString& Reason);
