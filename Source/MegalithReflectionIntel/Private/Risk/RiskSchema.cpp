...
// exposed via namespace MegalithRiskSchema and consumed exclusively from the
// indexer EnsureSchema() entry points. See SPEC_MegalithReflectionIntel.md
// (Phase 2 Schema section) for per-column documentation.

#include "Risk/RiskSchema.h"

namespace MegalithRiskSchema
{
