...
// route (`mcp__megalith__cppreflect_query("list_uproperties", ...)`).
//
...
// `Source/MegalithReflectionIntel/Private/Tests/Fixtures/CppReflectCorpus/`.
...
namespace MegalithCppReflectTestDetail
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"Megalith.ReflectionIntel.CppReflect.UHTArtefactParse",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FCppReflectUHTArtefactParseTest::RunTest(const FString& /*Parameters*/)
{
	using namespace MegalithCppReflectTestDetail;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"Megalith.ReflectionIntel.CppReflect.EmptyRootsDegraded",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"Megalith.ReflectionIntel.CppReflect.CursorPagination",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"Megalith.ReflectionIntel.CppReflect.FindSpecifier",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
