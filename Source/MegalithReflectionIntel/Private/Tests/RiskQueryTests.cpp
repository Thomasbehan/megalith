...
namespace MegalithRiskTestDetail
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"Megalith.ReflectionIntel.Risk.GitCoChangeSchema",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FRiskGitCoChangeSchemaTest::RunTest(const FString& /*Parameters*/)
{
	using namespace MegalithRiskTestDetail;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"Megalith.ReflectionIntel.Risk.ConditionalGateSweep",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"Megalith.ReflectionIntel.Risk.HotspotScoreFormula",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool FRiskHotspotScoreFormulaTest::RunTest(const FString& /*Parameters*/)
{
	...
	// "not under project root" branch keeps it as-is (forward-slashed).
	{
		...
		Ins.Create(Db, TEXT(
			...
			"VALUES (?, ?, ?, 0);"));
		Ins.SetBindingValueByIndex(1, FString(TEXT("Megalith")));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"Megalith.ReflectionIntel.Risk.CoChangeWeighting",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool FRiskCoChangeWeightingTest::RunTest(const FString& /*Parameters*/)
{
	...
	// Read back and verify.
	{
		...
		Q.SetBindingValueByIndex(1, FString(TEXT("Megalith")));
