...
// plugin's Source/MegalithReflectionIntel/Private/Tests/Fixtures/DecisionCorpus.
...
namespace MegalithDecisionTestDetail
{
	/** Resolve the fixture corpus path relative to the Megalith plugin install. */
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"Megalith.ReflectionIntel.Decision.SchemaBootstrap",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FDecisionSchemaBootstrapTest::RunTest(const FString& /*Parameters*/)
{
	using namespace MegalithDecisionTestDetail;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"Megalith.ReflectionIntel.Decision.HeuristicAccuracy",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"Megalith.ReflectionIntel.Decision.SupersessionChain",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"Megalith.ReflectionIntel.Decision.StalenessFlag",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
