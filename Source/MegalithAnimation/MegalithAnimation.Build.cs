...
public class MegalithAnimation : ModuleRules
{
	...
	public MegalithAnimation(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		//
		// Release builds: MEGALITH_RELEASE_BUILD=1 still forces this OFF so binary releases
