 ...
 * proven set_cdo_property scalar path), reads via FMegalithReflectionReader.
 *
 ...
 */
class FMegalithSkeletonRetargetActions
{
public:
	...
	static FMegalithActionResult HandleSetBoneTranslationRetargeting(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult HandleGetBoneTranslationRetargeting(const TSharedPtr<FJsonObject>& Params);

	// --- T2-1: IK-Rig per-solver per-bone settings ---
	static FMegalithActionResult HandleSetIkRigBoneSettings(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult HandleGetIkRigBoneSettings(const TSharedPtr<FJsonObject>& Params);
