...
/**
 * ABP graph node wiring actions for Megalith — Wave 7.
 ...
 */
class MEGALITHANIMATION_API FMegalithAbpWriteActions
{
public:
...
private:
	static FMegalithActionResult HandleAddAnimGraphNode(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult HandleConnectAnimGraphPins(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult HandleSetStateAnimation(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult HandleAddVariableGet(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult HandleSetAnimGraphNodeProperty(const TSharedPtr<FJsonObject>& Params);

	// Sprint 4 — Motion Matching AnimBP graph authoring.
	static FMegalithActionResult HandleConfigurePoseHistoryNode(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult HandleConfigureMotionMatchingNode(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult HandleBuildMotionMatchingNode(const TSharedPtr<FJsonObject>& Params);
	...
	static FMegalithActionResult HandleGetAnimGraphOutputConnection(const TSharedPtr<FJsonObject>& Params);
	...
	static FMegalithActionResult HandleBuildFootIkPass(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult HandleAssignPostProcessAnimRig(const TSharedPtr<FJsonObject>& Params);
	...
	static FMegalithActionResult HandleAddApplyAdditive(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult HandleAddApplyMeshSpaceAdditive(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult HandleAddSlotNode(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult HandleAddSaveCachedPose(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult HandleAddUseCachedPose(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult HandleSetOutputPoseSource(const TSharedPtr<FJsonObject>& Params);
	...
	static FMegalithActionResult HandleSetStateResultSource(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult HandleAddBlendByInt(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult HandleAddBlendByEnum(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult HandleSetSyncGroup(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult HandleSetLayeredBlendBones(const TSharedPtr<FJsonObject>& Params);
	...
	static FMegalithActionResult HandleAddAnimControlRigNode(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult HandleAddLinkedAnimLayer(const TSharedPtr<FJsonObject>& Params);
	...
	static FMegalithActionResult HandleAddAnimLayerGraph(const TSharedPtr<FJsonObject>& Params);
};
