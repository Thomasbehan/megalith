...
UIKRetargetOpControllerBase* FMegalithRetargetSettingsActions::ResolveOpController(
...
FMegalithActionResult FMegalithRetargetSettingsActions::HandleAlignRetargetPose(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (!Controller) { return FMegalithActionResult::Error(Error); }
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Unknown side '%s' — use 'source', 'target', or 'both'"), *SideStr));
	}
	...
	else if (ModeStr.Equals(TEXT("align_chain"), ESearchCase::IgnoreCase))
	{
		...
		{
			return FMegalithActionResult::Error(TEXT("mode 'align_chain' requires a non-empty 'chain_names' array of bone names"));
		}
	}
...
FMegalithActionResult FMegalithRetargetSettingsActions::HandleGetRetargetPose(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("retargeter_path"));
...
FMegalithActionResult FMegalithRetargetSettingsActions::HandleSetRetargetPose(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("retargeter_path"));
...
FMegalithActionResult FMegalithRetargetSettingsActions::HandleGetRetargetChainSettings(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("retargeter_path"));
...
FMegalithActionResult FMegalithRetargetSettingsActions::HandleSetRetargetChainSettings(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("retargeter_path"));
	...
	{
		return FMegalithActionResult::Error(TEXT("'chain_name' (target chain) is required"));
	}
	...
	if (!bAnyApplied)
	{
		...
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Target chain '%s' not found in the FK Chains op"), *ChainName));
		}
		if (bWantsIK && !bIKChainFound && !bWantsFK)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Target chain '%s' not found in the IK Chains op"), *ChainName));
		}
		...
		return FMegalithActionResult::Error(FString::Printf(TEXT("Target chain '%s' not found in the targeted op(s)"), *ChainName));
	}
...
FMegalithActionResult FMegalithRetargetSettingsActions::HandleSetRetargetRootSettings(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("retargeter_path"));
...
FMegalithActionResult FMegalithRetargetSettingsActions::HandleEnableFootGroundLock(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("retargeter_path"));
	...
	{
		return FMegalithActionResult::Error(TEXT("No valid chain entries found in 'chains' (each needs a non-empty target_chain)"));
	}
...
void FMegalithRetargetSettingsActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("align_retarget_pose"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAlignRetargetPose),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_retarget_pose"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetRetargetPose),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("retargeter_path"), TEXT("IK Retargeter (UIKRetargeter) asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_retarget_pose"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetRetargetPose),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("retargeter_path"), TEXT("IK Retargeter (UIKRetargeter) asset path"))
			.Optional(TEXT("side"), TEXT("string"), TEXT("'source' or 'target' (default 'target')"), TEXT("target"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_retarget_chain_settings"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetRetargetChainSettings),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("retargeter_path"), TEXT("IK Retargeter (UIKRetargeter) asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_retarget_chain_settings"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetRetargetChainSettings),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("retargeter_path"), TEXT("IK Retargeter (UIKRetargeter) asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_retarget_root_settings"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetRetargetRootSettings),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("retargeter_path"), TEXT("IK Retargeter (UIKRetargeter) asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("enable_foot_ground_lock"),
		...
		FMegalithActionHandler::CreateStatic(&HandleEnableFootGroundLock),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("retargeter_path"), TEXT("IK Retargeter (UIKRetargeter) asset path"))
