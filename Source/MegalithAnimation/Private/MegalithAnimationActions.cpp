...
#include "MegalithPropertyAccessReader.h"
#include "MegalithAnimNodeBindingReader.h" // Gap 2 (function bindings) + Gap 12 (pin bindings) read helpers
...
#if WITH_CHOOSER
// Phase-2 read-only recursive chooser-tree collector (same module, MegalithAnimation).
// Used to expand a referenced chooser's nested tree when recursive:true is requested.
#include "MegalithChooserTreeCollector.h"
...
// deliberate.
namespace MegalithAnimGraphChooser
{
...
void FMegalithAnimationActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	// Montage Sections
	Registry.RegisterAction(TEXT("animation"), TEXT("add_montage_section"),
		TEXT("Add a section to an animation montage"),
		FMegalithActionHandler::CreateStatic(&HandleAddMontageSection),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("delete_montage_section"),
		...
		FMegalithActionHandler::CreateStatic(&HandleDeleteMontageSection),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Montage asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_section_next"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetSectionNext),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Montage asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_section_time"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetSectionTime),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Montage asset path"))
			.Required(TEXT("section_name"), TEXT("string"), TEXT("Name of the section"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_blendspace_sample"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddBlendSpaceSample),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("edit_blendspace_sample"),
		...
		FMegalithActionHandler::CreateStatic(&HandleEditBlendSpaceSample),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("BlendSpace asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("delete_blendspace_sample"),
		...
		FMegalithActionHandler::CreateStatic(&HandleDeleteBlendSpaceSample),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("BlendSpace asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("bake_blend_space"),
		...
		FMegalithActionHandler::CreateStatic(&HandleBakeBlendSpace),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_blend_space_interpolation"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetBlendSpaceInterpolation),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("BlendSpace asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_state_machines"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetStateMachines),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_state_info"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetStateInfo),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_transitions"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetTransitions),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_blend_nodes"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetBlendNodes),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_anim_graph_choosers"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetAnimGraphChoosers),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_anim_node_function_bindings"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetAnimNodeFunctionBindings),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_anim_node_function_binding"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetAnimNodeFunctionBinding),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_anim_node_pin_bindings"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetAnimNodePinBindings),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_anim_node_pin_binding"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetAnimNodePinBinding),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
			.Required(TEXT("node_id"), TEXT("string"), TEXT("Node name or NodeGuid"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_notify_time"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetNotifyTime),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_notify_duration"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetNotifyDuration),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation asset path"))
			.Required(TEXT("notify_index"), TEXT("integer"), TEXT("Index of the notify"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_bone_track_keys"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetBoneTrackKeys),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_bone_track"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddBoneTrack),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation sequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_bone_track"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveBoneTrack),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation sequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("copy_bone_pose_between_sequences"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCopyBonePoseBetweenSequences),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_virtual_bone"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddVirtualBone),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_virtual_bones"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveVirtualBones),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Skeleton asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_skeleton_info"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetSkeletonInfo),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Skeleton asset path"))
			.Build());
	Registry.RegisterAction(TEXT("animation"), TEXT("get_skeletal_mesh_info"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetSkeletalMeshInfo),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_sequence_info"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetSequenceInfo),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_sequence_notifies"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetSequenceNotifies),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_bone_track_keys"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetBoneTrackKeys),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("list_bone_tracks"),
		...
		FMegalithActionHandler::CreateStatic(&HandleListBoneTracks),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
			.Build());
	Registry.RegisterAction(TEXT("animation"), TEXT("get_sequence_curves"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetSequenceCurves),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_skeleton_preview_attached_assets"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetSkeletonPreviewAttachedAssets),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Skeleton asset path"))
			.Build());
	Registry.RegisterAction(TEXT("animation"), TEXT("get_bone_ref_pose"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetBoneRefPose),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Skeleton or SkeletalMesh asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_animated_bone_transform"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetAnimatedBoneTransform),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_abp_info"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetAbpInfo),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_notify"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddNotify),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_notify_state"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddNotifyState),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_notify"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveNotify),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_notify_track"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetNotifyTrack),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("list_curves"),
		...
		FMegalithActionHandler::CreateStatic(&HandleListCurves),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_curve"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddCurve),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_curve"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveCurve),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_curve_keys"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetCurveKeys),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_curve_keys"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetCurveKeys),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
			.Required(TEXT("curve_name"), TEXT("string"), TEXT("Curve name"))
			.Build());
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_socket"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddSocket),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Skeleton asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_socket"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveSocket),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Skeleton asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_socket_transform"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetSocketTransform),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Skeleton asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_skeleton_curves"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetSkeletonCurves),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Skeleton asset path"))
			.Build());
	Registry.RegisterAction(TEXT("animation"), TEXT("set_blend_space_axis"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetBlendSpaceAxis),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("BlendSpace asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_root_motion_settings"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetRootMotionSettings),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_sequence"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateSequence),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("duplicate_sequence"),
		...
		FMegalithActionHandler::CreateStatic(&HandleDuplicateSequence),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_montage"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateMontage),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_montage_blend"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetMontageBlend),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Montage asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_montage_slot"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddMontageSlot),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Montage asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_montage_slot"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetMontageSlot),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Montage asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("apply_anim_modifier"),
		...
		FMegalithActionHandler::CreateStatic(&HandleApplyAnimModifier),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_composite_segment"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddCompositeSegment),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimComposite asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_composite_segment"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveCompositeSegment),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimComposite asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_ikrig_info"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetIKRigInfo),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_ik_solver"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddIKSolver),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("IKRig asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_ik_solver"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveIKSolver),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("IKRig asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_retargeter_info"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetRetargeterInfo),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_retarget_chain_mapping"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetRetargetChainMapping),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("IKRetargeter asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_control_rig_info"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetControlRigInfo),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_control_rig_variables"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetControlRigVariables),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("ControlRigBlueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_control_rig_element"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddControlRigElement),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("ControlRigBlueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_state_to_machine"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddStateToMachine),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_conduit"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddConduit),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
			.Required(TEXT("machine_name"), TEXT("string"), TEXT("State machine name (exact, as shown in get_state_machines)"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_transition"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddTransition),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
			.Required(TEXT("machine_name"), TEXT("string"), TEXT("State machine name"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_transition_rule"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetTransitionRule),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
			.Required(TEXT("machine_name"), TEXT("string"), TEXT("State machine name"))
			.Required(TEXT("from_state"), TEXT("string"), TEXT("Source state name"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_transition_rule"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetTransitionRule),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
			.Required(TEXT("machine_name"), TEXT("string"), TEXT("State machine name"))
			.Required(TEXT("from_state"), TEXT("string"), TEXT("Source state name"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_anim_state"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveAnimState),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
			.Required(TEXT("machine_name"), TEXT("string"), TEXT("State machine name"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_anim_entry_state"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetAnimEntryState),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
			.Required(TEXT("machine_name"), TEXT("string"), TEXT("State machine name"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_anim_transition"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveAnimTransition),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
			.Required(TEXT("machine_name"), TEXT("string"), TEXT("State machine name"))
			.Required(TEXT("from_state"), TEXT("string"), TEXT("Source state name"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_state_machine"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateStateMachine),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("build_state_machine"),
		...
		FMegalithActionHandler::CreateStatic(&HandleBuildStateMachine),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_abp_variables"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetAbpVariables),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
			.Build());
	Registry.RegisterAction(TEXT("animation"), TEXT("get_abp_linked_assets"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetAbpLinkedAssets),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_compatible_skeletons"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetCompatibleSkeletons),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Skeleton asset path"))
			.Build());
	Registry.RegisterAction(TEXT("animation"), TEXT("add_compatible_skeleton"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddCompatibleSkeleton),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_compatible_skeleton"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveCompatibleSkeleton),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Skeleton asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_blend_space"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateBlendSpace),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_blend_space_1d"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateBlendSpace1D),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_aim_offset"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateAimOffset),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_aim_offset_1d"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateAimOffset1D),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_composite"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateComposite),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_anim_blueprint"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateAnimBlueprint),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("compare_skeletons"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCompareSkeletons),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_sequence_properties"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetSequenceProperties),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_additive_settings"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetAdditiveSettings),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_compression_settings"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetCompressionSettings),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_sync_markers"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetSyncMarkers),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
			.Build());
	Registry.RegisterAction(TEXT("animation"), TEXT("add_sync_marker"),
		TEXT("Add an authored sync marker to a sequence"),
		FMegalithActionHandler::CreateStatic(&HandleAddSyncMarker),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_sync_marker"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveSyncMarker),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("rename_sync_marker"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRenameSyncMarker),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("derive_foot_sync_markers"),
		...
		FMegalithActionHandler::CreateStatic(&HandleDeriveFootSyncMarkers),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_montage_anim_segment"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddMontageAnimSegment),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Montage asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("clone_notify_setup"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCloneNotifySetup),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("source_path"), TEXT("Source animation asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("bulk_add_notify"),
		...
		FMegalithActionHandler::CreateStatic(&HandleBulkAddNotify),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_montage_from_sections"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateMontageFromSections),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Asset path for the new montage"))
			.RequiredAssetPath(TEXT("skeleton_path"), TEXT("Skeleton asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("build_sequence_from_poses"),
		...
		FMegalithActionHandler::CreateStatic(&HandleBuildSequenceFromPoses),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_notify_properties"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetNotifyProperties),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation asset path (sequence, montage, composite)"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_physics_asset_info"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetPhysicsAssetInfo),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_body_properties"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetBodyProperties),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Physics asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_constraint_properties"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetConstraintProperties),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Physics asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_retarget_chain"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddRetargetChain),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_retarget_chain"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveRetargetChain),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("IK Rig asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_retarget_chain_bones"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetRetargetChainBones),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("IK Rig asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_ik_rig"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateIKRig),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_ik_retargeter"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateIKRetargeter),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_retargeter_rigs"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetRetargeterRigs),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("batch_retarget_animations"),
		...
		FMegalithActionHandler::CreateStatic(&HandleBatchRetargetAnimations),
		FParamSchemaBuilder()
...
FMegalithActionResult FMegalithAnimationActions::HandleAddMontageSection(const TSharedPtr<FJsonObject>& Params)
{
	...
	UAnimMontage* Montage = FMegalithAssetUtils::LoadAssetByPath<UAnimMontage>(AssetPath);
	if (!Montage) return FMegalithActionResult::Error(FString::Printf(TEXT("Montage not found: %s"), *AssetPath));
	...
	if (Index == INDEX_NONE)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to add section '%s' (name may already exist)"), *SectionName));
	...
	return FMegalithActionResult::Success(Root);
}

FMegalithActionResult FMegalithAnimationActions::HandleDeleteMontageSection(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!Montage->IsValidSectionIndex(SectionIndex))
		return FMegalithActionResult::Error(FString::Printf(TEXT("Invalid section index: %d"), SectionIndex));

	if (Montage->CompositeSections.Num() <= 1)
		return FMegalithActionResult::Error(TEXT("Cannot delete the last remaining montage section"));
	...
	if (!bSuccess)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to delete section at index %d"), SectionIndex));
...
FMegalithActionResult FMegalithAnimationActions::HandleSetSectionNext(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SectionName = Params->GetStringField(TEXT("section_name"));
	...
	if (SectionIndex == INDEX_NONE)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Section not found: %s"), *SectionName));
...
FMegalithActionResult FMegalithAnimationActions::HandleSetSectionTime(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SectionName = Params->GetStringField(TEXT("section_name"));
...
FMegalithActionResult FMegalithAnimationActions::HandleAddBlendSpaceSample(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	UBlendSpace* BS = FMegalithAssetUtils::LoadAssetByPath<UBlendSpace>(AssetPath);
	if (!BS) return FMegalithActionResult::Error(FString::Printf(TEXT("BlendSpace not found: %s"), *AssetPath));

	UAnimSequence* Anim = FMegalithAssetUtils::LoadAssetByPath<UAnimSequence>(AnimPath);
	if (!Anim) return FMegalithActionResult::Error(FString::Printf(TEXT("AnimSequence not found: %s"), *AnimPath));
	...
	if (Index == INDEX_NONE)
		return FMegalithActionResult::Error(TEXT("Failed to add sample"));
...
FMegalithActionResult FMegalithAnimationActions::HandleEditBlendSpaceSample(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!BS->IsValidBlendSampleIndex(SampleIndex))
		return FMegalithActionResult::Error(FString::Printf(TEXT("Invalid sample index: %d"), SampleIndex));
...
FMegalithActionResult FMegalithAnimationActions::HandleDeleteBlendSpaceSample(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	int32 SampleIndex = static_cast<int32>(Params->GetNumberField(TEXT("sample_index")));
	...
	if (!bSuccess)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to delete sample at index %d"), SampleIndex));
...
FMegalithActionResult FMegalithAnimationActions::HandleBakeBlendSpace(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithAnimationActions::HandleSetBlendSpaceInterpolation(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithAnimationActions::HandleSetNotifyTime(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	int32 NotifyIndex = static_cast<int32>(Params->GetNumberField(TEXT("notify_index")));
	float NewTime = static_cast<float>(Params->GetNumberField(TEXT("new_time")));

	UAnimSequenceBase* Seq = FMegalithAssetUtils::LoadAssetByPath<UAnimSequenceBase>(AssetPath);
	if (!Seq) return FMegalithActionResult::Error(FString::Printf(TEXT("Animation asset not found: %s"), *AssetPath));

	if (!Seq->Notifies.IsValidIndex(NotifyIndex))
		return FMegalithActionResult::Error(FString::Printf(TEXT("Invalid notify index: %d (total: %d)"), NotifyIndex, Seq->Notifies.Num()));
...
FMegalithActionResult FMegalithAnimationActions::HandleSetNotifyDuration(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	int32 NotifyIndex = static_cast<int32>(Params->GetNumberField(TEXT("notify_index")));
	...
	if (!Seq->Notifies[NotifyIndex].NotifyStateClass)
		return FMegalithActionResult::Error(TEXT("Notify is not a state notify (no duration)"));
...
FMegalithActionResult FMegalithAnimationActions::HandleAddBoneTrack(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString BoneName = Params->GetStringField(TEXT("bone_name"));

	UAnimSequence* Seq = FMegalithAssetUtils::LoadAssetByPath<UAnimSequence>(AssetPath);
	if (!Seq) return FMegalithActionResult::Error(FString::Printf(TEXT("AnimSequence not found: %s"), *AssetPath));
...
FMegalithActionResult FMegalithAnimationActions::HandleRemoveBoneTrack(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString BoneName = Params->GetStringField(TEXT("bone_name"));
	...
	if (bIncludeChildren && !Seq->GetSkeleton())
		return FMegalithActionResult::Error(TEXT("Skeleton is null — cannot resolve children"));
...
FMegalithActionResult FMegalithAnimationActions::HandleSetBoneTrackKeys(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString BoneName = Params->GetStringField(TEXT("bone_name"));
...
FMegalithActionResult FMegalithAnimationActions::HandleAddVirtualBone(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SourceBone = Params->GetStringField(TEXT("source_bone"));
	FString TargetBone = Params->GetStringField(TEXT("target_bone"));

	USkeleton* Skeleton = FMegalithAssetUtils::LoadAssetByPath<USkeleton>(AssetPath);
	if (!Skeleton) return FMegalithActionResult::Error(FString::Printf(TEXT("Skeleton not found: %s"), *AssetPath));

	const FReferenceSkeleton& RefSkel = Skeleton->GetReferenceSkeleton();
	if (RefSkel.FindBoneIndex(FName(*SourceBone)) == INDEX_NONE)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Source bone not found in skeleton: %s"), *SourceBone));
	}
	if (RefSkel.FindBoneIndex(FName(*TargetBone)) == INDEX_NONE)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Target bone not found in skeleton: %s"), *TargetBone));
	}
	...
	if (!bSuccess)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to add virtual bone from '%s' to '%s'"), *SourceBone, *TargetBone));
...
FMegalithActionResult FMegalithAnimationActions::HandleRemoveVirtualBones(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	else
	{
		...
		{
			GEditor->EndTransaction();
			return FMegalithActionResult::Error(TEXT("No virtual bones found matching the given names"));
		}
	}
...
FMegalithActionResult FMegalithAnimationActions::HandleGetSkeletonInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithAnimationActions::HandleGetSkeletalMeshInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));

	USkeletalMesh* Mesh = FMegalithAssetUtils::LoadAssetByPath<USkeletalMesh>(AssetPath);
	if (!Mesh) return FMegalithActionResult::Error(FString::Printf(TEXT("SkeletalMesh not found: %s"), *AssetPath));
...
FMegalithActionResult FMegalithAnimationActions::HandleGetStateMachines(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));

	UAnimBlueprint* ABP = FMegalithAssetUtils::LoadAssetByPath<UAnimBlueprint>(AssetPath);
	if (!ABP) return FMegalithActionResult::Error(FString::Printf(TEXT("AnimBlueprint not found: %s"), *AssetPath));
...
FMegalithActionResult FMegalithAnimationActions::HandleGetStateInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: machine_name"));
	}
	if (StateName.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: state_name"));
	}
	...
	return FMegalithActionResult::Error(FString::Printf(TEXT("State '%s' not found in machine '%s'"), *StateName, *MachineName));
}

FMegalithActionResult FMegalithAnimationActions::HandleGetTransitions(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString MachineName = Params->GetStringField(TEXT("machine_name"));
...
FMegalithActionResult FMegalithAnimationActions::HandleGetBlendNodes(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString GraphName;
	...
	return FMegalithActionResult::Error(FString::Printf(TEXT("Graph '%s' not found"), *GraphName));
}

FMegalithActionResult FMegalithAnimationActions::HandleGetGraphs(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithAnimationActions::HandleGetNodes(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	for (UEdGraph* Graph : ABP->FunctionGraphs)
	{
		...
		for (UEdGraphNode* Node : Graph->Nodes)
		{
			...
			MegalithAnimNodeBindingReader::SerializeCompactFunctionBindings(AnimNode, NodeObj);
			MegalithAnimNodeBindingReader::SerializeCompactPinBindings(AnimNode, NodeObj);
	...
	if (bIncludeAnimGraph)
	{
		...
		for (UEdGraph* Graph : AllGraphs)
		{
			...
			for (UEdGraphNode* Node : Graph->Nodes)
			{
				...
				const bool bIsChooser = MegalithAnimGraphChooser::IsEvaluateChooserNode(Node);
				...
				if (bIsChooser)
				{
					...
					MegalithAnimGraphChooser::ResolveChooserAsset(Node, NodeObj);
				}
				if (bIsPropertyAccess)
				{
					// Reflectively resolve the private PropertyAccess path (shared helper, Gap 1).
					MegalithPropertyAccessReader::SerializePropertyAccessBlock(Node, NodeObj);
				}
...
FMegalithActionResult FMegalithAnimationActions::HandleGetAnimGraphChoosers(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	for (UEdGraph* Graph : AllGraphs)
	{
		...
		for (UEdGraphNode* Node : Graph->Nodes)
		{
			...
			// file-header comment on MegalithAnimGraphChooser for the v1/v2 rationale.
			if (!MegalithAnimGraphChooser::IsEvaluateChooserNode(Node)) continue;
			...
			UObject* ChooserAsset = MegalithAnimGraphChooser::ResolveChooserAsset(Node, ChooserObj);
			...
			if (bRecursive && ChooserAsset)
			{
				...
				if (UChooserTable* Table = Cast<UChooserTable>(ChooserAsset))
				{
					...
					TSharedPtr<FJsonObject> Tree = MegalithChooserTree::CollectTree(Table, VisitedTables);
					if (Tree.IsValid())
					{
...
FMegalithActionResult FMegalithAnimationActions::HandleGetLinkedLayers(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithAnimationActions::HandleGetSequenceInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithAnimationActions::HandleGetSequenceNotifies(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithAnimationActions::HandleGetBoneTrackKeys(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString BoneName = Params->GetStringField(TEXT("bone_name"));
	int32 StartFrame = 0;
	...
	const IAnimationDataModel* DataModel = Seq->GetDataModel();
	if (!DataModel) return FMegalithActionResult::Error(TEXT("No animation data model"));

	const FName BoneFName(*BoneName);
	if (!DataModel->IsValidBoneTrackName(BoneFName))
		return FMegalithActionResult::Error(FString::Printf(TEXT("Bone track not found: %s"), *BoneName));
	...
	if (MaxKeys == 0)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Bone track has no keys: %s"), *BoneName));
	if (StartFrame > EndFrame)
		return FMegalithActionResult::Error(FString::Printf(TEXT("start_frame (%d) > end_frame (%d)"), StartFrame, EndFrame));
...
FMegalithActionResult FMegalithAnimationActions::HandleListBoneTracks(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithAnimationActions::HandleGetSequenceCurves(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithAnimationActions::HandleGetMontageInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithAnimationActions::HandleGetBlendSpaceInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithAnimationActions::HandleGetSkeletonSockets(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	else
	{
		USkeletalMesh* Mesh = FMegalithAssetUtils::LoadAssetByPath<USkeletalMesh>(AssetPath);
		if (!Mesh)
			return FMegalithActionResult::Error(FString::Printf(TEXT("Skeleton or SkeletalMesh not found: %s"), *AssetPath));
...
FMegalithActionResult FMegalithAnimationActions::HandleGetSkeletonPreviewAttachedAssets(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));

	USkeleton* Skeleton = FMegalithAssetUtils::LoadAssetByPath<USkeleton>(AssetPath);
	if (!Skeleton)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Skeleton not found: %s"), *AssetPath));
...
FMegalithActionResult FMegalithAnimationActions::HandleGetBoneRefPose(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (USkeleton* Skeleton = FMegalithAssetUtils::LoadAssetByPath<USkeleton>(AssetPath))
	{
		RefSkel = &Skeleton->GetReferenceSkeleton();
		SourceType = TEXT("Skeleton");
	}
	else if (USkeletalMesh* Mesh = FMegalithAssetUtils::LoadAssetByPath<USkeletalMesh>(AssetPath))
	{
...
FMegalithActionResult FMegalithAnimationActions::HandleGetAnimatedBoneTransform(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (BoneName.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("bone_name is required"));
	}
	...
	{
		return FMegalithActionResult::Error(TEXT("Provide one of: frame (integer) or time (seconds)"));
	}
...
FMegalithActionResult FMegalithAnimationActions::HandleGetAbpInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithAnimationActions::HandleAddNotify(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (Time < 0.f || Time > Seq->GetPlayLength())
		return FMegalithActionResult::Error(FString::Printf(TEXT("Time %.3f out of range [0, %.3f]"), Time, Seq->GetPlayLength()));
	...
	if (!NotifyClass || !NotifyClass->IsChildOf(UAnimNotify::StaticClass()))
		return FMegalithActionResult::Error(FString::Printf(TEXT("Notify class not found or not a UAnimNotify subclass: %s"), *NotifyClassName));

	UAnimNotify* NewNotify = NewObject<UAnimNotify>(Seq, NotifyClass);
	if (!NewNotify)
		return FMegalithActionResult::Error(TEXT("Failed to create notify instance"));
...
FMegalithActionResult FMegalithAnimationActions::HandleAddNotifyState(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString NotifyClassName = Params->GetStringField(TEXT("notify_class"));
	float Time = static_cast<float>(Params->GetNumberField(TEXT("time")));
	...
	if (Time < 0.f || Time > Seq->GetPlayLength())
		return FMegalithActionResult::Error(FString::Printf(TEXT("Time %.3f out of range [0, %.3f]"), Time, Seq->GetPlayLength()));
	if (Duration <= 0.f)
		return FMegalithActionResult::Error(TEXT("Duration must be > 0"));
	if (Time + Duration > Seq->GetPlayLength())
		return FMegalithActionResult::Error(FString::Printf(TEXT("Time + Duration (%.3f) exceeds play length (%.3f)"), Time + Duration, Seq->GetPlayLength()));
	...
	if (!NotifyClass || !NotifyClass->IsChildOf(UAnimNotifyState::StaticClass()))
		return FMegalithActionResult::Error(FString::Printf(TEXT("NotifyState class not found or not a UAnimNotifyState subclass: %s"), *NotifyClassName));

	UAnimNotifyState* NewNotifyState = NewObject<UAnimNotifyState>(Seq, NotifyClass);
	if (!NewNotifyState)
		return FMegalithActionResult::Error(TEXT("Failed to create notify state instance"));
...
FMegalithActionResult FMegalithAnimationActions::HandleRemoveNotify(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	int32 NotifyIndex = static_cast<int32>(Params->GetNumberField(TEXT("notify_index")));
...
FMegalithActionResult FMegalithAnimationActions::HandleSetNotifyTrack(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	int32 NotifyIndex = static_cast<int32>(Params->GetNumberField(TEXT("notify_index")));
	...
	if (!Seq->AnimNotifyTracks.IsValidIndex(TrackIndex))
		return FMegalithActionResult::Error(FString::Printf(TEXT("Invalid track index: %d (total: %d)"), TrackIndex, Seq->AnimNotifyTracks.Num()));
...
FMegalithActionResult FMegalithAnimationActions::HandleListCurves(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithAnimationActions::HandleAddCurve(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (Seq->GetDataModel()->FindCurve(CurveId))
		return FMegalithActionResult::Error(FString::Printf(TEXT("Curve '%s' already exists"), *CurveName));
	...
	if (!bSuccess)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to add curve '%s'"), *CurveName));
...
FMegalithActionResult FMegalithAnimationActions::HandleRemoveCurve(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString CurveName = Params->GetStringField(TEXT("curve_name"));
	FString CurveTypeStr = Params->HasField(TEXT("curve_type")) ? Params->GetStringField(TEXT("curve_type")) : TEXT("Float");
	...
	if (!Seq->GetDataModel()->FindCurve(CurveId))
		return FMegalithActionResult::Error(FString::Printf(TEXT("Curve '%s' not found"), *CurveName));
	...
	if (!bSuccess)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to remove curve '%s'"), *CurveName));
...
FMegalithActionResult FMegalithAnimationActions::HandleSetCurveKeys(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString CurveName = Params->GetStringField(TEXT("curve_name"));
	...
	if (!Seq->GetDataModel()->FindCurve(CurveId))
		return FMegalithActionResult::Error(FString::Printf(TEXT("Curve '%s' not found — add it first"), *CurveName));
	...
	if (!FJsonSerializer::Deserialize(Reader, JsonKeys))
		return FMegalithActionResult::Error(TEXT("Failed to parse keys_json — expected JSON array"));
	...
	if (!bSuccess)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to set keys on curve '%s'"), *CurveName));
...
FMegalithActionResult FMegalithAnimationActions::HandleGetCurveKeys(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString CurveName = Params->GetStringField(TEXT("curve_name"));
...
FMegalithActionResult FMegalithAnimationActions::HandleAddSocket(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString BoneName = Params->GetStringField(TEXT("bone_name"));
	...
	if (Skeleton->GetReferenceSkeleton().FindBoneIndex(FName(*BoneName)) == INDEX_NONE)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Bone '%s' not found in skeleton"), *BoneName));

	// Check socket doesn't already exist
	if (Skeleton->FindSocket(FName(*SocketName)))
		return FMegalithActionResult::Error(FString::Printf(TEXT("Socket '%s' already exists"), *SocketName));
...
FMegalithActionResult FMegalithAnimationActions::HandleRemoveSocket(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SocketName = Params->GetStringField(TEXT("socket_name"));
	...
	if (!FoundSocket)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Socket '%s' not found"), *SocketName));
...
FMegalithActionResult FMegalithAnimationActions::HandleSetSocketTransform(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SocketName = Params->GetStringField(TEXT("socket_name"));
	...
	if (!bAnySet)
		return FMegalithActionResult::Error(TEXT("At least one of location, rotation, or scale must be provided"));
...
FMegalithActionResult FMegalithAnimationActions::HandleGetSkeletonCurves(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithAnimationActions::HandleSetBlendSpaceAxis(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (AxisStr.Equals(TEXT("X"), ESearchCase::IgnoreCase))
		...
		return FMegalithActionResult::Error(FString::Printf(TEXT("Invalid axis '%s' — must be X or Y"), *AxisStr));
	...
	if (!BlendParam)
		return FMegalithActionResult::Error(TEXT("Failed to access BlendParameters via reflection"));
	...
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(FString::Printf(TEXT("min (%.2f) must be less than max (%.2f)"), BlendParam->Min, BlendParam->Max));
	}
...
FMegalithActionResult FMegalithAnimationActions::HandleSetRootMotionSettings(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (Params->HasField(TEXT("root_motion_lock")))
	{
		...
		{
			GEditor->EndTransaction();
			return FMegalithActionResult::Error(FString::Printf(TEXT("Invalid root_motion_lock: '%s' — use AnimFirstFrame, Zero, or RefPose"), *LockStr));
		}
		bAnySet = true;
	}
	...
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(TEXT("At least one of enable_root_motion, root_motion_lock, or force_root_lock must be provided"));
	}
...
FMegalithActionResult FMegalithAnimationActions::HandleCreateSequence(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SkeletonPath = Params->GetStringField(TEXT("skeleton_path"));

	USkeleton* Skeleton = FMegalithAssetUtils::LoadAssetByPath<USkeleton>(SkeletonPath);
	if (!Skeleton) return FMegalithActionResult::Error(FString::Printf(TEXT("Skeleton not found: %s"), *SkeletonPath));
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Invalid asset path: %s"), *AssetPath));
	}
	AssetName = AssetPath.Mid(LastSlash + 1);

	// Check if asset already exists
	if (FMegalithAssetUtils::LoadAssetByPath<UObject>(AssetPath))
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Asset already exists at '%s'"), *AssetPath));
	}

	UPackage* Pkg = CreatePackage(*AssetPath);
	if (!Pkg)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create package at '%s'"), *AssetPath));
	}

	UAnimSequence* Seq = NewObject<UAnimSequence>(Pkg, FName(*AssetName), RF_Public | RF_Standalone);
	if (!Seq)
	{
		return FMegalithActionResult::Error(TEXT("Failed to create UAnimSequence object"));
	}
...
FMegalithActionResult FMegalithAnimationActions::HandleDuplicateSequence(const TSharedPtr<FJsonObject>& Params)
{
	FString SourcePath = Params->GetStringField(TEXT("source_path"));
	FString DestPath = Params->GetStringField(TEXT("dest_path"));

	// Check source exists
	UObject* SourceObj = FMegalithAssetUtils::LoadAssetByPath<UObject>(SourcePath);
	if (!SourceObj)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Source asset not found: %s"), *SourcePath));
	}

	// Check dest doesn't exist
	if (FMegalithAssetUtils::LoadAssetByPath<UObject>(DestPath))
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Asset already exists at '%s'"), *DestPath));
	}

	UObject* DuplicatedObj = UEditorAssetLibrary::DuplicateAsset(SourcePath, DestPath);
	if (!DuplicatedObj)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to duplicate '%s' to '%s'"), *SourcePath, *DestPath));
	}
...
FMegalithActionResult FMegalithAnimationActions::HandleCreateMontage(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SkeletonPath = Params->GetStringField(TEXT("skeleton_path"));
	...
	if (!Montage)
	{
		return FMegalithActionResult::Error(TEXT("Failed to create UAnimMontage object"));
	}
...
FMegalithActionResult FMegalithAnimationActions::HandleSetMontageBlend(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(TEXT("At least one of blend_in_time, blend_out_time, blend_out_trigger_time, or enable_auto_blend_out must be provided"));
	}
...
FMegalithActionResult FMegalithAnimationActions::HandleAddMontageSlot(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	for (const FSlotAnimationTrack& Track : Montage->SlotAnimTracks)
	{
		...
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Slot '%s' already exists on montage"), *SlotName));
		}
	}
...
FMegalithActionResult FMegalithAnimationActions::HandleSetMontageSlot(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Invalid slot index %d (montage has %d slots)"), SlotIndex, Montage->SlotAnimTracks.Num()));
	}
...
FMegalithActionResult FMegalithAnimationActions::HandleApplyAnimModifier(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!ModifierUClass)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Modifier class not found: %s"), *ModifierClass));
	}

	if (!ModifierUClass->IsChildOf(UAnimationModifier::StaticClass()))
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Class '%s' is not a UAnimationModifier subclass"), *ModifierClass));
	}
		...
		TArray<TSharedPtr<FJsonValue>>& OutUnresolved) -> int32
	{
		...
		{
			const FString PairKeyStr = MegalithKeyToString(Pair.Key);
	...
	if (bPersist)
	{
		...
		{
			return FMegalithActionResult::Error(TEXT("Failed to register modifier in the AnimationModifiers stack"));
		}
		...
		if (!Registered)
		{
			return FMegalithActionResult::Error(TEXT("Modifier registered but could not be recovered from the stack for apply"));
		}
	...
	else
	{
		...
		if (!Modifier)
		{
			return FMegalithActionResult::Error(TEXT("Failed to create modifier instance"));
		}
		if (bHasProperties)
		{
...
FMegalithActionResult FMegalithAnimationActions::HandleListAnimModifiers(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithAnimationActions::HandleGetCompositeInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));

	UAnimComposite* Composite = FMegalithAssetUtils::LoadAssetByPath<UAnimComposite>(AssetPath);
	if (!Composite) return FMegalithActionResult::Error(FString::Printf(TEXT("AnimComposite not found: %s"), *AssetPath));
...
FMegalithActionResult FMegalithAnimationActions::HandleAddCompositeSegment(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString AnimPath = Params->GetStringField(TEXT("anim_path"));
	...
	UAnimSequenceBase* Anim = FMegalithAssetUtils::LoadAssetByPath<UAnimSequenceBase>(AnimPath);
	if (!Anim) return FMegalithActionResult::Error(FString::Printf(TEXT("Animation not found: %s"), *AnimPath));
...
FMegalithActionResult FMegalithAnimationActions::HandleRemoveCompositeSegment(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Invalid segment index %d (composite has %d segments)"), SegmentIndex, Segments.Num()));
	}
...
FMegalithActionResult FMegalithAnimationActions::HandleGetAbpVariables(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithAnimationActions::HandleGetAbpLinkedAssets(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithAnimationActions::HandleGetCompatibleSkeletons(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithAnimationActions::HandleAddCompatibleSkeleton(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	USkeleton* Compat = FMegalithAssetUtils::LoadAssetByPath<USkeleton>(CompatPath);
	if (!Compat)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Compatible Skeleton not found: %s"), *CompatPath));

	if (Skeleton == Compat)
		return FMegalithActionResult::Error(TEXT("Cannot mark a skeleton compatible with itself"));
...
FMegalithActionResult FMegalithAnimationActions::HandleRemoveCompatibleSkeleton(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	const FString CompatPath = Params->GetStringField(TEXT("compatible_with"));
	bool bSave = true;
...
FMegalithActionResult FMegalithAnimationActions::HandleGetControlRigInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));

	UControlRigBlueprint* CRB = FMegalithAssetUtils::LoadAssetByPath<UControlRigBlueprint>(AssetPath);
	if (!CRB) return FMegalithActionResult::Error(FString::Printf(TEXT("ControlRigBlueprint not found: %s"), *AssetPath));

	URigHierarchy* H = CRB->Hierarchy;
	if (!H) return FMegalithActionResult::Error(TEXT("ControlRigBlueprint has no hierarchy"));
...
FMegalithActionResult FMegalithAnimationActions::HandleGetControlRigVariables(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithAnimationActions::HandleAddControlRigElement(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath    = Params->GetStringField(TEXT("asset_path"));
	...
	if (Name.IsEmpty())
		return FMegalithActionResult::Error(TEXT("name must not be empty"));

	UControlRigBlueprint* CRB = FMegalithAssetUtils::LoadAssetByPath<UControlRigBlueprint>(AssetPath);
	if (!CRB) return FMegalithActionResult::Error(FString::Printf(TEXT("ControlRigBlueprint not found: %s"), *AssetPath));

	URigHierarchyController* HC = CRB->GetHierarchyController();
	if (!HC) return FMegalithActionResult::Error(TEXT("Failed to get hierarchy controller"));

	// Parse element type
	ElementTypeStr.ToLowerInline();
	if (ElementTypeStr != TEXT("bone") && ElementTypeStr != TEXT("control") && ElementTypeStr != TEXT("null"))
		return FMegalithActionResult::Error(TEXT("Invalid element_type — use bone, control, or null"));
	...
	if (Params->TryGetStringField(TEXT("parent"), ParentName) && !ParentName.IsEmpty())
	{
		...
		if (!H || !H->Find(ParentKey))
			return FMegalithActionResult::Error(FString::Printf(TEXT("Parent element not found: %s"), *ParentName));
	}
	...
	if (!ResultKey.IsValid())
		return FMegalithActionResult::Error(TEXT("Failed to create element — AddBone/AddNull/AddControl returned invalid key"));
...
FMegalithActionResult FMegalithAnimationActions::HandleGetIKRigInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));

	UIKRigDefinition* Asset = FMegalithAssetUtils::LoadAssetByPath<UIKRigDefinition>(AssetPath);
	if (!Asset) return FMegalithActionResult::Error(FString::Printf(TEXT("IKRigDefinition not found: %s"), *AssetPath));

	UIKRigController* C = UIKRigController::GetController(Asset);
	if (!C) return FMegalithActionResult::Error(TEXT("Failed to get IKRigController"));
...
FMegalithActionResult FMegalithAnimationActions::HandleAddIKSolver(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (SolverType.IsEmpty())
		return FMegalithActionResult::Error(TEXT("solver_type is required"));
...
FMegalithActionResult FMegalithAnimationActions::HandleRemoveIKSolver(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!Params->HasField(TEXT("solver_index")))
		return FMegalithActionResult::Error(TEXT("solver_index is required"));
...
namespace MegalithRetargetOpReader
{
...
FMegalithActionResult FMegalithAnimationActions::HandleGetRetargeterInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));

	UIKRetargeter* Asset = FMegalithAssetUtils::LoadAssetByPath<UIKRetargeter>(AssetPath);
	if (!Asset) return FMegalithActionResult::Error(FString::Printf(TEXT("IKRetargeter not found: %s"), *AssetPath));

	UIKRetargeterController* C = UIKRetargeterController::GetController(Asset);
	if (!C) return FMegalithActionResult::Error(TEXT("Failed to get UIKRetargeterController"));
		...
		if (const FIKRetargetOpBase* Op = C->GetRetargetOpByIndex(OpIdx))
		{
			...
			if (SettingsStruct && OpSettings)
			{
				...
				OpObj->SetObjectField(TEXT("settings"),
					MegalithRetargetOpReader::StructToJson(SettingsStruct,
...
FMegalithActionResult FMegalithAnimationActions::HandleSetRetargetChainMapping(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FMegalithActionResult::Error(TEXT("Must provide either 'auto_map' or both 'source_chain' and 'target_chain'"));
	}
...
FMegalithActionResult FMegalithAnimationActions::HandleAddStateToMachine(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath   = Params->GetStringField(TEXT("asset_path"));
	FString MachineName = Params->GetStringField(TEXT("machine_name"));
	FString StateName   = Params->GetStringField(TEXT("state_name"));
	...
	if (MachineName.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required parameter: machine_name"));
	if (StateName.IsEmpty())   return FMegalithActionResult::Error(TEXT("Missing required parameter: state_name"));

	UAnimBlueprint* ABP = FMegalithAssetUtils::LoadAssetByPath<UAnimBlueprint>(AssetPath);
	if (!ABP) return FMegalithActionResult::Error(FString::Printf(TEXT("AnimBlueprint not found: %s"), *AssetPath));

	UAnimationStateMachineGraph* SMGraph = FindStateMachineGraphByName(ABP, MachineName);
	if (!SMGraph) return FMegalithActionResult::Error(FString::Printf(TEXT("State machine '%s' not found in ABP"), *MachineName));

	// Reject duplicate state names up front
	if (FindStateNodeByName(SMGraph, StateName))
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("A state named '%s' already exists in machine '%s'"), *StateName, *MachineName));
	}
	...
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(TEXT("Failed to spawn state node"));
	}

	if (!NewNode->BoundGraph)
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(TEXT("State node created but BoundGraph is null — state may be corrupt"));
	}
...
FMegalithActionResult FMegalithAnimationActions::HandleAddConduit(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath   = Params->GetStringField(TEXT("asset_path"));
	FString MachineName = Params->GetStringField(TEXT("machine_name"));
	...
	if (MachineName.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required parameter: machine_name"));
	if (ConduitName.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required parameter: conduit_name"));
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("A state named '%s' already exists in machine '%s'"), *ConduitName, *MachineName));
	}
	if (FindConduitNodeByName(SMGraph, ConduitName))
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("A conduit named '%s' already exists in machine '%s'"), *ConduitName, *MachineName));
	}
	...
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(TEXT("Failed to spawn conduit node"));
	}
	...
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(TEXT("Conduit node created but BoundGraph is null — conduit may be corrupt"));
	}
...
FMegalithActionResult FMegalithAnimationActions::HandleAddTransition(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath   = Params->GetStringField(TEXT("asset_path"));
	FString MachineName = Params->GetStringField(TEXT("machine_name"));
	...
	if (MachineName.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required parameter: machine_name"));
	if (FromState.IsEmpty())   return FMegalithActionResult::Error(TEXT("Missing required parameter: from_state"));
	if (ToState.IsEmpty())     return FMegalithActionResult::Error(TEXT("Missing required parameter: to_state"));
	...
	if (!FromNode) return FMegalithActionResult::Error(FString::Printf(TEXT("State '%s' not found in machine '%s'"), *FromState, *MachineName));

	UAnimStateNode* ToNode = FindStateNodeByName(SMGraph, ToState);
	if (!ToNode) return FMegalithActionResult::Error(FString::Printf(TEXT("State '%s' not found in machine '%s'"), *ToState, *MachineName));

	UEdGraphPin* OutputPin = FromNode->GetOutputPin();
	UEdGraphPin* InputPin  = ToNode->GetInputPin();

	if (!OutputPin) return FMegalithActionResult::Error(FString::Printf(TEXT("Source state '%s' has no output pin"), *FromState));
	if (!InputPin)  return FMegalithActionResult::Error(FString::Printf(TEXT("Target state '%s' has no input pin"), *ToState));
	...
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(TEXT("State machine graph has unexpected or null schema"));
	}
...
FMegalithActionResult FMegalithAnimationActions::HandleRemoveAnimState(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FMegalithActionResult::Error(TEXT("GEditor unavailable"));
	...
	if (!StateNode) return FMegalithActionResult::Error(FString::Printf(TEXT("State '%s' not found in machine '%s'"), *StateName, *MachineName));
...
FMegalithActionResult FMegalithAnimationActions::HandleSetAnimEntryState(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FMegalithActionResult::Error(TEXT("GEditor unavailable"));
	...
	if (!EntryNode) return FMegalithActionResult::Error(FString::Printf(TEXT("State machine '%s' has no entry node (corrupt)"), *MachineName));

	UAnimStateNode* TargetState = FindStateNodeByName(SMGraph, StateName);
	if (!TargetState) return FMegalithActionResult::Error(FString::Printf(TEXT("State '%s' not found in machine '%s'"), *StateName, *MachineName));
	...
	UEdGraphPin* EntryOut = EntryNode->GetOutputPin();
	if (!EntryOut) return FMegalithActionResult::Error(TEXT("Entry node has no output pin"));
	UEdGraphPin* StateIn = TargetState->GetInputPin();
	if (!StateIn) return FMegalithActionResult::Error(FString::Printf(TEXT("Target state '%s' has no input pin"), *StateName));

	const UAnimationStateMachineSchema* Schema = Cast<UAnimationStateMachineSchema>(SMGraph->GetSchema());
	if (!Schema) return FMegalithActionResult::Error(TEXT("State machine graph has unexpected or null schema"));
...
FMegalithActionResult FMegalithAnimationActions::HandleRemoveAnimTransition(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FMegalithActionResult::Error(TEXT("GEditor unavailable"));
...
// canonical capture in MegalithCommonUITemplateActions.cpp.
...
FMegalithActionResult FMegalithAnimationActions::HandleSetTransitionRule(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath    = Params->GetStringField(TEXT("asset_path"));
	FString MachineName  = Params->GetStringField(TEXT("machine_name"));
	FString FromState    = Params->GetStringField(TEXT("from_state"));
	...
	{
		return FMegalithActionResult::Error(ParsedRule.ParseError.IsEmpty()
	...
	else if (ParsedRule.Kind == FParsedTransitionRule::EKind::Expression)
	{
		...
		{
			return FMegalithActionResult::Error(TEXT("kind:expression requires at least one term in 'terms'."));
		}
	...
	if (!RuleGraph)
	{
		return FMegalithActionResult::Error(TEXT("Transition has no bound rule graph"));
	}
	...
	if (!ResultNode)
	{
		return FMegalithActionResult::Error(TEXT("Transition rule graph has no result node"));
	}

	UEdGraphPin* ResultPin = ResultNode->FindPin(TEXT("bCanEnterTransition"), EGPD_Input);
	if (!ResultPin)
	{
		return FMegalithActionResult::Error(TEXT("Could not find bCanEnterTransition pin on transition result node"));
	}
	...
	if (!bAuthored)
	{
		...
		FKismetEditorUtilities::CompileBlueprint(ABP);
		ABP->GetOutermost()->SetDirtyFlag(bWasDirty);
		return FMegalithActionResult::Error(FString::Printf(TEXT("Rule authoring failed (rolled back, no package change): %s"), *AuthorError));
	}
...
FMegalithActionResult FMegalithAnimationActions::HandleGetTransitionRule(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath   = Params->GetStringField(TEXT("asset_path"));
	FString MachineName = Params->GetStringField(TEXT("machine_name"));
	FString FromState   = Params->GetStringField(TEXT("from_state"));
...
FMegalithActionResult FMegalithAnimationActions::HandleCreateStateMachine(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!AnimGraph)
	{
		return FMegalithActionResult::Error(GraphName.IsEmpty()
	...
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(TEXT("Failed to spawn state machine node (SpawnNodeFromTemplate returned null or EditorStateMachineGraph was not created)"));
	}
...
FMegalithActionResult FMegalithAnimationActions::HandleBuildStateMachine(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SMName    = Params->HasField(TEXT("state_machine_name")) ? Params->GetStringField(TEXT("state_machine_name")) : TEXT("New State Machine");
	FString GraphName = Params->HasField(TEXT("graph_name")) ? Params->GetStringField(TEXT("graph_name")) : FString();
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing or empty required parameter: states (array of {name, animation?})"));
	}
	...
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(TEXT("Failed to spawn state machine node"));
	}
	UAnimationStateMachineGraph* SMGraph = Cast<UAnimationStateMachineGraph>(SMNode->EditorStateMachineGraph);
	if (!SMGraph)
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(TEXT("State machine graph has unexpected type"));
	}
	SMGraph->Modify();
	...
	for (const TSharedPtr<FJsonValue>& SV : *StatesJson)
	{
		...
		if ((*StateObj)->HasField(TEXT("animation")))
		{
			...
			if (!AnimPath.IsEmpty())
			{
				UAnimSequenceBase* Seq = FMegalithAssetUtils::LoadAssetByPath<UAnimSequenceBase>(AnimPath);
				if (!Seq)
				{
...
FMegalithActionResult FMegalithAnimationActions::HandleCreateBlendSpace(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SkeletonPath = Params->GetStringField(TEXT("skeleton_path"));
	...
	UPackage* Pkg = CreatePackage(*AssetPath);
	if (!Pkg) return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create package at '%s'"), *AssetPath));

	UBlendSpace* BS = NewObject<UBlendSpace>(Pkg, FName(*AssetName), RF_Public | RF_Standalone);
	if (!BS) return FMegalithActionResult::Error(TEXT("Failed to create UBlendSpace object"));
...
FMegalithActionResult FMegalithAnimationActions::HandleCreateBlendSpace1D(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SkeletonPath = Params->GetStringField(TEXT("skeleton_path"));
	...
	if (!BS) return FMegalithActionResult::Error(TEXT("Failed to create UBlendSpace1D object"));
...
FMegalithActionResult FMegalithAnimationActions::HandleCreateAimOffset(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SkeletonPath = Params->GetStringField(TEXT("skeleton_path"));
	...
	if (!AO) return FMegalithActionResult::Error(TEXT("Failed to create UAimOffsetBlendSpace object"));
...
FMegalithActionResult FMegalithAnimationActions::HandleCreateAimOffset1D(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SkeletonPath = Params->GetStringField(TEXT("skeleton_path"));
	...
	if (!AO) return FMegalithActionResult::Error(TEXT("Failed to create UAimOffsetBlendSpace1D object"));
...
FMegalithActionResult FMegalithAnimationActions::HandleCreateComposite(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SkeletonPath = Params->GetStringField(TEXT("skeleton_path"));
	...
	if (!Composite) return FMegalithActionResult::Error(TEXT("Failed to create UAnimComposite object"));
...
FMegalithActionResult FMegalithAnimationActions::HandleCreateAnimBlueprint(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SkeletonPath = Params->GetStringField(TEXT("skeleton_path"));
	...
	else
	{
		...
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Parent class '%s' not found or not derived from UAnimInstance"), *ParentClassName));
		}
	}
	...
	if (!AnimBP)
		return FMegalithActionResult::Error(TEXT("Failed to create Animation Blueprint via FKismetEditorUtilities::CreateBlueprint"));
...
FMegalithActionResult FMegalithAnimationActions::HandleCompareSkeletons(const TSharedPtr<FJsonObject>& Params)
{
	FString SkeletonPathA = Params->GetStringField(TEXT("skeleton_a"));
	FString SkeletonPathB = Params->GetStringField(TEXT("skeleton_b"));

	USkeleton* SkeletonA = FMegalithAssetUtils::LoadAssetByPath<USkeleton>(SkeletonPathA);
	if (!SkeletonA) return FMegalithActionResult::Error(FString::Printf(TEXT("Skeleton A not found: %s"), *SkeletonPathA));

	USkeleton* SkeletonB = FMegalithAssetUtils::LoadAssetByPath<USkeleton>(SkeletonPathB);
	if (!SkeletonB) return FMegalithActionResult::Error(FString::Printf(TEXT("Skeleton B not found: %s"), *SkeletonPathB));
...
FMegalithActionResult FMegalithAnimationActions::HandleSetSequenceProperties(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (Params->HasField(TEXT("interpolation")))
	{
		...
		{
			GEditor->EndTransaction();
			return FMegalithActionResult::Error(FString::Printf(TEXT("Invalid interpolation: '%s' — use Linear or Step"), *InterpStr));
		}
		bAnySet = true;
	}
	...
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(TEXT("At least one of rate_scale, loop, or interpolation must be provided"));
	}
...
FMegalithActionResult FMegalithAnimationActions::HandleSetAdditiveSettings(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (Params->HasField(TEXT("additive_anim_type")))
	{
		...
		{
			GEditor->EndTransaction();
			return FMegalithActionResult::Error(FString::Printf(TEXT("Invalid additive_anim_type: '%s' — use NoAdditive, LocalSpace, or MeshSpace"), *TypeStr));
		}
		bAnySet = true;
	}
	...
	if (Params->HasField(TEXT("ref_pose_type")))
	{
		...
		{
			GEditor->EndTransaction();
			return FMegalithActionResult::Error(FString::Printf(TEXT("Invalid ref_pose_type: '%s' — use RefPose, AnimScaled, AnimFrame, or LocalAnimFrame"), *RefStr));
		}
		bAnySet = true;
	}
	...
	if (Params->HasField(TEXT("ref_pose_seq")))
	{
		...
		{
			UAnimSequence* RefSeq = FMegalithAssetUtils::LoadAssetByPath<UAnimSequence>(RefSeqPath);
			if (!RefSeq)
			{
				GEditor->EndTransaction();
				return FMegalithActionResult::Error(FString::Printf(TEXT("Reference pose sequence not found: %s"), *RefSeqPath));
			}
	...
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(TEXT("At least one of additive_anim_type, ref_pose_type, ref_frame_index, or ref_pose_seq must be provided"));
	}
...
FMegalithActionResult FMegalithAnimationActions::HandleSetCompressionSettings(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (Params->HasField(TEXT("bone_compression")))
	{
		...
		{
			UAnimBoneCompressionSettings* BoneComp = FMegalithAssetUtils::LoadAssetByPath<UAnimBoneCompressionSettings>(BoneCompPath);
			if (!BoneComp)
			{
				GEditor->EndTransaction();
				return FMegalithActionResult::Error(FString::Printf(TEXT("Bone compression settings not found: %s"), *BoneCompPath));
			}
	...
	if (Params->HasField(TEXT("curve_compression")))
	{
		...
		{
			UAnimCurveCompressionSettings* CurveComp = FMegalithAssetUtils::LoadAssetByPath<UAnimCurveCompressionSettings>(CurveCompPath);
			if (!CurveComp)
			{
				GEditor->EndTransaction();
				return FMegalithActionResult::Error(FString::Printf(TEXT("Curve compression settings not found: %s"), *CurveCompPath));
			}
	...
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(TEXT("At least one of bone_compression or curve_compression must be provided"));
	}
...
FMegalithActionResult FMegalithAnimationActions::HandleGetSyncMarkers(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithAnimationActions::HandleAddSyncMarker(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithAnimationActions::HandleRemoveSyncMarker(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!bHasName && !bHasIndex)
		return FMegalithActionResult::Error(TEXT("Either marker_name or marker_index must be provided"));
	...
	if (bHasIndex)
	{
		...
		{
			GEditor->EndTransaction();
			return FMegalithActionResult::Error(FString::Printf(TEXT("Invalid marker_index: %d (have %d markers)"), MarkerIndex, Seq->AuthoredSyncMarkers.Num()));
		}
...
FMegalithActionResult FMegalithAnimationActions::HandleRenameSyncMarker(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (RenamedCount == 0)
		return FMegalithActionResult::Error(FString::Printf(TEXT("No sync markers found with name '%s'"), *OldName));
...
FMegalithActionResult FMegalithAnimationActions::HandleBatchExecute(const TSharedPtr<FJsonObject>& Params)
{
	...
	else if (OpsField->Type == EJson::String)
	{
		...
		{
			return FMegalithActionResult::Error(TEXT("Failed to parse operations string as JSON array"));
		}
	}
	else
	{
	...
	if (Ops.Num() == 0)
	{
		return FMegalithActionResult::Error(TEXT("operations array is empty"));
	}

	bool bStopOnError = false;
	Params->TryGetBoolField(TEXT("stop_on_error"), bStopOnError);

	GEditor->BeginTransaction(NSLOCTEXT("Megalith", "AnimBatchExec", "Animation Batch Execute"));
	...
	for (int32 i = 0; i < Ops.Num(); ++i)
	{
		...
		{
			const FString OpFieldKey = MegalithKeyToString(Pair.Key);
		...
		FMegalithActionResult SubResult = FMegalithActionResult::Error(FString::Printf(TEXT("Unknown op: %s"), *OpName));
	...
	return FMegalithActionResult::Success(Final);
}

// ---------------------------------------------------------------------------

FMegalithActionResult FMegalithAnimationActions::HandleAddMontageAnimSegment(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString AnimPath = Params->GetStringField(TEXT("anim_path"));
	...
	if (SlotIndex < 0 || SlotIndex >= Montage->SlotAnimTracks.Num())
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Invalid slot_index %d (montage has %d slots)"), SlotIndex, Montage->SlotAnimTracks.Num()));
	}
...
FMegalithActionResult FMegalithAnimationActions::HandleCloneNotifySetup(const TSharedPtr<FJsonObject>& Params)
{
	FString SourcePath = Params->GetStringField(TEXT("source_path"));
	...
	UAnimSequenceBase* Source = FMegalithAssetUtils::LoadAssetByPath<UAnimSequenceBase>(SourcePath);
	if (!Source) return FMegalithActionResult::Error(FString::Printf(TEXT("Source animation not found: %s"), *SourcePath));

	UAnimSequenceBase* Target = FMegalithAssetUtils::LoadAssetByPath<UAnimSequenceBase>(TargetPath);
	if (!Target) return FMegalithActionResult::Error(FString::Printf(TEXT("Target animation not found: %s"), *TargetPath));

	if (Source == Target)
		return FMegalithActionResult::Error(TEXT("Source and target cannot be the same asset"));

	if (Source->Notifies.Num() == 0)
		return FMegalithActionResult::Error(TEXT("Source has no notifies to clone"));
...
FMegalithActionResult FMegalithAnimationActions::HandleBulkAddNotify(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (!PathsField.IsValid())
		return FMegalithActionResult::Error(TEXT("Missing required field: asset_paths"));
	...
	else if (PathsField->Type == EJson::String)
	{
		...
		if (!FJsonSerializer::Deserialize(Reader, PathValues))
			return FMegalithActionResult::Error(TEXT("Failed to parse asset_paths string as JSON array"));
	}
	else
	{
		return FMegalithActionResult::Error(TEXT("'asset_paths' must be an array"));
	}

	if (PathValues.Num() == 0)
		return FMegalithActionResult::Error(TEXT("asset_paths array is empty"));
	...
	if (!NotifyClass)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Notify class not found: %s"), *NotifyClassName));

	if (NotifyClass->IsChildOf(UAnimNotifyState::StaticClass()))
	{
		bIsNotifyState = true;
		if (!bIsState)
			return FMegalithActionResult::Error(TEXT("Notify class is a state notify — 'duration' parameter is required"));
	}
	else if (!NotifyClass->IsChildOf(UAnimNotify::StaticClass()))
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Class '%s' is not a UAnimNotify or UAnimNotifyState subclass"), *NotifyClassName));
	}
...
FMegalithActionResult FMegalithAnimationActions::HandleCreateMontageFromSections(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SkeletonPath = Params->GetStringField(TEXT("skeleton_path"));
	...
	FMegalithActionResult CreateResult = HandleCreateMontage(CreateParams);
	if (!CreateResult.bSuccess)
		return CreateResult;

	UAnimMontage* Montage = FMegalithAssetUtils::LoadAssetByPath<UAnimMontage>(AssetPath);
	if (!Montage)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Created montage but failed to load: %s"), *AssetPath));
	...
	if (Params->TryGetArrayField(TEXT("sections"), SectionsArr) && SectionsArr)
	{
		...
		for (int32 i = 0; i < SectionsArr->Num(); ++i)
		{
			...
			{
				UAnimSequenceBase* Anim = FMegalithAssetUtils::LoadAssetByPath<UAnimSequenceBase>(SectionAnimPath);
				if (Anim)
				{
					FAnimSegment NewSeg;
					NewSeg.SetAnimReference(Anim);
...
FMegalithActionResult FMegalithAnimationActions::HandleBuildSequenceFromPoses(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SkeletonPath = Params->GetStringField(TEXT("skeleton_path"));
	...
	if (!FramesField.IsValid())
		return FMegalithActionResult::Error(TEXT("Missing required field: frames"));
	...
	else if (FramesField->Type == EJson::String)
	{
		...
		if (!FJsonSerializer::Deserialize(Reader, FramesArr))
			return FMegalithActionResult::Error(TEXT("Failed to parse frames string as JSON array"));
	}
	else
	{
		return FMegalithActionResult::Error(TEXT("'frames' must be an array"));
	}

	if (FramesArr.Num() == 0)
		return FMegalithActionResult::Error(TEXT("frames array is empty"));
	...
	if (!Seq)
	{
		...
		if (!Seq) return FMegalithActionResult::Error(TEXT("Failed to create UAnimSequence object"));
	...
	if (BoneNameSet.Num() == 0)
		return FMegalithActionResult::Error(TEXT("No bone data found in frames"));
...
FMegalithActionResult FMegalithAnimationActions::HandleSetNotifyProperties(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	int32 NotifyIndex = static_cast<int32>(Params->GetNumberField(TEXT("notify_index")));
	...
	if (NotifyIndex < 0 || NotifyIndex >= Seq->Notifies.Num())
		return FMegalithActionResult::Error(FString::Printf(TEXT("Invalid notify_index %d (asset has %d notifies)"), NotifyIndex, Seq->Notifies.Num()));
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Notify at index %d has no Notify or NotifyStateClass object"), NotifyIndex));
	}
	...
	if (!Params->TryGetObjectField(TEXT("properties"), PropsPtr) || !PropsPtr || !PropsPtr->IsValid())
	{
		...
		if (Params->TryGetStringField(TEXT("properties"), PropsString))
		{
			...
			{
				return FMegalithActionResult::Error(TEXT("Failed to parse 'properties' as JSON object"));
			}
		}
		else
		{
			return FMegalithActionResult::Error(TEXT("'properties' parameter is required and must be a JSON object"));
		}
	}

	if (!PropsPtr || !PropsPtr->IsValid() || (*PropsPtr)->Values.Num() == 0)
		return FMegalithActionResult::Error(TEXT("'properties' object is empty"));
	...
	{
		const FString PropName = MegalithKeyToString(Pair.Key);
...
FMegalithActionResult FMegalithAnimationActions::HandleGetPhysicsAssetInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));

	UPhysicsAsset* PhysAsset = FMegalithAssetUtils::LoadAssetByPath<UPhysicsAsset>(AssetPath);
	if (!PhysAsset) return FMegalithActionResult::Error(FString::Printf(TEXT("Physics asset not found: %s"), *AssetPath));
...
FMegalithActionResult FMegalithAnimationActions::HandleSetBodyProperties(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString BoneName = Params->GetStringField(TEXT("bone_name"));
	...
	if (BodyIdx == INDEX_NONE)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Body not found for bone: %s"), *BoneName));

	USkeletalBodySetup* BodySetup = PhysAsset->SkeletalBodySetups[BodyIdx];
	if (!BodySetup) return FMegalithActionResult::Error(TEXT("BodySetup is null"));
...
FMegalithActionResult FMegalithAnimationActions::HandleSetConstraintProperties(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (ConstraintIdx == INDEX_NONE || !PhysAsset->ConstraintSetup.IsValidIndex(ConstraintIdx))
		return FMegalithActionResult::Error(TEXT("Constraint not found. Provide constraint_index or bone_1+bone_2 pair."));

	UPhysicsConstraintTemplate* CT = PhysAsset->ConstraintSetup[ConstraintIdx];
	if (!CT) return FMegalithActionResult::Error(TEXT("Constraint template is null"));
...
FMegalithActionResult FMegalithAnimationActions::HandleAddRetargetChain(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (ResultName.IsNone())
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to add retarget chain '%s'"), *ChainName));
...
FMegalithActionResult FMegalithAnimationActions::HandleRemoveRetargetChain(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString ChainName = Params->GetStringField(TEXT("chain_name"));
	...
	if (!bSuccess)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to remove retarget chain '%s' — chain may not exist"), *ChainName));
...
FMegalithActionResult FMegalithAnimationActions::HandleSetRetargetChainBones(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString ChainName = Params->GetStringField(TEXT("chain_name"));
	...
	if (!Chain)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Retarget chain not found: %s"), *ChainName));
	...
	if (Params->TryGetStringField(TEXT("start_bone"), StartBone) && !StartBone.IsEmpty())
	{
		...
		if (!bOk) return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to set start bone '%s' on chain '%s'"), *StartBone, *ChainName));
	...
	if (Params->TryGetStringField(TEXT("end_bone"), EndBone) && !EndBone.IsEmpty())
	{
		...
		if (!bOk) return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to set end bone '%s' on chain '%s'"), *EndBone, *ChainName));
	...
	if (Params->TryGetStringField(TEXT("goal_name"), GoalStr) && !GoalStr.IsEmpty())
	{
		...
		if (!bOk) return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to set goal '%s' on chain '%s'"), *GoalStr, *ChainName));
	...
	if (Params->TryGetStringField(TEXT("new_name"), NewName) && !NewName.IsEmpty())
	{
		...
		if (RenamedName.IsNone())
			return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to rename chain '%s' to '%s'"), *ChainName, *NewName));
...
FMegalithActionResult FMegalithAnimationActions::HandleCreateIKRig(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString MeshPath = Params->GetStringField(TEXT("skeletal_mesh_path"));

	USkeletalMesh* Mesh = FMegalithAssetUtils::LoadAssetByPath<USkeletalMesh>(MeshPath);
	if (!Mesh) return FMegalithActionResult::Error(FString::Printf(TEXT("Skeletal mesh not found: %s"), *MeshPath));
	...
	if (!Rig) return FMegalithActionResult::Error(TEXT("Failed to create UIKRigDefinition object"));

	UIKRigController* C = UIKRigController::GetController(Rig);
	if (!C) return FMegalithActionResult::Error(TEXT("Failed to get IKRigController for new rig"));

	// Loads the mesh's skeleton into the rig's IKRigSkeleton.
	const bool bMeshSet = C->SetSkeletalMesh(Mesh);
	if (!bMeshSet)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("SetSkeletalMesh failed — mesh '%s' incompatible with IK Rig"), *MeshPath));
	}
...
FMegalithActionResult FMegalithAnimationActions::HandleCreateIKRetargeter(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!Retargeter) return FMegalithActionResult::Error(TEXT("Failed to create UIKRetargeter object"));

	UIKRetargeterController* C = UIKRetargeterController::GetController(Retargeter);
	if (!C) return FMegalithActionResult::Error(TEXT("Failed to get UIKRetargeterController for new retargeter"));
	...
	{
		UIKRigDefinition* SourceRig = FMegalithAssetUtils::LoadAssetByPath<UIKRigDefinition>(SourceRigPath);
		if (!SourceRig) return FMegalithActionResult::Error(FString::Printf(TEXT("Source IK Rig not found: %s"), *SourceRigPath));
	...
	{
		UIKRigDefinition* TargetRig = FMegalithAssetUtils::LoadAssetByPath<UIKRigDefinition>(TargetRigPath);
		if (!TargetRig) return FMegalithActionResult::Error(FString::Printf(TEXT("Target IK Rig not found: %s"), *TargetRigPath));
...
FMegalithActionResult FMegalithAnimationActions::HandleSetRetargeterRigs(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	UIKRetargeter* Retargeter = FMegalithAssetUtils::LoadAssetByPath<UIKRetargeter>(AssetPath);
	if (!Retargeter) return FMegalithActionResult::Error(FString::Printf(TEXT("IKRetargeter not found: %s"), *AssetPath));
	...
	{
		USkeletalMesh* SourceMesh = FMegalithAssetUtils::LoadAssetByPath<USkeletalMesh>(SourceMeshPath);
		if (!SourceMesh)
		{
			GEditor->EndTransaction();
			return FMegalithActionResult::Error(FString::Printf(TEXT("Source preview mesh not found: %s"), *SourceMeshPath));
		}
	...
	{
		USkeletalMesh* TargetMesh = FMegalithAssetUtils::LoadAssetByPath<USkeletalMesh>(TargetMeshPath);
		if (!TargetMesh)
		{
			GEditor->EndTransaction();
			return FMegalithActionResult::Error(FString::Printf(TEXT("Target preview mesh not found: %s"), *TargetMeshPath));
		}
...
FMegalithActionResult FMegalithAnimationActions::HandleBatchRetargetAnimations(const TSharedPtr<FJsonObject>& Params)
{
	...
	UIKRetargeter* Retargeter = FMegalithAssetUtils::LoadAssetByPath<UIKRetargeter>(RetargeterPath);
	if (!Retargeter) return FMegalithActionResult::Error(FString::Printf(TEXT("IKRetargeter not found: %s"), *RetargeterPath));
	...
	{
		SourceMesh = FMegalithAssetUtils::LoadAssetByPath<USkeletalMesh>(SourceMeshPath);
		if (!SourceMesh) return FMegalithActionResult::Error(FString::Printf(TEXT("Source mesh not found: %s"), *SourceMeshPath));
	}
	else
	{
	...
	{
		TargetMesh = FMegalithAssetUtils::LoadAssetByPath<USkeletalMesh>(TargetMeshPath);
		if (!TargetMesh) return FMegalithActionResult::Error(FString::Printf(TEXT("Target mesh not found: %s"), *TargetMeshPath));
	}
	else
	{
	...
	if (!SourceMesh) return FMegalithActionResult::Error(TEXT("No source mesh — pass 'source_mesh' or set the retargeter's source preview mesh"));
	if (!TargetMesh) return FMegalithActionResult::Error(TEXT("No target mesh — pass 'target_mesh' or set the retargeter's target preview mesh"));
	if (SourceMesh == TargetMesh) return FMegalithActionResult::Error(TEXT("Source and target meshes must differ"));
	...
	{
		return FMegalithActionResult::Error(TEXT("'source_anims' must be a non-empty array of animation asset paths"));
	}
	...
	for (const TSharedPtr<FJsonValue>& Val : *AnimsArray)
	{
		...
		UAnimationAsset* Anim = FMegalithAssetUtils::LoadAssetByPath<UAnimationAsset>(AnimPath);
		if (!Anim)
		{
	...
	{
		return FMegalithActionResult::Error(TEXT("No valid animation assets resolved from 'source_anims'"));
	}
	...
	if (!Context.IsValid())
	{
		return FMegalithActionResult::Error(TEXT("Batch context invalid — check source/target meshes and retargeter"));
	}
	...
	for (const FString& Expected : ExpectedPaths)
	{
		...
		if (UObject* Created = FMegalithAssetUtils::LoadAssetByPath<UObject>(PackagePath))
		{
...
// ---------------------------------------------------------------------------
FMegalithActionResult FMegalithAnimationActions::HandleCopyBonePoseBetweenSequences(const TSharedPtr<FJsonObject>& Params)
{
	FString SourcePath = Params->GetStringField(TEXT("source_path"));
	FString DestPath = Params->GetStringField(TEXT("dest_path"));
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing or empty required field: bone_names"));
	}

	UAnimSequence* SourceSeq = FMegalithAssetUtils::LoadAssetByPath<UAnimSequence>(SourcePath);
	if (!SourceSeq) return FMegalithActionResult::Error(FString::Printf(TEXT("Source AnimSequence not found: %s"), *SourcePath));

	UAnimSequence* DestSeq = FMegalithAssetUtils::LoadAssetByPath<UAnimSequence>(DestPath);
	if (!DestSeq) return FMegalithActionResult::Error(FString::Printf(TEXT("Dest AnimSequence not found: %s"), *DestPath));
	...
	if (!SourceSkel || !DestSkel) return FMegalithActionResult::Error(TEXT("Source or destination has no skeleton assigned"));

	const IAnimationDataModel* DestDataModel = DestSeq->GetDataModel();
	if (!DestDataModel) return FMegalithActionResult::Error(TEXT("Destination has no animation data model"));
...
namespace MegalithAnimNodeBindingHelpers
{
...
FMegalithActionResult FMegalithAnimationActions::HandleGetAnimNodeFunctionBindings(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString NodeId;
	...
	auto EmitNode = [OwnerClass](UAnimGraphNode_Base* AnimNode, UEdGraph* Graph) -> TSharedPtr<FJsonObject>
	{
		...
		NodeObj->SetObjectField(TEXT("initial_update"),
			MegalithAnimNodeBindingReader::SerializeFunctionBinding(AnimNode->InitialUpdateFunction, OwnerClass));
		NodeObj->SetObjectField(TEXT("become_relevant"),
			MegalithAnimNodeBindingReader::SerializeFunctionBinding(AnimNode->BecomeRelevantFunction, OwnerClass));
		NodeObj->SetObjectField(TEXT("update"),
			MegalithAnimNodeBindingReader::SerializeFunctionBinding(AnimNode->UpdateFunction, OwnerClass));
		return NodeObj;
	};
	...
	if (!NodeId.IsEmpty())
	{
		...
		UAnimGraphNode_Base* AnimNode = MegalithAnimNodeBindingHelpers::FindAnimNode(ABP, NodeId, GraphFilter);
		if (!AnimNode)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Anim node not found: %s"), *NodeId));
		}
	...
	else
	{
		...
		for (UEdGraph* Graph : AllGraphs)
		{
			...
			for (UEdGraphNode* Node : Graph->Nodes)
			{
				UAnimGraphNode_Base* AnimNode = Cast<UAnimGraphNode_Base>(Node);
				if (!AnimNode) continue;
				if (!MegalithAnimNodeBindingReader::HasAnyFunctionBinding(AnimNode)) continue;
...
FMegalithActionResult FMegalithAnimationActions::HandleSetAnimNodeFunctionBinding(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FMegalithActionResult::Error(TEXT("binding must be one of: initial_update, become_relevant, update"));
	}
	...
	UAnimGraphNode_Base* AnimNode = MegalithAnimNodeBindingHelpers::FindAnimNode(ABP, NodeId, GraphFilter);
	if (!AnimNode) return FMegalithActionResult::Error(FString::Printf(TEXT("Anim node not found: %s"), *NodeId));

	FName PropertyName = NAME_None;
	FMemberReference* Ref = MegalithAnimNodeBindingHelpers::ResolveFunctionRef(AnimNode, Binding, PropertyName);
	if (!Ref) return FMegalithActionResult::Error(TEXT("Could not resolve the function-binding member reference"));
	...
	else
	{
		...
		if (!FunctionClassPath.IsEmpty())
		{
			...
			if (!FunctionClass)
			{
				return FMegalithActionResult::Error(FString::Printf(TEXT("function_class not found: %s"), *FunctionClassPath));
			}
		}
...
FMegalithActionResult FMegalithAnimationActions::HandleGetAnimNodePinBindings(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString NodeId;
	Params->TryGetStringField(TEXT("node_id"), NodeId);
	...
	auto EmitNode = [](UAnimGraphNode_Base* AnimNode, UEdGraph* Graph) -> TSharedPtr<FJsonObject>
	{
		...
		FString Note;
		MegalithAnimNodeBindingReader::ReadPinBindings(AnimNode, Entries, Note);
		...
		for (UEdGraph* Graph : AllGraphs)
		{
			...
			for (UEdGraphNode* Node : Graph->Nodes)
			{
				...
				const bool bHasPropertyBinding =
					MegalithAnimNodeBindingReader::ReadPinBindings(AnimNode, Probe, ProbeNote) > 0;
...
FMegalithActionResult FMegalithAnimationActions::HandleSetAnimNodePinBinding(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString NodeId = Params->GetStringField(TEXT("node_id"));
	...
	if (Pin.IsEmpty()) return FMegalithActionResult::Error(TEXT("pin (PropertyName) is required"));
	...
	bool bHasMap = MegalithAnimNodeBindingReader::ResolvePropertyBindingsMap(AnimNode, MapProp, MapPtr, BindingObj);
	...
	else
	{
		...
		if (!bHasMap)
		{
			...
			//    same property the reader reads at MegalithAnimNodeBindingReader.h:139-141.
			...
			bHasMap = MegalithAnimNodeBindingReader::ResolvePropertyBindingsMap(AnimNode, MapProp, MapPtr, BindingObj);
			if (!bHasMap)
			{
				return FMegalithActionResult::Error(
		...
		{
			return FMegalithActionResult::Error(TEXT("PropertyBindings value type is not FAnimGraphNodePropertyBinding"));
		}
		FNameProperty* KeyProp = CastField<FNameProperty>(MapProp->KeyProp);
		if (!KeyProp)
		{
			return FMegalithActionResult::Error(TEXT("PropertyBindings key type is not FName"));
		}
...
//
// File-local helpers below are deliberately namespace-scoped (Megalith::FootSync)
// to avoid file-local-symbol collisions under full-unity release builds.
namespace Megalith { namespace FootSync {
...
}} // namespace Megalith::FootSync

FMegalithActionResult FMegalithAnimationActions::HandleDeriveFootSyncMarkers(const TSharedPtr<FJsonObject>& Params)
{
	using namespace Megalith::FootSync;
	...
	{
		return FMegalithActionResult::Error(TEXT("thresholds.sample_rate must be > 0"));
	}
	...
	if (!Seq)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("AnimSequence not found: %s"), *AssetPath));
	}
	...
	if (Source.IsEmpty() && Method == TEXT("from_bones"))
	{
		...
		if (!Skeleton)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("method=from_bones: no skeleton on %s"), *AssetPath));
		}
	...
	if (Source.IsEmpty() && WantSignal(TEXT("footspeed")))
	{
		...
		if (!Skeleton)
		{
			...
			{
				return FMegalithActionResult::Error(FString::Printf(TEXT("method=footspeed: no skeleton on %s"), *AssetPath));
			}
		}
		else
		{
