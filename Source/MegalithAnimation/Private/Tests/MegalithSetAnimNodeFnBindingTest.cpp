...
// =============================================================================
// MegalithSetAnimNodeFnBindingTest.cpp
//
// Regression test for the set_anim_node_function_binding subsystem-refresh fix.
//
// THE FIX (HandleSetAnimNodeFunctionBinding, MegalithAnimationActions.cpp):
...
//
// WHAT THIS ASSERTS:
//   Create a disposable AnimBlueprint in /Game/Tests/Megalith/, add a sequence-player
...
//   path (FMegalithAnimationActions::HandleSetAnimNodeFunctionBinding), and after the
...
namespace MegalithSetAnimNodeFnBindingTest
{
	static const TCHAR* const TestAbpPath = TEXT("/Game/Tests/Megalith/ABP_FnBindingRefreshTest");
	static const TCHAR* const TestFuncName = TEXT("MegalithTestBecomeRelevant");
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithAnimNodeFnBindingSubsystemRefreshTest,
	"Megalith.AnimNodeFnBinding.SubsystemRefresh",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithAnimNodeFnBindingSubsystemRefreshTest::RunTest(const FString& /*Parameters*/)
{
	using namespace MegalithSetAnimNodeFnBindingTest;
	...
	FMegalithActionResult BindResult = FMegalithAnimationActions::HandleSetAnimNodeFunctionBinding(BindParams);
	if (!TestTrue(
