...
void FMegalithAbpWriteActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	// --- add_anim_graph_node ---
	Registry.RegisterAction(TEXT("animation"), TEXT("add_anim_graph_node"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddAnimGraphNode),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("connect_anim_graph_pins"),
		...
		FMegalithActionHandler::CreateStatic(&HandleConnectAnimGraphPins),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_state_animation"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetStateAnimation),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_variable_get"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddVariableGet),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_anim_graph_node_property"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetAnimGraphNodeProperty),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("configure_pose_history_node"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAbpWriteActions::HandleConfigurePoseHistoryNode),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("configure_motion_matching_node"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAbpWriteActions::HandleConfigureMotionMatchingNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("abp_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("build_motion_matching_node"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAbpWriteActions::HandleBuildMotionMatchingNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("abp_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_anim_graph_output_connection"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAbpWriteActions::HandleGetAnimGraphOutputConnection),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("abp_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("build_foot_ik_pass"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAbpWriteActions::HandleBuildFootIkPass),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("abp_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("assign_post_process_anim_rig"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAbpWriteActions::HandleAssignPostProcessAnimRig),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_apply_additive"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAbpWriteActions::HandleAddApplyAdditive),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_apply_mesh_space_additive"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAbpWriteActions::HandleAddApplyMeshSpaceAdditive),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
			.Optional(TEXT("base_node"), TEXT("string"), TEXT("Node whose pose output drives the Base input (must be in the same graph)"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_slot_node"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAbpWriteActions::HandleAddSlotNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_save_cached_pose"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAbpWriteActions::HandleAddSaveCachedPose),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_use_cached_pose"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAbpWriteActions::HandleAddUseCachedPose),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_output_pose_source"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAbpWriteActions::HandleSetOutputPoseSource),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_state_result_source"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAbpWriteActions::HandleSetStateResultSource),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_blend_by_int"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAbpWriteActions::HandleAddBlendByInt),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_blend_by_enum"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAbpWriteActions::HandleAddBlendByEnum),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_sync_group"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAbpWriteActions::HandleSetSyncGroup),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_layered_blend_bones"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAbpWriteActions::HandleSetLayeredBlendBones),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_anim_control_rig_node"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAbpWriteActions::HandleAddAnimControlRigNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_linked_anim_layer"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAbpWriteActions::HandleAddLinkedAnimLayer),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_anim_layer_graph"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAbpWriteActions::HandleAddAnimLayerGraph),
		FParamSchemaBuilder()
...
FMegalithActionResult FMegalithAbpWriteActions::HandleAddAnimGraphNode(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (!NodeClass)
	{
		return FMegalithActionResult::Error(ClassError);
	}

	// Resolve the target graph
	FString GraphError;
	UEdGraph* TargetGraph = ResolveTargetGraph(ABP, GraphName, StateName, GraphError);
	if (!TargetGraph) return FMegalithActionResult::Error(GraphError);
	...
	if (!Template)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create node template for class '%s'"), *NodeClass->GetPathName()));
	}
	...
	if (!AnimAsset.IsEmpty())
	{
		...
		if (AssetPlayer)
		{
			UAnimationAsset* Asset = FMegalithAssetUtils::LoadAssetByPath<UAnimationAsset>(AnimAsset);
			if (!Asset)
			{
				return FMegalithActionResult::Error(FString::Printf(TEXT("Animation asset not found: %s"), *AnimAsset));
			}
		...
		else
		{
			...
			UE_LOG(LogTemp, Warning, TEXT("Megalith: Node type '%s' does not support anim_asset parameter — ignored"), *NodeType);
		}
	}
	...
	if (!SpawnedNode)
	{
		return FMegalithActionResult::Error(TEXT("PerformAction failed — node was not spawned. Check that the target graph supports this node type."));
	}
...
FMegalithActionResult FMegalithAbpWriteActions::HandleConnectAnimGraphPins(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath  = Params->GetStringField(TEXT("asset_path"));
	...
	if (SourceNode.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required parameter: source_node"));
	if (SourcePin.IsEmpty())  return FMegalithActionResult::Error(TEXT("Missing required parameter: source_pin"));
	if (TargetNode.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required parameter: target_node"));
	if (TargetPin.IsEmpty())  return FMegalithActionResult::Error(TEXT("Missing required parameter: target_pin"));
	...
	if (!SrcNode)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Source node '%s' not found in ABP"), *SourceNode));
	}

	UEdGraphNode* DstNode = FindNodeByName(ABP, TargetNode, ScopeGraph);
	if (!DstNode)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Target node '%s' not found in ABP"), *TargetNode));
	}
...
FMegalithActionResult FMegalithAbpWriteActions::HandleSetStateAnimation(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath    = Params->GetStringField(TEXT("asset_path"));
	...
	if (AnimAssetPath.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required parameter: anim_asset_path"));
	...
	UAnimationStateGraph* StateGraph = Cast<UAnimationStateGraph>(StateNode->BoundGraph);
	if (!StateGraph) return FMegalithActionResult::Error(FString::Printf(TEXT("State '%s' has no inner animation graph"), *StateName));

	UAnimGraphNode_StateResult* ResultNode = StateGraph->MyResultNode;
	if (!ResultNode) return FMegalithActionResult::Error(FString::Printf(TEXT("State '%s' has no result node — state graph may be corrupt"), *StateName));

	// Load the animation asset
	UAnimationAsset* AnimAsset = FMegalithAssetUtils::LoadAssetByPath<UAnimationAsset>(AnimAssetPath);
	if (!AnimAsset) return FMegalithActionResult::Error(FString::Printf(TEXT("Animation asset not found: %s"), *AnimAssetPath));
	...
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(TEXT("Could not find 'Result' input pin on state result node"));
	}
	...
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(TEXT("Failed to create animation player node template"));
	}
	...
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(TEXT("PerformAction failed — animation player node was not spawned"));
	}
	...
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(TEXT("Spawned node has no 'Pose' output pin — cannot wire to state result"));
	}
	...
	if (!bWired)
	{
		return FMegalithActionResult::Error(TEXT("TryCreateConnection failed wiring Pose -> Result. The node was spawned but not connected."));
	}
...
FMegalithActionResult FMegalithAbpWriteActions::HandleAddVariableGet(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (VarName.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required parameter: variable_name"));
	...
	if (!SpawnedNode)
	{
		return FMegalithActionResult::Error(TEXT("PerformAction failed for K2Node_VariableGet."));
	}
...
FMegalithActionResult FMegalithAbpWriteActions::HandleSetAnimGraphNodeProperty(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath    = Params->GetStringField(TEXT("asset_path"));
	...
	if (NodeId.IsEmpty())       return FMegalithActionResult::Error(TEXT("Missing required parameter: node_id"));
	if (PropertyPath.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required parameter: property_path"));
	...
	if (bScopeSupplied)
	{
		...
		{
			return FMegalithActionResult::Error(ScopeError);
		}
	}
	...
	if (!FoundNode)
	{
		return FMegalithActionResult::Error(bScopeSupplied
			? FString::Printf(
	...
	{
		return FMegalithActionResult::Error(ResolveError);
	}
...
FMegalithActionResult FMegalithAbpWriteActions::HandleConfigurePoseHistoryNode(const TSharedPtr<FJsonObject>& Params)
{
	const FString AbpPath = Params->GetStringField(TEXT("abp_path"));
	const FString NodeId  = Params->GetStringField(TEXT("node_id"));
	if (NodeId.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required parameter: node_id"));

	UAnimBlueprint* ABP = FMegalithAssetUtils::LoadAssetByPath<UAnimBlueprint>(AbpPath);
	if (!ABP) return FMegalithActionResult::Error(FString::Printf(TEXT("AnimBlueprint not found: %s"), *AbpPath));

	UEdGraphNode* FoundNode = FindNodeByName(ABP, NodeId, nullptr);
	if (!FoundNode) return FMegalithActionResult::Error(FString::Printf(TEXT("Node '%s' not found"), *NodeId));

	UAnimGraphNode_Base* AnimNode = Cast<UAnimGraphNode_Base>(FoundNode);
	if (!AnimNode) return FMegalithActionResult::Error(FString::Printf(
	...
	if (Params->TryGetBoolField(TEXT("generate_trajectory"), bGenTraj))
	{
		...
		{ GEditor->EndTransaction(); return FMegalithActionResult::Error(WriteError); }
...
FMegalithActionResult FMegalithAbpWriteActions::HandleConfigureMotionMatchingNode(const TSharedPtr<FJsonObject>& Params)
{
	const FString AbpPath = Params->GetStringField(TEXT("abp_path"));
	const FString NodeId  = Params->GetStringField(TEXT("node_id"));
	if (NodeId.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required parameter: node_id"));
	...
	if (bHasMin || bHasMax)
	{
		...
		{ GEditor->EndTransaction(); return FMegalithActionResult::Error(TEXT("PoseJumpThresholdTime is not a struct property")); }
...
FMegalithActionResult FMegalithAbpWriteActions::HandleBuildMotionMatchingNode(const TSharedPtr<FJsonObject>& Params)
{
	const FString AbpPath      = Params->GetStringField(TEXT("abp_path"));
	...
	if (DatabasePath.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required parameter: database_path"));

	UAnimBlueprint* ABP = FMegalithAssetUtils::LoadAssetByPath<UAnimBlueprint>(AbpPath);
	if (!ABP) return FMegalithActionResult::Error(FString::Printf(TEXT("AnimBlueprint not found: %s"), *AbpPath));

	UPoseSearchDatabase* Database = FMegalithAssetUtils::LoadAssetByPath<UPoseSearchDatabase>(DatabasePath);
	if (!Database) return FMegalithActionResult::Error(FString::Printf(TEXT("UPoseSearchDatabase not found: %s"), *DatabasePath));
	...
	FMegalithActionResult HistResult = HandleAddAnimGraphNode(HistParams);
	...
	FMegalithActionResult MMResult = HandleAddAnimGraphNode(MMParams);
	...
	FMegalithActionResult ConnResult = HandleConnectAnimGraphPins(ConnParams);
	...
	UAnimBlueprint* ABP2 = FMegalithAssetUtils::LoadAssetByPath<UAnimBlueprint>(AbpPath);
	UEdGraphNode* MMNode = FindNodeByName(ABP2, MMNodeName, nullptr);
	UAnimGraphNode_Base* MMAnim = Cast<UAnimGraphNode_Base>(MMNode);
	if (!MMAnim) return FMegalithActionResult::Error(TEXT("Spawned MotionMatching node could not be re-resolved"));
	...
	if (!DbObjProp)
	{ GEditor->EndTransaction(); return FMegalithActionResult::Error(TEXT("MM node has no FObjectProperty 'Database'")); }
	...
	FString OutputWireNote;
	{
		...
		else
		{
			...
			FMegalithActionResult RootConnResult = HandleConnectAnimGraphPins(RootConn);
...
FMegalithActionResult FMegalithAbpWriteActions::HandleGetAnimGraphOutputConnection(const TSharedPtr<FJsonObject>& Params)
{
	const FString AbpPath = Params->GetStringField(TEXT("abp_path"));
	FString GraphName = Params->HasField(TEXT("graph_name")) ? Params->GetStringField(TEXT("graph_name")) : TEXT("AnimGraph");
	if (GraphName.IsEmpty()) GraphName = TEXT("AnimGraph");

	if (AbpPath.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required parameter: abp_path"));
	...
	if (!Graph) return FMegalithActionResult::Error(GraphError);
 ...
 */
FMegalithActionResult ApplyAdditiveImpl(const TSharedPtr<FJsonObject>& Params, bool bMeshSpace)
{
	if (!GEditor) return FMegalithActionResult::Error(TEXT("Editor is not available"));
	...
	if (!NewNode) return FMegalithActionResult::Error(SpawnError);
	...
	FString WireError;
	if (!WireInput(BaseNode, TEXT("Base"), WireError))         return FMegalithActionResult::Error(WireError);
	if (!WireInput(AdditiveNode, TEXT("Additive"), WireError)) return FMegalithActionResult::Error(WireError);
...
FMegalithActionResult FMegalithAbpWriteActions::HandleAddApplyAdditive(const TSharedPtr<FJsonObject>& Params)
{
	return ApplyAdditiveImpl(Params, /*bMeshSpace=*/false);
}

FMegalithActionResult FMegalithAbpWriteActions::HandleAddApplyMeshSpaceAdditive(const TSharedPtr<FJsonObject>& Params)
{
...
FMegalithActionResult FMegalithAbpWriteActions::HandleAddSlotNode(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FMegalithActionResult::Error(TEXT("Editor is not available"));
	...
	if (SlotName.IsEmpty())
	{
		...
		return FMegalithActionResult::Error(TEXT("Missing required parameter: slot_name (an unnamed slot node is a no-op pass-through)"));
	}
	...
	if (!SourceNode.IsEmpty())
	{
		...
		if (!Src) return FMegalithActionResult::Error(FString::Printf(TEXT("Source node '%s' not found in target graph"), *SourceNode));
	}
	...
	// set_anim_graph_node_property uses (persisted through compile).
	{
		...
		if (!ResolveInnerAnimNode(NewNode, NodeStruct, NodeAddr, ResolveErr))
		{
			return FMegalithActionResult::Error(ResolveErr);
		}
		FString WriteErr;
		if (!ImportTextOntoStruct(NodeStruct, NodeAddr, TEXT("SlotName"), SlotName, NewNode, WriteErr))
		{
			return FMegalithActionResult::Error(WriteErr);
		}
...
FMegalithActionResult FMegalithAbpWriteActions::HandleAddSaveCachedPose(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FMegalithActionResult::Error(TEXT("Editor is not available"));
	...
	if (CacheName.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required parameter: cache_name"));
	...
	if (!StateName.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("Save Cached Pose nodes live only in the main AnimGraph, not inside a state's inner graph (they are sink nodes). Omit state_name."));
	}
	...
	if (!SaveNode) return FMegalithActionResult::Error(TEXT("Spawned node is not a SaveCachedPose node"));
...
FMegalithActionResult FMegalithAbpWriteActions::HandleAddUseCachedPose(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FMegalithActionResult::Error(TEXT("Editor is not available"));
	...
	// pointer re-resolves by name at compile.
	{
		...
		if (!StrProp)
		{
			return FMegalithActionResult::Error(TEXT("Could not resolve 'NameOfCache' FStrProperty on UseCachedPose node"));
		}
...
FMegalithActionResult FMegalithAbpWriteActions::HandleSetOutputPoseSource(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FMegalithActionResult::Error(TEXT("Editor is not available"));
	...
	if (!ResultPin)
	{
		return FMegalithActionResult::Error(TEXT("Output Pose node has no 'Result' input pin (corrupt graph)"));
	}

	UEdGraphNode* Src = FindNodeByName(ABP, SourceNode, TargetGraph);
	if (!Src) return FMegalithActionResult::Error(FString::Printf(TEXT("Source node '%s' not found in graph '%s'"), *SourceNode, *GraphName));
	...
	for (UEdGraphPin* Linked : ResultPin->LinkedTo)
	{
		if (Linked == OutPin)
		{
			...
			return FMegalithActionResult::Success(NoOp);
		}
	}
...
FMegalithActionResult FMegalithAbpWriteActions::HandleSetStateResultSource(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FMegalithActionResult::Error(TEXT("Editor is not available"));
	...
	UAnimationStateMachineGraph* SMGraph = FindSMGraphByName(ABP, MachineName);
	if (!SMGraph) return FMegalithActionResult::Error(FString::Printf(TEXT("State machine '%s' not found"), *MachineName));

	UAnimStateNode* StateNode = FindStateByName(SMGraph, StateName);
	if (!StateNode) return FMegalithActionResult::Error(FString::Printf(TEXT("State '%s' not found in state machine '%s'"), *StateName, *MachineName));
...
FMegalithActionResult FMegalithAbpWriteActions::HandleAddBlendByInt(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FMegalithActionResult::Error(TEXT("Editor is not available"));
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: num_poses"));
	}
	const int32 NumPoses = static_cast<int32>(NumVal);
	if (NumPoses < 2)  return FMegalithActionResult::Error(TEXT("num_poses must be >= 2 (a blend list needs at least two poses)"));
	if (NumPoses > 32) return FMegalithActionResult::Error(TEXT("num_poses is capped at 32"));
	...
	if (!BlendNode) return FMegalithActionResult::Error(TEXT("Spawned node is not a BlendListByInt node"));
...
// Local duplicate of MegalithReflectionWalker.cpp's IsAutoMaxSentinel (lives in an anonymous
// namespace in MegalithCore; duplicated here to avoid a cross-module surface change for one
...
FMegalithActionResult FMegalithAbpWriteActions::HandleAddBlendByEnum(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FMegalithActionResult::Error(TEXT("Editor is not available"));
	...
	if (EnumPath.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: enum_path"));
	}
	...
	if (Params->HasField(TEXT("enumerators")))
	{
		...
		{
			return FMegalithActionResult::Error(TEXT("Parameter 'enumerators' must be an array of enumerator name strings"));
		}
		...
		{
			return FMegalithActionResult::Error(TEXT("Parameter 'enumerators' resolved to no usable enumerator names"));
		}
	}
	else
	{
	...
	if (!EnumNode) return FMegalithActionResult::Error(TEXT("Spawned node is not a BlendListByEnum node"));
	...
	if (!BoundEnumObjProp)
	{
		return FMegalithActionResult::Error(TEXT("BlendListByEnum node has no FObjectProperty 'BoundEnum' (engine layout changed?)"));
	}
	...
	if (!VisibleProp)
	{
		return FMegalithActionResult::Error(TEXT("BlendListByEnum node has no array property 'VisibleEnumEntries' (engine layout changed?)"));
	}
	FNameProperty* VisibleInnerName = CastField<FNameProperty>(VisibleProp->Inner);
	if (!VisibleInnerName)
	{
		return FMegalithActionResult::Error(TEXT("'VisibleEnumEntries' inner is not an FNameProperty (engine layout changed?)"));
	}
...
FMegalithActionResult FMegalithAbpWriteActions::HandleSetSyncGroup(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FMegalithActionResult::Error(TEXT("Editor is not available"));
	...
	if (NodeId.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required parameter: node_id"));
	if (!Params->HasField(TEXT("group_name"))) return FMegalithActionResult::Error(TEXT("Missing required parameter: group_name"));
...
FMegalithActionResult FMegalithAbpWriteActions::HandleSetLayeredBlendBones(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FMegalithActionResult::Error(TEXT("Editor is not available"));
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: layers (array of { bones: [{ bone, depth }] })"));
	}
	const int32 NumLayers = LayersArray->Num();
	if (NumLayers < 1) return FMegalithActionResult::Error(TEXT("layers must contain at least one layer"));
	if (NumLayers > 32) return FMegalithActionResult::Error(TEXT("layers is capped at 32"));
	...
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(TEXT("Could not resolve 'LayerSetup' array property on the inner node"));
	}
	FStructProperty* LayerElemProp = CastField<FStructProperty>(LayerSetupProp->Inner);
	if (!LayerElemProp || !LayerElemProp->Struct)
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(TEXT("LayerSetup inner is not a struct (FInputBlendPose expected)"));
	}
	...
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(TEXT("FInputBlendPose has no 'BranchFilters' array property"));
	}
	...
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(TEXT("BranchFilters inner is not a struct (FBranchFilter expected)"));
	}
	...
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(TEXT("FBranchFilter is missing the expected BoneName (FName) / BlendDepth (int32) fields"));
	}
	...
	for (int32 LayerIdx = 0; LayerIdx < NumLayers; ++LayerIdx)
	{
		...
		{
			GEditor->EndTransaction();
			return FMegalithActionResult::Error(FString::Printf(TEXT("layers[%d] is not an object"), LayerIdx));
		}
...
FMegalithActionResult FMegalithAbpWriteActions::HandleBuildFootIkPass(const TSharedPtr<FJsonObject>& Params)
{
	const FString AbpPath       = Params->GetStringField(TEXT("abp_path"));
	...
	if (LeftFootBone.IsEmpty() || RightFootBone.IsEmpty() || PelvisBone.IsEmpty())
		return FMegalithActionResult::Error(TEXT("left_foot_bone, right_foot_bone and pelvis_bone are all required"));
	...
	Graph->GetNodesOfClass<UAnimGraphNode_Root>(Roots);
	if (Roots.Num() == 0)
		return FMegalithActionResult::Error(FString::Printf(TEXT("No Output Pose (UAnimGraphNode_Root) in graph '%s'"), *GraphName));
	UAnimGraphNode_Root* RootNode = Roots[0];
	UEdGraphPin* RootResultPin = RootNode->FindPin(FName(TEXT("Result")), EGPD_Input);
	if (!RootResultPin)
		return FMegalithActionResult::Error(TEXT("Output Pose node has no 'Result' input pin"));
	...
	auto SpawnNode = [&](const TSharedPtr<FJsonObject>& P) -> FString
	{
		...
		FMegalithActionResult R = HandleAddAnimGraphNode(P);
	...
	if (L2CNode.IsEmpty() || PelvisNode.IsEmpty() || IkLNode.IsEmpty() || IkRNode.IsEmpty() || C2LNode.IsEmpty())
		return FMegalithActionResult::Error(TEXT("One or more foot-IK pass nodes failed to spawn"));
...
FMegalithActionResult FMegalithAbpWriteActions::HandleAssignPostProcessAnimRig(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (MeshPath.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required parameter: mesh_path"));

	USkeletalMesh* Mesh = FMegalithAssetUtils::LoadAssetByPath<USkeletalMesh>(MeshPath);
	if (!Mesh) return FMegalithActionResult::Error(FString::Printf(TEXT("SkeletalMesh not found: %s"), *MeshPath));
	...
	if (!bClearing)
	{
		...
		UAnimBlueprint* PostAbp = FMegalithAssetUtils::LoadAssetByPath<UAnimBlueprint>(PostAbpPath);
		if (PostAbp)
		{
			UClass* GenClass = PostAbp->GeneratedClass;
			if (!GenClass || !GenClass->IsChildOf(UAnimInstance::StaticClass()))
				return FMegalithActionResult::Error(FString::Printf(TEXT("AnimBlueprint '%s' has no UAnimInstance generated class (recompile it first)"), *PostAbpPath));
			PostClass = GenClass;
		}
		else
		{
			...
			if (!AsClass)
				return FMegalithActionResult::Error(FString::Printf(TEXT("Could not resolve post-process AnimBlueprint or AnimInstance class: %s"), *PostAbpPath));
			PostClass = AsClass;
		}
	}
...
FMegalithActionResult FMegalithAbpWriteActions::HandleAddAnimControlRigNode(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FMegalithActionResult::Error(TEXT("Editor is not available"));
	...
	if (ControlRigClassSpec.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required parameter: control_rig_class"));
	...
	if (!RigClass) return FMegalithActionResult::Error(ClassError);
	...
	{
		Src = FindNodeByName(ABP, SourceNode, TargetGraph);
		if (!Src) return FMegalithActionResult::Error(FString::Printf(TEXT("source_node '%s' not found in target graph"), *SourceNode));
	}
	...
	if (!CRNode) return FMegalithActionResult::Error(TEXT("Spawned node is not a Control Rig anim node"));
...
FMegalithActionResult FMegalithAbpWriteActions::HandleAddLinkedAnimLayer(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FMegalithActionResult::Error(TEXT("Editor is not available"));
	...
	if (LayerName.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required parameter: layer_name"));
	...
	if (!InterfaceClassSpec.IsEmpty())
	{
		...
		if (!RequestedInterface) return FMegalithActionResult::Error(IfaceErr);
	}
	...
	if (!InstanceClassSpec.IsEmpty())
	{
		...
		if (!InstanceClass) return FMegalithActionResult::Error(InstErr);
	}
	...
	UAnimGraphNode_LinkedAnimLayer* LayerNode = nullptr;
	{
		...
		{
			GEditor->EndTransaction();
			return FMegalithActionResult::Error(TEXT("FGraphNodeCreator failed to create the Linked Anim Layer node"));
		}
	...
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(FString::Printf(TEXT("Could not write Layer name: %s"), *WriteErr));
	}
	...
	if (ResolvedInterfaceClass)
	{
		...
		{
			GEditor->EndTransaction();
			return FMegalithActionResult::Error(FString::Printf(TEXT("Could not write Interface class: %s"), *WriteErr));
		}
	}
	...
	if (InstanceClass)
	{
		...
		{
			GEditor->EndTransaction();
			return FMegalithActionResult::Error(FString::Printf(TEXT("Could not write InstanceClass: %s"), *WriteErr));
		}
	}
	...
	// build it locally and copy it through the reflected UPROPERTY.
	{
		...
		{
			GEditor->EndTransaction();
			return FMegalithActionResult::Error(TEXT("Could not locate the FunctionReference UPROPERTY on the Linked Anim Layer node"));
		}
	}
	...
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(TEXT("Could not locate the InterfaceGuid UPROPERTY on the Linked Anim Layer node"));
	}
...
FMegalithActionResult FMegalithAbpWriteActions::HandleAddAnimLayerGraph(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FMegalithActionResult::Error(TEXT("Editor is not available"));
	...
	{
		return FMegalithActionResult::Error(TEXT("'AnimGraph' is the reserved name of the ABP's default anim graph — choose a different layer_name"));
	}
	...
	if (bHasPoseArray)
	{
		...
		for (const TSharedPtr<FJsonValue>& Entry : *PoseArray)
		{
			...
			{
				return FMegalithActionResult::Error(TEXT("'None' is not a usable input pose name"));
			}
	...
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create anim layer graph: %s"), *LayerName));
	}
	...
	// the anim schema and NOT a K2 graph. No other Megalith action reports either field —
