...
// module taking the "Chooser" dependency (same as MegalithChooserActions.cpp).
...
void FMegalithChooserAuthoringActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	...
	Registry.RegisterAction(TEXT("chooser"), TEXT("create_chooser_table"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateChooserTable),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("chooser"), TEXT("add_chooser_column"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddChooserColumn),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("chooser"), TEXT("add_chooser_row"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddChooserRow),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("UChooserTable asset path"))
	...
	Registry.RegisterAction(TEXT("chooser"), TEXT("set_chooser_cell"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetChooserCell),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("UChooserTable asset path"))
...
// ===========================================================================
// WITH_CHOOSER == 0 : clean off-gate stubs (mirrors MegalithChooserActions.cpp:99-105)
// ===========================================================================
#if !WITH_CHOOSER

namespace
{
	FMegalithActionResult ChooserAuthoringUnavailable()
	{
		return FMegalithActionResult::Error(TEXT("Chooser plugin not available"));
	}
}

FMegalithActionResult FMegalithChooserAuthoringActions::HandleCreateChooserTable(const TSharedPtr<FJsonObject>&) { return ChooserAuthoringUnavailable(); }
FMegalithActionResult FMegalithChooserAuthoringActions::HandleAddChooserColumn(const TSharedPtr<FJsonObject>&)  { return ChooserAuthoringUnavailable(); }
FMegalithActionResult FMegalithChooserAuthoringActions::HandleAddChooserRow(const TSharedPtr<FJsonObject>&)     { return ChooserAuthoringUnavailable(); }
FMegalithActionResult FMegalithChooserAuthoringActions::HandleSetChooserCell(const TSharedPtr<FJsonObject>&)   { return ChooserAuthoringUnavailable(); }
...
FMegalithActionResult FMegalithChooserAuthoringActions::HandleCreateChooserTable(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (!Table)
	{
		return FMegalithActionResult::Error(TEXT("Failed to create UChooserTable object"));
	}
...
FMegalithActionResult FMegalithChooserAuthoringActions::HandleAddChooserColumn(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath  = Params->GetStringField(TEXT("asset_path"));
	...
	return FMegalithActionResult::Success(Root);
#else
	return FMegalithActionResult::Error(TEXT("ColumnsStructs is editor-only data; not available in this build"));
#endif
}
...
FMegalithActionResult FMegalithChooserAuthoringActions::HandleAddChooserRow(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required array parameter: cells"));
	}
	...
	UObject* OutputAsset = FMegalithAssetUtils::LoadAssetByPath(OutputPsd);
	if (!OutputAsset)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("output_psd asset not found: %s"), *OutputPsd));
	}
	...
	return FMegalithActionResult::Success(Root);
#else
	return FMegalithActionResult::Error(TEXT("ResultsStructs/ColumnsStructs are editor-only data; not available in this build"));
#endif
}
...
FMegalithActionResult FMegalithChooserAuthoringActions::HandleSetChooserCell(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: column_index"));
	}
	if (!Params->TryGetNumberField(TEXT("row_index"), RowIdxD))
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: row_index"));
	}
	...
	return FMegalithActionResult::Success(Root);
#else
	return FMegalithActionResult::Error(TEXT("ColumnsStructs are editor-only data; not available in this build"));
#endif
}
