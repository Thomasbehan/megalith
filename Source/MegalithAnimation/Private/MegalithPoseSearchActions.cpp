...
static FMegalithActionResult HandleSetDatabaseNormalizationSet(const TSharedPtr<FJsonObject>& Params);
// Task 1.4 — add_database_entry (file-local, no header edit)
static FMegalithActionResult HandleAddDatabaseEntry(const TSharedPtr<FJsonObject>& Params);
// Task 2.3 — configure_schema_channel (file-local, no header edit)
static FMegalithActionResult HandleConfigureSchemaChannel(const TSharedPtr<FJsonObject>& Params);
// Task 2.4 — add_pose_search_notify (file-local, no header edit)
static FMegalithActionResult HandleAddPoseSearchNotify(const TSharedPtr<FJsonObject>& Params);
// Task 2.5 — derive_schema_channels_from_skeleton (file-local, no header edit)
static FMegalithActionResult HandleDeriveSchemaChannelsFromSkeleton(const TSharedPtr<FJsonObject>& Params);
// Task 2.6 — validate_pose_search_database (file-local, no header edit)
static FMegalithActionResult HandleValidatePoseSearchDatabase(const TSharedPtr<FJsonObject>& Params);

// ---------------------------------------------------------------------------
// Registration
// ---------------------------------------------------------------------------

void FMegalithPoseSearchActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	Registry.RegisterAction(TEXT("animation"), TEXT("get_pose_search_schema"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetPoseSearchSchema),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_pose_search_database"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetPoseSearchDatabase),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_database_sequence"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddDatabaseSequence),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("PoseSearchDatabase asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_database_sequence"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveDatabaseSequence),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("PoseSearchDatabase asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_database_stats"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetDatabaseStats),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("PoseSearchDatabase asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_pose_search_schema"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreatePoseSearchSchema),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_pose_search_database"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreatePoseSearchDatabase),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_database_sequence_properties"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetDatabaseSequenceProperties),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("PoseSearchDatabase asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_schema_channel"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddSchemaChannel),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("PoseSearchSchema asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_schema_channel"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveSchemaChannel),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("PoseSearchSchema asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_channel_weight"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetChannelWeight),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("PoseSearchSchema asset path"))
			.Required(TEXT("channel_index"), TEXT("integer"), TEXT("Index into the authored Channels array"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("rebuild_pose_search_index"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRebuildPoseSearchIndex),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("PoseSearchDatabase asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_database_search_mode"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetDatabaseSearchMode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("PoseSearchDatabase asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_normalization_set"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateNormalizationSet),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_database_to_normalization_set"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddDatabaseToNormalizationSet),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_database_normalization_set"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetDatabaseNormalizationSet),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_database_entry"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddDatabaseEntry),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("database_path"), TEXT("PoseSearchDatabase asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_database_entry_tags"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetDatabaseEntryTags),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("database_path"), TEXT("PoseSearchDatabase asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("configure_schema_channel"),
		...
		FMegalithActionHandler::CreateStatic(&HandleConfigureSchemaChannel),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_pose_search_notify"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddPoseSearchNotify),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("derive_schema_channels_from_skeleton"),
		...
		FMegalithActionHandler::CreateStatic(&HandleDeriveSchemaChannelsFromSkeleton),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("schema_path"), TEXT("PoseSearchSchema asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("validate_pose_search_database"),
		...
		FMegalithActionHandler::CreateStatic(&HandleValidatePoseSearchDatabase),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("database_path"), TEXT("PoseSearchDatabase asset path"))
			.Build());
}
...
FMegalithActionResult FMegalithPoseSearchActions::HandleGetPoseSearchSchema(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));

	UPoseSearchSchema* Schema = FMegalithAssetUtils::LoadAssetByPath<UPoseSearchSchema>(AssetPath);
	if (!Schema)
		return FMegalithActionResult::Error(FString::Printf(TEXT("PoseSearchSchema not found: %s"), *AssetPath));
...
FMegalithActionResult FMegalithPoseSearchActions::HandleGetPoseSearchDatabase(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));

	UPoseSearchDatabase* Database = FMegalithAssetUtils::LoadAssetByPath<UPoseSearchDatabase>(AssetPath);
	if (!Database)
		return FMegalithActionResult::Error(FString::Printf(TEXT("PoseSearchDatabase not found: %s"), *AssetPath));
...
FMegalithActionResult FMegalithPoseSearchActions::HandleAddDatabaseSequence(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	UObject* AnimAsset = FMegalithAssetUtils::LoadAssetByPath<UObject>(AnimPath);
	if (!AnimAsset)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Animation asset not found: %s"), *AnimPath));

	// Check if already in database
	if (Database->Contains(AnimAsset))
		return FMegalithActionResult::Error(FString::Printf(TEXT("Animation already in database: %s"), *AnimPath));
...
FMegalithActionResult FMegalithPoseSearchActions::HandleRemoveDatabaseSequence(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (SequenceIndex < 0 || SequenceIndex >= NumAssets)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Invalid sequence index: %d (database has %d entries)"), SequenceIndex, NumAssets));
...
FMegalithActionResult FMegalithPoseSearchActions::HandleGetDatabaseStats(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithPoseSearchActions::HandleCreatePoseSearchSchema(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!Schema) return FMegalithActionResult::Error(TEXT("Failed to create UPoseSearchSchema object"));
...
FMegalithActionResult FMegalithPoseSearchActions::HandleCreatePoseSearchDatabase(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SchemaPath = Params->GetStringField(TEXT("schema_path"));

	UPoseSearchSchema* Schema = FMegalithAssetUtils::LoadAssetByPath<UPoseSearchSchema>(SchemaPath);
	if (!Schema) return FMegalithActionResult::Error(FString::Printf(TEXT("PoseSearchSchema not found: %s"), *SchemaPath));
	...
	if (!Database) return FMegalithActionResult::Error(TEXT("Failed to create UPoseSearchDatabase object"));
...
FMegalithActionResult FMegalithPoseSearchActions::HandleSetDatabaseSequenceProperties(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (SeqIndex < 0 || SeqIndex >= NumAssets)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Invalid sequence_index %d (database has %d entries)"), SeqIndex, NumAssets));

	FPoseSearchDatabaseAnimationAsset* Entry = Database->GetMutableDatabaseAnimationAsset(SeqIndex);
	if (!Entry)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to get mutable entry at index %d"), SeqIndex));
	...
	if (Params->HasField(TEXT("mirror_option")))
	{
		...
		{
			GEditor->EndTransaction();
			return FMegalithActionResult::Error(FString::Printf(TEXT("Invalid mirror_option: '%s'. Use UnmirroredOnly, MirroredOnly, or UnmirroredAndMirrored"), *MirrorStr));
		}
	}
...
FMegalithActionResult FMegalithPoseSearchActions::HandleAddSchemaChannel(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!ChannelClass)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Unknown channel type: '%s'. Supported: Position, Velocity, Heading, Pose, Trajectory, Phase, Distance, Curve, Group"), *ChannelType));
	...
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create channel of type %s"), *ChannelType));
	}
...
FMegalithActionResult FMegalithPoseSearchActions::HandleRemoveSchemaChannel(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!Channels)
		return FMegalithActionResult::Error(TEXT("Failed to access Channels property on schema via reflection"));

	if (ChannelIndex < 0 || ChannelIndex >= Channels->Num())
		return FMegalithActionResult::Error(FString::Printf(TEXT("Invalid channel_index %d (schema has %d authored channels)"), ChannelIndex, Channels->Num()));
...
FMegalithActionResult FMegalithPoseSearchActions::HandleSetChannelWeight(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	int32 ChannelIndex = static_cast<int32>(Params->GetNumberField(TEXT("channel_index")));
	...
	if (!Channel)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Channel at index %d is null"), ChannelIndex));

	// Weight is WITH_EDITORONLY_DATA — use reflection to set it on any channel type
#if WITH_EDITORONLY_DATA
	FProperty* WeightProp = Channel->GetClass()->FindPropertyByName(TEXT("Weight"));
	if (!WeightProp)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Channel class %s has no Weight property"), *Channel->GetClass()->GetName()));
	...
	return FMegalithActionResult::Success(Root);
#else
	return FMegalithActionResult::Error(TEXT("Channel weights are only available in editor builds (WITH_EDITORONLY_DATA)"));
#endif
}
...
FMegalithActionResult FMegalithPoseSearchActions::HandleRebuildPoseSearchIndex(const TSharedPtr<FJsonObject>& Params)
{
#if WITH_EDITOR
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	return FMegalithActionResult::Success(Root);
#else
	return FMegalithActionResult::Error(TEXT("rebuild_pose_search_index is only available in editor builds"));
#endif
}
...
FMegalithActionResult FMegalithPoseSearchActions::HandleSetDatabaseSearchMode(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (Params->HasField(TEXT("pose_search_mode")))
	{
		...
		{
			GEditor->EndTransaction();
			return FMegalithActionResult::Error(FString::Printf(TEXT("Invalid pose_search_mode: '%s'. Use BruteForce, PCAKDTree, VPTree, or EventOnly"), *ModeStr));
		}
	}
...
FMegalithActionResult FMegalithPoseSearchActions::HandleCreateNormalizationSet(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!Set) return FMegalithActionResult::Error(TEXT("Failed to create UPoseSearchNormalizationSet object"));
...
FMegalithActionResult FMegalithPoseSearchActions::HandleAddDatabaseToNormalizationSet(const TSharedPtr<FJsonObject>& Params)
{
	FString SetPath = Params->GetStringField(TEXT("set_path"));
	FString DatabasePath = Params->GetStringField(TEXT("database_path"));

	UPoseSearchNormalizationSet* Set = FMegalithAssetUtils::LoadAssetByPath<UPoseSearchNormalizationSet>(SetPath);
	if (!Set)
		return FMegalithActionResult::Error(FString::Printf(TEXT("PoseSearchNormalizationSet not found: %s"), *SetPath));

	UPoseSearchDatabase* Database = FMegalithAssetUtils::LoadAssetByPath<UPoseSearchDatabase>(DatabasePath);
	if (!Database)
		return FMegalithActionResult::Error(FString::Printf(TEXT("PoseSearchDatabase not found: %s"), *DatabasePath));
...
FMegalithActionResult FMegalithPoseSearchActions::HandleSetDatabaseEntryTags(const TSharedPtr<FJsonObject>& Params)
{
	FString DatabasePath = Params->GetStringField(TEXT("database_path"));
	...
	if (EntryIndex < 0 || EntryIndex >= NumAssets)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Invalid entry_index %d (database has %d entries)"), EntryIndex, NumAssets));

	FPoseSearchDatabaseAnimationAsset* Entry = Database->GetMutableDatabaseAnimationAsset(EntryIndex);
	if (!Entry)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to get mutable entry at index %d"), EntryIndex));
	...
	return FMegalithActionResult::Success(Root);
#else
	return FMegalithActionResult::Error(TEXT("set_database_entry_tags requires editor-only data (WITH_EDITORONLY_DATA)"));
#endif
}
...
static FMegalithActionResult HandleSetDatabaseNormalizationSet(const TSharedPtr<FJsonObject>& Params)
{
	...
	return FMegalithActionResult::Success(Root);
#else
	return FMegalithActionResult::Error(TEXT("set_database_normalization_set requires editor-only data (WITH_EDITORONLY_DATA)"));
#endif
}
...
static FMegalithActionResult HandleConfigureSchemaChannel(const TSharedPtr<FJsonObject>& Params)
{
	...
	UPoseSearchSchema* Schema = FMegalithAssetUtils::LoadAssetByPath<UPoseSearchSchema>(SchemaPath);
	if (!Schema)
		return FMegalithActionResult::Error(FString::Printf(TEXT("PoseSearchSchema not found: %s"), *SchemaPath));
	...
	return FMegalithActionResult::Success(Root);
#else
	return FMegalithActionResult::Error(TEXT("configure_schema_channel requires editor-only data (WITH_EDITORONLY_DATA)"));
#endif
}
...
static FMegalithActionResult HandleAddPoseSearchNotify(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (StartTime < 0.f || StartTime > Seq->GetPlayLength())
		return FMegalithActionResult::Error(FString::Printf(TEXT("start_time %.3f out of range [0, %.3f]"), StartTime, Seq->GetPlayLength()));
	if (Duration <= 0.f)
		return FMegalithActionResult::Error(TEXT("duration must be > 0"));
	if (StartTime + Duration > Seq->GetPlayLength())
		return FMegalithActionResult::Error(FString::Printf(TEXT("start_time + duration (%.3f) exceeds play length (%.3f)"), StartTime + Duration, Seq->GetPlayLength()));
	...
	if (!NewNotify)
		return FMegalithActionResult::Error(TEXT("Failed to create PoseSearch notify-state instance"));
...
static FMegalithActionResult HandleDeriveSchemaChannelsFromSkeleton(const TSharedPtr<FJsonObject>& Params)
{
	...
	USkeleton* Skeleton = FMegalithAssetUtils::LoadAssetByPath<USkeleton>(SkeletonPath);
	if (!Skeleton)
		return FMegalithActionResult::Error(FString::Printf(TEXT("Skeleton not found: %s"), *SkeletonPath));
	...
	return FMegalithActionResult::Success(Root);
#else
	return FMegalithActionResult::Error(TEXT("derive_schema_channels_from_skeleton requires editor-only data (WITH_EDITORONLY_DATA)"));
#endif
}
