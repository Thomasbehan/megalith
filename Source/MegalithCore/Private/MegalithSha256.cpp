...
// MEGALITH_SHA256_ALGO_BEGIN — everything between the markers is pure FIPS 180-4
...
void MegalithSha256::Compute(const uint8* Data, uint64 NumBytes, FSHA256Signature& OutSignature)
{
	uint32 H[8] = {
