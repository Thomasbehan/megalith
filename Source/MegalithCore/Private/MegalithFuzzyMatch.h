...
// enough for MegalithToolRegistry.cpp (same module) and the dev-automation
// test file (also same module) to call it without leaking into MegalithCore's
// public surface.
...
namespace MegalithFuzzyMatchDetail
{
	/**
