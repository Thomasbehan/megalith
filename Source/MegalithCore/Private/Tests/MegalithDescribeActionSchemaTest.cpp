...
// Handover: Plugins/Megalith/Docs/plans/2026-05-29-ri-ergonomics-improvements-handover.md
//
// Goals:
...
namespace MegalithDescribeActionSchemaTestDetail
{
	/** Resolve the registered describe action_schema; assumes FMegalithBulkFillActions::RegisterAll fired at module startup. */
	static FMegalithActionResult Invoke(const TSharedPtr<FJsonObject>& Params)
	{
		return FMegalithToolRegistry::Get().ExecuteAction(TEXT("describe"), TEXT("action_schema"), Params);
	}
}
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithDescribeActionSchemaTargetActionTest,
	"Megalith.Describe.ActionSchema.TargetAction",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithDescribeActionSchemaTargetActionTest::RunTest(const FString& /*Parameters*/)
{
	using namespace MegalithDescribeActionSchemaTestDetail;
	...
	const FMegalithActionResult R = Invoke(Params);
...
// ---------------------------------------------------------------------------
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithDescribeActionSchemaLegacyActionAliasTest,
	"Megalith.Describe.ActionSchema.LegacyActionAlias",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithDescribeActionSchemaLegacyActionAliasTest::RunTest(const FString& /*Parameters*/)
{
	using namespace MegalithDescribeActionSchemaTestDetail;
...
// ---------------------------------------------------------------------------
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithDescribeActionSchemaAliasCollisionTest,
	"Megalith.Describe.ActionSchema.AliasCollision",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithDescribeActionSchemaAliasCollisionTest::RunTest(const FString& /*Parameters*/)
{
	using namespace MegalithDescribeActionSchemaTestDetail;
...
// ---------------------------------------------------------------------------
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithDescribeActionSchemaMissingBothTest,
	"Megalith.Describe.ActionSchema.MissingBoth",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithDescribeActionSchemaMissingBothTest::RunTest(const FString& /*Parameters*/)
{
	using namespace MegalithDescribeActionSchemaTestDetail;
