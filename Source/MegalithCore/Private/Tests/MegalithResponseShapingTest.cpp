...
namespace MegalithResponseShapingTestDetail
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithResponseShapingFieldsWhitelistTest,
	"Megalith.ResponseShaping.FieldsWhitelist",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithResponseShapingFieldsWhitelistTest::RunTest(const FString& /*Parameters*/)
{
	using namespace MegalithResponseShapingTestDetail;
...
// ---------------------------------------------------------------------------
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithResponseShapingOmitBlacklistTest,
	"Megalith.ResponseShaping.OmitBlacklist",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithResponseShapingOmitBlacklistTest::RunTest(const FString& /*Parameters*/)
{
	using namespace MegalithResponseShapingTestDetail;
...
// ---------------------------------------------------------------------------
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithResponseShapingMutuallyExclusiveTest,
	"Megalith.ResponseShaping.MutuallyExclusive",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithResponseShapingMutuallyExclusiveTest::RunTest(const FString& /*Parameters*/)
{
	using namespace MegalithResponseShapingTestDetail;
...
// ---------------------------------------------------------------------------
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithResponseShapingEmptyFieldsNoOpTest,
	"Megalith.ResponseShaping.EmptyFieldsNoOp",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithResponseShapingEmptyFieldsNoOpTest::RunTest(const FString& /*Parameters*/)
{
	using namespace MegalithResponseShapingTestDetail;
...
// ---------------------------------------------------------------------------
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithResponseShapingCompactJsonTest,
	"Megalith.ResponseShaping.CompactJson",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithResponseShapingCompactJsonTest::RunTest(const FString& /*Parameters*/)
{
	using namespace MegalithResponseShapingTestDetail;
...
//
// Registers a throwaway action under namespace "megalith_test_shaping" with
...
// ---------------------------------------------------------------------------
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithResponseShapingStrictParamsAllowlistTest,
	"Megalith.ResponseShaping.StrictParamsAllowlist",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithResponseShapingStrictParamsAllowlistTest::RunTest(const FString& /*Parameters*/)
{
	using namespace MegalithResponseShapingTestDetail;

	const FString TestNs = TEXT("megalith_test_shaping");
	...
	ON_SCOPE_EXIT
	{
		...
		FMegalithToolRegistry::Get().UnregisterNamespace(TEXT("megalith_test_shaping"));
	};
	...
	auto Handler = FMegalithActionHandler::CreateLambda(
		[](const TSharedPtr<FJsonObject>& Params) -> FMegalithActionResult
		{
	...
	FMegalithToolRegistry::Get().RegisterAction(TestNs, TestAction, TEXT("Test."), Handler, Schema);
	...
	FMegalithActionResult R = FMegalithToolRegistry::Get().ExecuteAction(TestNs, TestAction, CallParams);
...
// Handover doc: Plugins/Megalith/Docs/plans/2026-05-29-ri-ergonomics-improvements-handover.md
// =============================================================================
...
// ---------------------------------------------------------------------------
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithResponseShapingRowFieldsTest,
	"Megalith.ResponseShaping.RowFields",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithResponseShapingRowFieldsTest::RunTest(const FString& /*Parameters*/)
{
	using namespace MegalithResponseShapingTestDetail;
...
// ---------------------------------------------------------------------------
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithResponseShapingRowFieldsNoListTest,
	"Megalith.ResponseShaping.RowFieldsNoList",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithResponseShapingRowFieldsNoListTest::RunTest(const FString& /*Parameters*/)
{
	using namespace MegalithResponseShapingTestDetail;
...
// ---------------------------------------------------------------------------
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithResponseShapingRowFieldsAmbiguousTest,
	"Megalith.ResponseShaping.RowFieldsAmbiguous",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithResponseShapingRowFieldsAmbiguousTest::RunTest(const FString& /*Parameters*/)
{
	using namespace MegalithResponseShapingTestDetail;
...
// ---------------------------------------------------------------------------
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithResponseShapingPathFieldsTest,
	"Megalith.ResponseShaping.PathFields",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithResponseShapingPathFieldsTest::RunTest(const FString& /*Parameters*/)
{
	using namespace MegalithResponseShapingTestDetail;
...
// ---------------------------------------------------------------------------
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithResponseShapingPathFieldsMissingTest,
	"Megalith.ResponseShaping.PathFieldsMissing",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithResponseShapingPathFieldsMissingTest::RunTest(const FString& /*Parameters*/)
{
	using namespace MegalithResponseShapingTestDetail;
...
// ---------------------------------------------------------------------------
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithResponseShapingRowFieldsNoMatchTest,
	"Megalith.ResponseShaping.RowFieldsNoMatch",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithResponseShapingRowFieldsNoMatchTest::RunTest(const FString& /*Parameters*/)
{
	using namespace MegalithResponseShapingTestDetail;
...
// ---------------------------------------------------------------------------
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithResponseShapingRowFieldsPartialMatchTest,
	"Megalith.ResponseShaping.RowFieldsPartialMatch",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithResponseShapingRowFieldsPartialMatchTest::RunTest(const FString& /*Parameters*/)
{
	using namespace MegalithResponseShapingTestDetail;
...
// ---------------------------------------------------------------------------
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithResponseShapingPathFieldsNoMatchTest,
	"Megalith.ResponseShaping.PathFieldsNoMatch",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithResponseShapingPathFieldsNoMatchTest::RunTest(const FString& /*Parameters*/)
{
	using namespace MegalithResponseShapingTestDetail;
