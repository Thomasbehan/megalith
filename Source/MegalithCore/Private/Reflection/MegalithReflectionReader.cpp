...
TSharedPtr<FJsonValue> FMegalithReflectionReader::PropertyToJsonValue(FProperty* Prop, const void* ValuePtr, const UObject* Owner)
{
...
TSharedPtr<FJsonObject> FMegalithReflectionReader::PropertiesToJsonObject(UObject* Object)
{
