...
// FMegalithReflectionWalker automation tests. Phase 0.
//
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithReflectionWalkerScalarsAndContainersTest,
	"Leviathan.Megalith.Reflection.WalkerWritesAllScalarsAndContainers",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithReflectionWalkerScalarsAndContainersTest::RunTest(const FString& /*Parameters*/)
{
	// Phase 0 polish task: load /Game/Tests/Megalith/Reflection/S_BulkFillWalkerTestStruct,
...
// ---------------------------------------------------------------------------
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithReflectionWalkerRejectsTypeCoerceTrapTest,
	"Leviathan.Megalith.Reflection.WalkerRejectsTypeCoerceTrap",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithReflectionWalkerRejectsTypeCoerceTrapTest::RunTest(const FString& /*Parameters*/)
{
	TestTrue(TEXT("Phase 0 stub — body deferred to polish task post Phase 1"), true);
	return true;
}
...
// ---------------------------------------------------------------------------
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithReflectionWalkerStrictModeBlocksUnknownKeyTest,
	"Leviathan.Megalith.Reflection.WalkerStrictModeBlocksUnknownKey",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithReflectionWalkerStrictModeBlocksUnknownKeyTest::RunTest(const FString& /*Parameters*/)
{
	TestTrue(TEXT("Phase 0 stub — body deferred to polish task post Phase 1"), true);
	return true;
}
...
// ---------------------------------------------------------------------------
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithReflectionWalkerEnumMissReportsTypoTest,
	"Leviathan.Megalith.Reflection.WalkerEnumMissReportsTypo",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithReflectionWalkerEnumMissReportsTypoTest::RunTest(const FString& /*Parameters*/)
{
	TestTrue(TEXT("Phase 0 stub — body deferred to polish task post Phase 1"), true);
	return true;
}
...
// ---------------------------------------------------------------------------
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithReflectionWalkerDryRunNoSideEffectsTest,
	"Leviathan.Megalith.Reflection.DryRunNoSideEffects",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithReflectionWalkerDryRunNoSideEffectsTest::RunTest(const FString& /*Parameters*/)
{
	TestTrue(TEXT("Phase 0 stub — body deferred to polish task post Phase 1"), true);
	return true;
}
