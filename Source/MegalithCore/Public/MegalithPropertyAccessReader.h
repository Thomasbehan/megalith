...
// ============================================================
//  MegalithPropertyAccessReader  (Gap 1 — resolved PropertyAccess path)
//
...
//  MegalithBlueprintNodeActions.cpp) already spawns the node and sets its private
...
//
//  Lives here in MegalithCore/Public so the K2 node serializer
//  (MegalithBlueprintInternal.h) and the anim node serializer
//  (MegalithAnimationActions.cpp) share ONE implementation — no duplication.
...
//  MegalithCore Build.cs dependency is required.
//
...
namespace MegalithPropertyAccessReader
{
	// Flat pin-type string, matching MegalithBlueprintInternal::PinTypeToString /
