...
// ============================================================
//  MegalithAnimNodeBindingReader  (Gap 2 + Gap 12 — anim-node bindings)
//
...
//
//  Header-only inline (the Gap-1 MegalithPropertyAccessReader pattern): MegalithCore
//  deps Engine but NOT AnimGraph, so the bodies must compile at the include site
//  (MegalithAnimation, which already deps AnimGraph + includes AnimGraphNode_Base.h).
//  No MegalithCore Build.cs dependency is added.
//
...
namespace MegalithAnimNodeBindingReader
{
