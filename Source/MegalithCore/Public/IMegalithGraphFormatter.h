 ...
 * Registered via IModularFeatures. MegalithBABridge is the canonical implementation.
 *
...
public:
	 ...
	 * Returns FMegalithFormatterInfo with type, support status, and graph class name.
	 */
