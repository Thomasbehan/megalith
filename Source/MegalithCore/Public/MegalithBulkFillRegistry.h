...
// FMegalithBulkFillRegistry — per-namespace adapter table for `bulk_fill` and
 ...
 */
class MEGALITHCORE_API FMegalithBulkFillRegistry
{
public:
	static FMegalithBulkFillRegistry& Get();
...
private:
	FMegalithBulkFillRegistry() = default;
