 ...
 */
enum class EMegalithParamKind : uint8
{
	Other = 0,
	AssetPath,
	DiskPath,
...
namespace MegalithParamKind
{
	inline const TCHAR* ToString(EMegalithParamKind Kind)
	{
		switch (Kind)
		{
			case EMegalithParamKind::AssetPath:   return TEXT("AssetPath");
			case EMegalithParamKind::DiskPath:    return TEXT("DiskPath");
			case EMegalithParamKind::GameplayTag: return TEXT("GameplayTag");
			default:                              return TEXT("Other");
		}
	}

	inline EMegalithParamKind FromString(const FString& S)
	{
		if (S == TEXT("AssetPath"))   return EMegalithParamKind::AssetPath;
		if (S == TEXT("DiskPath"))    return EMegalithParamKind::DiskPath;
		if (S == TEXT("GameplayTag")) return EMegalithParamKind::GameplayTag;
		return EMegalithParamKind::Other;
	}
}
...
public:
	...
	{
		AddParam(Name, Type, Desc, /*bRequired=*/true, /*Default=*/TEXT(""), /*bHasDefault=*/false, {}, EMegalithParamKind::Other);
		return *this;
	}
	...
	{
		AddParam(Name, Type, Desc, /*bRequired=*/true, /*Default=*/TEXT(""), /*bHasDefault=*/false, Aliases, EMegalithParamKind::Other);
		return *this;
	}
	...
	{
		AddParam(Name, Type, Desc, /*bRequired=*/false, Default, /*bHasDefault=*/!Default.IsEmpty(), {}, EMegalithParamKind::Other);
		return *this;
	}
	...
	{
		AddParam(Name, Type, Desc, /*bRequired=*/false, Default, /*bHasDefault=*/!Default.IsEmpty(), Aliases, EMegalithParamKind::Other);
		return *this;
	}
	...
	FParamSchemaBuilder& Optional(const FString& Name, const FString& Type, const FString& Desc,
		std::initializer_list<const TCHAR*> Aliases)
	{
		AddParam(Name, Type, Desc, /*bRequired=*/false, /*Default=*/TEXT(""), /*bHasDefault=*/false, Aliases, EMegalithParamKind::Other);
		return *this;
	}
	...
	{
		AddParam(Name, TEXT("string"), Description, /*bRequired=*/true, TEXT(""), /*bHasDefault=*/false, {}, EMegalithParamKind::AssetPath);
		return *this;
	}

	FParamSchemaBuilder& OptionalAssetPath(const TCHAR* Name, const TCHAR* Description)
	{
		AddParam(Name, TEXT("string"), Description, /*bRequired=*/false, TEXT(""), /*bHasDefault=*/false, {}, EMegalithParamKind::AssetPath);
		return *this;
	}

	FParamSchemaBuilder& RequiredDiskPath(const TCHAR* Name, const TCHAR* Description)
	{
		AddParam(Name, TEXT("string"), Description, /*bRequired=*/true, TEXT(""), /*bHasDefault=*/false, {}, EMegalithParamKind::DiskPath);
		return *this;
	}

	FParamSchemaBuilder& OptionalDiskPath(const TCHAR* Name, const TCHAR* Description)
	{
		AddParam(Name, TEXT("string"), Description, /*bRequired=*/false, TEXT(""), /*bHasDefault=*/false, {}, EMegalithParamKind::DiskPath);
		return *this;
	}
	...
	FParamSchemaBuilder& RequiredAssetPath(const TCHAR* Name, const TCHAR* Description,
		std::initializer_list<const TCHAR*> Aliases)
	{
		AddParam(Name, TEXT("string"), Description, /*bRequired=*/true, TEXT(""), /*bHasDefault=*/false, Aliases, EMegalithParamKind::AssetPath);
		return *this;
	}
	...
	FParamSchemaBuilder& OptionalAssetPath(const TCHAR* Name, const TCHAR* Description,
		std::initializer_list<const TCHAR*> Aliases)
	{
		AddParam(Name, TEXT("string"), Description, /*bRequired=*/false, TEXT(""), /*bHasDefault=*/false, Aliases, EMegalithParamKind::AssetPath);
		return *this;
	}
	...
	FParamSchemaBuilder& RequiredDiskPath(const TCHAR* Name, const TCHAR* Description,
		std::initializer_list<const TCHAR*> Aliases)
	{
		AddParam(Name, TEXT("string"), Description, /*bRequired=*/true, TEXT(""), /*bHasDefault=*/false, Aliases, EMegalithParamKind::DiskPath);
		return *this;
	}
	...
	FParamSchemaBuilder& OptionalDiskPath(const TCHAR* Name, const TCHAR* Description,
		std::initializer_list<const TCHAR*> Aliases)
	{
		AddParam(Name, TEXT("string"), Description, /*bRequired=*/false, TEXT(""), /*bHasDefault=*/false, Aliases, EMegalithParamKind::DiskPath);
		return *this;
	}
	...
	FParamSchemaBuilder& OptionalAssetPathWithDefault(const TCHAR* Name, const TCHAR* Description,
		const TCHAR* Default)
	{
		AddParam(Name, TEXT("string"), Description, /*bRequired=*/false, Default, /*bHasDefault=*/true, {}, EMegalithParamKind::AssetPath);
		return *this;
	}
	...
	{
		AddParam(Name, TEXT("string"), Description, /*bRequired=*/false, Default, /*bHasDefault=*/true, Aliases, EMegalithParamKind::AssetPath);
		return *this;
	}
	...
	FParamSchemaBuilder& OptionalDiskPathWithDefault(const TCHAR* Name, const TCHAR* Description,
		const TCHAR* Default)
	{
		AddParam(Name, TEXT("string"), Description, /*bRequired=*/false, Default, /*bHasDefault=*/true, {}, EMegalithParamKind::DiskPath);
		return *this;
	}
	...
	FParamSchemaBuilder& OptionalDiskPathWithDefault(const TCHAR* Name, const TCHAR* Description,
		const TCHAR* Default, std::initializer_list<const TCHAR*> Aliases)
	{
		AddParam(Name, TEXT("string"), Description, /*bRequired=*/false, Default, /*bHasDefault=*/true, Aliases, EMegalithParamKind::DiskPath);
		return *this;
	}
...
private:
		...
		EMegalithParamKind Kind)
	{
		...
		if (Kind != EMegalithParamKind::Other)
		{
			Param->SetStringField(TEXT("kind"), MegalithParamKind::ToString(Kind));
		}
 ...
 */
class MEGALITHCORE_API FMegalithParamSchema
{
public:
