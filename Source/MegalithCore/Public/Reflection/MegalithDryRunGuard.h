...
// FMegalithDryRunGuard — RAII-ish helper used inside existing write actions
 ...
 *
 * Usage:
 *   FMegalithActionResult FMyActions::HandleFoo(const TSharedPtr<FJsonObject>& Params)
 *   {
 ...
 *   }
 */
class MEGALITHCORE_API FMegalithDryRunGuard
{
public:
	explicit FMegalithDryRunGuard(const TSharedPtr<FJsonObject>& Params);
	...
	FMegalithActionResult MakeDryRunResponse(const FDryRunReport& Report) const;
