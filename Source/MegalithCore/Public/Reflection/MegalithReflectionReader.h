...
// FMegalithReflectionReader — FProperty -> JSON-value reader.
// Read counterpart to the write-side FMegalithReflectionWalker; deliberately a
 ...
 *
 * This is the canonical FProperty->JSON reader for Megalith. It is the read
 * counterpart to FMegalithReflectionWalker (which writes JSON->FProperty). It is
 ...
 */
class MEGALITHCORE_API FMegalithReflectionReader
{
public:
	/**
