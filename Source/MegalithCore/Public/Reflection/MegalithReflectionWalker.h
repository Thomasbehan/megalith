...
// FMegalithReflectionWalker — JSON-tree -> FProperty schema walker.
 ...
 * (mirrors the cradle pattern at MegalithBlueprintCDOActions.cpp:417-424).
 */
class MEGALITHCORE_API FMegalithReflectionWalker
{
public:
	/**
	 ...
	 * Mirrors existing MegalithBlueprintCDOActions.cpp:385-396 pattern so behaviour
