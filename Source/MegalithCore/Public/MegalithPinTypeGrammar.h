...
// ============================================================
//  MegalithPinTypeGrammar  (issue #115)
//
...
//
//  It previously existed twice — MegalithBlueprintInternal.h and
//  MegalithUIRegistryActions.cpp — and the copies drifted: the blueprint copy
...
//  MegalithCore does NOT link BlueprintGraph, so this header is header-only
//  inline and must NEVER be included from a MegalithCore .cpp (nor from a
//  MegalithCore test). The UEdGraphSchema_K2::PC_* constants are dllimport'd
//  from BlueprintGraph; referencing them from a MegalithCore translation unit
//  is an LNK2019. The modules that DO link BlueprintGraph, and may include
//  this header from a .cpp, are: MegalithAI, MegalithAnimation,
//  MegalithBlueprint, MegalithComboGraph, MegalithGAS, MegalithIndex,
//  MegalithLevelSequence, MegalithLogicDriver, MegalithUI.
//  Same pattern as MegalithPropertyAccessReader.h and
//  MegalithAnimNodeBindingReader.h, which live here for the same reason.
//
...
namespace MegalithPinTypeGrammar
{
	/**
