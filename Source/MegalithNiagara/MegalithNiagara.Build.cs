...
public class MegalithNiagara : ModuleRules
{
	public MegalithNiagara(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		// header). Default ON for dev; MEGALITH_RELEASE_BUILD=1 forces it OFF so the engine-private
