#include "MegalithNiagaraQueryLibrary.h"
...
namespace
{
	/** Serialize a JSON object to a compact FString (matches the in-module idiom at MegalithNiagaraActions.cpp:1303). */
	...
	FString& OutError)
{
	...
	const FMegalithActionResult Result = Registry.ExecuteAction(TEXT("niagara"), Action, SafeParams);
...
FString UMegalithNiagaraQueryLibrary::GetNiagaraSystemInfo(
...
FString UMegalithNiagaraQueryLibrary::GetNiagaraEmitters(
...
FString UMegalithNiagaraQueryLibrary::GetNiagaraEmitterSummary(
...
FString UMegalithNiagaraQueryLibrary::GetNiagaraModules(
...
FString UMegalithNiagaraQueryLibrary::GetNiagaraModuleInputs(
...
FString UMegalithNiagaraQueryLibrary::GetNiagaraModuleGraph(
...
FString UMegalithNiagaraQueryLibrary::GetNiagaraParameters(
...
FString UMegalithNiagaraQueryLibrary::GetNiagaraUserParameters(
	const FString& AssetPath, bool& bSuccess, FString& OutError)
{
	const TSharedPtr<FJsonObject> Params = MakeShared<FJsonObject>();
	Params->SetStringField(TEXT("asset_path"), AssetPath);
...
FString UMegalithNiagaraQueryLibrary::GetNiagaraRenderers(
...
FString UMegalithNiagaraQueryLibrary::GetNiagaraEvents(
...
FString UMegalithNiagaraQueryLibrary::GetNiagaraDIFunctions(
...
FString UMegalithNiagaraQueryLibrary::GetNiagaraSimulationStages(
	const FString& AssetPath, const FString& Emitter, bool& bSuccess, FString& OutError)
{
	const TSharedPtr<FJsonObject> Params = MakeShared<FJsonObject>();
	Params->SetStringField(TEXT("asset_path"), AssetPath);
...
FString UMegalithNiagaraQueryLibrary::GetNiagaraStats(
...
FString UMegalithNiagaraQueryLibrary::GetNiagaraInventory(
...
FString UMegalithNiagaraQueryLibrary::GetNiagaraHLSLOutput(
	const FString& AssetPath, const FString& Emitter, bool& bSuccess, FString& OutError)
{
	const TSharedPtr<FJsonObject> Params = MakeShared<FJsonObject>();
	Params->SetStringField(TEXT("asset_path"), AssetPath);
...
FString UMegalithNiagaraQueryLibrary::SearchNiagaraSystems(
	const FString& Search, const FString& Path, int32 Limit, bool& bSuccess, FString& OutError)
{
	const TSharedPtr<FJsonObject> Params = MakeShared<FJsonObject>();
	SetOptionalString(Params, TEXT("search"), Search);
...
FString UMegalithNiagaraQueryLibrary::SearchNiagaraModules(
...
FString UMegalithNiagaraQueryLibrary::SearchNiagaraByParameter(
...
FString UMegalithNiagaraQueryLibrary::SearchNiagaraByDataInterface(
...
FString UMegalithNiagaraQueryLibrary::QueryNiagara(
...
FString UMegalithNiagaraQueryLibrary::FindSimilarNiagaraSystems(
...
FString UMegalithNiagaraQueryLibrary::SearchNiagaraByMaterial(
...
FString UMegalithNiagaraQueryLibrary::FindNiagaraReferences(
...
FString UMegalithNiagaraQueryLibrary::GetNiagaraDataInterfaces(
	const FString& AssetPath, bool& bSuccess, FString& OutError)
{
	const TSharedPtr<FJsonObject> Params = MakeShared<FJsonObject>();
	Params->SetStringField(TEXT("asset_path"), AssetPath);
