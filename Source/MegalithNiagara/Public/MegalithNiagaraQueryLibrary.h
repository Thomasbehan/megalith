...
#include "MegalithNiagaraQueryLibrary.generated.h"
 ...
 *
 * EDITOR GAME-THREAD ONLY. MegalithNiagara is an Editor-type module and is never cooked into a
 ...
 */
UCLASS(MinimalAPI)
class UMegalithNiagaraQueryLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()

public:
	// ---------------------------------------------------------------------------------------
	// Inspection (Megalith|Niagara|Inspection)
	// ---------------------------------------------------------------------------------------

	/** System-level summary (emitter count, sim targets, bounds, etc.). Wraps niagara.get_system_summary. */
	UFUNCTION(BlueprintCallable,
		Category = "Megalith|Niagara|Inspection",
		meta = (AdvancedDisplay = "DetailLevel",
		        Keywords = "niagara system info summary inspect"))
	static MEGALITHNIAGARA_API FString GetNiagaraSystemInfo(
	...
	static MEGALITHNIAGARA_API FString GetNiagaraEmitters(
		const FString& AssetPath,
		UPARAM(DisplayName = "Success") bool& bSuccess,
		FString& OutError);
	...
	static MEGALITHNIAGARA_API FString GetNiagaraEmitterSummary(
		const FString& AssetPath,
	...
	static MEGALITHNIAGARA_API FString GetNiagaraModules(
		const FString& AssetPath,
		const FString& Emitter,
		const FString& Usage,
		UPARAM(DisplayName = "Success") bool& bSuccess,
	...
	static MEGALITHNIAGARA_API FString GetNiagaraModuleInputs(
		const FString& AssetPath,
		const FString& Emitter,
	...
	static MEGALITHNIAGARA_API FString GetNiagaraModuleGraph(
	...
	static MEGALITHNIAGARA_API FString GetNiagaraParameters(
		const FString& AssetPath,
		const FString& Emitter,
		const FString& Scope,
		UPARAM(DisplayName = "Success") bool& bSuccess,
	...
	static MEGALITHNIAGARA_API FString GetNiagaraUserParameters(
		const FString& AssetPath,
		UPARAM(DisplayName = "Success") bool& bSuccess,
		FString& OutError);
	...
	static MEGALITHNIAGARA_API FString GetNiagaraRenderers(
		const FString& AssetPath,
		const FString& Emitter,
	...
	static MEGALITHNIAGARA_API FString GetNiagaraEvents(
		const FString& AssetPath,
		const FString& Emitter,
		UPARAM(DisplayName = "Success") bool& bSuccess,
		FString& OutError);
	...
	static MEGALITHNIAGARA_API FString GetNiagaraDIFunctions(
	...
	static MEGALITHNIAGARA_API FString GetNiagaraSimulationStages(
		const FString& AssetPath,
		const FString& Emitter,
		UPARAM(DisplayName = "Success") bool& bSuccess,
		FString& OutError);
	...
	static MEGALITHNIAGARA_API FString GetNiagaraStats(
		const FString& AssetPath,
		bool bCompileFirst,
		UPARAM(DisplayName = "Success") bool& bSuccess,
		FString& OutError);
	...
	static MEGALITHNIAGARA_API FString GetNiagaraInventory(
	...
	static MEGALITHNIAGARA_API FString GetNiagaraHLSLOutput(
		const FString& AssetPath,
		const FString& Emitter,
		UPARAM(DisplayName = "Success") bool& bSuccess,
		FString& OutError);
	...
	static MEGALITHNIAGARA_API FString SearchNiagaraModules(
		const FString& Search,
		const FString& Usage,
		int32 Limit,
	...
	// ---------------------------------------------------------------------------------------
	// Tranche 2 (#64): Search & Discovery gap-action nodes (Megalith|Niagara|Search)
	// ---------------------------------------------------------------------------------------
	...
	static MEGALITHNIAGARA_API FString SearchNiagaraByParameter(
	...
	static MEGALITHNIAGARA_API FString SearchNiagaraByDataInterface(
		const FString& DIClass,
		const FString& Folder,
		int32 Limit,
		UPARAM(DisplayName = "Success") bool& bSuccess,
	...
	static MEGALITHNIAGARA_API FString QueryNiagara(
	...
	static MEGALITHNIAGARA_API FString FindSimilarNiagaraSystems(
		const FString& AssetPath,
		float Threshold,
		int32 Limit,
		UPARAM(DisplayName = "Success") bool& bSuccess,
	...
	static MEGALITHNIAGARA_API FString SearchNiagaraByMaterial(
	...
	static MEGALITHNIAGARA_API FString FindNiagaraReferences(
		const FString& AssetPath,
		int32 Limit,
		UPARAM(DisplayName = "Success") bool& bSuccess,
		FString& OutError);
	...
	// ---------------------------------------------------------------------------------------
	// Tranche 2 (#64): per-system Data Interface enumeration (Megalith|Niagara|Inspection)
	// ---------------------------------------------------------------------------------------
	...
	static MEGALITHNIAGARA_API FString GetNiagaraDataInterfaces(
		const FString& AssetPath,
		UPARAM(DisplayName = "Success") bool& bSuccess,
		FString& OutError);
};
