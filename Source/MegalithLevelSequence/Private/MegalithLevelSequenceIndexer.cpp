...
void FLevelSequenceIndexer::EnsureTablesExist(FMegalithIndexDatabase& DB)
{
	...
	// Pattern borrowed from MegalithAI/FAIIndexer (its ai_assets is also
	...
	// dispatchers are NOT recorded — same convention as MegalithBlueprint's
...
bool FLevelSequenceIndexer::IndexAsset(const FAssetData& AssetData, UObject* LoadedAsset, FMegalithIndexDatabase& DB, int64 AssetId)
{
	...
	// Mirrors MegalithBlueprint's convention: skip inherited base-class
