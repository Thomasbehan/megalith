...
void FMegalithLevelSequenceActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	Registry.RegisterAction(TEXT("level_sequence"), TEXT("ping"),
		TEXT("Smoke test — returns {status:ok, module:MegalithLevelSequence} when the module is loaded."),
		FMegalithActionHandler::CreateStatic(&FMegalithLevelSequenceActions::Ping),
	...
	Registry.RegisterAction(TEXT("level_sequence"), TEXT("list_directors"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithLevelSequenceActions::ListDirectors),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("level_sequence"), TEXT("get_director_info"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithLevelSequenceActions::GetDirectorInfo),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("level_sequence"), TEXT("list_director_functions"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithLevelSequenceActions::ListDirectorFunctions),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("level_sequence"), TEXT("list_event_bindings"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithLevelSequenceActions::ListEventBindings),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Full Level Sequence asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("level_sequence"), TEXT("find_director_function_callers"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithLevelSequenceActions::FindDirectorFunctionCallers),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("level_sequence"), TEXT("list_director_variables"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithLevelSequenceActions::ListDirectorVariables),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Full Level Sequence asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("level_sequence"), TEXT("list_bindings"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithLevelSequenceActions::ListBindings),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Full Level Sequence asset path"))
...
FMegalithActionResult FMegalithLevelSequenceActions::Ping(const TSharedPtr<FJsonObject>& Params)
{
	auto Result = MakeShared<FJsonObject>();
	Result->SetStringField(TEXT("status"), TEXT("ok"));
	Result->SetStringField(TEXT("module"), TEXT("MegalithLevelSequence"));
	return FMegalithActionResult::Success(Result);
}

FMegalithActionResult FMegalithLevelSequenceActions::ListDirectors(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor)
	{
	...
	UMegalithIndexSubsystem* IndexSS = GEditor->GetEditorSubsystem<UMegalithIndexSubsystem>();
	if (!IndexSS || !IndexSS->GetDatabase())
	{
		return FMegalithActionResult::Error(TEXT("Index database not ready"));
	}

	FSQLiteDatabase* RawDB = IndexSS->GetDatabase()->GetRawDatabase();
	if (!RawDB)
	{
		return FMegalithActionResult::Error(TEXT("Raw SQLite database not available"));
	}
	...
	{
		return FMegalithActionResult::Error(TEXT("Failed to prepare list_directors SQL"));
	}
...
FMegalithActionResult FMegalithLevelSequenceActions::GetDirectorInfo(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor)
	{
		return FMegalithActionResult::Error(TEXT("GEditor not available"));
	...
	FString DirName;
	{
		...
		{
			return FMegalithActionResult::Error(TEXT("Failed to prepare director lookup SQL"));
		}
...
FMegalithActionResult FMegalithLevelSequenceActions::ListDirectorFunctions(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor)
	{
		return FMegalithActionResult::Error(TEXT("GEditor not available"));
	...
	if (!Stmt.Create(*RawDB, *SQL))
	{
		return FMegalithActionResult::Error(TEXT("Failed to prepare list_director_functions SQL"));
	}
	Stmt.SetBindingValueByIndex(1, AssetPath);
...
FMegalithActionResult FMegalithLevelSequenceActions::ListEventBindings(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor)
	{
		return FMegalithActionResult::Error(TEXT("GEditor not available"));
	...
	if (!Stmt.Create(*RawDB, *SQL))
	{
		return FMegalithActionResult::Error(TEXT("Failed to prepare list_event_bindings SQL"));
	}
	Stmt.SetBindingValueByIndex(1, AssetPath);
...
FMegalithActionResult FMegalithLevelSequenceActions::FindDirectorFunctionCallers(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor)
	{
		return FMegalithActionResult::Error(TEXT("GEditor not available"));
	...
	{
		return FMegalithActionResult::Error(TEXT("function_name is required"));
	}
	...
	if (!Stmt.Create(*RawDB, *SQL))
	{
		return FMegalithActionResult::Error(TEXT("Failed to prepare find_director_function_callers SQL"));
	}
...
FMegalithActionResult FMegalithLevelSequenceActions::ListDirectorVariables(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor)
	{
		return FMegalithActionResult::Error(TEXT("GEditor not available"));
	...
	if (!Stmt.Create(*RawDB, TEXT(
		...
		"ORDER BY v.id")))
	{
		return FMegalithActionResult::Error(TEXT("Failed to prepare list_director_variables SQL"));
	}
	Stmt.SetBindingValueByIndex(1, AssetPath);
...
FMegalithActionResult FMegalithLevelSequenceActions::ListBindings(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor)
	{
		return FMegalithActionResult::Error(TEXT("GEditor not available"));
	...
	if (!Stmt.Create(*RawDB, *SQL))
	{
		return FMegalithActionResult::Error(TEXT("Failed to prepare list_bindings SQL"));
	}
	Stmt.SetBindingValueByIndex(1, LsAssetId);
	if (bFilterByKind)
	{
