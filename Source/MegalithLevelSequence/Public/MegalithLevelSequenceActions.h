...
/**
 * Level Sequence domain action handlers for Megalith.
 ...
 */
class FMegalithLevelSequenceActions
{
public:
	...
	// --- Action handlers ---
	static FMegalithActionResult Ping(const TSharedPtr<FJsonObject>& Params);
	 ...
	 */
	static FMegalithActionResult ListDirectors(const TSharedPtr<FJsonObject>& Params);
	 ...
	 */
	static FMegalithActionResult GetDirectorInfo(const TSharedPtr<FJsonObject>& Params);
	 ...
	 */
	static FMegalithActionResult ListDirectorFunctions(const TSharedPtr<FJsonObject>& Params);
	 ...
	 */
	static FMegalithActionResult ListEventBindings(const TSharedPtr<FJsonObject>& Params);
	 ...
	 */
	static FMegalithActionResult FindDirectorFunctionCallers(const TSharedPtr<FJsonObject>& Params);

	/**
	 * List a Director's variables (name + K2-schema-formatted type) in
	 * declaration order. Variables come from DirBP->NewVariables.
	 */
	static FMegalithActionResult ListDirectorVariables(const TSharedPtr<FJsonObject>& Params);
	 ...
	 * editor-facing label.
	 */
	static FMegalithActionResult ListBindings(const TSharedPtr<FJsonObject>& Params);
};
