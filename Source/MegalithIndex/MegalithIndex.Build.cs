...
public class MegalithIndex : ModuleRules
{
	...
	public MegalithIndex(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		// EnabledByDefault:false (and Optional:true in Megalith.uplugin), so a source builder
		// who hasn't enabled it would otherwise hard-link MetasoundEngine/MetasoundFrontend → 126.
		// Release builds: MEGALITH_RELEASE_BUILD=1 still forces this OFF (Issue #30 defense).
