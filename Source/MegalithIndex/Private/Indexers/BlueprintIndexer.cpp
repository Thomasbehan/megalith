...
bool FBlueprintIndexer::IndexAsset(const FAssetData& AssetData, UObject* LoadedAsset, FMegalithIndexDatabase& DB, int64 AssetId)
{
...
void FBlueprintIndexer::IndexGraph(UEdGraph* Graph, FMegalithIndexDatabase& DB, int64 AssetId)
{
	if (!Graph) return;
...
void FBlueprintIndexer::IndexVariables(UBlueprint* Blueprint, FMegalithIndexDatabase& DB, int64 AssetId)
{
	if (!Blueprint) return;
