...
bool FMaterialIndexer::IndexAsset(const FAssetData& AssetData, UObject* LoadedAsset, FMegalithIndexDatabase& DB, int64 AssetId)
{
...
void FMaterialIndexer::IndexMaterialExpressions(UMaterial* Material, FMegalithIndexDatabase& DB, int64 AssetId)
{
	if (!Material) return;
...
void FMaterialIndexer::IndexMaterialInstance(UMaterialInstanceConstant* MIC, FMegalithIndexDatabase& DB, int64 AssetId)
{
	if (!MIC) return;
