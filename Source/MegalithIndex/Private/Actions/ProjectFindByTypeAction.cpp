...
FMegalithActionResult FProjectFindByTypeAction::Execute(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (AssetClass.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("'asset_type' (or 'asset_class') parameter is required"), -32602);
	}
