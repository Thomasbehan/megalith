...
DECLARE_LOG_CATEGORY_EXTERN(LogMegalithMemory, Log, All);
 ...
 */
struct MEGALITHINDEX_API FMegalithMemoryHelper
{
	/**
	 ...
	 * Override via Project Settings > Megalith > Indexing > Performance.
	 */
