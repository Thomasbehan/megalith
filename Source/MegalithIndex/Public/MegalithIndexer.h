 ...
 */
class MEGALITHINDEX_API IMegalithIndexer
{
public:
	virtual ~IMegalithIndexer() = default;
	 ...
	 */
	virtual bool IndexAsset(const FAssetData& AssetData, UObject* LoadedAsset, FMegalithIndexDatabase& DB, int64 AssetId) = 0;
	...
	virtual bool IndexScoped(const TSet<FString>& ChangedPaths, const TSet<FString>& RemovedPaths, FMegalithIndexDatabase& DB) { return false; }
};
