...
enum class EMegalithProjectSearchStatus : uint8
{
...
enum class EMegalithDeepIndexQueueDecision : uint8
{
 ...
 */
MEGALITHINDEX_API EMegalithDeepIndexQueueDecision MegalithDecideDeepIndexQueueEntry(
...
inline constexpr int32 MegalithMaxDeepIndexAttempts = 2;

/**
 * RAII wrapper around FSQLiteDatabase for the Megalith project index.
 ...
 */
class MEGALITHINDEX_API FMegalithIndexDatabase
{
public:
	FMegalithIndexDatabase();
	~FMegalithIndexDatabase();
	 ...
	 */
	EMegalithProjectSearchStatus FullTextSearch(
		const FString& Query,
		int32 Limit,
