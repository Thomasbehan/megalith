 ...
 * Persists to JSON files in Saved/Megalith/SpatialRegistry/.
 *
 * 10 actions:
...
class FMegalithMeshSpatialRegistry
{
public:
...
private:
	...
	static FMegalithActionResult RegisterBuilding(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult RegisterRoom(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult RegisterStreetFurniture(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult QueryRoomAt(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult QueryAdjacentRooms(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult QueryRoomsByFilter(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult QueryBuildingExits(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult PathBetweenRooms(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult SaveBlockDescriptor(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult LoadBlockDescriptor(const TSharedPtr<FJsonObject>& Params);
