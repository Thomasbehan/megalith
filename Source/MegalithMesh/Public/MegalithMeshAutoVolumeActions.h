 ...
 */
class FMegalithMeshAutoVolumeActions
{
public:
...
private:
	// ---- Action Handlers ----
	static FMegalithActionResult AutoVolumesForBuilding(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult AutoVolumesForBlock(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult SpawnNavLink(const TSharedPtr<FJsonObject>& Params);
