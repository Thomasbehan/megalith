 ...
 */
class FMegalithMeshDecalActions
{
public:
...
private:
	// --- Decal placement ---
	static FMegalithActionResult PlaceDecals(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult PlaceAlongPath(const TSharedPtr<FJsonObject>& Params);

	// --- Analysis ---
	static FMegalithActionResult AnalyzePropDensity(const TSharedPtr<FJsonObject>& Params);

	// --- Storytelling ---
	static FMegalithActionResult PlaceStorytellingScene(const TSharedPtr<FJsonObject>& Params);
