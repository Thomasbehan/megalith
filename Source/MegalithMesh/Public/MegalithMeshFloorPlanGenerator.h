 ...
 */
class FMegalithMeshFloorPlanGenerator
{
public:
...
private:
	// ---- Action handlers ----
	static FMegalithActionResult GenerateFloorPlan(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult ListBuildingArchetypes(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult GetBuildingArchetype(const TSharedPtr<FJsonObject>& Params);
