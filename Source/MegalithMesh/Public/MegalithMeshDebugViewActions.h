 ...
 */
class FMegalithMeshDebugViewActions
{
public:
...
private:
	...
	static FMegalithActionResult ToggleSectionView(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult ToggleCeilingVisibility(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult CaptureFloorPlan(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult HighlightRoom(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult SaveCameraBookmark(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult LoadCameraBookmark(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult CaptureBuildingViews(const TSharedPtr<FJsonObject>& Params);
