 ...
 */
class FMegalithMeshContextPropActions
{
public:
...
private:
	// --- Surface scatter ---
	static FMegalithActionResult ScatterOnSurface(const TSharedPtr<FJsonObject>& Params);

	// --- Disturbance ---
	static FMegalithActionResult SetRoomDisturbance(const TSharedPtr<FJsonObject>& Params);

	// --- Physics ---
	static FMegalithActionResult ConfigurePhysicsProps(const TSharedPtr<FJsonObject>& Params);

	// --- Settle ---
	static FMegalithActionResult SettleProps(const TSharedPtr<FJsonObject>& Params);

	// --- Prop kits ---
	static FMegalithActionResult CreatePropKit(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult PlacePropKit(const TSharedPtr<FJsonObject>& Params);

	// --- Wall/ceiling scatter ---
	static FMegalithActionResult ScatterOnWalls(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult ScatterOnCeiling(const TSharedPtr<FJsonObject>& Params);
	...
	/** Find all actors with a given Megalith.Owner:{volume} tag */
