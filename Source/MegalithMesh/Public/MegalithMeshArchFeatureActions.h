 ...
 */
class FMegalithMeshArchFeatureActions
{
public:
...
private:
	...
	// Action handlers
	static FMegalithActionResult CreateBalcony(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult CreatePorch(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult CreateFireEscape(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult CreateRampConnector(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult CreateRailing(const TSharedPtr<FJsonObject>& Params);
	...
	/** Save mesh to asset, optionally place in scene. Uses public helpers from FMegalithMeshProceduralActions.
