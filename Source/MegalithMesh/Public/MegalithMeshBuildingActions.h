 ...
 */
class FMegalithMeshBuildingActions
{
public:
...
private:
	...
	// Action handlers
	static FMegalithActionResult CreateBuildingFromGrid(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult CreateGridFromRooms(const TSharedPtr<FJsonObject>& Params);
