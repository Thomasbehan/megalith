 ...
 */
class FMegalithMeshProceduralActions
{
public:
	...
	// ---- Shared helpers (public for cross-module use, e.g. FMegalithMeshBuildingActions) ----
...
private:
	...
	static FMegalithActionResult CreateParametricMesh(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult CreateHorrorProp(const TSharedPtr<FJsonObject>& Params);

	// Action handlers — Phase 19B (Structures + Mazes)
	static FMegalithActionResult CreateStructure(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult CreateBuildingShell(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult CreateMaze(const TSharedPtr<FJsonObject>& Params);

	// Action handlers — Phase 19C (Pipes + Fragments)
	static FMegalithActionResult CreatePipeNetwork(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult CreateFragments(const TSharedPtr<FJsonObject>& Params);

	// Action handlers — Phase 19D (Terrain)
	static FMegalithActionResult CreateTerrainPatch(const TSharedPtr<FJsonObject>& Params);
	...
	static FMegalithActionResult ListCachedMeshes(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult ClearCacheAction(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult ValidateCacheAction(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult GetCacheStatsAction(const TSharedPtr<FJsonObject>& Params);

	static void RegisterCacheActions(FMegalithToolRegistry& Registry);
