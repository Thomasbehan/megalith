 ...
 */
class FMegalithMeshTerrainActions
{
public:
...
private:
	...
	// ---- Action handlers ----
	static FMegalithActionResult SampleTerrainGrid(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult AnalyzeBuildingSite(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult CreateFoundation(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult CreateRetainingWall(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult PlaceBuildingOnTerrain(const TSharedPtr<FJsonObject>& Params);
