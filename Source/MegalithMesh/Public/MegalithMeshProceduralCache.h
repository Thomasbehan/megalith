 ...
 *
 * Manifest location: Plugins/Megalith/Saved/Megalith/ProceduralCache/manifest.json
 ...
 */
class FMegalithMeshProceduralCache
{
public:
	/** Singleton accessor */
	static FMegalithMeshProceduralCache& Get();
...
private:
	FMegalithMeshProceduralCache() = default;
