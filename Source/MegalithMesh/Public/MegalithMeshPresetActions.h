 ...
 * Make Megalith's horror-specific systems genre-agnostic via JSON preset authoring.
 ...
 */
class FMegalithMeshPresetActions
{
public:
...
private:
	...
	static FMegalithActionResult ListStorytellingPatterns(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult CreateStorytellingPattern(const TSharedPtr<FJsonObject>& Params);

	// --- Acoustic profiles ---
	static FMegalithActionResult ListAcousticProfiles(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult CreateAcousticProfile(const TSharedPtr<FJsonObject>& Params);

	// --- Tension profiles ---
	static FMegalithActionResult CreateTensionProfile(const TSharedPtr<FJsonObject>& Params);

	// --- Genre preset bundles ---
	static FMegalithActionResult ListGenrePresets(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult ExportGenrePreset(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult ImportGenrePreset(const TSharedPtr<FJsonObject>& Params);
