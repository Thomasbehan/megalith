...
bool FMegalithMeshCatalog::CreateTable(FSQLiteDatabase& DB)
{
...
bool FMegalithMeshCatalog::InsertEntry(
	FSQLiteDatabase& DB,
...
TSharedPtr<FJsonObject> FMegalithMeshCatalog::SearchBySize(
	FSQLiteDatabase& DB,
...
TSharedPtr<FJsonObject> FMegalithMeshCatalog::GetStats(FSQLiteDatabase& DB)
{
	auto Result = MakeShared<FJsonObject>();
...
FString FMegalithMeshCatalog::ClassifySizeClass(float BoundsMax)
{
...
FString FMegalithMeshCatalog::InferCategory(const FString& AssetPath)
{
