...
void FMegalithMeshBuildingValidationActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	Registry.RegisterAction(TEXT("mesh"), TEXT("validate_building"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshBuildingValidationActions::ValidateBuilding),
		FParamSchemaBuilder()
...
namespace BuildingValidationHelpers
{
	...
	bool GetBoolParam(const TSharedPtr<FJsonObject>& Params, const FString& Key, bool Default)
	{
		if (Params->HasField(Key))
		{
			...
			const TSharedPtr<FJsonValue>& Val = Params->Values.FindChecked(MegalithMakeJsonKey(Key));
...
TSet<FString> FMegalithMeshBuildingValidationActions::BFSReachable(
...
FString FMegalithMeshBuildingValidationActions::FindEntranceRoom(
	const FSpatialBlock& Block,
...
TArray<FString> FMegalithMeshBuildingValidationActions::GetBuildingRoomIds(
	const FSpatialBlock& Block,
	const FString& BuildingId)
{
...
TSharedPtr<FJsonObject> FMegalithMeshBuildingValidationActions::ValidateDoors(
	const FSpatialBlock& Block,
	const FString& BuildingId,
	float CapsuleRadius,
...
TSharedPtr<FJsonObject> FMegalithMeshBuildingValidationActions::ValidateConnectivity(
	const FSpatialBlock& Block,
	const FString& BuildingId)
{
	auto Result = MakeShared<FJsonObject>();
...
TSharedPtr<FJsonObject> FMegalithMeshBuildingValidationActions::ValidateWindows(
	const FSpatialBlock& Block,
	const FString& BuildingId,
	UWorld* World)
{
...
TSharedPtr<FJsonObject> FMegalithMeshBuildingValidationActions::ValidateStairs(
	const FSpatialBlock& Block,
	const FString& BuildingId,
	float MaxStairAngle)
{
...
FMegalithActionResult FMegalithMeshBuildingValidationActions::ValidateBuilding(
	const TSharedPtr<FJsonObject>& Params)
{
	...
	{
		return FMegalithActionResult::Error(TEXT("building_id is required"));
	}
	...
	return FMegalithActionResult::Success(Response);
}
