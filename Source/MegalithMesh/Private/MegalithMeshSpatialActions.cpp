...
ECollisionChannel FMegalithMeshSpatialActions::ParseCollisionChannel(const FString& ChannelName, bool& bSuccess)
{
	bSuccess = true;
...
TArray<TSharedPtr<FJsonValue>> FMegalithMeshSpatialActions::VectorToJsonArray(const FVector& V)
{
...
TSharedPtr<FJsonObject> FMegalithMeshSpatialActions::HitResultToJson(const FHitResult& Hit)
{
...
void FMegalithMeshSpatialActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	// 1. query_raycast
	Registry.RegisterAction(TEXT("mesh"), TEXT("query_raycast"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshSpatialActions::QueryRaycast),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("query_multi_raycast"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshSpatialActions::QueryMultiRaycast),
		FParamSchemaBuilder()
			.Required(TEXT("start"), TEXT("array"), TEXT("Start position [x, y, z]"))
			.Required(TEXT("end"), TEXT("array"), TEXT("End position [x, y, z]"))
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("query_radial_sweep"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshSpatialActions::QueryRadialSweep),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("query_overlap"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshSpatialActions::QueryOverlap),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("query_nearest"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshSpatialActions::QueryNearest),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("query_line_of_sight"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshSpatialActions::QueryLineOfSight),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("get_actors_in_volume"),
		TEXT("Get all actors inside a named BlockingVolume. Checks Megalith.Owner tags and spatial containment."),
		FMegalithActionHandler::CreateStatic(&FMegalithMeshSpatialActions::GetActorsInVolume),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("get_scene_bounds"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshSpatialActions::GetSceneBounds),
		FParamSchemaBuilder()
			.Optional(TEXT("class_filter"), TEXT("string"), TEXT("Filter by class name (e.g. StaticMeshActor)"))
			.Build());
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("get_scene_statistics"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshSpatialActions::GetSceneStatistics),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("get_spatial_relationships"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshSpatialActions::GetSpatialRelationships),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("query_navmesh"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshSpatialActions::QueryNavmesh),
		FParamSchemaBuilder()
			.Required(TEXT("start"), TEXT("array"), TEXT("Start position [x, y, z]"))
			.Required(TEXT("end"), TEXT("array"), TEXT("End position [x, y, z]"))
...
FMegalithActionResult FMegalithMeshSpatialActions::QueryRaycast(const TSharedPtr<FJsonObject>& Params)
{
	FVector Start, End;
	...
	// Build query params
	FCollisionQueryParams QueryParams(SCENE_QUERY_STAT(MegalithRaycast), true);
	...
	if (Params->TryGetArrayField(TEXT("ignore_actors"), IgnoreArr))
	{
		...
		{
			FString Error;
			AActor* IgnoreActor = MegalithMeshUtils::FindActorByName(Val->AsString(), Error);
			if (IgnoreActor)
			{
...
FMegalithActionResult FMegalithMeshSpatialActions::QueryMultiRaycast(const TSharedPtr<FJsonObject>& Params)
{
	FVector Start, End;
	if (!MegalithMeshUtils::ParseVector(Params, TEXT("start"), Start))
	{
	...
	FCollisionQueryParams QueryParams(SCENE_QUERY_STAT(MegalithMultiRaycast), true);
	QueryParams.bReturnPhysicalMaterial = true;
...
FMegalithActionResult FMegalithMeshSpatialActions::QueryRadialSweep(const TSharedPtr<FJsonObject>& Params)
{
	FVector Origin;
	if (!MegalithMeshUtils::ParseVector(Params, TEXT("origin"), Origin))
	{
		return FMegalithActionResult::Error(TEXT("Missing or invalid required param: origin (array of 3 numbers)"));
	}
	...
	FCollisionQueryParams QueryParams(SCENE_QUERY_STAT(MegalithRadialSweep), true);
	QueryParams.bReturnPhysicalMaterial = true;
...
FMegalithActionResult FMegalithMeshSpatialActions::QueryOverlap(const TSharedPtr<FJsonObject>& Params)
{
	FVector Location;
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required param: shape (box, sphere, or capsule)"));
	}
	...
	if (ShapeStr.Equals(TEXT("sphere"), ESearchCase::IgnoreCase))
	{
		...
		{
			return FMegalithActionResult::Error(TEXT("For sphere shape, extent must be a number (radius)"));
		}
	...
	{
		FVector BoxExtent;
		if (!MegalithMeshUtils::ParseVector(Params, TEXT("extent"), BoxExtent))
		{
			return FMegalithActionResult::Error(TEXT("For box shape, extent must be an array [x, y, z] (half-extents)"));
		}
	...
	else if (ShapeStr.Equals(TEXT("capsule"), ESearchCase::IgnoreCase))
	{
		...
		{
			return FMegalithActionResult::Error(TEXT("For capsule shape, extent must be an array [radius, half_height]"));
		}
	...
	FCollisionQueryParams QueryParams(SCENE_QUERY_STAT(MegalithOverlap), true);
...
FMegalithActionResult FMegalithMeshSpatialActions::QueryNearest(const TSharedPtr<FJsonObject>& Params)
{
	FVector Location;
	if (!MegalithMeshUtils::ParseVector(Params, TEXT("location"), Location))
	{
	...
	FCollisionQueryParams QueryParams(SCENE_QUERY_STAT(MegalithNearest), true);
...
FMegalithActionResult FMegalithMeshSpatialActions::QueryLineOfSight(const TSharedPtr<FJsonObject>& Params)
{
	FVector From, To;
	if (!MegalithMeshUtils::ParseVector(Params, TEXT("from"), From))
	{
		return FMegalithActionResult::Error(TEXT("Missing or invalid required param: from (array of 3 numbers)"));
	}
	if (!MegalithMeshUtils::ParseVector(Params, TEXT("to"), To))
	{
		return FMegalithActionResult::Error(TEXT("Missing or invalid required param: to (array of 3 numbers)"));
	}
	...
	FCollisionQueryParams QueryParams(SCENE_QUERY_STAT(MegalithLOS), true);
	QueryParams.bReturnPhysicalMaterial = true;
...
FMegalithActionResult FMegalithMeshSpatialActions::GetActorsInVolume(const TSharedPtr<FJsonObject>& Params)
{
	FString VolumeName;
	...
	if (!Volume)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("BlockingVolume not found: %s"), *VolumeName));
	}
	...
	// Collect actors: those with Megalith.Owner tag matching this volume, or spatially inside
...
FMegalithActionResult FMegalithMeshSpatialActions::GetSceneBounds(const TSharedPtr<FJsonObject>& Params)
{
	UWorld* World = MegalithMeshUtils::GetEditorWorld();
	if (!World)
	{
	...
	if (ActorCount == 0)
	{
		return FMegalithActionResult::Error(ClassFilter.IsEmpty()
...
FMegalithActionResult FMegalithMeshSpatialActions::GetSceneStatistics(const TSharedPtr<FJsonObject>& Params)
{
	UWorld* World = MegalithMeshUtils::GetEditorWorld();
	if (!World)
	{
...
FMegalithActionResult FMegalithMeshSpatialActions::GetSpatialRelationships(const TSharedPtr<FJsonObject>& Params)
{
	FString ActorName;
	...
	FString Error;
	AActor* TargetActor = MegalithMeshUtils::FindActorByName(ActorName, Error);
	if (!TargetActor)
	{
	...
	FCollisionQueryParams QueryParams(SCENE_QUERY_STAT(MegalithSpatialRel), true);
...
FMegalithActionResult FMegalithMeshSpatialActions::QueryNavmesh(const TSharedPtr<FJsonObject>& Params)
{
	FVector Start, End;
	if (!MegalithMeshUtils::ParseVector(Params, TEXT("start"), Start))
	{
	...
	if (!NavSys)
	{
		return FMegalithActionResult::Error(TEXT("Navmesh not built. Build navigation in the editor first (Build > Build Paths)."));
	}
