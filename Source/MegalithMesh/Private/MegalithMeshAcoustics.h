...
#include "MegalithMeshAcoustics.generated.h"
 ...
 *
 * Loads acoustic properties from a DataTable (UMegalithSettings::SurfaceAcousticsTablePath).
 ...
 */
namespace MegalithMeshAcoustics
{
	// ========================================================================
