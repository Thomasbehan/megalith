...
UMegalithMeshHandlePool* FMegalithMeshOperationActions::Pool = nullptr;

void FMegalithMeshOperationActions::SetHandlePool(UMegalithMeshHandlePool* InPool)
{
	Pool = InPool;
}
...
void FMegalithMeshOperationActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	Registry.RegisterAction(TEXT("mesh"), TEXT("create_handle"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshOperationActions::CreateHandle),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("release_handle"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshOperationActions::ReleaseHandle),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("list_handles"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshOperationActions::ListHandles),
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("save_handle"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshOperationActions::SaveHandle),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("mesh_boolean"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshOperationActions::MeshBoolean),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("mesh_simplify"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshOperationActions::MeshSimplify),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("mesh_remesh"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshOperationActions::MeshRemesh),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("generate_collision"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshOperationActions::GenerateCollision),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("generate_lods"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshOperationActions::GenerateLods),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("fill_holes"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshOperationActions::FillHoles),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("compute_uvs"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshOperationActions::ComputeUvs),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("mirror_mesh"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshOperationActions::MirrorMesh),
		FParamSchemaBuilder()
...
FMegalithActionResult FMegalithMeshOperationActions::CreateHandle(const TSharedPtr<FJsonObject>& Params)
{
	if (!Pool)
	{
		return FMegalithActionResult::Error(TEXT("Enable the GeometryScripting plugin in your .uproject to use mesh operations."));
	}
	...
	{
		return FMegalithActionResult::Error(TEXT("Both 'source' and 'handle' are required"));
	}
...
FMegalithActionResult FMegalithMeshOperationActions::ReleaseHandle(const TSharedPtr<FJsonObject>& Params)
{
	if (!Pool)
	{
		return FMegalithActionResult::Error(TEXT("Enable the GeometryScripting plugin in your .uproject to use mesh operations."));
	...
	{
		return FMegalithActionResult::Error(TEXT("'handle' is required"));
	}

	if (!Pool->ReleaseHandle(HandleName))
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Handle '%s' not found"), *HandleName));
	}
...
FMegalithActionResult FMegalithMeshOperationActions::ListHandles(const TSharedPtr<FJsonObject>& /*Params*/)
{
	if (!Pool)
	{
		return FMegalithActionResult::Error(TEXT("Enable the GeometryScripting plugin in your .uproject to use mesh operations."));
...
FMegalithActionResult FMegalithMeshOperationActions::SaveHandle(const TSharedPtr<FJsonObject>& Params)
{
	if (!Pool)
	{
		return FMegalithActionResult::Error(TEXT("Enable the GeometryScripting plugin in your .uproject to use mesh operations."));
	...
	{
		return FMegalithActionResult::Error(TEXT("Both 'handle' and 'target_path' are required"));
	}
...
FMegalithActionResult FMegalithMeshOperationActions::MeshBoolean(const TSharedPtr<FJsonObject>& Params)
{
	if (!Pool)
	{
		return FMegalithActionResult::Error(TEXT("Enable the GeometryScripting plugin in your .uproject to use mesh operations."));
	...
	{
		return FMegalithActionResult::Error(TEXT("handle_a, handle_b, operation, and result_handle are all required"));
	}
	...
	if (!MeshA) return FMegalithActionResult::Error(ErrorA);
	if (!MeshB) return FMegalithActionResult::Error(ErrorB);
	...
	{
		return FMegalithActionResult::Error(CreateError);
	}

	UDynamicMesh* ResultMesh = Pool->GetHandle(ResultHandle, CreateError);
	if (!ResultMesh)
	{
		return FMegalithActionResult::Error(TEXT("Failed to get newly created result handle"));
	}
...
FMegalithActionResult FMegalithMeshOperationActions::MeshSimplify(const TSharedPtr<FJsonObject>& Params)
{
	if (!Pool)
	{
		return FMegalithActionResult::Error(TEXT("Enable the GeometryScripting plugin in your .uproject to use mesh operations."));
	...
	if (!Mesh) return FMegalithActionResult::Error(Error);
	...
	{
		return FMegalithActionResult::Error(TEXT("Either 'target_triangles' or 'target_percentage' is required"));
	}
...
FMegalithActionResult FMegalithMeshOperationActions::MeshRemesh(const TSharedPtr<FJsonObject>& Params)
{
	if (!Pool)
	{
		return FMegalithActionResult::Error(TEXT("Enable the GeometryScripting plugin in your .uproject to use mesh operations."));
	...
	{
		return FMegalithActionResult::Error(TEXT("'target_edge_length' must be positive"));
	}
...
FMegalithActionResult FMegalithMeshOperationActions::GenerateCollision(const TSharedPtr<FJsonObject>& Params)
{
	if (!Pool)
	{
		return FMegalithActionResult::Error(TEXT("Enable the GeometryScripting plugin in your .uproject to use mesh operations."));
...
FMegalithActionResult FMegalithMeshOperationActions::GenerateLods(const TSharedPtr<FJsonObject>& Params)
{
	if (!Pool)
	{
		return FMegalithActionResult::Error(TEXT("Enable the GeometryScripting plugin in your .uproject to use mesh operations."));
	...
	{
		return FMegalithActionResult::Error(TEXT("'lod_count' must be between 1 and 8"));
	}
	...
	if (!SourceMesh) return FMegalithActionResult::Error(Error);
	...
	for (int32 Lod = 1; Lod <= LodCount; ++Lod)
	{
		...
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create LOD handle: %s"), *CreateError));
		}

		UDynamicMesh* LodMesh = Pool->GetHandle(LodHandleName, CreateError);
		if (!LodMesh)
		{
			return FMegalithActionResult::Error(TEXT("Failed to get LOD handle"));
		}
...
FMegalithActionResult FMegalithMeshOperationActions::FillHoles(const TSharedPtr<FJsonObject>& Params)
{
	if (!Pool)
	{
		return FMegalithActionResult::Error(TEXT("Enable the GeometryScripting plugin in your .uproject to use mesh operations."));
...
FMegalithActionResult FMegalithMeshOperationActions::ComputeUvs(const TSharedPtr<FJsonObject>& Params)
{
	if (!Pool)
	{
		return FMegalithActionResult::Error(TEXT("Enable the GeometryScripting plugin in your .uproject to use mesh operations."));
...
FMegalithActionResult FMegalithMeshOperationActions::MirrorMesh(const TSharedPtr<FJsonObject>& Params)
{
	if (!Pool)
	{
		return FMegalithActionResult::Error(TEXT("Enable the GeometryScripting plugin in your .uproject to use mesh operations."));
	...
	{
		return FMegalithActionResult::Error(TEXT("'axis' must be X, Y, or Z"));
	}
