...
// =============================================================================
// MegalithMeshPersistenceTests.cpp
//
...
// once the disposable `/Game/Tests/Megalith/` save/load harness exists.
//
...
// `ai::place_smart_object_actor` action test belongs in a future MegalithAI
// test pack.
// =============================================================================
...
namespace MegalithMeshPersistenceTests
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithMeshConvertToHismPersistenceTest,
	"Megalith.Mesh.Persistence.ConvertToHism",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithMeshConvertToHismPersistenceTest::RunTest(const FString& /*Parameters*/)
{
	UWorld* World = MegalithMeshPersistenceTests::GetTestWorld();
	if (!TestNotNull(TEXT("Editor world available"), World))
	{
		return false;
	}

	AActor* HISMActor = MegalithMeshPersistenceTests::SpawnHostActor(World);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithMeshPlaceSplinePersistenceTest,
	"Megalith.Mesh.Persistence.PlaceSpline",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithMeshPlaceSplinePersistenceTest::RunTest(const FString& /*Parameters*/)
{
	UWorld* World = MegalithMeshPersistenceTests::GetTestWorld();
	if (!TestNotNull(TEXT("Editor world available"), World))
	{
	...
	AActor* SplineActor = MegalithMeshPersistenceTests::SpawnHostActor(World);
...
// MegalithAI test pack (would need a disposable USmartObjectDefinition asset).
// ============================================================================

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithAIPlaceSmartObjectActorPersistenceTest,
	"Megalith.AI.Persistence.PlaceSmartObjectActor.RootComponent",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithAIPlaceSmartObjectActorPersistenceTest::RunTest(const FString& /*Parameters*/)
{
	UWorld* World = MegalithMeshPersistenceTests::GetTestWorld();
	if (!TestNotNull(TEXT("Editor world available"), World))
	{
	...
	AActor* NewActor = MegalithMeshPersistenceTests::SpawnHostActor(World);
