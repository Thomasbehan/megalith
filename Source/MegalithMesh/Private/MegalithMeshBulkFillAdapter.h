 ...
 * Self-registers with FMegalithBulkFillRegistry from FMegalithMeshModule::StartupModule.
 *
 ...
 * `megalith_reindex` on `search_meshes_by_size` (design quirk row), and the
 * Mobility-ordering note in any ActorProperties-targeted describe output.
 */
class FMegalithMeshBulkFillAdapter
{
public:
