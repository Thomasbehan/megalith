...
void FMegalithMeshAccessibilityActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("validate_path_width"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshAccessibilityActions::ValidatePathWidth),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("validate_navigation_complexity"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshAccessibilityActions::ValidateNavigationComplexity),
		FParamSchemaBuilder()
			.Required(TEXT("start"), TEXT("array"), TEXT("Start position [x, y, z]"))
			.Required(TEXT("end"), TEXT("array"), TEXT("End position [x, y, z]"))
			.Build());
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("analyze_visual_contrast"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshAccessibilityActions::AnalyzeVisualContrast),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("find_rest_points"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshAccessibilityActions::FindRestPoints),
		FParamSchemaBuilder()
			.Required(TEXT("start"), TEXT("array"), TEXT("Start position [x, y, z]"))
			.Required(TEXT("end"), TEXT("array"), TEXT("End position [x, y, z]"))
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("validate_interactive_reach"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshAccessibilityActions::ValidateInteractiveReach),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("generate_accessibility_report"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMeshAccessibilityActions::GenerateAccessibilityReport),
		FParamSchemaBuilder()
			.Required(TEXT("start"), TEXT("array"), TEXT("Start position [x, y, z]"))
			.Required(TEXT("end"), TEXT("array"), TEXT("End position [x, y, z]"))
...
FMegalithActionResult FMegalithMeshAccessibilityActions::ValidatePathWidth(const TSharedPtr<FJsonObject>& Params)
{
	FVector Start, End;
...
FMegalithActionResult FMegalithMeshAccessibilityActions::ValidateNavigationComplexity(const TSharedPtr<FJsonObject>& Params)
{
	FVector Start, End;
	if (!MegalithMeshUtils::ParseVector(Params, TEXT("start"), Start))
	{
	...
	if (!MegalithMeshAnalysis::FindNavPath(World, Start, End, PathPoints, PathDist))
	{
		return FMegalithActionResult::Error(TEXT("No navmesh path found."));
	}
...
FMegalithActionResult FMegalithMeshAccessibilityActions::AnalyzeVisualContrast(const TSharedPtr<FJsonObject>& Params)
{
	FVector Location;
	...
	FCollisionQueryParams QueryParams(SCENE_QUERY_STAT(MegalithContrast), true);
...
FMegalithActionResult FMegalithMeshAccessibilityActions::FindRestPoints(const TSharedPtr<FJsonObject>& Params)
{
	FVector Start, End;
	if (!MegalithMeshUtils::ParseVector(Params, TEXT("start"), Start))
	{
	...
	// Also sample tension along path to find natural calm zones
	{
		...
		for (int32 i = 0; i < PathPoints.Num(); ++i)
		{
			...
			if (FMath::Fmod(CumulDist, SampleInterval) < 50.0f || i == 0)
			{
				...
				FCollisionQueryParams QP(SCENE_QUERY_STAT(MegalithRest), true);
				...
				Inputs.CeilingHeight = MegalithMeshAnalysis::MeasureCeilingHeight(World, PathPoints[i]);
...
FMegalithActionResult FMegalithMeshAccessibilityActions::ValidateInteractiveReach(const TSharedPtr<FJsonObject>& Params)
{
	UWorld* World = MegalithMeshUtils::GetEditorWorld();
	if (!World)
	{
	...
	FCollisionQueryParams QueryParams(SCENE_QUERY_STAT(MegalithReach), true);
...
FMegalithActionResult FMegalithMeshAccessibilityActions::GenerateAccessibilityReport(const TSharedPtr<FJsonObject>& Params)
{
	FVector Start, End;
	if (!MegalithMeshUtils::ParseVector(Params, TEXT("start"), Start))
	{
	...
	// 1. Path Width
	{
		...
		FMegalithActionResult PathResult = ValidatePathWidth(PathParams);
	...
	// 2. Navigation Complexity
	{
		...
		FMegalithActionResult NavResult = ValidateNavigationComplexity(NavParams);
	...
	// 3. Visual Contrast
	{
		...
		FMegalithActionResult ContrastResult = AnalyzeVisualContrast(ContrastParams);
	...
	// 4. Rest Points
	{
		...
		FMegalithActionResult RestResult = FindRestPoints(RestParams);
	...
	// 5. Interactive Reach
	{
		...
		FMegalithActionResult ReachResult = ValidateInteractiveReach(ReachParams);
