...
public class MegalithMesh : ModuleRules
{
	...
	public MegalithMesh(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		//
		// Release builds: set MEGALITH_RELEASE_BUILD=1 to force this dep off so
		...
		if (bHasGeometryScripting)
		{
			...
			// Delay-bind the GeometryScripting module DLLs so MegalithMesh.dll loads
