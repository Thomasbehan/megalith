...
#include "MegalithBlueprintComponentResolver.h"
...
void FMegalithBlueprintActions::RegisterActions()
{
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("list_graphs"),
		...
		FMegalithActionHandler::CreateStatic(&HandleListGraphs),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_graph_data"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetGraphData),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_graph_summary"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetGraphSummary),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_variables"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetVariables),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_execution_flow"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetExecutionFlow),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("search_nodes"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSearchNodes),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_components"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetComponents),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_component_details"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetComponentDetails),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_functions"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetFunctions),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_event_dispatchers"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetEventDispatchers),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_parent_class"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetParentClass),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_interfaces"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetInterfaces),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_construction_script"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetConstructionScript),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("search_functions"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSearchFunctions),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_interface_functions"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetInterfaceFunctions),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_function_signature"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetFunctionSignature),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),         TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_event_dispatcher_details"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetEventDispatcherDetails),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),       TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_blueprint_info"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetBlueprintInfo),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("find_variable_references"),
		...
		FMegalithActionHandler::CreateStatic(&HandleFindVariableReferences),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),     TEXT("Blueprint asset path"))
...
UBlueprint* FMegalithBlueprintActions::LoadBlueprint(const TSharedPtr<FJsonObject>& Params, FString& OutAssetPath)
{
	return MegalithBlueprintInternal::LoadBlueprintFromParams(Params, OutAssetPath);
}

// --- list_graphs ---

FMegalithActionResult FMegalithBlueprintActions::HandleListGraphs(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	...
	MegalithBlueprintInternal::AddGraphArray(GraphsArr, BP->UbergraphPages, TEXT("event_graph"));
	MegalithBlueprintInternal::AddGraphArray(GraphsArr, BP->FunctionGraphs, TEXT("function"));
	MegalithBlueprintInternal::AddGraphArray(GraphsArr, BP->MacroGraphs, TEXT("macro"));
	MegalithBlueprintInternal::AddGraphArray(GraphsArr, BP->DelegateSignatureGraphs, TEXT("delegate_signature"));
	...
	for (const FBPInterfaceDescription& Iface : BP->ImplementedInterfaces)
	{
		...
		MegalithBlueprintInternal::AddGraphArray(GraphsArr, Iface.Graphs, TEXT("interface"), IfaceName);
	}
...
FMegalithActionResult FMegalithBlueprintActions::HandleGetGraphData(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
	...
	if (!Graph)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Graph not found: %s"), *GraphName));
	}
	...
	FString ParentGraph;
	const FString GraphType = MegalithBlueprintInternal::ClassifyGraphType(
	...
	for (UEdGraphNode* Node : Graph->Nodes)
	{
		...
		NodesArr.Add(MakeShared<FJsonValueObject>(MegalithBlueprintInternal::SerializeNode(Node)));
	}
...
FMegalithActionResult FMegalithBlueprintActions::HandleGetGraphSummary(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
...
FMegalithActionResult FMegalithBlueprintActions::HandleGetVariables(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
	...
	for (const FBPVariableDescription& Var : BP->NewVariables)
	{
		...
		VObj->SetStringField(TEXT("type"),
			MegalithBlueprintInternal::ContainerPrefix(Var.VarType) +
			MegalithBlueprintInternal::PinTypeToString(Var.VarType));
...
FMegalithActionResult FMegalithBlueprintActions::HandleGetExecutionFlow(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: entry_point"));
	}
	...
	auto SearchGraphs = [&](const TArray<TObjectPtr<UEdGraph>>& Graphs)
	{
		...
		{
			if (!Graph) continue;
			UEdGraphNode* Node = MegalithBlueprintInternal::FindEntryNode(Graph, EntryPoint);
			if (Node)
			{
				EntryNode = Node;
				FoundGraph = Graph;
	...
	if (!EntryNode)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Entry point not found: %s"), *EntryPoint));
	}

	TSet<UEdGraphNode*> Visited;
	TSharedPtr<FJsonObject> Flow = MegalithBlueprintInternal::TraceExecFlow(EntryNode, Visited);
...
FMegalithActionResult FMegalithBlueprintActions::HandleSearchNodes(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
	...
	if (Query.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: query"));
	}
	...
	for (UEdGraph* Graph : AllGraphs)
	{
		...
		FString InterfaceName;
		FString ParentGraph;
		const FString Type = MegalithBlueprintInternal::ClassifyGraphType(
			BP, Graph, InterfaceName, &ParentGraph);
...
FMegalithActionResult FMegalithBlueprintActions::HandleGetComponents(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
	...
	AActor* CDO = MegalithBlueprintComponentResolver::ResolveComponentCdo(BP, bParentCdoFallback);
	...
	TArray<TSharedPtr<FJsonValue>> InheritedComponentsArr;
	{
		...
		MegalithBlueprintComponentResolver::CollectInheritedScsNodes(BP, InheritedNodes);
		for (USCS_Node* Node : InheritedNodes)
		{
			if (!Node) continue;
			UActorComponent* Override = MegalithBlueprintComponentResolver::FindExistingIchOverride(BP, Node);
			...
			IObj->SetStringField(TEXT("source"), MegalithBlueprintComponentResolver::SourceToString(
				Override ? MegalithBlueprintComponentResolver::ESource::IchOverride
				         : MegalithBlueprintComponentResolver::ESource::InheritedScs));
	...
	if (NativeComponentsArr.Num() > 0)
	{
		...
		Root->SetStringField(TEXT("native_components_source"),
			MegalithBlueprintComponentResolver::SourceToString(bParentCdoFallback
				? MegalithBlueprintComponentResolver::ESource::ParentCdoFallback
				: MegalithBlueprintComponentResolver::ESource::CdoNative));
	}
	...
	{
		Root->SetStringField(TEXT("note"), MegalithBlueprintComponentResolver::ParentCdoFallbackNote());
	}
...
FMegalithActionResult FMegalithBlueprintActions::HandleGetComponentDetails(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: component_name"));
	}

	// One resolver for the whole module — see MegalithBlueprintComponentResolver.h.
	...
	const MegalithBlueprintComponentResolver::FResult Resolved =
		MegalithBlueprintComponentResolver::Resolve(
			BP, ComponentName, UActorComponent::StaticClass(), /*bCreateIchOverride=*/false);

	if (!Resolved.IsValid())
	{
		return FMegalithActionResult::Error(Resolved.Error.IsEmpty()
	...
	Root->SetBoolField(TEXT("is_inherited_native"),
		Resolved.Source == MegalithBlueprintComponentResolver::ESource::CdoNative);
	Root->SetStringField(TEXT("source"), MegalithBlueprintComponentResolver::SourceToString(Resolved.Source));
...
FMegalithActionResult FMegalithBlueprintActions::HandleGetFunctions(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
...
FMegalithActionResult FMegalithBlueprintActions::HandleGetEventDispatchers(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
...
FMegalithActionResult FMegalithBlueprintActions::HandleGetParentClass(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
...
FMegalithActionResult FMegalithBlueprintActions::HandleGetInterfaces(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
...
FMegalithActionResult FMegalithBlueprintActions::HandleGetConstructionScript(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
	...
	if (!CSGraph)
	{
		return FMegalithActionResult::Error(TEXT("No Construction Script found (Blueprint may not have one)"));
	}
...
FMegalithActionResult FMegalithBlueprintActions::HandleSearchFunctions(const TSharedPtr<FJsonObject>& Params)
{
	FString Query       = Params->GetStringField(TEXT("query"));
	...
	{
		return FMegalithActionResult::Error(TEXT("At least one of 'query' or 'class_filter' is required to avoid a full scan"));
	}
...
FMegalithActionResult FMegalithBlueprintActions::HandleGetNodeDetails(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
	...
	TSharedPtr<FJsonObject> NodeObj = MegalithBlueprintInternal::SerializeNode(Node);
	...
	return FMegalithActionResult::Success(NodeObj);
}
...
FMegalithActionResult FMegalithBlueprintActions::HandleGetInterfaceFunctions(const TSharedPtr<FJsonObject>& Params)
{
	FString InterfaceClassName = Params->GetStringField(TEXT("interface_class"));
	if (InterfaceClassName.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: interface_class"));
	}
...
FMegalithActionResult FMegalithBlueprintActions::HandleGetFunctionSignature(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
	...
	if (FuncName.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: function_name"));
	}
		...
		if (EntryNode)
		{
			...
			for (const FBPVariableDescription& LVar : EntryNode->LocalVariables)
			{
				...
				LObj->SetStringField(TEXT("type"),
					MegalithBlueprintInternal::ContainerPrefix(PT) +
					MegalithBlueprintInternal::PinTypeToString(PT));
...
FMegalithActionResult FMegalithBlueprintActions::HandleGetEventDispatcherDetails(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: dispatcher_name"));
	}
...
FMegalithActionResult FMegalithBlueprintActions::HandleGetBlueprintInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
...
FMegalithActionResult FMegalithBlueprintActions::HandleFindVariableReferences(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: variable_name"));
	}
	...
	for (UEdGraph* Graph : AllGraphs)
	{
		...
		for (UEdGraphNode* Node : Graph->Nodes)
		{
			...
			// it by class-name string (mirrors MegalithPropertyAccessReader).
			FString Access;
			...
			MegalithPropertyAccessReader::SerializePropertyAccessBlock(K2Node, MObj);
