...
void FMegalithBlueprintVariableActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	Registry.RegisterAction(TEXT("blueprint"), TEXT("add_variable"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddVariable),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("remove_variable"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveVariable),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("rename_variable"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRenameVariable),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("set_variable_type"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetVariableType),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
			.Required(TEXT("name"),       TEXT("string"), TEXT("Variable name"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("set_variable_defaults"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetVariableDefaults),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),        TEXT("Blueprint asset path"))
			.Required(TEXT("name"),               TEXT("string"),  TEXT("Variable name"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("add_local_variable"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddLocalVariable),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),    TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("remove_local_variable"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveLocalVariable),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),    TEXT("Blueprint asset path"))
			.Required(TEXT("function_name"), TEXT("string"), TEXT("Function graph name"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("add_replicated_variable"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddReplicatedVariable),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),            TEXT("Blueprint asset path"))
...
FMegalithActionResult FMegalithBlueprintVariableActions::HandleAddVariable(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	...
	if (TypeStr.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: type"));
	}
...
FMegalithActionResult FMegalithBlueprintVariableActions::HandleRemoveVariable(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = MegalithBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (!bFound)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Variable not found: %s"), *Name));
	}
...
FMegalithActionResult FMegalithBlueprintVariableActions::HandleRenameVariable(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = MegalithBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (!bFound)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Variable not found: %s"), *OldName));
	}
...
FMegalithActionResult FMegalithBlueprintVariableActions::HandleSetVariableType(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = MegalithBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	FEdGraphPinType NewType = MegalithPinTypeGrammar::ParsePinTypeFromString(TypeStr);
...
FMegalithActionResult FMegalithBlueprintVariableActions::HandleSetVariableDefaults(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = MegalithBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
...
FMegalithActionResult FMegalithBlueprintVariableActions::HandleAddLocalVariable(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = MegalithBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	UEdGraph* FuncGraph = MegalithBlueprintInternal::FindGraphByName(BP, FunctionName);
	if (!FuncGraph)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Function graph not found: %s"), *FunctionName));
	}
...
FMegalithActionResult FMegalithBlueprintVariableActions::HandleRemoveLocalVariable(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = MegalithBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
...
FMegalithActionResult FMegalithBlueprintVariableActions::HandleAddReplicatedVariable(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = MegalithBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
