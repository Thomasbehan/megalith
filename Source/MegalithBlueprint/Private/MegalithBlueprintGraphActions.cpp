...
#include "MegalithPinTypeGrammar.h"
...
void FMegalithBlueprintGraphActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	Registry.RegisterAction(TEXT("blueprint"), TEXT("add_function"),
		TEXT("Add a new function graph to a Blueprint"),
		FMegalithActionHandler::CreateStatic(&HandleAddFunction),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("set_function_thread_safe"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetFunctionThreadSafe),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("override_parent_function"),
		...
		FMegalithActionHandler::CreateStatic(&HandleOverrideParentFunction),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("remove_function"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveFunction),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("rename_function"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRenameFunction),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("add_macro"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddMacro),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("remove_macro"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveMacro),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("rename_macro"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRenameMacro),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("add_event_dispatcher"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddEventDispatcher),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("set_function_params"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetFunctionParams),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("implement_interface"),
		...
		FMegalithActionHandler::CreateStatic(&HandleImplementInterface),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("remove_interface"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveInterface),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("reparent_blueprint"),
		...
		FMegalithActionHandler::CreateStatic(&HandleReparentBlueprint),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("remove_event_dispatcher"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveEventDispatcher),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),      TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("set_event_dispatcher_params"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetEventDispatcherParams),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),      TEXT("Blueprint asset path"))
			.Required(TEXT("dispatcher_name"), TEXT("string"), TEXT("Event dispatcher name (without _Signature suffix)"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("scaffold_interface_implementation"),
		...
		FMegalithActionHandler::CreateStatic(&HandleScaffoldInterfaceImplementation),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),       TEXT("Blueprint asset path"))
...
FMegalithActionResult FMegalithBlueprintGraphActions::HandleAddFunction(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	...
	if (FuncName.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: name"));
	}
	...
	for (const UEdGraph* Existing : BP->FunctionGraphs)
	{
		...
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Function already exists: %s"), *FuncName));
		}
	}
	...
	if (!NewGraph)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create function graph: %s"), *FuncName));
	}
...
FMegalithActionResult FMegalithBlueprintGraphActions::HandleOverrideParentFunction(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = MegalithBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: parent_function_name"));
	}
...
FMegalithActionResult FMegalithBlueprintGraphActions::HandleRemoveFunction(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = MegalithBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (!Graph)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Function not found: %s"), *FuncName));
	}
...
FMegalithActionResult FMegalithBlueprintGraphActions::HandleSetFunctionThreadSafe(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = MegalithBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
...
FMegalithActionResult FMegalithBlueprintGraphActions::HandleRenameFunction(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = MegalithBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (OldName.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: old_name"));
	}
	if (NewName.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: new_name"));
	}

	UEdGraph* Graph = MegalithBlueprintInternal::FindGraphByName(BP, OldName);
	if (!Graph)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Function not found: %s"), *OldName));
	}

	// Ensure we're only renaming function graphs, not event graphs or macros
	if (!BP->FunctionGraphs.Contains(Graph))
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Graph '%s' is not a function graph (cannot rename event graphs or macros this way)"), *OldName));
	}
	...
	for (const UEdGraph* Existing : BP->FunctionGraphs)
	{
		...
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("A function named '%s' already exists"), *NewName));
		}
	}
...
FMegalithActionResult FMegalithBlueprintGraphActions::HandleAddMacro(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = MegalithBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	for (const UEdGraph* Existing : BP->MacroGraphs)
	{
		...
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Macro already exists: %s"), *MacroName));
		}
	}
	...
	if (!NewGraph)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create macro graph: %s"), *MacroName));
	}
...
FMegalithActionResult FMegalithBlueprintGraphActions::HandleRemoveMacro(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = MegalithBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (MacroName.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: macro_name"));
	}
	...
	if (!Graph)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Macro not found: %s"), *MacroName));
	}
...
FMegalithActionResult FMegalithBlueprintGraphActions::HandleRenameMacro(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = MegalithBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (!Graph)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Macro not found: %s"), *OldName));
	}
	...
	for (const UEdGraph* Existing : BP->MacroGraphs)
	{
		if (Existing && Existing != Graph && Existing->GetName() == NewName)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("A macro named '%s' already exists"), *NewName));
		}
	}
...
FMegalithActionResult FMegalithBlueprintGraphActions::HandleAddEventDispatcher(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = MegalithBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	for (const UEdGraph* Existing : BP->DelegateSignatureGraphs)
	{
		...
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Event dispatcher already exists: %s"), *DispatcherName));
		}
	}
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to add delegate member variable: %s"), *DispatcherName));
	}
	...
	if (!NewGraph)
	{
		...
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create delegate signature graph: %s"), *DispatcherName));
	}
...
FMegalithActionResult FMegalithBlueprintGraphActions::HandleSetFunctionParams(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = MegalithBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (!EntryNode)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("No FunctionEntry node found in: %s"), *FuncName));
	}
		...
		TArray<TPair<FName, FEdGraphPinType>>& OutParsed, FString& OutError) -> bool
	{
		...
		for (const TSharedPtr<FJsonValue>& PinVal : *PinArray)
		{
			...
			FString TypeError;
			if (!MegalithPinTypeGrammar::TryParsePinType(TypeStr, PinType, TypeError))
			{
	...
	{
		return FMegalithActionResult::Error(TEXT("No valid inputs or outputs provided"));
	}
...
FMegalithActionResult FMegalithBlueprintGraphActions::HandleImplementInterface(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = MegalithBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (!InterfaceClass)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Interface class not found: %s"), *InterfaceClassName));
	}

	if (!InterfaceClass->HasAnyClassFlags(CLASS_Interface))
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Class '%s' is not an interface"), *InterfaceClassName));
	}
	...
	for (const FBPInterfaceDescription& Existing : BP->ImplementedInterfaces)
	{
		...
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Interface already implemented: %s"), *InterfaceClassName));
		}
	}
	...
	if (!bAdded)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to implement interface: %s"), *InterfaceClassName));
	}
...
FMegalithActionResult FMegalithBlueprintGraphActions::HandleRemoveInterface(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = MegalithBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (!InterfaceClass)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Interface not implemented by this Blueprint: %s"), *InterfaceClassName));
	}
...
FMegalithActionResult FMegalithBlueprintGraphActions::HandleScaffoldInterfaceImplementation(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = MegalithBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (!bAlreadyImplemented)
	{
		...
		if (!bAdded)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("ImplementNewInterface failed for: %s"), *InterfaceClassName));
		}
		FBlueprintEditorUtils::MarkBlueprintAsStructurallyModified(BP);
	}
...
FMegalithActionResult FMegalithBlueprintGraphActions::HandleReparentBlueprint(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = MegalithBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: new_parent_class"));
	}

	UClass* NewParent = FindFirstObject<UClass>(*ClassName, EFindFirstObjectOptions::NativeFirst);
	if (!NewParent)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Parent class not found: %s"), *ClassName));
	}

	if (NewParent->HasAnyClassFlags(CLASS_Interface))
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Cannot reparent to an interface class: %s"), *ClassName));
	}
...
FMegalithActionResult FMegalithBlueprintGraphActions::HandleRemoveEventDispatcher(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = MegalithBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
...
FMegalithActionResult FMegalithBlueprintGraphActions::HandleSetEventDispatcherParams(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = MegalithBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: params (array of {name, type})"));
	}
