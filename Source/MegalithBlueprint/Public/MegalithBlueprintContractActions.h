 ...
 */
class FMegalithBlueprintContractActions
{
public:
	static void RegisterActions(FMegalithToolRegistry& Registry);

private:
	static FMegalithActionResult HandleCompareClassVariableContract(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult HandlePromoteVariablesToParent(const TSharedPtr<FJsonObject>& Params);
};
