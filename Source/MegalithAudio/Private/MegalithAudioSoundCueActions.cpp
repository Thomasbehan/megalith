...
#include "MegalithJsonUtils.h" // LogMegalith
...
const TMap<FString, UClass*>& FMegalithAudioSoundCueActions::GetNodeTypeRegistry()
{
...
UClass* FMegalithAudioSoundCueActions::ResolveNodeType(const FString& TypeName)
{
...
USoundCue* FMegalithAudioSoundCueActions::LoadSoundCue(const FString& AssetPath, FString& OutError)
{
...
FString FMegalithAudioSoundCueActions::MakeNodeId(USoundCue* Cue, USoundNode* Node)
{
...
USoundNode* FMegalithAudioSoundCueActions::FindNodeById(USoundCue* Cue, const FString& NodeId)
{
...
TSharedPtr<FJsonObject> FMegalithAudioSoundCueActions::SerializeNode(USoundCue* Cue, USoundNode* Node)
{
...
bool FMegalithAudioSoundCueActions::SetNodeProperty(USoundNode* Node, const FString& PropName, const TSharedPtr<FJsonValue>& Value, FString& OutError)
{
...
void FMegalithAudioSoundCueActions::FinalizeCue(USoundCue* Cue)
{
	if (!Cue) return;
...
USoundCue* FMegalithAudioSoundCueActions::CreateEmptySoundCue(const FString& AssetPath, FString& OutError)
{
	int32 LastSlash;
...
TArray<USoundNode*> FMegalithAudioSoundCueActions::CreateWavePlayerNodes(USoundCue* Cue, const TArray<FString>& WavePaths, FString& OutError)
{
...
void FMegalithAudioSoundCueActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	// --- CRUD ---
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("create_sound_cue"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioSoundCueActions::CreateSoundCue),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("get_sound_cue_graph"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioSoundCueActions::GetSoundCueGraph),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("add_sound_cue_node"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioSoundCueActions::AddSoundCueNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Asset path of the USoundCue"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("remove_sound_cue_node"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioSoundCueActions::RemoveSoundCueNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Asset path of the USoundCue"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("connect_sound_cue_nodes"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioSoundCueActions::ConnectSoundCueNodes),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Asset path of the USoundCue"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("set_sound_cue_first_node"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioSoundCueActions::SetSoundCueFirstNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Asset path of the USoundCue"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("set_sound_cue_node_property"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioSoundCueActions::SetSoundCueNodeProperty),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Asset path of the USoundCue"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("list_sound_cue_node_types"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioSoundCueActions::ListSoundCueNodeTypes),
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("find_sound_waves_in_cue"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioSoundCueActions::FindSoundWavesInCue),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Asset path of the USoundCue"))
			.Build());
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("validate_sound_cue"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioSoundCueActions::ValidateSoundCue),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Asset path of the USoundCue"))
			.Build());
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("build_sound_cue_from_spec"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioSoundCueActions::BuildSoundCueFromSpec),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("create_random_sound_cue"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioSoundCueActions::CreateRandomSoundCue),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Asset path for the new Sound Cue"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("create_layered_sound_cue"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioSoundCueActions::CreateLayeredSoundCue),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Asset path for the new Sound Cue"))
			.Required(TEXT("sound_waves"), TEXT("array"), TEXT("Array of SoundWave asset paths"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("create_looping_ambient_cue"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioSoundCueActions::CreateLoopingAmbientCue),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Asset path for the new Sound Cue"))
			.Required(TEXT("sound_waves"), TEXT("array"), TEXT("Array of SoundWave asset paths"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("create_distance_crossfade_cue"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioSoundCueActions::CreateDistanceCrossfadeCue),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Asset path for the new Sound Cue"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("create_switch_sound_cue"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioSoundCueActions::CreateSwitchSoundCue),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Asset path for the new Sound Cue"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("duplicate_sound_cue"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioSoundCueActions::DuplicateSoundCue),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("delete_audio_asset"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioSoundCueActions::DeleteAudioAsset),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("preview_sound"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioSoundCueActions::PreviewSound),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("stop_preview"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioSoundCueActions::StopPreview),
		FParamSchemaBuilder().Build());

	Registry.RegisterAction(TEXT("audio"), TEXT("get_sound_cue_duration"),
		TEXT("Get the cached duration of a Sound Cue"),
		FMegalithActionHandler::CreateStatic(&FMegalithAudioSoundCueActions::GetSoundCueDuration),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Asset path of the USoundCue"))
			.Build());
}
...
FMegalithActionResult FMegalithAudioSoundCueActions::CreateSoundCue(const TSharedPtr<FJsonObject>& Params)
{
...
FMegalithActionResult FMegalithAudioSoundCueActions::GetSoundCueGraph(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
...
FMegalithActionResult FMegalithAudioSoundCueActions::AddSoundCueNode(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	const FString NodeType = Params->GetStringField(TEXT("node_type"));
	if (AssetPath.IsEmpty() || NodeType.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("asset_path and node_type are required"));
	}

	UClass* NodeClass = ResolveNodeType(NodeType);
	if (!NodeClass)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Unknown node type '%s'. Use list_sound_cue_node_types for valid types."), *NodeType));
	}
	...
	if (!NewNode)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to construct node of type '%s'"), *NodeType));
	}
	...
	if (Params->TryGetObjectField(TEXT("properties"), PropsObj) && PropsObj && PropsObj->IsValid())
	{
		for (const auto& Pair : (*PropsObj)->Values)
		{
			...
			{
				UE_LOG(LogMegalith, Warning, TEXT("add_sound_cue_node: property '%s' error: %s"), *PairKeyStr, *PropError);
			}
		}
	}
...
FMegalithActionResult FMegalithAudioSoundCueActions::RemoveSoundCueNode(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	const FString NodeId = Params->GetStringField(TEXT("node_id"));
	if (AssetPath.IsEmpty() || NodeId.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("asset_path and node_id are required"));
	}
	...
	if (!NodeToRemove)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Node '%s' not found in cue"), *NodeId));
	}
...
FMegalithActionResult FMegalithAudioSoundCueActions::ConnectSoundCueNodes(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FMegalithActionResult::Error(TEXT("asset_path, from_node_id, and to_node_id are required"));
	}
	...
	if (!FromNode)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("From node '%s' not found"), *FromNodeId));
	}
	if (!ToNode)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("To node '%s' not found"), *ToNodeId));
	}
...
FMegalithActionResult FMegalithAudioSoundCueActions::SetSoundCueFirstNode(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	const FString NodeId = Params->GetStringField(TEXT("node_id"));
	if (AssetPath.IsEmpty() || NodeId.IsEmpty())
	...
	if (!Node)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Node '%s' not found"), *NodeId));
	}
...
FMegalithActionResult FMegalithAudioSoundCueActions::SetSoundCueNodeProperty(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	const FString NodeId = Params->GetStringField(TEXT("node_id"));
	...
	{
		return FMegalithActionResult::Error(TEXT("asset_path, node_id, and property_name are required"));
	}
...
FMegalithActionResult FMegalithAudioSoundCueActions::ListSoundCueNodeTypes(const TSharedPtr<FJsonObject>& Params)
{
...
FMegalithActionResult FMegalithAudioSoundCueActions::FindSoundWavesInCue(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
...
FMegalithActionResult FMegalithAudioSoundCueActions::ValidateSoundCue(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
...
FMegalithActionResult FMegalithAudioSoundCueActions::BuildSoundCueFromSpec(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
	...
	{
		return FMegalithActionResult::Error(TEXT("spec object is required"));
	}
	...
	if (Spec->TryGetArrayField(TEXT("nodes"), NodesArray) && NodesArray)
	{
		for (const auto& NodeVal : *NodesArray)
		{
			...
			{
				return FMegalithActionResult::Error(TEXT("Each node in spec must have 'id' and 'type'"));
			}

			UClass* NodeClass = ResolveNodeType(TypeName);
			if (!NodeClass)
			{
				return FMegalithActionResult::Error(FString::Printf(TEXT("Unknown node type '%s' for node '%s'"), *TypeName, *Id));
			}

			USoundNode* NewNode = Cue->ConstructSoundNode<USoundNode>(NodeClass);
			if (!NewNode)
			{
				return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to construct node '%s' of type '%s'"), *Id, *TypeName));
			}
		...
		for (const auto& NodeVal : *NodesArray)
		{
			...
			if (NodeObj->TryGetObjectField(TEXT("properties"), PropsObj) && PropsObj && PropsObj->IsValid())
			{
				for (const auto& Pair : (*PropsObj)->Values)
				{
					...
					{
						UE_LOG(LogMegalith, Warning, TEXT("build_sound_cue_from_spec: node '%s' property '%s' error: %s"),
	...
	if (Spec->TryGetArrayField(TEXT("connections"), ConnsArray) && ConnsArray)
	{
		for (const auto& ConnVal : *ConnsArray)
		{
			...
			if (!FromPtr || !*FromPtr)
			{
				return FMegalithActionResult::Error(FString::Printf(TEXT("Connection 'from' node '%s' not found"), *FromId));
			}
			if (!ToPtr || !*ToPtr)
			{
				return FMegalithActionResult::Error(FString::Printf(TEXT("Connection 'to' node '%s' not found"), *ToId));
			}
	...
	if (!FirstNodeId.IsEmpty())
	{
		...
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("first_node '%s' not found in node map"), *FirstNodeId));
		}
...
FMegalithActionResult FMegalithAudioSoundCueActions::CreateRandomSoundCue(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
	...
	if (!Params->TryGetArrayField(TEXT("sound_waves"), WavesArray) || !WavesArray || WavesArray->Num() == 0)
	{
		return FMegalithActionResult::Error(TEXT("sound_waves array is required and must not be empty"));
	}
	...
	FString Error;
	USoundCue* Cue = CreateEmptySoundCue(AssetPath, Error);
	if (!Cue) return FMegalithActionResult::Error(Error);

	TArray<USoundNode*> WaveNodes = CreateWavePlayerNodes(Cue, WavePaths, Error);
	if (WaveNodes.Num() == 0)
	{
		return FMegalithActionResult::Error(Error.IsEmpty() ? TEXT("Failed to create WavePlayer nodes") : Error);
	}
	...
	if (!RandomNode)
	{
		return FMegalithActionResult::Error(TEXT("Failed to construct Random node"));
	}
...
FMegalithActionResult FMegalithAudioSoundCueActions::CreateLayeredSoundCue(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
	...
	if (!MixerNode)
	{
		return FMegalithActionResult::Error(TEXT("Failed to construct Mixer node"));
	}
...
FMegalithActionResult FMegalithAudioSoundCueActions::CreateLoopingAmbientCue(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
	...
	if (!DelayNode)
	{
		return FMegalithActionResult::Error(TEXT("Failed to construct Delay node"));
	}
	...
	if (!LoopingNode)
	{
		return FMegalithActionResult::Error(TEXT("Failed to construct Looping node"));
	}
...
FMegalithActionResult FMegalithAudioSoundCueActions::CreateDistanceCrossfadeCue(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
	...
	{
		return FMegalithActionResult::Error(TEXT("bands array is required and must not be empty"));
	}
	...
	if (!CrossFadeNode)
	{
		return FMegalithActionResult::Error(TEXT("Failed to construct DistanceCrossFade node"));
	}
	...
	for (const auto& BandVal : *BandsArray)
	{
		...
		if (WavePath.IsEmpty())
		{
			return FMegalithActionResult::Error(TEXT("Each band must have a 'sound_wave' path"));
		}

		USoundWave* Wave = Cast<USoundWave>(StaticLoadObject(USoundWave::StaticClass(), nullptr, *WavePath));
		if (!Wave)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Could not load SoundWave at '%s'"), *WavePath));
		}

		USoundNodeWavePlayer* WavePlayer = Cue->ConstructSoundNode<USoundNodeWavePlayer>();
		if (!WavePlayer)
		{
			return FMegalithActionResult::Error(TEXT("Failed to construct WavePlayer"));
		}
		WavePlayer->SetSoundWave(Wave);
...
FMegalithActionResult FMegalithAudioSoundCueActions::CreateSwitchSoundCue(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	const FString ParameterName = Params->GetStringField(TEXT("parameter_name"));
	if (AssetPath.IsEmpty() || ParameterName.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("asset_path and parameter_name are required"));
	}
	...
	if (!SwitchNode)
	{
		return FMegalithActionResult::Error(TEXT("Failed to construct Switch node"));
	}
...
FMegalithActionResult FMegalithAudioSoundCueActions::DuplicateSoundCue(const TSharedPtr<FJsonObject>& Params)
{
	...
	{
		return FMegalithActionResult::Error(TEXT("source_path and dest_path are required"));
	}

	IAssetTools& AssetTools = FAssetToolsModule::GetModule().Get();
	UObject* Source = StaticLoadObject(UObject::StaticClass(), nullptr, *SourcePath);
	if (!Source) { return FMegalithActionResult::Error(FString::Printf(TEXT("Source asset not found: '%s'"), *SourcePath)); }
...
FMegalithActionResult FMegalithAudioSoundCueActions::DeleteAudioAsset(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
	...
	if (!Asset)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Asset not found at '%s'"), *AssetPath));
	}

	bool bDeleted = ObjectTools::DeleteSingleObject(Asset, /*bPerformReferenceCheck=*/false);
	if (!bDeleted)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to delete asset at '%s'"), *AssetPath));
	}
...
FMegalithActionResult FMegalithAudioSoundCueActions::PreviewSound(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
	...
	if (!Sound)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Could not load USoundBase at '%s'"), *AssetPath));
	}

	if (!GEditor)
	{
		return FMegalithActionResult::Error(TEXT("GEditor is not available"));
	}
...
FMegalithActionResult FMegalithAudioSoundCueActions::StopPreview(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor)
	{
		return FMegalithActionResult::Error(TEXT("GEditor is not available"));
...
FMegalithActionResult FMegalithAudioSoundCueActions::GetSoundCueDuration(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
