...
void FMegalithAudioMetaSoundActions::RegisterNodeIdAlias(const FString& AssetPath, const FString& UserLabel, const FGuid& NodeGuid)
{
...
FGuid FMegalithAudioMetaSoundActions::LookupNodeIdAlias(const FString& AssetPath, const FString& UserLabel)
{
...
bool FMegalithAudioMetaSoundActions::SplitAssetPath(const FString& AssetPath, FString& OutPackagePath, FString& OutAssetName)
{
	int32 LastSlash;
...
bool FMegalithAudioMetaSoundActions::CreateLiteralFromJson(
...
bool FMegalithAudioMetaSoundActions::ParseNodeClassName(
...
UMetaSoundBuilderBase* FMegalithAudioMetaSoundActions::GetBuilderForAsset(const FString& AssetPath, FString& OutError)
{
...
bool FMegalithAudioMetaSoundActions::ResolveNodeHandle(
...
void FMegalithAudioMetaSoundActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	// ---- Core CRUD (12) ----
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("create_metasound_source"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundActions::CreateMetaSoundSource),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("create_metasound_patch"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundActions::CreateMetaSoundPatch),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("add_metasound_node"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundActions::AddMetaSoundNode),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("remove_metasound_node"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundActions::RemoveMetaSoundNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MetaSound asset path"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("connect_metasound_nodes"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundActions::ConnectMetaSoundNodes),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MetaSound asset path"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("disconnect_metasound_nodes"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundActions::DisconnectMetaSoundNodes),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MetaSound asset path"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("add_metasound_input"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundActions::AddMetaSoundInput),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MetaSound asset path"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("add_metasound_output"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundActions::AddMetaSoundOutput),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MetaSound asset path"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("set_metasound_input_default"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundActions::SetMetaSoundInputDefault),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MetaSound asset path"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("add_metasound_interface"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundActions::AddMetaSoundInterface),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MetaSound asset path"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("get_metasound_graph"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundActions::GetMetaSoundGraph),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MetaSound asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("list_metasound_connections"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundActions::ListMetaSoundConnections),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MetaSound asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("list_available_metasound_nodes"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundActions::ListAvailableMetaSoundNodes),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("get_metasound_node_info"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundActions::GetMetaSoundNodeInfo),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("find_metasound_node_inputs"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundActions::FindMetaSoundNodeInputs),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MetaSound asset path"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("find_metasound_node_outputs"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundActions::FindMetaSoundNodeOutputs),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MetaSound asset path"))
			.Required(TEXT("node_id_or_handle"), TEXT("string"), TEXT("Node GUID or graph I/O name"))
			.Build());
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("get_metasound_input_names"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundActions::GetMetaSoundInputNames),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MetaSound asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("build_metasound_from_spec"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundActions::BuildMetaSoundFromSpec),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("create_metasound_preset"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundActions::CreateMetaSoundPreset),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("create_oneshot_sfx"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundActions::CreateOneShotSfx),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Asset path for the new MetaSound"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("create_looping_ambient_metasound"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundActions::CreateLoopingAmbientMetaSound),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Asset path for the new MetaSound"))
			.Required(TEXT("sound_wave"), TEXT("string"), TEXT("Path to the SoundWave asset"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("create_synthesized_tone"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundActions::CreateSynthesizedTone),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Asset path for the new MetaSound"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("create_interactive_metasound"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundActions::CreateInteractiveMetaSound),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Asset path for the new MetaSound"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("add_metasound_variable"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundActions::AddMetaSoundVariable),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MetaSound asset path"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("set_metasound_node_location"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundActions::SetMetaSoundNodeLocation),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MetaSound asset path"))
			.Required(TEXT("node_id_or_handle"), TEXT("string"), TEXT("Node GUID or graph I/O name"))
...
FMegalithActionResult FMegalithAudioMetaSoundActions::CreateMetaSoundSource(const TSharedPtr<FJsonObject>& Params)
{
	...
	{
		return FMegalithActionResult::Error(TEXT("Invalid asset_path — must contain at least one '/'"));
	}
	...
	FName BuilderName = FName(*FString::Printf(TEXT("Megalith_%s"), *AssetName));
	...
	if (!Builder || BuildResult != EMetaSoundBuilderResult::Succeeded)
	{
		return FMegalithActionResult::Error(TEXT("Failed to create MetaSound source builder"));
	}
	...
	if (!EditorSub)
	{
		return FMegalithActionResult::Error(TEXT("UMetaSoundEditorSubsystem not available"));
	}

	EMetaSoundBuilderResult SaveResult;
	TScriptInterface<IMetaSoundDocumentInterface> NewAsset = EditorSub->BuildToAsset(
		Builder, TEXT("Megalith"), AssetName, PackagePath, SaveResult, nullptr);

	if (SaveResult != EMetaSoundBuilderResult::Succeeded || !NewAsset.GetObject())
	{
		return FMegalithActionResult::Error(TEXT("BuildToAsset failed for MetaSound source"));
	}
...
FMegalithActionResult FMegalithAudioMetaSoundActions::CreateMetaSoundPatch(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
	...
	if (!SplitAssetPath(AssetPath, PackagePath, AssetName))
	{
		return FMegalithActionResult::Error(TEXT("Invalid asset_path"));
	}
	...
	if (!Builder || BuildResult != EMetaSoundBuilderResult::Succeeded)
	{
		return FMegalithActionResult::Error(TEXT("Failed to create MetaSound patch builder"));
	}
	...
	if (SaveResult != EMetaSoundBuilderResult::Succeeded || !NewAsset.GetObject())
	{
		return FMegalithActionResult::Error(TEXT("BuildToAsset failed for MetaSound patch"));
	}
...
FMegalithActionResult FMegalithAudioMetaSoundActions::AddMetaSoundNode(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
	...
	{
		return FMegalithActionResult::Error(TEXT("node_class is required (array of [Namespace, Name, Variant])"));
	}
...
FMegalithActionResult FMegalithAudioMetaSoundActions::RemoveMetaSoundNode(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	const FString NodeIdStr = Params->GetStringField(TEXT("node_id_or_handle"));
	if (AssetPath.IsEmpty() || NodeIdStr.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("asset_path and node_id_or_handle are required"));
	}
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to remove node '%s'"), *NodeIdStr));
	}
...
FMegalithActionResult FMegalithAudioMetaSoundActions::ConnectMetaSoundNodes(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FMegalithActionResult::Error(TEXT("asset_path, from_node, from_output, to_node, and to_input are all required"));
	}
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("from_node: %s"), *Error));
	}
	if (!ResolveNodeHandle(Builder, ToNode, DestHandle, Error, AssetPath))
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("to_node: %s"), *Error));
	}
...
FMegalithActionResult FMegalithAudioMetaSoundActions::DisconnectMetaSoundNodes(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	const FString FromNode = Params->GetStringField(TEXT("from_node"));
	const FString FromOutput = Params->GetStringField(TEXT("from_output"));
	...
	if (Result != EMetaSoundBuilderResult::Succeeded)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Output pin '%s' not found on node '%s'"), *FromOutput, *FromNode));
	}

	FMetaSoundBuilderNodeInputHandle InputHandle = Builder->FindNodeInputByName(DestHandle, FName(*ToInput), Result);
	if (Result != EMetaSoundBuilderResult::Succeeded)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Input pin '%s' not found on node '%s'"), *ToInput, *ToNode));
	}
...
FMegalithActionResult FMegalithAudioMetaSoundActions::AddMetaSoundInput(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FMegalithActionResult::Error(TEXT("asset_path, name, and data_type are required"));
	}
	...
	if (Result != EMetaSoundBuilderResult::Succeeded)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to add graph input '%s' of type '%s'"), *Name, *DataType));
	}
...
FMegalithActionResult FMegalithAudioMetaSoundActions::AddMetaSoundOutput(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	const FString Name = Params->GetStringField(TEXT("name"));
	const FString DataType = Params->GetStringField(TEXT("data_type"));
	...
	if (Result != EMetaSoundBuilderResult::Succeeded)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to add graph output '%s' of type '%s'"), *Name, *DataType));
	}
...
FMegalithActionResult FMegalithAudioMetaSoundActions::SetMetaSoundInputDefault(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FMegalithActionResult::Error(TEXT("asset_path and input_name are required"));
	}
	...
	if (Result != EMetaSoundBuilderResult::Succeeded || !InputNode.IsSet())
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Graph input '%s' not found"), *InputName));
	}
	...
	{
		return FMegalithActionResult::Error(TEXT("value is required"));
	}
	...
	if (InputHandles.Num() > 0)
	{
		...
		if (Result != EMetaSoundBuilderResult::Succeeded)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to set default for input '%s'"), *InputName));
		}
	}
...
FMegalithActionResult FMegalithAudioMetaSoundActions::AddMetaSoundInterface(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FMegalithActionResult::Error(TEXT("asset_path and interface_name are required"));
	}
	...
	if (Result != EMetaSoundBuilderResult::Succeeded)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to add interface '%s'"), *InterfaceName));
	}
...
FMegalithActionResult FMegalithAudioMetaSoundActions::GetMetaSoundGraph(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
	...
	if (!Loaded)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("MetaSound asset not found at '%s'"), *AssetPath));
	}

	IMetaSoundDocumentInterface* DocInterface = Cast<IMetaSoundDocumentInterface>(Loaded);
	if (!DocInterface)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Asset at '%s' does not implement IMetaSoundDocumentInterface"), *AssetPath));
	}
...
FMegalithActionResult FMegalithAudioMetaSoundActions::ListMetaSoundConnections(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
...
FMegalithActionResult FMegalithAudioMetaSoundActions::ListAvailableMetaSoundNodes(const TSharedPtr<FJsonObject>& Params)
{
...
FMegalithActionResult FMegalithAudioMetaSoundActions::GetMetaSoundNodeInfo(const TSharedPtr<FJsonObject>& Params)
{
	const TArray<TSharedPtr<FJsonValue>>* ClassArray = nullptr;
	if (!Params->TryGetArrayField(TEXT("node_class"), ClassArray) || !ClassArray)
	{
...
FMegalithActionResult FMegalithAudioMetaSoundActions::FindMetaSoundNodeInputs(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	const FString NodeIdStr = Params->GetStringField(TEXT("node_id_or_handle"));
	...
	if (Result != EMetaSoundBuilderResult::Succeeded)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to find inputs for node '%s'"), *NodeIdStr));
	}
...
FMegalithActionResult FMegalithAudioMetaSoundActions::FindMetaSoundNodeOutputs(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	const FString NodeIdStr = Params->GetStringField(TEXT("node_id_or_handle"));
	...
	if (Result != EMetaSoundBuilderResult::Succeeded)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to find outputs for node '%s'"), *NodeIdStr));
	}
...
FMegalithActionResult FMegalithAudioMetaSoundActions::GetMetaSoundInputNames(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
...
FMegalithActionResult FMegalithAudioMetaSoundActions::BuildMetaSoundFromSpec(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
	...
	{
		return FMegalithActionResult::Error(TEXT("spec is required (JSON object)"));
	}
	...
	if (!Builder || BuildResult != EMetaSoundBuilderResult::Succeeded)
	{
		return FMegalithActionResult::Error(TEXT("Failed to create MetaSound builder"));
	}
	...
	if (Spec->TryGetArrayField(TEXT("nodes"), NodesArray) && NodesArray)
	{
		for (const auto& NodeVal : *NodesArray)
		{
			...
			{
				UE_LOG(LogMegalith, Warning, TEXT("build_metasound_from_spec: Skipping node '%s': %s"), *NodeId, *ParseError);
			...
			{
				UE_LOG(LogMegalith, Warning, TEXT("build_metasound_from_spec: Failed to add node '%s' [%s, %s, %s]"),
	...
	if (Spec->TryGetArrayField(TEXT("connections"), ConnectionsArray) && ConnectionsArray)
	{
		for (const auto& ConnVal : *ConnectionsArray)
		{
			...
			{
				UE_LOG(LogMegalith, Warning, TEXT("build_metasound_from_spec: Connection from '%s' to '%s' — node not found"), *FromId, *ToId);
			...
			{
				UE_LOG(LogMegalith, Warning, TEXT("build_metasound_from_spec: Failed to connect %s.%s -> %s.%s"),
	...
	if (Spec->TryGetArrayField(TEXT("graph_input_connections"), GraphInputConns) && GraphInputConns)
	{
		for (const auto& ConnVal : *GraphInputConns)
		{
			...
			if (!ToHandle)
			{
				UE_LOG(LogMegalith, Warning, TEXT("build_metasound_from_spec: graph_input_connection to '%s' — node not found"), *ToNodeId);
	...
	if (Spec->TryGetObjectField(TEXT("interface_connections"), InterfaceConns) && InterfaceConns && InterfaceConns->IsValid())
	{
		...
		{
			const FString InterfacePinName = MegalithKeyToString(Pair.Key);
			const TSharedPtr<FJsonObject>& ConnObj = Pair.Value->AsObject();
			if (!ConnObj.IsValid())
			{
			...
			if (ConnObj->HasField(TEXT("to_node")))
			{
				...
				if (!ToHandle)
				{
					UE_LOG(LogMegalith, Warning, TEXT("build_metasound_from_spec: interface_connection '%s' -> '%s' — node not found"), *InterfacePinName, *ToNodeId);
			...
			if (ConnObj->HasField(TEXT("from_node")))
			{
				...
				if (!FromHandle)
				{
					UE_LOG(LogMegalith, Warning, TEXT("build_metasound_from_spec: interface_connection from '%s' — node not found"), *FromNodeId);
					SkippedInterfaces.Add(MakeSkipObj(
	...
	if (SaveResult != EMetaSoundBuilderResult::Succeeded || !NewAsset.GetObject())
	{
		return FMegalithActionResult::Error(TEXT("BuildToAsset failed"));
	}
...
FMegalithActionResult FMegalithAudioMetaSoundActions::CreateMetaSoundPreset(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FMegalithActionResult::Error(TEXT("asset_path and reference_metasound are required"));
	}
	...
	if (!RefObj)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Reference MetaSound not found at '%s'"), *ReferencePath));
	}
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Asset at '%s' does not implement IMetaSoundDocumentInterface"), *ReferencePath));
	}

	UMetaSoundBuilderSubsystem& Sub = UMetaSoundBuilderSubsystem::GetChecked();
	EMetaSoundBuilderResult BuildResult;
	FName BuilderName = FName(*FString::Printf(TEXT("Megalith_Preset_%s"), *AssetName));
	...
	{
		return FMegalithActionResult::Error(TEXT("Failed to create preset builder"));
	}
	...
	if (SaveResult != EMetaSoundBuilderResult::Succeeded || !NewAsset.GetObject())
	{
		return FMegalithActionResult::Error(TEXT("BuildToAsset failed for preset"));
	}
...
FMegalithActionResult FMegalithAudioMetaSoundActions::CreateOneShotSfx(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FMegalithActionResult::Error(TEXT("asset_path and sound_wave are required"));
	}

	USoundWave* Wave = Cast<USoundWave>(StaticLoadObject(USoundWave::StaticClass(), nullptr, *WavePath));
	if (!Wave)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("SoundWave not found at '%s'"), *WavePath));
	}
	...
	if (!Builder || BuildResult != EMetaSoundBuilderResult::Succeeded)
	{
		return FMegalithActionResult::Error(TEXT("Failed to create source builder"));
	}
	...
	{
		return FMegalithActionResult::Error(TEXT("Failed to add Wave Player node"));
	}
...
FMegalithActionResult FMegalithAudioMetaSoundActions::CreateLoopingAmbientMetaSound(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	const FString WavePath = Params->GetStringField(TEXT("sound_wave"));
...
FMegalithActionResult FMegalithAudioMetaSoundActions::CreateSynthesizedTone(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
...
FMegalithActionResult FMegalithAudioMetaSoundActions::CreateInteractiveMetaSound(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
	...
	{
		return FMegalithActionResult::Error(TEXT("sound_waves is required and must contain at least 2 entries"));
	}
...
FMegalithActionResult FMegalithAudioMetaSoundActions::AddMetaSoundVariable(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (Result != EMetaSoundBuilderResult::Succeeded)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to add variable '%s' of type '%s'"), *VarName, *DataType));
	}
...
FMegalithActionResult FMegalithAudioMetaSoundActions::SetMetaSoundNodeLocation(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	const FString NodeIdStr = Params->GetStringField(TEXT("node_id_or_handle"));
	...
	{
		return FMegalithActionResult::Error(TEXT("x and y are required"));
	}
	...
	if (Result != EMetaSoundBuilderResult::Succeeded)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to set location for node '%s'"), *NodeIdStr));
	}
