...
bool FMegalithAudioAssetActions::SplitAssetPath(const FString& AssetPath, FString& OutPackagePath, FString& OutAssetName)
{
	int32 LastSlash;
...
template<typename T>
T* FMegalithAudioAssetActions::LoadAudioAsset(const FString& AssetPath, FString& OutError)
{
...
TAsset* FMegalithAudioAssetActions::CreateAudioAsset(const FString& AssetPath, FString& OutError)
{
...
TSharedPtr<FJsonObject> FMegalithAudioAssetActions::StructToJson(const UStruct* StructDef, const void* StructData)
{
...
bool FMegalithAudioAssetActions::JsonToStruct(const TSharedPtr<FJsonObject>& Json, const UStruct* StructDef, void* StructData, FString& OutError)
{
	if (!Json.IsValid())
	{
	...
	{
		const FString FieldName = MegalithKeyToString(Pair.Key);
...
void FMegalithAudioAssetActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	// --- Sound Attenuation ---
	Registry.RegisterAction(TEXT("audio"), TEXT("create_sound_attenuation"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioAssetActions::CreateSoundAttenuation),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("get_attenuation_settings"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioAssetActions::GetAttenuationSettings),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("set_attenuation_settings"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioAssetActions::SetAttenuationSettings),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Asset path of the USoundAttenuation"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("create_sound_class"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioAssetActions::CreateSoundClass),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("get_sound_class_properties"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioAssetActions::GetSoundClassProperties),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("set_sound_class_properties"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioAssetActions::SetSoundClassProperties),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Asset path of the USoundClass"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("create_sound_mix"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioAssetActions::CreateSoundMix),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("get_sound_mix_settings"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioAssetActions::GetSoundMixSettings),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("set_sound_mix_settings"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioAssetActions::SetSoundMixSettings),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Asset path of the USoundMix"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("create_sound_concurrency"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioAssetActions::CreateSoundConcurrency),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("get_concurrency_settings"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioAssetActions::GetConcurrencySettings),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("set_concurrency_settings"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioAssetActions::SetConcurrencySettings),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Asset path of the USoundConcurrency"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("create_sound_submix"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioAssetActions::CreateSoundSubmix),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("get_submix_properties"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioAssetActions::GetSubmixProperties),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("set_submix_properties"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioAssetActions::SetSubmixProperties),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Asset path of the USoundSubmix"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("create_test_wave"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioAssetActions::CreateTestWave),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("path"), TEXT("Destination asset path under /Game/ (e.g. /Game/Tests/Megalith/Audio/SW_Test_Sine_440)"))
...
FMegalithActionResult FMegalithAudioAssetActions::CreateSoundAttenuation(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (Params->TryGetObjectField(TEXT("settings"), SettingsJson) && SettingsJson && SettingsJson->IsValid())
	{
		...
		{
			UE_LOG(LogMegalith, Warning, TEXT("create_sound_attenuation: partial settings error: %s"), *SetError);
		}
...
FMegalithActionResult FMegalithAudioAssetActions::GetAttenuationSettings(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
...
FMegalithActionResult FMegalithAudioAssetActions::SetAttenuationSettings(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
	...
	if (!Params->TryGetObjectField(TEXT("settings"), SettingsJson) || !SettingsJson || !SettingsJson->IsValid())
	{
		return FMegalithActionResult::Error(TEXT("settings object is required"));
	}
...
FMegalithActionResult FMegalithAudioAssetActions::CreateSoundClass(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
	...
	if (Params->TryGetStringField(TEXT("parent_class"), ParentClassPath) && !ParentClassPath.IsEmpty())
	{
		...
		{
			UE_LOG(LogMegalith, Warning, TEXT("create_sound_class: could not load parent_class '%s': %s"), *ParentClassPath, *LoadError);
		}
	}
	...
	if (Params->TryGetObjectField(TEXT("properties"), PropsJson) && PropsJson && PropsJson->IsValid())
	{
		...
		{
			UE_LOG(LogMegalith, Warning, TEXT("create_sound_class: partial properties error: %s"), *SetError);
		}
		Asset->GetPackage()->MarkPackageDirty();
	}
...
FMegalithActionResult FMegalithAudioAssetActions::GetSoundClassProperties(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
...
FMegalithActionResult FMegalithAudioAssetActions::SetSoundClassProperties(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
	...
	if (Params->TryGetStringField(TEXT("parent_class"), ParentClassPath))
	{
		...
		else
		{
			...
			{
				return FMegalithActionResult::Error(FString::Printf(TEXT("Could not load parent_class '%s': %s"), *ParentClassPath, *LoadError));
			}
		}
	}
...
FMegalithActionResult FMegalithAudioAssetActions::CreateSoundMix(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
	...
	if (Params->TryGetObjectField(TEXT("eq_settings"), EqJson) && EqJson && EqJson->IsValid())
	{
		...
		{
			UE_LOG(LogMegalith, Warning, TEXT("create_sound_mix: EQ settings error: %s"), *SetError);
		}
	}
	...
	if (Params->TryGetArrayField(TEXT("class_effects"), ClassEffectsArr) && ClassEffectsArr)
	{
		...
		for (const auto& Val : *ClassEffectsArr)
		{
			...
			if (Val->TryGetObject(AdjusterObj) && AdjusterObj)
			{
				...
				{
					UE_LOG(LogMegalith, Warning, TEXT("create_sound_mix: class effect error: %s"), *AdjError);
				}
			}
		}
	}
...
FMegalithActionResult FMegalithAudioAssetActions::GetSoundMixSettings(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
...
FMegalithActionResult FMegalithAudioAssetActions::SetSoundMixSettings(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
	...
	if (Params->TryGetArrayField(TEXT("class_effects"), ClassEffectsArr) && ClassEffectsArr)
	{
		...
		for (const auto& Val : *ClassEffectsArr)
		{
			...
			if (Val->TryGetObject(AdjusterObj) && AdjusterObj)
			{
				...
				{
					return FMegalithActionResult::Error(FString::Printf(TEXT("class_effects error: %s"), *AdjError));
				}
			}
		}
	}
...
FMegalithActionResult FMegalithAudioAssetActions::CreateSoundConcurrency(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
	...
	if (Params->TryGetObjectField(TEXT("settings"), SettingsJson) && SettingsJson && SettingsJson->IsValid())
	{
		...
		{
			UE_LOG(LogMegalith, Warning, TEXT("create_sound_concurrency: settings error: %s"), *SetError);
		}
		Asset->GetPackage()->MarkPackageDirty();
	}
...
FMegalithActionResult FMegalithAudioAssetActions::GetConcurrencySettings(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
...
FMegalithActionResult FMegalithAudioAssetActions::SetConcurrencySettings(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
...
FMegalithActionResult FMegalithAudioAssetActions::CreateSoundSubmix(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
	...
	if (Params->TryGetStringField(TEXT("parent_submix"), ParentPath) && !ParentPath.IsEmpty())
	{
		...
		{
			UE_LOG(LogMegalith, Warning, TEXT("create_sound_submix: could not load parent_submix '%s': %s"), *ParentPath, *LoadError);
		}
	}
...
FMegalithActionResult FMegalithAudioAssetActions::GetSubmixProperties(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
...
FMegalithActionResult FMegalithAudioAssetActions::SetSubmixProperties(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
	...
	if (!Params->TryGetObjectField(TEXT("properties"), PropsJson) || !PropsJson || !PropsJson->IsValid())
	{
		return FMegalithActionResult::Error(TEXT("properties object is required"));
	}
	...
	if ((*PropsJson)->TryGetStringField(TEXT("parent_submix"), ParentPath))
	{
		...
		else
		{
			...
			{
				return FMegalithActionResult::Error(FString::Printf(TEXT("Could not load parent_submix '%s': %s"), *ParentPath, *LoadError));
			}
		}
	}
...
FMegalithActionResult FMegalithAudioAssetActions::CreateTestWave(const TSharedPtr<FJsonObject>& Params)
{
	// ---- 1. Validate path ---------------------------------------------------
	const FString AssetPath = Params->GetStringField(TEXT("path"));
	if (AssetPath.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("path is required"));
	}
	...
	if (!SplitAssetPath(AssetPath, PackagePath, AssetName))
	{
		return FMegalithActionResult::Error(TEXT("Invalid asset path — must contain at least one '/' (e.g. /Game/Tests/Megalith/Audio/SW_Test_Sine_440)"));
	}
	...
	{
		return FMegalithActionResult::Error(TEXT("Computed sample count is non-positive — sample_rate × duration_seconds collapsed to zero"));
	}
	...
	if (!Wave)
	{
		return FMegalithActionResult::Error(TEXT("NewObject<USoundWave> returned null"));
	}
