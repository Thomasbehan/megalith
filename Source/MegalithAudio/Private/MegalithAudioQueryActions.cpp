...
UClass* FMegalithAudioQueryActions::ResolveAudioClass(const FString& TypeName)
{
...
FString FMegalithAudioQueryActions::CompressionTypeToString(uint8 Type)
{
	switch (Type)
	{
...
void FMegalithAudioQueryActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	Registry.RegisterAction(TEXT("audio"), TEXT("list_audio_assets"),
		TEXT("List audio assets by type with optional path filter"),
		FMegalithActionHandler::CreateStatic(&FMegalithAudioQueryActions::ListAudioAssets),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("search_audio_assets"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioQueryActions::SearchAudioAssets),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("get_sound_wave_info"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioQueryActions::GetSoundWaveInfo),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("get_sound_class_hierarchy"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioQueryActions::GetSoundClassHierarchy),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("get_submix_hierarchy"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioQueryActions::GetSubmixHierarchy),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("find_audio_references"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioQueryActions::FindAudioReferences),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("find_unused_audio"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioQueryActions::FindUnusedAudio),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("find_sounds_without_class"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioQueryActions::FindSoundsWithoutClass),
		FParamSchemaBuilder()
			.OptionalAssetPath(TEXT("path_filter"), TEXT("Only scan assets under this content path"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("find_unattenuated_sounds"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioQueryActions::FindUnattenuatedSounds),
		FParamSchemaBuilder()
			.OptionalAssetPath(TEXT("path_filter"), TEXT("Only scan assets under this content path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("get_audio_stats"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioQueryActions::GetAudioStats),
...
FMegalithActionResult FMegalithAudioQueryActions::ListAudioAssets(const TSharedPtr<FJsonObject>& Params)
{
...
FMegalithActionResult FMegalithAudioQueryActions::SearchAudioAssets(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (Query.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("'query' parameter cannot be empty"));
	}
...
FMegalithActionResult FMegalithAudioQueryActions::GetSoundWaveInfo(const TSharedPtr<FJsonObject>& Params)
{
...
TSharedPtr<FJsonObject> FMegalithAudioQueryActions::BuildSoundClassTree(USoundClass* SoundClass, TSet<USoundClass*>& Visited)
{
...
FMegalithActionResult FMegalithAudioQueryActions::GetSoundClassHierarchy(const TSharedPtr<FJsonObject>& Params)
{
...
TSharedPtr<FJsonObject> FMegalithAudioQueryActions::BuildSubmixTree(USoundSubmixBase* SubmixBase, TSet<USoundSubmixBase*>& Visited)
{
...
FMegalithActionResult FMegalithAudioQueryActions::GetSubmixHierarchy(const TSharedPtr<FJsonObject>& Params)
{
...
FMegalithActionResult FMegalithAudioQueryActions::FindAudioReferences(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithAudioQueryActions::FindUnusedAudio(const TSharedPtr<FJsonObject>& Params)
{
	const FString TypeStr = Params->HasField(TEXT("type")) ? Params->GetStringField(TEXT("type")) : TEXT("All");
	const FString PathFilter = Params->HasField(TEXT("path_filter")) ? Params->GetStringField(TEXT("path_filter")) : TEXT("");
	const int32 Limit = Params->HasField(TEXT("limit")) ? static_cast<int32>(Params->GetNumberField(TEXT("limit"))) : 100;
	...
	else
	{
		...
		if (!ResolvedClass)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Unknown audio type '%s'"), *TypeStr));
		}
...
FMegalithActionResult FMegalithAudioQueryActions::FindSoundsWithoutClass(const TSharedPtr<FJsonObject>& Params)
{
	const FString PathFilter = Params->HasField(TEXT("path_filter")) ? Params->GetStringField(TEXT("path_filter")) : TEXT("");
	const int32 Limit = Params->HasField(TEXT("limit")) ? static_cast<int32>(Params->GetNumberField(TEXT("limit"))) : 100;
...
FMegalithActionResult FMegalithAudioQueryActions::FindUnattenuatedSounds(const TSharedPtr<FJsonObject>& Params)
{
	const FString PathFilter = Params->HasField(TEXT("path_filter")) ? Params->GetStringField(TEXT("path_filter")) : TEXT("");
...
FMegalithActionResult FMegalithAudioQueryActions::GetAudioStats(const TSharedPtr<FJsonObject>& Params)
{
	IAssetRegistry& AR = FModuleManager::LoadModuleChecked<FAssetRegistryModule>("AssetRegistry").Get();
