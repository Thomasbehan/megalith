...
// FMegalithAudioSoundCueActions (different translation unit, different class,
...
void FMegalithAudioMetaSoundIntrospectionActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	Registry.RegisterAction(TEXT("audio"), TEXT("list_metasounds"),
		TEXT("List all MetaSound assets in the project (Sources + Patches)"),
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundIntrospectionActions::HandleListMetaSounds),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("list_metasound_documents"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundIntrospectionActions::HandleListMetaSoundDocuments),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("get_metasound_document"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundIntrospectionActions::HandleGetMetaSoundDocument),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MetaSound asset path"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("get_metasound_summary"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundIntrospectionActions::HandleGetMetaSoundSummary),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MetaSound asset path"))
			.Optional(TEXT("page_id"), TEXT("string"), TEXT("Page GUID (default: default page)"))
			.Build());
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("inspect_metasound_node_instance"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundIntrospectionActions::HandleInspectMetaSoundNodeInstance),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MetaSound asset path"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("get_metasound_document_connections"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundIntrospectionActions::HandleGetMetaSoundDocumentConnections),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MetaSound asset path"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("get_metasound_document_variables"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundIntrospectionActions::HandleGetMetaSoundDocumentVariables),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MetaSound asset path"))
			.Optional(TEXT("page_id"), TEXT("string"), TEXT("Page GUID (default: default page)"))
			.Build());
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("get_metasound_user_parameters"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundIntrospectionActions::HandleGetMetaSoundUserParameters),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MetaSound asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("search_metasound_document_nodes"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundIntrospectionActions::HandleSearchMetaSoundDocumentNodes),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MetaSound asset path"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("get_metasound_info"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundIntrospectionActions::HandleGetMetaSoundInfo),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MetaSound asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("get_metasound_dependencies"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundIntrospectionActions::HandleGetMetaSoundDependencies),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MetaSound asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("validate_metasound"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioMetaSoundIntrospectionActions::HandleValidateMetaSound),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MetaSound asset path"))
			.Build());
}
...
FMegalithActionResult FMegalithAudioMetaSoundIntrospectionActions::HandleListMetaSoundDocuments(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));

	UObject* Asset = FMegalithAssetUtils::LoadAssetByPath(AssetPath);
	if (!Asset)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Asset not found: %s"), *AssetPath), FMegalithJsonUtils::ErrInvalidParams);
	}

	IMetaSoundDocumentInterface* DocInterface = Introspection_GetDocumentInterface(Asset);
	if (!DocInterface)
	{
		return FMegalithActionResult::Error(TEXT("Asset is not a MetaSound"), FMegalithJsonUtils::ErrInvalidParams);
	}
...
FMegalithActionResult FMegalithAudioMetaSoundIntrospectionActions::HandleGetMetaSoundDocument(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!Graph)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Graph page not found: %s"), *PageIdStr), FMegalithJsonUtils::ErrInvalidParams);
	}
...
FMegalithActionResult FMegalithAudioMetaSoundIntrospectionActions::HandleGetMetaSoundSummary(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString PageIdStr = Params->HasField(TEXT("page_id")) ? Params->GetStringField(TEXT("page_id")) : FString();
...
FMegalithActionResult FMegalithAudioMetaSoundIntrospectionActions::HandleInspectMetaSoundNodeInstance(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString PageIdStr = Params->HasField(TEXT("page_id")) ? Params->GetStringField(TEXT("page_id")) : FString();
	...
	{
		return FMegalithActionResult::Error(TEXT("Must provide either node_id or node_name"), FMegalithJsonUtils::ErrInvalidParams);
	}
	...
	if (!FoundNode)
	{
		return FMegalithActionResult::Error(FString::Printf(
			...
			!NodeIdStr.IsEmpty() ? *NodeIdStr : *NodeName), FMegalithJsonUtils::ErrInvalidParams);
	}
...
FMegalithActionResult FMegalithAudioMetaSoundIntrospectionActions::HandleGetMetaSoundDocumentConnections(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString PageIdStr = Params->HasField(TEXT("page_id")) ? Params->GetStringField(TEXT("page_id")) : FString();
	FString NodeIdStr = Params->HasField(TEXT("node_id")) ? Params->GetStringField(TEXT("node_id")) : FString();
	...
	if (!NodeIdStr.IsEmpty())
	{
		...
		if (!FGuid::Parse(NodeIdStr, NodeId))
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Invalid node_id GUID: %s"), *NodeIdStr), FMegalithJsonUtils::ErrInvalidParams);
		}
...
FMegalithActionResult FMegalithAudioMetaSoundIntrospectionActions::HandleGetMetaSoundDocumentVariables(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString PageIdStr = Params->HasField(TEXT("page_id")) ? Params->GetStringField(TEXT("page_id")) : FString();
...
FMegalithActionResult FMegalithAudioMetaSoundIntrospectionActions::HandleGetMetaSoundUserParameters(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithAudioMetaSoundIntrospectionActions::HandleSearchMetaSoundDocumentNodes(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithAudioMetaSoundIntrospectionActions::HandleGetMetaSoundInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithAudioMetaSoundIntrospectionActions::HandleGetMetaSoundDependencies(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithAudioMetaSoundIntrospectionActions::HandleListMetaSounds(const TSharedPtr<FJsonObject>& Params)
{
...
FMegalithActionResult FMegalithAudioMetaSoundIntrospectionActions::HandleValidateMetaSound(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
