...
// LogMegalith declared in MegalithJsonUtils.h (MegalithCore)
...
void FMegalithAudioBatchActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	Registry.RegisterAction(TEXT("audio"), TEXT("batch_assign_sound_class"),
		TEXT("Assign a SoundClass to multiple USoundBase assets"),
		FMegalithActionHandler::CreateStatic(&FMegalithAudioBatchActions::BatchAssignSoundClass),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("batch_assign_attenuation"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioBatchActions::BatchAssignAttenuation),
		FParamSchemaBuilder()
			.Required(TEXT("asset_paths"), TEXT("array"), TEXT("Array of USoundBase asset paths"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("batch_set_compression"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioBatchActions::BatchSetCompression),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("batch_set_submix"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioBatchActions::BatchSetSubmix),
		FParamSchemaBuilder()
			.Required(TEXT("asset_paths"), TEXT("array"), TEXT("Array of USoundBase asset paths"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("batch_set_concurrency"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioBatchActions::BatchSetConcurrency),
		FParamSchemaBuilder()
			.Required(TEXT("asset_paths"), TEXT("array"), TEXT("Array of USoundBase asset paths"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("batch_set_looping"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioBatchActions::BatchSetLooping),
		FParamSchemaBuilder()
			.Required(TEXT("asset_paths"), TEXT("array"), TEXT("Array of USoundWave asset paths"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("batch_set_virtualization"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioBatchActions::BatchSetVirtualization),
		FParamSchemaBuilder()
			.Required(TEXT("asset_paths"), TEXT("array"), TEXT("Array of USoundBase asset paths"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("batch_rename_audio"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioBatchActions::BatchRenameAudio),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("batch_set_sound_wave_properties"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioBatchActions::BatchSetSoundWaveProperties),
		FParamSchemaBuilder()
			.Required(TEXT("asset_paths"), TEXT("array"), TEXT("Array of USoundWave asset paths"))
	...
	Registry.RegisterAction(TEXT("audio"), TEXT("apply_audio_template"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithAudioBatchActions::ApplyAudioTemplate),
		FParamSchemaBuilder()
...
FMegalithActionResult FMegalithAudioBatchActions::BatchAssignSoundClass(const TSharedPtr<FJsonObject>& Params)
{
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required field 'sound_class'"));
	}

	USoundClass* SoundClass = LoadAudioAsset<USoundClass>(SoundClassPath);
	if (!SoundClass)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to load SoundClass at '%s'"), *SoundClassPath));
	}
	...
	return FMegalithActionResult::Success(MakeBatchResult(Modified, Failed));
}
...
FMegalithActionResult FMegalithAudioBatchActions::BatchAssignAttenuation(const TSharedPtr<FJsonObject>& Params)
{
	using namespace AudioBatchHelpers;
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required field 'attenuation'"));
	}

	USoundAttenuation* Attenuation = LoadAudioAsset<USoundAttenuation>(AttenuationPath);
	if (!Attenuation)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to load SoundAttenuation at '%s'"), *AttenuationPath));
	}
...
FMegalithActionResult FMegalithAudioBatchActions::BatchSetCompression(const TSharedPtr<FJsonObject>& Params)
{
	using namespace AudioBatchHelpers;
	...
	{
		return FMegalithActionResult::Error(TEXT("At least one of 'quality' or 'type' must be specified"));
	}
...
FMegalithActionResult FMegalithAudioBatchActions::BatchSetSubmix(const TSharedPtr<FJsonObject>& Params)
{
	using namespace AudioBatchHelpers;
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required field 'submix'"));
	}

	USoundSubmix* Submix = LoadAudioAsset<USoundSubmix>(SubmixPath);
	if (!Submix)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to load SoundSubmix at '%s'"), *SubmixPath));
	}
...
FMegalithActionResult FMegalithAudioBatchActions::BatchSetConcurrency(const TSharedPtr<FJsonObject>& Params)
{
	using namespace AudioBatchHelpers;
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required field 'concurrency'"));
	}

	USoundConcurrency* Concurrency = LoadAudioAsset<USoundConcurrency>(ConcurrencyPath);
	if (!Concurrency)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to load SoundConcurrency at '%s'"), *ConcurrencyPath));
	}
...
FMegalithActionResult FMegalithAudioBatchActions::BatchSetLooping(const TSharedPtr<FJsonObject>& Params)
{
	using namespace AudioBatchHelpers;
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required field 'looping'"));
	}
...
FMegalithActionResult FMegalithAudioBatchActions::BatchSetVirtualization(const TSharedPtr<FJsonObject>& Params)
{
	using namespace AudioBatchHelpers;
	...
	if (ModeStr.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("Missing required field 'mode'"));
	}
	...
	{
		return FMegalithActionResult::Error(ModeError);
	}
...
FMegalithActionResult FMegalithAudioBatchActions::BatchRenameAudio(const TSharedPtr<FJsonObject>& Params)
{
	using namespace AudioBatchHelpers;
	...
	{
		return FMegalithActionResult::Error(TEXT("At least one of 'prefix', 'suffix', or 'find' must be specified"));
	}
...
FMegalithActionResult FMegalithAudioBatchActions::BatchSetSoundWaveProperties(const TSharedPtr<FJsonObject>& Params)
{
	using namespace AudioBatchHelpers;
	...
	if (!Params->TryGetObjectField(TEXT("properties"), PropertiesPtr) || !PropertiesPtr || !(*PropertiesPtr).IsValid())
	{
		...
		{
			return FMegalithActionResult::Error(TEXT("Missing or invalid 'properties' object"));
		}
	}
	...
	for (const FString& Path : AssetPaths)
	{
		...
		{
			const FString PropName = MegalithKeyToString(PropPair.Key);
...
FMegalithActionResult FMegalithAudioBatchActions::ApplyAudioTemplate(const TSharedPtr<FJsonObject>& Params)
{
	using namespace AudioBatchHelpers;
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing or empty 'template' object"));
	}
	...
	if (Template->HasField(TEXT("sound_class")))
	{
		...
		if (!SoundClass)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to load SoundClass '%s'"), *ClassPath));
		}
	...
	if (Template->HasField(TEXT("attenuation")))
	{
		...
		if (!Attenuation)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to load SoundAttenuation '%s'"), *AttenPath));
		}
	...
	if (Template->HasField(TEXT("submix")))
	{
		...
		if (!Submix)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to load SoundSubmix '%s'"), *SubmixPath));
		}
	...
	if (Template->HasField(TEXT("concurrency")))
	{
		...
		if (!Concurrency)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to load SoundConcurrency '%s'"), *ConcPath));
		}
	...
	{
		return FMegalithActionResult::Error(TEXT("Template has no recognized fields"));
	}
	...
	for (const FString& Path : AssetPaths)
	{
		...
		else if (bHasLooping || bHasCompression)
		{
			...
			UE_LOG(LogMegalith, Warning, TEXT("[apply_audio_template] %s: %s"), *Path, *Warning);
		}
