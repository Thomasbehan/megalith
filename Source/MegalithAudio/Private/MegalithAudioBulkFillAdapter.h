 ...
 * Self-registers with FMegalithBulkFillRegistry from FMegalithAudioModule::StartupModule.
 *
 ...
 * them would trip the release smoke. MegalithAudio.Build.cs already does the
 ...
 *      }
 */
class FMegalithAudioBulkFillAdapter
{
public:
