...
public class MegalithAudio : ModuleRules
{
	...
	public MegalithAudio(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		{
			"MegalithCore",            // Registry, FMegalithActionResult
			"MegalithAudioRuntime",    // UMegalithSoundPerceptionUserData (Phase I3)
		...
		// EnabledByDefault:false (and Optional:true in Megalith.uplugin); a source builder
		// who hasn't enabled it would otherwise hard-link MetasoundEngine/Frontend/Editor → 126.
		// Release builds: MEGALITH_RELEASE_BUILD=1 still forces this OFF.
