...
void FMegalithMaterialActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	Registry.RegisterAction(TEXT("material"), TEXT("get_all_expressions"),
		TEXT("Get all expression nodes in a base material"),
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::GetAllExpressions),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("material"), TEXT("get_expression_details"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::GetExpressionDetails),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material asset path"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("get_full_connection_graph"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::GetFullConnectionGraph),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("material"), TEXT("disconnect_expression"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::DisconnectExpression),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material asset path"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("build_material_graph"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::BuildMaterialGraph),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material asset path"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("begin_transaction"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::BeginTransaction),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("material"), TEXT("end_transaction"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::EndTransaction),
	...
	Registry.RegisterAction(TEXT("material"), TEXT("export_material_graph"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::ExportMaterialGraph),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material asset path"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("import_material_graph"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::ImportMaterialGraph),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material asset path"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("validate_material"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::ValidateMaterial),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material asset path"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("render_preview"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::RenderPreview),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material asset path"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("get_thumbnail"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::GetThumbnail),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material asset path"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("create_custom_hlsl_node"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::CreateCustomHLSLNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material asset path"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("get_layer_info"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::GetLayerInfo),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("material"), TEXT("create_material"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::CreateMaterial),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("material"), TEXT("create_material_instance"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::CreateMaterialInstance),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("material"), TEXT("set_material_property"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::SetMaterialProperty),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material asset path"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("delete_expression"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::DeleteExpression),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material asset path"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("get_material_parameters"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::GetMaterialParameters),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("material"), TEXT("set_instance_parameter"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::SetInstanceParameter),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("material"), TEXT("recompile_material"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::RecompileMaterial),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material asset path"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("duplicate_material"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::DuplicateMaterial),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("material"), TEXT("get_compilation_stats"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::GetCompilationStats),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("material"), TEXT("set_expression_property"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::SetExpressionProperty),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material asset path"))
			.Required(TEXT("expression_name"), TEXT("string"), TEXT("Name of the expression node"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("connect_expressions"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::ConnectExpressions),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material asset path"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("auto_layout"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::AutoLayout),
		FParamSchemaBuilder()
			...
			.Optional(TEXT("formatter"), TEXT("string"),
				TEXT("Formatter: 'auto' (default, prefers Blueprint Assist if available), "
					 "'blueprint_assist' (requires asset open in editor), or 'megalith' (UE built-in layout)"),
				TEXT("auto"))
			.Build());
	...
	Registry.RegisterAction(TEXT("material"), TEXT("duplicate_expression"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::DuplicateExpression),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material asset path"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("list_expression_classes"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::ListExpressionClasses),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("material"), TEXT("get_expression_connections"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::GetExpressionConnections),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material asset path"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("move_expression"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::MoveExpression),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material asset path"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("get_material_properties"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::GetMaterialProperties),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material or material instance asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("material"), TEXT("get_instance_parameters"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::GetInstanceParameters),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material instance asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("material"), TEXT("set_instance_parameters"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::SetInstanceParameters),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material instance asset path"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("set_instance_parent"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::SetInstanceParent),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material instance asset path"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("clear_instance_parameter"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::ClearInstanceParameter),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material instance asset path"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("save_material"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::SaveMaterial),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material asset path"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("update_custom_hlsl_node"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::UpdateCustomHlslNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material asset path"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("replace_expression"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::ReplaceExpression),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material asset path"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("get_expression_pin_info"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::GetExpressionPinInfo),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("material"), TEXT("rename_expression"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::RenameExpression),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material asset path"))
			.Required(TEXT("expression_name"), TEXT("string"), TEXT("Name of the expression node"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("list_material_instances"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::ListMaterialInstances),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("material"), TEXT("create_material_function"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::CreateMaterialFunction),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("material"), TEXT("build_function_graph"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::BuildFunctionGraph),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("material"), TEXT("get_function_info"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::GetFunctionInfo),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material function asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("material"), TEXT("export_function_graph"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::ExportFunctionGraph),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("material"), TEXT("set_function_metadata"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::SetFunctionMetadata),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MaterialFunction asset path"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("update_material_function"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::UpdateMaterialFunction),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("material"), TEXT("delete_function_expression"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::DeleteFunctionExpression),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MaterialFunction asset path"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("batch_set_material_property"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::BatchSetMaterialProperty),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("material"), TEXT("batch_recompile"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::BatchRecompile),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("material"), TEXT("import_texture"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::ImportTexture),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("material"), TEXT("create_pbr_material_from_disk"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::CreatePbrMaterialFromDisk),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("material"), TEXT("create_function_instance"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::CreateFunctionInstance),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("material"), TEXT("set_function_instance_parameter"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::SetFunctionInstanceParameter),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("material"), TEXT("get_function_instance_info"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::GetFunctionInstanceInfo),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MFI asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("material"), TEXT("layout_function_expressions"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::LayoutFunctionExpressions),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MaterialFunction asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("material"), TEXT("rename_function_parameter_group"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::RenameFunctionParameterGroup),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("MaterialFunction asset path"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("clear_graph"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::ClearGraph),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material asset path"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("delete_expressions"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::DeleteExpressions),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material asset path"))
	...
	Registry.RegisterAction(TEXT("material"), TEXT("get_texture_properties"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::GetTextureProperties),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("material"), TEXT("preview_texture"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::PreviewTexture),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Texture asset path"))
			.Optional(TEXT("resolution"), TEXT("integer"), TEXT("Preview resolution in pixels"), TEXT("256"))
			.OptionalDiskPath(TEXT("output_path"), TEXT("Custom output file path (default: Saved/Megalith/previews/)"))
			.Build());
	...
	Registry.RegisterAction(TEXT("material"), TEXT("preview_textures"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::PreviewTextures),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("material"), TEXT("check_tiling_quality"),
		...
		FMegalithActionHandler::CreateStatic(&FMegalithMaterialActions::CheckTilingQuality),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Material asset path"))
			.Build());
}
...
UMaterial* FMegalithMaterialActions::LoadBaseMaterial(const FString& AssetPath)
{
...
TSharedPtr<FJsonObject> FMegalithMaterialActions::SerializeExpression(const UMaterialExpression* Expression)
{
...
FMegalithActionResult FMegalithMaterialActions::GetAllExpressions(const TSharedPtr<FJsonObject>& Params)
{
	...
	return FMegalithActionResult::Success(ResultJson);
}
...
FMegalithActionResult FMegalithMaterialActions::GetExpressionDetails(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithMaterialActions::GetFullConnectionGraph(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!Mat)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to load base material at '%s'"), *AssetPath));
	}
...
FMegalithActionResult FMegalithMaterialActions::DisconnectExpression(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString ExpressionName = Params->GetStringField(TEXT("expression_name"));
	...
	GEditor->BeginTransaction(NSLOCTEXT("Megalith", "DisconnectExpr", "Disconnect Expression"));
	Mat->Modify();
...
FMegalithActionResult FMegalithMaterialActions::BeginTransaction(const TSharedPtr<FJsonObject>& Params)
{
...
FMegalithActionResult FMegalithMaterialActions::EndTransaction(const TSharedPtr<FJsonObject>& Params)
{
	GEditor->EndTransaction();
...
FMegalithActionResult FMegalithMaterialActions::BuildMaterialGraph(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	else if (Params->HasTypedField<EJson::String>(TEXT("graph_spec")))
	{
		...
		{
			return FMegalithActionResult::Error(TEXT("Failed to parse graph_spec JSON string"));
		}
	}
	else
	{
		return FMegalithActionResult::Error(TEXT("Missing 'graph_spec' parameter"));
	}
...
FMegalithActionResult FMegalithMaterialActions::ExportMaterialGraph(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithMaterialActions::ImportMaterialGraph(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	else if (Mode == TEXT("merge"))
	{
		...
		{
			return FMegalithActionResult::Error(TEXT("Failed to parse graph_json for merge"));
		}
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Unknown import mode '%s'. Use 'overwrite' or 'merge'."), *Mode));
	}
}
...
FMegalithActionResult FMegalithMaterialActions::ValidateMaterial(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithMaterialActions::RenderPreview(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	// uv_tiling or preview_mesh differ from defaults (avoids MegalithEditor dependency)
	...
	if (bUseCustomPipeline)
	{
		...
		FMegalithActionResult CaptureResult = FMegalithToolRegistry::Get().ExecuteAction(
	...
	{
		return FMegalithActionResult::Error(TEXT("Thumbnail rendering produced an empty image"));
	}
	...
	if (PngData.Num() == 0)
	{
		return FMegalithActionResult::Error(TEXT("Failed to compress thumbnail to PNG"));
	}

	FString MaterialName = FPaths::GetBaseFilename(AssetPath);
	FString PreviewDir = FPaths::Combine(FPaths::ProjectSavedDir(), TEXT("Megalith"), TEXT("previews"));
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to save PNG to '%s'"), *FilePath));
	}
...
FMegalithActionResult FMegalithMaterialActions::GetThumbnail(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	int32 Resolution = Params->HasField(TEXT("resolution")) ? static_cast<int32>(Params->GetNumberField(TEXT("resolution"))) : 256;
	if (Resolution <= 0)
	...
	if (bSaveToFile)
	{
		...
		FString SaveDir = FPaths::Combine(FPaths::ProjectSavedDir(), TEXT("Megalith"), TEXT("previews"));
		...
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to save thumbnail to '%s'"), *FullPath));
		}
...
FMegalithActionResult FMegalithMaterialActions::CreateCustomHLSLNode(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(TEXT("Failed to create Custom HLSL expression"));
	}
...
FMegalithActionResult FMegalithMaterialActions::GetLayerInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Asset '%s' is not a MaterialFunction, MaterialLayer, or MaterialLayerBlend"), *AssetPath));
	}
...
FMegalithActionResult FMegalithMaterialActions::CreateMaterial(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	const FString PathError = MegalithCore::ValidatePackagePath(AssetPath);
	...
	{
		return FMegalithActionResult::Error(TEXT("Invalid asset path — must contain at least one '/' (e.g. /Game/Materials/M_Name)"));
	}

	if (AssetName.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("Asset name is empty"));
	}
	...
	if (!NewMat)
	{
		return FMegalithActionResult::Error(TEXT("Failed to create UMaterial object"));
	}
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("material_domain: %s"), *EnumError));
	}
	EBlendMode BlendMode;
	if (!ParseEnum<EBlendMode>(BlendModeStr, BlendMode, EnumError))
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("blend_mode: %s"), *EnumError));
	}
	EMaterialShadingModel ShadingModel;
	if (!ParseEnum<EMaterialShadingModel>(ShadingModelStr, ShadingModel, EnumError))
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("shading_model: %s"), *EnumError));
	}
...
FMegalithActionResult FMegalithMaterialActions::CreateMaterialInstance(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!ParentMat)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to load parent material at '%s'"), *ParentPath));
	}
	...
	{
		return FMegalithActionResult::Error(TEXT("Invalid asset path"));
	}
	AssetName = AssetPath.Mid(LastSlash + 1);
	...
	if (!Pkg)
	{
		return FMegalithActionResult::Error(TEXT("Failed to create package"));
	}
	...
	if (!MIC)
	{
		return FMegalithActionResult::Error(TEXT("Failed to create UMaterialInstanceConstant"));
	}
...
FMegalithActionResult FMegalithMaterialActions::SetMaterialProperty(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithMaterialActions::DeleteExpression(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithMaterialActions::GetMaterialParameters(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!MatInterface)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to load material at '%s'"), *AssetPath));
	}
...
FMegalithActionResult FMegalithMaterialActions::SetInstanceParameter(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	else if (Params->HasField(TEXT("texture_value")))
	{
		...
		if (!Tex)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to load texture at '%s'"), *TexPath));
		}
	...
	{
		return FMegalithActionResult::Error(TEXT("Must provide one of: scalar_value, vector_value, texture_value, switch_value"));
	}
...
FMegalithActionResult FMegalithMaterialActions::RecompileMaterial(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithMaterialActions::DuplicateMaterial(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (!SourceObj)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Source material not found at '%s'"), *SourcePath));
	}
...
FMegalithActionResult FMegalithMaterialActions::GetCompilationStats(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!BaseMat)
	{
		return FMegalithActionResult::Error(TEXT("Could not resolve base material"));
	}
...
FMegalithActionResult FMegalithMaterialActions::SetExpressionProperty(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString ExprName = Params->GetStringField(TEXT("expression_name"));
	...
	if (!bSuccess)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to set property '%s' to '%s' on expression '%s'"), *PropName, *ValueStr, *ExprName));
	}
...
FMegalithActionResult FMegalithMaterialActions::ConnectExpressions(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FMegalithActionResult::Error(TEXT("Must provide either to_expression or to_property"));
	}
	...
	if (!bConnected)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Connection failed: %s"), *ConnectionDesc));
	}
...
FMegalithActionResult FMegalithMaterialActions::AutoLayout(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	// Validate formatter
	if (Formatter != TEXT("auto") && Formatter != TEXT("blueprint_assist") && Formatter != TEXT("megalith"))
	{
		return FMegalithActionResult::Error(FString::Printf(
			TEXT("Unknown formatter '%s'. Valid: 'auto', 'blueprint_assist', 'megalith'"), *Formatter));
	}
	...
	if (Formatter == TEXT("auto") || Formatter == TEXT("blueprint_assist"))
	{
		...
		bool bBAAvailable = MaterialGraph
			&& IMegalithGraphFormatter::IsAvailable()
			&& IMegalithGraphFormatter::Get().SupportsGraph(MaterialGraph);

		if (bBAAvailable)
		{
			int32 NodesFormatted = 0;
			FString ErrorMessage;
			if (IMegalithGraphFormatter::Get().FormatGraph(MaterialGraph, NodesFormatted, ErrorMessage))
			{
				...
				FMegalithFormatterInfo Info = IMegalithGraphFormatter::Get().GetFormatterInfo(MaterialGraph);
			...
			if (!MaterialGraph)
			{
				return FMegalithActionResult::Error(
					TEXT("Blueprint Assist formatting is only supported for UMaterial assets (not MaterialFunctions). "
						 "Use formatter='megalith' for MaterialFunction layout."));
			}
			return FMegalithActionResult::Error(
	...
	if (MatFunc)
	{
		...
		ResultJson->SetStringField(TEXT("formatter_used"), TEXT("megalith"));
		return FMegalithActionResult::Success(ResultJson);
	}
	...
	return FMegalithActionResult::Error(FString::Printf(TEXT("Asset '%s' is not a Material or MaterialFunction"), *AssetPath));
}
...
FMegalithActionResult FMegalithMaterialActions::DuplicateExpression(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString ExprName = Params->GetStringField(TEXT("expression_name"));
	...
	{
		GEditor->EndTransaction();
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to duplicate expression '%s'"), *ExprName));
	}
...
FMegalithActionResult FMegalithMaterialActions::ListExpressionClasses(const TSharedPtr<FJsonObject>& Params)
{
...
FMegalithActionResult FMegalithMaterialActions::GetExpressionConnections(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString ExprName = Params->GetStringField(TEXT("expression_name"));
...
FMegalithActionResult FMegalithMaterialActions::MoveExpression(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FMegalithActionResult::Error(TEXT("Must provide either 'expression_name' or 'expressions' array"));
	}

	if (MoveOps.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("No move operations specified"));
	}
...
FMegalithActionResult FMegalithMaterialActions::GetMaterialProperties(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithMaterialActions::GetInstanceParameters(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!MIC)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to load material instance at '%s'"), *AssetPath));
	}
...
FMegalithActionResult FMegalithMaterialActions::SetInstanceParameters(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required 'parameters' array"));
	}
...
FMegalithActionResult FMegalithMaterialActions::SetInstanceParent(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!NewParent)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to load new parent material at '%s'"), *NewParentPath));
	}
...
FMegalithActionResult FMegalithMaterialActions::ClearInstanceParameter(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithMaterialActions::SaveMaterial(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithMaterialActions::UpdateCustomHlslNode(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString ExprName = Params->GetStringField(TEXT("expression_name"));
...
FMegalithActionResult FMegalithMaterialActions::ReplaceExpression(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString ExprName = Params->GetStringField(TEXT("expression_name"));
...
FMegalithActionResult FMegalithMaterialActions::GetExpressionPinInfo(const TSharedPtr<FJsonObject>& Params)
{
...
FMegalithActionResult FMegalithMaterialActions::RenameExpression(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString ExprName = Params->GetStringField(TEXT("expression_name"));
...
FMegalithActionResult FMegalithMaterialActions::ListMaterialInstances(const TSharedPtr<FJsonObject>& Params)
{
...
void FMegalithMaterialActions::BuildGraphFromSpec(
...
FMegalithActionResult FMegalithMaterialActions::CreateMaterialFunction(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FMegalithActionResult::Error(TEXT("Invalid asset path — must contain at least one '/' (e.g. /Game/Materials/Functions/MF_MyFunc)"));
	}
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Unknown function type '%s' — valid values: MaterialFunction, MaterialLayer, MaterialLayerBlend"), *FuncType));
	}
	...
	if (!NewFunc)
	{
		return FMegalithActionResult::Error(TEXT("Failed to create UMaterialFunction object"));
	}
...
FMegalithActionResult FMegalithMaterialActions::BuildFunctionGraph(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!Func)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Asset '%s' is not a UMaterialFunction"), *AssetPath));
	}
...
FMegalithActionResult FMegalithMaterialActions::GetFunctionInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!MatFunc)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Asset '%s' is not a MaterialFunction"), *AssetPath));
	}
...
FMegalithActionResult FMegalithMaterialActions::ExportFunctionGraph(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithMaterialActions::SetFunctionMetadata(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithMaterialActions::UpdateMaterialFunction(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!MatFuncInterface)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Asset '%s' is not a MaterialFunction or MaterialFunctionInstance"), *AssetPath));
	}
...
FMegalithActionResult FMegalithMaterialActions::DeleteFunctionExpression(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FMegalithActionResult::Error(TEXT("Cannot delete expressions from a function instance — modify the base function instead"));
	}
...
FMegalithActionResult FMegalithMaterialActions::BatchSetMaterialProperty(const TSharedPtr<FJsonObject>& Params)
{
	...
	{
		return FMegalithActionResult::Error(ParseError);
	}
...
FMegalithActionResult FMegalithMaterialActions::BatchRecompile(const TSharedPtr<FJsonObject>& Params)
{
	// Parse asset_paths array
	TArray<TSharedPtr<FJsonValue>> PathsJsonArray;
	FString ParseError;
...
FMegalithActionResult FMegalithMaterialActions::ImportTexture(const TSharedPtr<FJsonObject>& Params)
{
	...
	{
		return FMegalithActionResult::Error(ImportResult.ErrorMessage);
	}
...
FMegalithActionResult FMegalithMaterialActions::CreatePbrMaterialFromDisk(const TSharedPtr<FJsonObject>& Params)
{
	// ---- Parse required params ----
	if (!Params->HasField(TEXT("material_path")))
	{
		return FMegalithActionResult::Error(TEXT("Missing required param: material_path"));
	}
	if (!Params->HasField(TEXT("texture_folder")))
	{
		return FMegalithActionResult::Error(TEXT("Missing required param: texture_folder"));
	}
	if (!Params->HasField(TEXT("maps")))
	{
		return FMegalithActionResult::Error(TEXT("Missing required param: maps"));
	}
	...
	{
		return FMegalithActionResult::Error(TEXT("'maps' must be a non-empty object mapping PBR type to disk file path"));
	}
	...
	const FString MaterialPathError = MegalithCore::ValidatePackagePath(MaterialPath);
	if (!MaterialPathError.IsEmpty())
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("material_path: %s"), *MaterialPathError));
	}
	...
	FString MaterialPackagePath, MaterialAssetName;
	{
		...
		{
			return FMegalithActionResult::Error(TEXT("Invalid material_path — must contain at least one '/' and an asset name (e.g. /Game/Materials/M_MyMat)"));
		}
	...
	{
		return FMegalithActionResult::Error(TEXT("material_path has empty asset name"));
	}
	...
	const FString TextureFolderError = MegalithCore::ValidatePackagePath(TextureFolder);
	if (!TextureFolderError.IsEmpty())
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("texture_folder: %s"), *TextureFolderError));
	}
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Material already exists at '%s'. Set replace_existing: true to overwrite."), *MaterialPath));
	}
	...
	{
		FString MapType = MegalithKeyToString(MapEntry.Key).ToLower();
	...
	if (ImportedTextures.Num() == 0)
	{
		...
		return FMegalithActionResult::Error(FString::Printf(TEXT("No textures were imported. Errors: %s"), *CombinedErrors));
	}
	...
	if (!Pkg)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create package at '%s'"), *MaterialPath));
	}
	...
	GEditor->BeginTransaction(NSLOCTEXT("Megalith", "CreatePBR", "Create PBR Material From Disk"));
...
// ============================================================================
FMegalithActionResult FMegalithMaterialActions::CreateFunctionInstance(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!ParentFunc)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to load parent function at '%s'"), *ParentPath));
	}
	...
	if (!MFI)
	{
		return FMegalithActionResult::Error(TEXT("Failed to create MaterialFunctionInstance object"));
	}
...
FMegalithActionResult FMegalithMaterialActions::SetFunctionInstanceParameter(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString ParamName = Params->GetStringField(TEXT("parameter_name"));
	...
	if (!MFI)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to load material function instance at '%s'"), *AssetPath));
	}
	...
	if (TypeCount > 1)
	{
		return FMegalithActionResult::Error(TEXT("Only one of scalar_value, vector_value, texture_value, switch_value may be specified"));
	}
	...
	if (Params->HasField(TEXT("scalar_value")))
	{
		...
		if (!bFound)
		{
			...
			if (!FoundGUID)
			{
				return FMegalithActionResult::Error(FString::Printf(TEXT("Scalar parameter '%s' not found in base function"), *ParamName));
			}
			FScalarParameterValue NewEntry;
	...
	else if (Params->HasField(TEXT("vector_value")))
	{
		...
		if (!Params->TryGetObjectField(TEXT("vector_value"), ColorObj))
		{
			return FMegalithActionResult::Error(TEXT("vector_value must be a JSON object with r, g, b, a fields"));
		}
		...
		if (!bFound)
		{
			...
			if (!FoundGUID)
			{
				return FMegalithActionResult::Error(FString::Printf(TEXT("Vector parameter '%s' not found in base function"), *ParamName));
			}
			FVectorParameterValue NewEntry;
			NewEntry.ParameterInfo = FMaterialParameterInfo(ParamFName);
			NewEntry.ExpressionGUID = *FoundGUID;
	...
	else if (Params->HasField(TEXT("texture_value")))
	{
		...
		if (!bFound)
		{
			...
			if (!FoundGUID)
			{
				return FMegalithActionResult::Error(FString::Printf(TEXT("Texture parameter '%s' not found in base function"), *ParamName));
			}
			FTextureParameterValue NewEntry;
			NewEntry.ParameterInfo = FMaterialParameterInfo(ParamFName);
			NewEntry.ExpressionGUID = *FoundGUID;
	...
	else if (Params->HasField(TEXT("switch_value")))
	{
		...
		if (!bFound)
		{
			...
			if (!FoundGUID)
			{
				return FMegalithActionResult::Error(FString::Printf(TEXT("Static switch parameter '%s' not found in base function"), *ParamName));
			}
			FStaticSwitchParameter NewEntry;
			NewEntry.ParameterInfo = FMaterialParameterInfo(ParamFName);
			NewEntry.ExpressionGUID = *FoundGUID;
...
FMegalithActionResult FMegalithMaterialActions::GetFunctionInstanceInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!MFI)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Asset '%s' is not a MaterialFunctionInstance (type: %s)"), *AssetPath, *LoadedAsset->GetClass()->GetName()));
	}
...
FMegalithActionResult FMegalithMaterialActions::LayoutFunctionExpressions(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (Cast<UMaterialFunctionInstance>(LoadedAsset))
	{
		return FMegalithActionResult::Error(TEXT("Cannot layout a function instance — layout the base function instead"));
	}

	UMaterialFunction* MatFunc = Cast<UMaterialFunction>(LoadedAsset);
	if (!MatFunc)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Asset '%s' is not a UMaterialFunction (type: %s)"), *AssetPath, *LoadedAsset->GetClass()->GetName()));
	}
...
FMegalithActionResult FMegalithMaterialActions::RenameFunctionParameterGroup(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!MatFuncInterface)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Asset '%s' is not a MaterialFunctionInterface (type: %s)"), *AssetPath, *LoadedAsset->GetClass()->GetName()));
	}
...
FMegalithActionResult FMegalithMaterialActions::ClearGraph(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FMegalithActionResult FMegalithMaterialActions::DeleteExpressions(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required 'expression_names' array"));
	}
	...
	{
		return FMegalithActionResult::Error(TEXT("expression_names array is empty"));
	}
...
FMegalithActionResult FMegalithMaterialActions::GetTextureProperties(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!Tex)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Asset '%s' is not a UTexture (type: %s)"), *AssetPath, *LoadedAsset->GetClass()->GetName()));
	}
...
FMegalithActionResult FMegalithMaterialActions::PreviewTexture(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to save PNG to '%s'"), *OutputPath));
	}
...
FMegalithActionResult FMegalithMaterialActions::PreviewTextures(const TSharedPtr<FJsonObject>& Params)
{
	const TArray<TSharedPtr<FJsonValue>>* PathsArray = nullptr;
	if (!Params->TryGetArrayField(TEXT("asset_paths"), PathsArray) || !PathsArray || PathsArray->Num() == 0)
	{
		return FMegalithActionResult::Error(TEXT("Missing or empty 'asset_paths' array"));
	}
	...
	if (PngData.Num() == 0)
	{
		return FMegalithActionResult::Error(TEXT("Failed to compress contact sheet to PNG"));
	}
	...
	if (!FFileHelper::SaveArrayToFile(PngData, *OutputPath))
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to save contact sheet to '%s'"), *OutputPath));
	}
...
FMegalithActionResult FMegalithMaterialActions::CheckTilingQuality(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
