...
/**
 * DDL constants for the Megalith engine source SQLite database.
 ...
 * Use ExecuteMulti() in MegalithSourceDatabase.cpp — FSQLiteDatabase::Execute() only
 ...
 */
namespace MegalithSourceSchema
{
