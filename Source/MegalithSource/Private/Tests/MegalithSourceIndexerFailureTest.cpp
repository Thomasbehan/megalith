...
// editor restarted. Every exit now routes through FMegalithSourceIndexer::CompleteRun.
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithSourceIndexerOpenFailureCompletionTest,
	"Megalith.Source.Indexer.WriterOpenFailureBroadcastsCompletion",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithSourceIndexerOpenFailureCompletionTest::RunTest(const FString& /*Parameters*/)
{
	...
	const FString TestDirectory = FPaths::Combine(
		...
		TEXT("MegalithSourceIndexerFailureTests"),
