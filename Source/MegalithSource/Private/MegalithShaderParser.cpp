...
FParsedFileResult FMegalithShaderParser::ParseFile(const FString& FilePath)
{
	...
	{
		UE_LOG(LogMegalithSource, Warning, TEXT("ShaderParser: Failed to read file: %s"), *FilePath);
		return Result;
	}
...
void FMegalithShaderParser::ExtractIncludes(const FString& Text, const TArray<FString>& Lines, FParsedFileResult& Result)
{
...
void FMegalithShaderParser::ExtractDefines(const FString& Text, const TArray<FString>& Lines, FParsedFileResult& Result)
{
...
void FMegalithShaderParser::ExtractStructs(const FString& Text, const TArray<FString>& Lines, FParsedFileResult& Result)
{
...
void FMegalithShaderParser::ExtractFunctions(const FString& Text, const TArray<FString>& Lines, FParsedFileResult& Result)
{
...
int32 FMegalithShaderParser::FindClosingBrace(const TArray<FString>& Lines, int32 OpenLineIdx)
{
	int32 Depth = 0;
...
FString FMegalithShaderParser::FindDocstring(const TArray<FString>& Lines, int32 FuncLineIdx)
{
