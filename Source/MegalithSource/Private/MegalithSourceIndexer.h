...
class FMegalithSourceIndexer : public FRunnable
{
public:
	FMegalithSourceIndexer();
	~FMegalithSourceIndexer();
...
private:
	...
	void IndexModule(const FModuleEntry& Module, FMegalithSourceDatabase& DB);
	int32 IndexCppFile(const FString& FilePath, int64 ModuleId, FMegalithSourceDatabase& DB);
	int32 IndexShaderFile(const FString& FilePath, int64 ModuleId, FMegalithSourceDatabase& DB);
	void Finalize(FMegalithSourceDatabase& DB);
