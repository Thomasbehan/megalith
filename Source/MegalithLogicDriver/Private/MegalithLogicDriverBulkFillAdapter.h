 ...
 * Self-registers from FMegalithLogicDriverModule::StartupModule.
 *
 ...
 *     in this build" error in FDryRunReport so `megalith_discover("logicdriver")`
 ...
 */
class FMegalithLogicDriverBulkFillAdapter
{
public:
