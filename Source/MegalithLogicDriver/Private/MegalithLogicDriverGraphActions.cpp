...
#include "MegalithLogicDriverInternal.h"
...
DEFINE_LOG_CATEGORY_STATIC(LogMegalithLDGraph, Log, All);

void FMegalithLogicDriverGraphActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	// ── Read (Phase 1) ──
	...
	Registry.RegisterAction(TEXT("logicdriver"), TEXT("get_sm_structure"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetSMStructure),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("logicdriver"), TEXT("get_node_details"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetNodeDetails),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("SM Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("logicdriver"), TEXT("get_node_connections"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetNodeConnections),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("SM Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("logicdriver"), TEXT("find_nodes_by_type"),
		...
		FMegalithActionHandler::CreateStatic(&HandleFindNodesByType),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("SM Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("logicdriver"), TEXT("add_state"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddState),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("SM Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("logicdriver"), TEXT("add_state_machine_node"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddStateMachineNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("SM Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("logicdriver"), TEXT("add_any_state_node"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddAnyStateNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("SM Blueprint asset path"))
			.Optional(TEXT("position_x"), TEXT("number"), TEXT("X position in graph"), TEXT("0"))
			.Optional(TEXT("position_y"), TEXT("number"), TEXT("Y position in graph"), TEXT("0"))
	...
	Registry.RegisterAction(TEXT("logicdriver"), TEXT("set_node_properties"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetNodeProperties),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("SM Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("logicdriver"), TEXT("set_initial_state"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetInitialState),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("SM Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("logicdriver"), TEXT("set_end_state"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetEndState),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("SM Blueprint asset path"))
			.Required(TEXT("node_guid"), TEXT("string"), TEXT("Node GUID"))
	...
	Registry.RegisterAction(TEXT("logicdriver"), TEXT("set_node_class"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetNodeClass),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("SM Blueprint asset path"))
			.Required(TEXT("node_guid"), TEXT("string"), TEXT("Node GUID"))
	...
	Registry.RegisterAction(TEXT("logicdriver"), TEXT("rename_node"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRenameNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("SM Blueprint asset path"))
			.Required(TEXT("node_guid"), TEXT("string"), TEXT("Node GUID"))
	...
	Registry.RegisterAction(TEXT("logicdriver"), TEXT("compile_state_machine"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCompileStateMachine),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("logicdriver"), TEXT("find_nodes_by_class"),
		...
		FMegalithActionHandler::CreateStatic(&HandleFindNodesByClass),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("SM Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("logicdriver"), TEXT("get_sm_statistics"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetSMStatistics),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("SM Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("logicdriver"), TEXT("move_node"),
		...
		FMegalithActionHandler::CreateStatic(&HandleMoveNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("SM Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("logicdriver"), TEXT("auto_arrange_graph"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAutoArrangeGraph),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("SM Blueprint asset path"))
			.Optional(TEXT("formatter"), TEXT("string"), TEXT("Formatter to use: default, blueprint_assist, builtin"), TEXT("default"))
			.Build());

	UE_LOG(LogMegalithLDGraph, Log, TEXT("MegalithLogicDriver Graph: registered 20 actions (6 read + 13 write + compile)"));
}

FMegalithActionResult FMegalithLogicDriverGraphActions::HandleGetSMStructure(const TSharedPtr<FJsonObject>& Params)
{
	...
	FString LoadError;
	UBlueprint* SMBlueprint = MegalithLD::LoadSMBlueprint(AssetPath, LoadError);
	if (!SMBlueprint)
	{
		return FMegalithActionResult::Error(LoadError);
	}

	TSharedPtr<FJsonObject> Structure = MegalithLD::SMStructureToJson(SMBlueprint, Depth);
	if (!Structure.IsValid())
	{
		return FMegalithActionResult::Error(TEXT("Failed to serialize SM structure"));
	}

	return FMegalithActionResult::Success(Structure);
}

FMegalithActionResult FMegalithLogicDriverGraphActions::HandleGetNodeDetails(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (NodeGuid.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("Missing required param 'node_guid'"));
	}
	...
	UEdGraph* RootGraph = MegalithLD::GetRootGraph(SMBlueprint);
	if (!RootGraph)
	{
		return FMegalithActionResult::Error(TEXT("No root SM graph found"));
	}

	UEdGraphNode* Node = MegalithLD::FindNodeByGuid(RootGraph, NodeGuid);
	if (!Node)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Node not found with GUID '%s'"), *NodeGuid));
	}

	// Get detailed node JSON from the helper
	TSharedPtr<FJsonObject> Result = MegalithLD::NodeToJson(Node, /*bDetailed=*/ true);
...
FMegalithActionResult FMegalithLogicDriverGraphActions::HandleGetNodeConnections(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString NodeGuid = Params->GetStringField(TEXT("node_guid"));
	if (AssetPath.IsEmpty())
	...
	for (UEdGraphPin* Pin : Node->Pins)
	{
		...
		for (UEdGraphPin* LinkedPin : Pin->LinkedTo)
		{
			...
			ConnJson->SetStringField(TEXT("type"), MegalithLD::GetNodeType(ConnectedRaw));
...
FMegalithActionResult FMegalithLogicDriverGraphActions::HandleFindNodesByType(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (NodeType.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("Missing required param 'node_type'"));
	}
	...
	for (UEdGraphNode* RawNode : RootGraph->Nodes)
	{
		...
		FString DetectedType = MegalithLD::GetNodeType(RawNode);
		if (DetectedType == NodeType)
		{
			TSharedPtr<FJsonObject> NodeJson = MegalithLD::NodeToJson(RawNode);
...
FMegalithActionResult FMegalithLogicDriverGraphActions::HandleFindNodesByClass(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString ClassName = Params->GetStringField(TEXT("class_name"));
	if (AssetPath.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required param 'asset_path'"));
	if (ClassName.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required param 'class_name'"));

	FString LoadError;
	UBlueprint* SMBlueprint = MegalithLD::LoadSMBlueprint(AssetPath, LoadError);
	if (!SMBlueprint) return FMegalithActionResult::Error(LoadError);

	UEdGraph* RootGraph = MegalithLD::GetRootGraph(SMBlueprint);
	if (!RootGraph) return FMegalithActionResult::Error(TEXT("No root SM graph found"));
	...
	for (UEdGraphNode* RawNode : RootGraph->Nodes)
	{
		...
		{
			TSharedPtr<FJsonObject> NodeJson = MegalithLD::NodeToJson(RawNode, true);
...
FMegalithActionResult FMegalithLogicDriverGraphActions::HandleGetSMStatistics(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required param 'asset_path'"));
	...
	for (UEdGraphNode* RawNode : RootGraph->Nodes)
	{
		...
		FString NodeType = MegalithLD::GetNodeType(RawNode);
		if (NodeType == TEXT("state"))
		{
			StateCount++;
			if (MegalithLD::GetBoolProperty(RawNode, TEXT("bIsEndState")))
			{
				EndStateCount++;
			}
			...
			UClass* BaseClass = MegalithLD::GetSMGraphNodeBaseClass();
...
namespace
{
	...
	void TrySetNodeName(UEdGraphNode* Node, const FString& Name)
	{
		...
		MegalithLD::SetNodeName(Node, Name);
	}
...
FMegalithActionResult FMegalithLogicDriverGraphActions::HandleAddState(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
		return FMegalithActionResult::Error(TEXT("Missing required param 'asset_path'"));
	...
	FString LoadError;
	UBlueprint* BP = MegalithLD::LoadSMBlueprint(AssetPath, LoadError);
	if (!BP) return FMegalithActionResult::Error(LoadError);

	UEdGraph* RootGraph = MegalithLD::GetRootGraph(BP);
	if (!RootGraph) return FMegalithActionResult::Error(TEXT("No root SM graph found"));

	UClass* StateClass = MegalithLD::GetSMGraphNodeStateClass();
	if (!StateClass) return FMegalithActionResult::Error(TEXT("SMGraphNode_StateNode class not found — is Logic Driver loaded?"));
	...
	if (!NewNode) return FMegalithActionResult::Error(TEXT("Failed to create state node"));
	...
	TSharedPtr<FJsonObject> Result = MegalithLD::NodeToJson(NewNode, true);
	Result->SetStringField(TEXT("action"), TEXT("add_state"));
	return FMegalithActionResult::Success(Result);
}

FMegalithActionResult FMegalithLogicDriverGraphActions::HandleAddTransition(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SourceGuid = Params->GetStringField(TEXT("source_guid"));
	FString TargetGuid = Params->GetStringField(TEXT("target_guid"));
	if (AssetPath.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required param 'asset_path'"));
	if (SourceGuid.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required param 'source_guid'"));
	if (TargetGuid.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required param 'target_guid'"));
	...
	UEdGraphNode* SourceNode = MegalithLD::FindNodeByGuid(RootGraph, SourceGuid);
	if (!SourceNode) return FMegalithActionResult::Error(FString::Printf(TEXT("Source node not found: %s"), *SourceGuid));

	UEdGraphNode* TargetNode = MegalithLD::FindNodeByGuid(RootGraph, TargetGuid);
	if (!TargetNode) return FMegalithActionResult::Error(FString::Printf(TEXT("Target node not found: %s"), *TargetGuid));

	UClass* TransClass = MegalithLD::GetSMGraphNodeTransitionClass();
	if (!TransClass) return FMegalithActionResult::Error(TEXT("SMGraphNode_TransitionEdge class not found"));
	...
	if (!TransNode) return FMegalithActionResult::Error(TEXT("Failed to create transition node"));
	...
	TSharedPtr<FJsonObject> Result = MegalithLD::NodeToJson(TransNode, true);
...
FMegalithActionResult FMegalithLogicDriverGraphActions::HandleAddConduit(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required param 'asset_path'"));
	...
	UClass* ConduitClass = MegalithLD::GetSMGraphNodeConduitClass();
	if (!ConduitClass) return FMegalithActionResult::Error(TEXT("SMGraphNode_ConduitNode class not found"));

	int32 PosX = Params->HasField(TEXT("position_x")) ? static_cast<int32>(Params->GetNumberField(TEXT("position_x"))) : 0;
	int32 PosY = Params->HasField(TEXT("position_y")) ? static_cast<int32>(Params->GetNumberField(TEXT("position_y"))) : 0;

	UEdGraphNode* NewNode = CreateGraphNode(RootGraph, ConduitClass, PosX, PosY);
	if (!NewNode) return FMegalithActionResult::Error(TEXT("Failed to create conduit node"));
...
FMegalithActionResult FMegalithLogicDriverGraphActions::HandleAddStateMachineNode(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required param 'asset_path'"));
	...
	UClass* SMNodeClass = MegalithLD::GetSMGraphNodeSMClass();
	if (!SMNodeClass) return FMegalithActionResult::Error(TEXT("SMGraphNode_StateMachineStateNode class not found"));

	int32 PosX = Params->HasField(TEXT("position_x")) ? static_cast<int32>(Params->GetNumberField(TEXT("position_x"))) : 0;
	int32 PosY = Params->HasField(TEXT("position_y")) ? static_cast<int32>(Params->GetNumberField(TEXT("position_y"))) : 0;

	UEdGraphNode* NewNode = CreateGraphNode(RootGraph, SMNodeClass, PosX, PosY);
	if (!NewNode) return FMegalithActionResult::Error(TEXT("Failed to create state machine node"));
...
FMegalithActionResult FMegalithLogicDriverGraphActions::HandleAddAnyStateNode(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required param 'asset_path'"));
	...
	UClass* AnyStateClass = MegalithLD::GetSMGraphNodeAnyStateClass();
	if (!AnyStateClass) return FMegalithActionResult::Error(TEXT("SMGraphNode_AnyStateNode class not found"));

	int32 PosX = Params->HasField(TEXT("position_x")) ? static_cast<int32>(Params->GetNumberField(TEXT("position_x"))) : 0;
	int32 PosY = Params->HasField(TEXT("position_y")) ? static_cast<int32>(Params->GetNumberField(TEXT("position_y"))) : 0;

	UEdGraphNode* NewNode = CreateGraphNode(RootGraph, AnyStateClass, PosX, PosY);
	if (!NewNode) return FMegalithActionResult::Error(TEXT("Failed to create Any State node"));
...
FMegalithActionResult FMegalithLogicDriverGraphActions::HandleRemoveNode(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString NodeGuid = Params->GetStringField(TEXT("node_guid"));
	if (AssetPath.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required param 'asset_path'"));
	if (NodeGuid.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required param 'node_guid'"));
	...
	UEdGraphNode* Node = MegalithLD::FindNodeByGuid(RootGraph, NodeGuid);
	if (!Node) return FMegalithActionResult::Error(FString::Printf(TEXT("Node not found with GUID '%s'"), *NodeGuid));

	// Don't allow removing the entry node
	FString NodeType = MegalithLD::GetNodeType(Node);
	if (NodeType == TEXT("entry"))
	{
		return FMegalithActionResult::Error(TEXT("Cannot remove the entry node"));
	}
...
FMegalithActionResult FMegalithLogicDriverGraphActions::HandleSetNodeProperties(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString NodeGuid = Params->GetStringField(TEXT("node_guid"));
	if (AssetPath.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required param 'asset_path'"));
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing or invalid required param 'properties' (must be an object)"));
	}
...
FMegalithActionResult FMegalithLogicDriverGraphActions::HandleSetInitialState(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString NodeGuid = Params->GetStringField(TEXT("node_guid"));
	if (AssetPath.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required param 'asset_path'"));
	...
	UEdGraphNode* TargetNode = MegalithLD::FindNodeByGuid(RootGraph, NodeGuid);
	if (!TargetNode) return FMegalithActionResult::Error(FString::Printf(TEXT("Node not found with GUID '%s'"), *NodeGuid));

	// Find the entry node — it's the one whose type is "entry"
	UEdGraphNode* EntryNode = nullptr;
	for (UEdGraphNode* N : RootGraph->Nodes)
	{
		if (N && MegalithLD::GetNodeType(N) == TEXT("entry"))
		{
			EntryNode = N;
			break;
		}
	...
	if (!EntryNode)
	{
		return FMegalithActionResult::Error(TEXT("No entry node found in the state machine graph"));
	}
	...
	if (!EntryOutPin)
	{
		return FMegalithActionResult::Error(TEXT("Entry node has no output pin"));
	}
	...
	if (!TargetInPin)
	{
		return FMegalithActionResult::Error(TEXT("Target node has no input pin"));
	}
...
FMegalithActionResult FMegalithLogicDriverGraphActions::HandleSetEndState(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString NodeGuid = Params->GetStringField(TEXT("node_guid"));
	if (AssetPath.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required param 'asset_path'"));
	...
	if (!bSet)
	{
		...
		if (!bSet)
		{
			return FMegalithActionResult::Error(TEXT("Could not find bIsEndState property on this node — is it a state node?"));
		}
	}
...
FMegalithActionResult FMegalithLogicDriverGraphActions::HandleSetNodeClass(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString NodeGuid = Params->GetStringField(TEXT("node_guid"));
	...
	if (AssetPath.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required param 'asset_path'"));
	if (NodeGuid.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required param 'node_guid'"));
	if (ClassPath.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required param 'class_path'"));
	...
	if (!NodeInstanceClass)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Could not find or load class: %s"), *ClassPath));
	}
	...
	if (!bSet)
	{
		return FMegalithActionResult::Error(TEXT("Could not find a suitable class property (NodeInstanceClass, StateClass, etc.) on this node"));
	}
...
FMegalithActionResult FMegalithLogicDriverGraphActions::HandleRenameNode(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString NodeGuid = Params->GetStringField(TEXT("node_guid"));
	...
	if (AssetPath.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required param 'asset_path'"));
	if (NodeGuid.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required param 'node_guid'"));
	if (NewName.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required param 'new_name'"));
	...
	FString OldName = MegalithLD::GetNodeName(Node);

	MegalithLD::SetNodeName(Node, NewName);
...
FMegalithActionResult FMegalithLogicDriverGraphActions::HandleMoveNode(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString NodeGuid = Params->GetStringField(TEXT("node_guid"));
	if (AssetPath.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required param 'asset_path'"));
	if (NodeGuid.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required param 'node_guid'"));
	if (!Params->HasField(TEXT("position_x"))) return FMegalithActionResult::Error(TEXT("Missing required param 'position_x'"));
	if (!Params->HasField(TEXT("position_y"))) return FMegalithActionResult::Error(TEXT("Missing required param 'position_y'"));
...
FMegalithActionResult FMegalithLogicDriverGraphActions::HandleAutoArrangeGraph(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required param 'asset_path'"));
	...
	// Try IMegalithGraphFormatter if not explicitly requesting builtin
	if (FormatterMode != TEXT("builtin"))
	{
		if (IMegalithGraphFormatter::IsAvailable())
		{
			...
			if (Formatter.SupportsGraph(RootGraph))
			{
				...
				{
					return FMegalithActionResult::Error(FString::Printf(TEXT("Formatter failed: %s"), *FormatError));
				}
			}
			else if (FormatterMode == TEXT("blueprint_assist"))
			{
				return FMegalithActionResult::Error(TEXT("External formatter does not support this graph type"));
			}
		}
		else if (FormatterMode == TEXT("blueprint_assist"))
		{
			return FMegalithActionResult::Error(TEXT("No external graph formatter is available (Blueprint Assist not loaded?)"));
		}
	}
	...
	{
		if (!Node) continue;
		if (MegalithLD::GetNodeType(Node) == TEXT("entry"))
		{
			EntryNode = Node;
	...
	if (!InitialState)
	{
		...
		{
			if (!Node) continue;
			FString NT = MegalithLD::GetNodeType(Node);
	...
	if (!InitialState)
	{
		return FMegalithActionResult::Error(TEXT("No state nodes found in graph"));
	}
	...
	{
		if (!Node) continue;
		if (MegalithLD::GetNodeType(Node) != TEXT("transition")) continue;
...
FMegalithActionResult FMegalithLogicDriverGraphActions::HandleCompileStateMachine(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	if (AssetPath.IsEmpty())
	{
	...
	bool bSuccess = MegalithLD::CompileSMBlueprint(SMBlueprint, CompileError);
