...
DEFINE_LOG_CATEGORY_STATIC(LogMegalithLDScaffold, Log, All);
...
void FMegalithLogicDriverScaffoldActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	Registry.RegisterAction(TEXT("logicdriver"), TEXT("scaffold_hello_world_sm"),
		...
		FMegalithActionHandler::CreateStatic(&HandleScaffoldHelloWorldSM),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("logicdriver"), TEXT("scaffold_weapon_sm"),
		...
		FMegalithActionHandler::CreateStatic(&HandleScaffoldWeaponSM),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("logicdriver"), TEXT("scaffold_horror_encounter_sm"),
		...
		FMegalithActionHandler::CreateStatic(&HandleScaffoldHorrorEncounterSM),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("logicdriver"), TEXT("scaffold_game_flow_sm"),
		...
		FMegalithActionHandler::CreateStatic(&HandleScaffoldGameFlowSM),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("logicdriver"), TEXT("scaffold_dialogue_sm"),
		...
		FMegalithActionHandler::CreateStatic(&HandleScaffoldDialogueSM),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("logicdriver"), TEXT("scaffold_quest_sm"),
		...
		FMegalithActionHandler::CreateStatic(&HandleScaffoldQuestSM),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("save_path"), TEXT("Asset path for the new SM"))
			.Required(TEXT("name"), TEXT("string"), TEXT("Asset name"))
	...
	Registry.RegisterAction(TEXT("logicdriver"), TEXT("scaffold_interactable_sm"),
		...
		FMegalithActionHandler::CreateStatic(&HandleScaffoldInteractableSM),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("save_path"), TEXT("Asset path for the new SM"))
			.Required(TEXT("name"), TEXT("string"), TEXT("Asset name"))
	...
	UE_LOG(LogMegalithLDScaffold, Log, TEXT("MegalithLogicDriver Scaffold: registered 7 actions"));
}

FMegalithActionResult FMegalithLogicDriverScaffoldActions::HandleScaffoldHelloWorldSM(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (!SMBlueprint)
	{
		return FMegalithActionResult::Error(TEXT("Created asset is not a Blueprint"));
	}
	...
	if (!RootGraph)
	{
		return FMegalithActionResult::Error(TEXT("No root SM graph found in new Blueprint"));
	}

	UClass* StateClass = MegalithLD::GetSMGraphNodeStateClass();
	if (!StateClass)
	{
		return FMegalithActionResult::Error(TEXT("SMGraphNode_StateNode class not found"));
	}
	...
	{
		return FMegalithActionResult::Error(TEXT("Failed to create one or more state nodes"));
	}
	...
	MegalithLD::SetNodeName(IdleNode, TEXT("Idle"));
	MegalithLD::SetNodeName(ActiveNode, TEXT("Active"));
	MegalithLD::SetNodeName(CompleteNode, TEXT("Complete"));
...
static FMegalithActionResult ScaffoldGeneric(
	...
	int32 InitialStateIndex)
{
	...
	// 1. Create SM Blueprint via factory
	UClass* FactoryClass = MegalithLD::GetSMBlueprintFactoryClass();
	if (!FactoryClass) return FMegalithActionResult::Error(TEXT("SMBlueprintFactory not found. Is Logic Driver Pro loaded?"));
	...
	for (const FScaffoldStateDesc& Desc : StateDescs)
	{
		...
		if (!Node) return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create state: %s"), *Desc.Name));
	...
	{
		MegalithLD::SetNodeName(StateNodes[i], StateDescs[i].Name);
	}
...
FMegalithActionResult FMegalithLogicDriverScaffoldActions::HandleScaffoldDialogueSM(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath = Params->GetStringField(TEXT("save_path"));
	if (SavePath.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required param 'save_path'"));
...
FMegalithActionResult FMegalithLogicDriverScaffoldActions::HandleScaffoldQuestSM(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath = Params->GetStringField(TEXT("save_path"));
	if (SavePath.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required param 'save_path'"));
...
FMegalithActionResult FMegalithLogicDriverScaffoldActions::HandleScaffoldInteractableSM(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath = Params->GetStringField(TEXT("save_path"));
	if (SavePath.IsEmpty()) return FMegalithActionResult::Error(TEXT("Missing required param 'save_path'"));
...
FMegalithActionResult FMegalithLogicDriverScaffoldActions::HandleScaffoldWeaponSM(const TSharedPtr<FJsonObject>& Params)
{
...
FMegalithActionResult FMegalithLogicDriverScaffoldActions::HandleScaffoldHorrorEncounterSM(const TSharedPtr<FJsonObject>& Params)
{
...
FMegalithActionResult FMegalithLogicDriverScaffoldActions::HandleScaffoldGameFlowSM(const TSharedPtr<FJsonObject>& Params)
{
