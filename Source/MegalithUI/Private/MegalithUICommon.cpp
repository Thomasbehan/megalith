...
// baked into public Megalith source.
#include "UObject/Class.h"
#include "UObject/UObjectIterator.h"
#include "UObject/UObjectGlobals.h"
#include "UObject/WeakObjectPtr.h"

DEFINE_LOG_CATEGORY(LogMegalithUISpec);
...
namespace MegalithUI
{
    ...
    UWidgetBlueprint* LoadWidgetBlueprint(const FString& AssetPath, FMegalithActionResult& OutError)
    {
    ...
    namespace
    {
        ...
        //      MegalithUIModule.cpp required for the R3b landing.
