...
void FMegalithUIStylingActions::RegisterActions(FMegalithToolRegistry& Registry)
{
    Registry.RegisterAction(
        TEXT("ui"), TEXT("set_brush"),
        TEXT("Configure a slate brush on any widget property (background, fill image, etc.)"),
        FMegalithActionHandler::CreateStatic(&HandleSetBrush),
        FParamSchemaBuilder()
    ...
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&HandleSetFont),
        FParamSchemaBuilder()
            .RequiredAssetPath(TEXT("asset_path"), TEXT("Widget Blueprint asset path"))
    ...
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&HandleSetColorScheme),
        FParamSchemaBuilder()
    ...
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&HandleBatchStyle),
        FParamSchemaBuilder()
            .RequiredAssetPath(TEXT("asset_path"), TEXT("Widget Blueprint asset path"))
    ...
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&HandleSetText),
        FParamSchemaBuilder()
            .RequiredAssetPath(TEXT("asset_path"), TEXT("Widget Blueprint asset path"))
    ...
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&HandleSetImage),
        FParamSchemaBuilder()
            .RequiredAssetPath(TEXT("asset_path"), TEXT("Widget Blueprint asset path"))
...
// --- set_brush ---
FMegalithActionResult FMegalithUIStylingActions::HandleSetBrush(const TSharedPtr<FJsonObject>& Params)
{
    ...
    if (!Widget)
    {
        ...
        return MegalithUIInternal::MakeErrorFromSpecError(E);
    }
    ...
    if (!Brush)
    {
        return FMegalithActionResult::Error(TEXT("Failed to get brush pointer"));
    }
    ...
    {
        Brush->TintColor = FSlateColor(MegalithUIInternal::ParseColor(TintColor));
        PropsSet++;
    }
    ...
    {
        Brush->OutlineSettings.Color = FSlateColor(MegalithUIInternal::ParseColor(OutlineColor));
        PropsSet++;
    }
    ...
    if (!TexturePath.IsEmpty())
    {
        ...
        {
            return FMegalithActionResult::Error(FString::Printf(TEXT("Texture not found: %s"), *TexturePath));
        }
    }
...
// --- set_font ---
FMegalithActionResult FMegalithUIStylingActions::HandleSetFont(const TSharedPtr<FJsonObject>& Params)
{
    FString AssetPath = Params->GetStringField(TEXT("asset_path"));
    FString WidgetName = Params->GetStringField(TEXT("widget_name"));
    ...
    if (!FontFamily.IsEmpty())
    {
        ...
        {
            return FMegalithActionResult::Error(FString::Printf(TEXT("Font asset not found: %s"), *FontFamily));
        }
    }
    ...
    if (!OutlineColor.IsEmpty())
    {
        FontInfo->OutlineSettings.OutlineColor = MegalithUIInternal::ParseColor(OutlineColor);
        PropsSet++;
    }
...
// --- set_color_scheme ---
FMegalithActionResult FMegalithUIStylingActions::HandleSetColorScheme(const TSharedPtr<FJsonObject>& Params)
{
    const TSharedPtr<FJsonObject>* ColorsObj = nullptr;
    if (!Params->TryGetObjectField(TEXT("colors"), ColorsObj))
    {
        return FMegalithActionResult::Error(TEXT("Missing required param: colors (object with slot names as keys)"));
    }
    ...
    for (const auto& Pair : (*ColorsObj)->Values)
    {
        ...
        FLinearColor Color = MegalithUIInternal::ParseColor(ColorStr);
    ...
    if (SlotsSet == 0)
    {
        return FMegalithActionResult::Error(TEXT("No colors specified in the colors object"));
    }
...
// --- batch_style ---
FMegalithActionResult FMegalithUIStylingActions::HandleBatchStyle(const TSharedPtr<FJsonObject>& Params)
{
    FString AssetPath = Params->GetStringField(TEXT("asset_path"));
    ...
    UClass* TargetClass = MegalithUIInternal::WidgetClassFromName(WidgetClassName);
    if (!TargetClass)
    {
        return FMegalithActionResult::Error(
...
// --- set_text ---
FMegalithActionResult FMegalithUIStylingActions::HandleSetText(const TSharedPtr<FJsonObject>& Params)
{
    FString AssetPath = Params->GetStringField(TEXT("asset_path"));
    FString WidgetName = Params->GetStringField(TEXT("widget_name"));
    ...
    if (UTextBlock* TB = Cast<UTextBlock>(Widget))
    {
        ...
        {
            TB->SetColorAndOpacity(FSlateColor(MegalithUIInternal::ParseColor(TextColor)));
            PropsSet++;
        }
...
// --- set_image ---
FMegalithActionResult FMegalithUIStylingActions::HandleSetImage(const TSharedPtr<FJsonObject>& Params)
{
    FString AssetPath = Params->GetStringField(TEXT("asset_path"));
    FString WidgetName = Params->GetStringField(TEXT("widget_name"));
    ...
    if (!TintColor.IsEmpty())
    {
        ImageWidget->SetColorAndOpacity(MegalithUIInternal::ParseColor(TintColor));
        PropsSet++;
    }
