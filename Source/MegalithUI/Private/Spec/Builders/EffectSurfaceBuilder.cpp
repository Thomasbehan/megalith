...
namespace MegalithUI::EffectSurfaceBuilderInternal
{
    /**
...
bool MegalithUI::EffectSurfaceBuilder::ApplyEffect(
    FUIBuildContext& Context,
    const FUISpecNode& Node,
    UWidget* Widget)
{
    using namespace MegalithUI::EffectSurfaceBuilderInternal;
    ...
    const FName WidgetToken = MegalithUI::MakeTokenFromClassName(Widget->GetClass());
