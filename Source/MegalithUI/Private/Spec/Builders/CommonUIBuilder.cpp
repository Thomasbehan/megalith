...
namespace MegalithUI::CommonUIBuilderInternal
{
#if WITH_COMMONUI
    /**
        ...
        const FUISpecNode& Node)
    {
        ...
        W.SuggestedFix = TEXT("Install/enable the CommonUI plugin and rebuild Megalith.");
        Context.Warnings.Add(MoveTemp(W));
    }
#endif
} // namespace MegalithUI::CommonUIBuilderInternal
...
bool MegalithUI::CommonUIBuilder::ApplyCommonUI(
    FUIBuildContext& Context,
    const FUISpecNode& Node,
    UWidget* Widget)
{
    using namespace MegalithUI::CommonUIBuilderInternal;
