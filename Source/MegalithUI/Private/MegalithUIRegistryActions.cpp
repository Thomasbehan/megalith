...
#include "MegalithUICommon.h"  // MegalithUI::LoadWidgetBlueprint
#include "Components/Widget.h"
#include "Blueprint/WidgetTree.h"

namespace MegalithUIRegistryPhase2
{
    ...
    static FMegalithActionResult HandleAddWidgetVariable(const TSharedPtr<FJsonObject>& Params)
    {
        if (!Params.IsValid())
        {
            return FMegalithActionResult::Error(TEXT("Missing parameters object."), -32602);
        }
        ...
        if (WbpPath.IsEmpty())
        {
            return FMegalithActionResult::Error(TEXT("wbp_path (or asset_path) required"), -32602);
        }

        FString VarName, VarType;
        if (!Params->TryGetStringField(TEXT("var_name"), VarName) || VarName.IsEmpty())
        {
            return FMegalithActionResult::Error(TEXT("Required parameter 'var_name' missing or empty."), -32602);
        }
        ...
        UWidgetBlueprint* WBP = MegalithUI::LoadWidgetBlueprint(WbpPath, LoadErr);
        ...
        FString TypeError;
        if (!MegalithPinTypeGrammar::TryParsePinType(VarType, PinType, TypeError))
        {
            return FMegalithActionResult::Error(
    ...
    // here since MegalithUI links UMG. MegalithBlueprint's get_variables reads
    ...
    static FMegalithActionResult HandleSetWidgetIsVariable(const TSharedPtr<FJsonObject>& Params)
    {
        if (!Params.IsValid())
        {
            return FMegalithActionResult::Error(TEXT("Missing parameters object."), -32602);
        ...
        {
            return FMegalithActionResult::Error(TEXT("Required parameter 'widget_name' missing or empty."), -32602);
        }

        bool bIsVariable = false;
        if (!Params->TryGetBoolField(TEXT("is_variable"), bIsVariable))
        {
            return FMegalithActionResult::Error(TEXT("Required parameter 'is_variable' (bool) missing."), -32602);
        }
    ...
    static FMegalithActionResult HandleListWidgetPropertyEnums(const TSharedPtr<FJsonObject>& Params)
    {
        if (!Params.IsValid())
        {
            return FMegalithActionResult::Error(TEXT("Missing parameters object."), -32602);
...
void FMegalithUIRegistryActions::RegisterActions(FMegalithToolRegistry& Registry)
{
    Registry.RegisterAction(
        TEXT("ui"), TEXT("dump_property_allowlist"),
        TEXT("Dump the property allowlist for a widget type. Returns {type, allowed_paths:[...]}."),
        FMegalithActionHandler::CreateStatic(&HandleDumpPropertyAllowlist),
        FParamSchemaBuilder()
    ...
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&MegalithUIRegistryPhase2::HandleAddWidgetVariable),
        FParamSchemaBuilder()
    ...
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&MegalithUIRegistryPhase2::HandleSetWidgetIsVariable),
        FParamSchemaBuilder()
    ...
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&MegalithUIRegistryPhase2::HandleListWidgetPropertyEnums),
        FParamSchemaBuilder()
...
FMegalithActionResult FMegalithUIRegistryActions::HandleDumpPropertyAllowlist(const TSharedPtr<FJsonObject>& Params)
{
    if (!Params.IsValid())
    {
        return FMegalithActionResult::Error(TEXT("Missing parameters object."), -32602);
    ...
    {
        return FMegalithActionResult::Error(TEXT("Required parameter 'widget_type' missing or empty."), -32602);
    }
    ...
    {
        return FMegalithActionResult::Error(
            TEXT("UMegalithUIRegistrySubsystem not available — editor not initialised?"), -32603);
    }
