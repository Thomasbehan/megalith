...
// here rather than as static members on FMegalithUIActions because the plan
...
namespace MegalithUIActionsPhase2
{
    static FMegalithActionResult HandleRenameWidget(const TSharedPtr<FJsonObject>& Params);
    static FMegalithActionResult HandleDumpBlueprintCompileLog(const TSharedPtr<FJsonObject>& Params);
}

void FMegalithUIActions::RegisterActions(FMegalithToolRegistry& Registry)
{
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&HandleCreateWidgetBlueprint),
        FParamSchemaBuilder()
    ...
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&HandleGetWidgetTree),
        FParamSchemaBuilder()
    ...
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&HandleAddWidget),
        FParamSchemaBuilder()
            .RequiredAssetPath(TEXT("asset_path"), TEXT("Widget Blueprint asset path"))
    ...
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&HandleRemoveWidget),
        FParamSchemaBuilder()
            .RequiredAssetPath(TEXT("asset_path"), TEXT("Widget Blueprint asset path"))
    ...
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&HandleSetWidgetProperty),
        FParamSchemaBuilder()
            .RequiredAssetPath(TEXT("asset_path"), TEXT("Widget Blueprint asset path"))
    ...
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&HandleCompileWidget),
        FParamSchemaBuilder()
            .RequiredAssetPath(TEXT("asset_path"), TEXT("Widget Blueprint asset path"))
            .Build()
    );
    ...
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&HandleListWidgetTypes),
        FParamSchemaBuilder()
    ...
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&MegalithUIActionsPhase2::HandleRenameWidget),
        FParamSchemaBuilder()
    ...
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&MegalithUIActionsPhase2::HandleDumpBlueprintCompileLog),
        FParamSchemaBuilder()
...
FMegalithActionResult FMegalithUIActions::HandleCreateWidgetBlueprint(const TSharedPtr<FJsonObject>& Params)
{
    FMegalithActionResult ParamError;
    FString SavePath;
    if (!MegalithUIInternal::TryGetRequiredString(Params, TEXT("save_path"), SavePath, ParamError))
    {
        return ParamError;
    }
    ...
    if (const FString ValidationError = MegalithCore::ValidatePackagePath(SavePath); !ValidationError.IsEmpty())
    {
        return FMegalithActionResult::Error(ValidationError);
    }

    FString ParentClassName = MegalithUIInternal::GetOptionalString(Params, TEXT("parent_class"));
    if (ParentClassName.IsEmpty()) ParentClassName = TEXT("UserWidget");

    FString RootWidgetType = MegalithUIInternal::GetOptionalString(Params, TEXT("root_widget"));
    if (RootWidgetType.IsEmpty()) RootWidgetType = TEXT("CanvasPanel");

    const bool bSkipSave = MegalithUIInternal::GetOptionalBool(Params, TEXT("skip_save"), false);
    ...
    if (!ParentClass || !ParentClass->IsChildOf(UUserWidget::StaticClass()))
    {
        ...
        return MegalithUIInternal::MakeErrorFromSpecError(MegalithUIInternal::MakeSpecError(
            TEXT("Type"),
            TEXT("/parent_class"),
    ...
    {
        return FMegalithActionResult::Error(TEXT("Invalid save_path — must contain at least one / separator"));
    }
    ...
    if (!WBP)
    {
        return FMegalithActionResult::Error(TEXT("UWidgetBlueprintFactory::FactoryCreateNew returned null"));
    }

    // Set root widget if tree is empty
    if (WBP->WidgetTree && !WBP->WidgetTree->RootWidget)
    {
        UClass* RootClass = MegalithUIInternal::WidgetClassFromName(RootWidgetType);
        if (RootClass && RootClass->IsChildOf(UPanelWidget::StaticClass()))
        {
            ...
            MegalithUIInternal::RegisterCreatedWidget(WBP, Root);
        }
    }

    // Compile
    MegalithUIInternal::ReconcileWidgetVariableGuids(WBP);
...
// --- get_widget_tree ---
FMegalithActionResult FMegalithUIActions::HandleGetWidgetTree(const TSharedPtr<FJsonObject>& Params)
{
    FString AssetPath;
    if (!Params.IsValid() || !Params->TryGetStringField(TEXT("asset_path"), AssetPath) || AssetPath.IsEmpty())
    {
        return FMegalithActionResult::Error(TEXT("missing required asset_path parameter"));
    }
    ...
    if (!WBP->WidgetTree)
    {
        return FMegalithActionResult::Error(TEXT("WidgetTree is null (editor-only data not available)"));
    }
    ...
    {
        Result->SetObjectField(TEXT("root"), MegalithUIInternal::SerializeWidget(WBP->WidgetTree->RootWidget));
    }
...
// --- add_widget ---
FMegalithActionResult FMegalithUIActions::HandleAddWidget(const TSharedPtr<FJsonObject>& Params)
{
    FMegalithActionResult ParamError;
    FString AssetPath;
    if (!MegalithUIInternal::TryGetRequiredString(Params, TEXT("asset_path"), AssetPath, ParamError))
    {
        return ParamError;
    }

    FString WidgetClassName;
    if (!MegalithUIInternal::TryGetRequiredString(Params, TEXT("widget_class"), WidgetClassName, ParamError))
    {
        return ParamError;
    }
    ...
    UClass* WidgetClass = MegalithUIInternal::WidgetClassFromName(WidgetClassName);
    if (!WidgetClass)
    {
    ...
    // Widget name
    FString WidgetName = MegalithUIInternal::GetOptionalString(Params, TEXT("widget_name"));
    FName WidgetFName = WidgetName.IsEmpty() ? NAME_None : FName(*WidgetName);

    // Find parent widget
    UPanelWidget* ParentPanel = nullptr;
    FString ParentName = MegalithUIInternal::GetOptionalString(Params, TEXT("parent_name"));
    ...
    if (!Slot)
    {
        ...
        return FMegalithActionResult::Error(TEXT("AddChild returned null slot"));
    }
    ...
    {
        // Anchor preset
        FString AnchorPreset = MegalithUIInternal::GetOptionalString(Params, TEXT("anchor_preset"));
        if (!AnchorPreset.IsEmpty())
        {
            CSlot->SetAnchors(MegalithUIInternal::GetAnchorPreset(AnchorPreset));
        }
        ...
        // Auto-size
        CSlot->SetAutoSize(MegalithUIInternal::GetOptionalBool(Params, TEXT("auto_size"), CSlot->GetAutoSize()));
    }

    // Configure box/overlay slot alignment
    FString HAlign = MegalithUIInternal::GetOptionalString(Params, TEXT("h_align"));
    FString VAlign = MegalithUIInternal::GetOptionalString(Params, TEXT("v_align"));
    ...
    MegalithUIInternal::RegisterCreatedWidget(WBP, NewWidget);

    // Mark modified
    FBlueprintEditorUtils::MarkBlueprintAsStructurallyModified(WBP);

    // Compile if requested
    const bool bCompile = MegalithUIInternal::GetOptionalBool(Params, TEXT("compile"), true);
    if (bCompile)
    {
        FKismetEditorUtilities::CompileBlueprint(WBP);
    }
...
// --- remove_widget ---
FMegalithActionResult FMegalithUIActions::HandleRemoveWidget(const TSharedPtr<FJsonObject>& Params)
{
    FString AssetPath = Params->GetStringField(TEXT("asset_path"));
    FString WidgetName = Params->GetStringField(TEXT("widget_name"));
    if (WidgetName.IsEmpty())
    {
        return FMegalithActionResult::Error(TEXT("Missing required param: widget_name"));
    }
    ...
    {
        return FMegalithActionResult::Error(TEXT("Cannot remove the root widget"));
    }
    ...
    bool bCompile = true;
    bCompile = MegalithUIInternal::GetOptionalBool(Params, TEXT("compile"), true);
...
// shapes survive.
FMegalithActionResult FMegalithUIActions::HandleSetWidgetProperty(const TSharedPtr<FJsonObject>& Params)
{
    if (!Params.IsValid())
    {
        return FMegalithActionResult::Error(TEXT("set_widget_property: Params is null"));
    }

    FString AssetPath = Params->GetStringField(TEXT("asset_path"));
    FString WidgetName = Params->GetStringField(TEXT("widget_name"));
    FString PropertyName = Params->GetStringField(TEXT("property_name"));
    const bool bRawMode = MegalithUIInternal::GetOptionalBool(Params, TEXT("raw_mode"), false);
    ...
    UMegalithUIRegistrySubsystem* Sub = UMegalithUIRegistrySubsystem::Get();
    ...
    if (ApplyRes.bSuccess)
    {
        ...
        const bool bCompile = MegalithUIInternal::GetOptionalBool(Params, TEXT("compile"), false);
        if (bCompile) FKismetEditorUtilities::CompileBlueprint(WBP);
    ...
    FUISpecError E = MegalithUIInternal::MakeSpecError(
        Category,
    ...
    // not internal-error.
    return MegalithUIInternal::MakeErrorFromSpecError(E, -32602);
}
...
// MegalithBlueprintCompileActions.cpp:80 (HandleCompileBlueprint).
FMegalithActionResult FMegalithUIActions::HandleCompileWidget(const TSharedPtr<FJsonObject>& Params)
{
    FString AssetPath = Params->GetStringField(TEXT("asset_path"));
    FMegalithActionResult Err;
    UWidgetBlueprint* WBP = MegalithUIInternal::LoadWidgetBlueprint(AssetPath, Err);
    ...
    // error/warning messages — the dispatcher (MegalithHttpServer:716)
    // surfaces only the FMegalithActionResult::ErrorMessage text on a failed
    ...
    if (WBP->Status == BS_Error)
    {
        ...
        return MegalithUIInternal::MakeErrorFromSpecError(E, -32603);
    }
...
// --- list_widget_types ---
FMegalithActionResult FMegalithUIActions::HandleListWidgetTypes(const TSharedPtr<FJsonObject>& Params)
{
    FString Filter = MegalithUIInternal::GetOptionalString(Params, TEXT("filter"));
...
// are file-static rather than members of FMegalithUIActions so the migration
...
namespace MegalithUIActionsPhase2
{
    ...
    static FMegalithActionResult HandleRenameWidget(const TSharedPtr<FJsonObject>& Params)
    {
        ...
        // convention) are accepted — matches MegalithCommonUI::GetWbpPath.
        FString WbpPath;
        if (!Params.IsValid()
        ...
        FMegalithActionResult ParamError;
        if (!MegalithUIInternal::TryGetRequiredString(Params, TEXT("old_name"), OldName, ParamError))
            return ParamError;
        if (!MegalithUIInternal::TryGetRequiredString(Params, TEXT("new_name"), NewName, ParamError))
            return ParamError;
        ...
        UWidgetBlueprint* WBP = MegalithUIInternal::LoadWidgetBlueprint(WbpPath, LoadErr);
        if (!WBP) return LoadErr;
        if (!WBP->WidgetTree)
        {
            return FMegalithActionResult::Error(TEXT("WidgetTree is null (editor-only data not available)"), -32603);
        }
    ...
    FMegalithActionResult HandleDumpBlueprintCompileLog(const TSharedPtr<FJsonObject>& Params)
    {
        FString AssetPath;
        FMegalithActionResult ParamError;
        if (!MegalithUIInternal::TryGetRequiredString(Params, TEXT("asset_path"), AssetPath, ParamError))
