// MegalithUIAnimationActions.cpp
...
void FMegalithUIAnimationActions::RegisterActions(FMegalithToolRegistry& Registry)
{
    Registry.RegisterAction(
        TEXT("ui"), TEXT("list_animations"),
        TEXT("List all UWidgetAnimation assets on a Widget Blueprint"),
        FMegalithActionHandler::CreateStatic(&HandleListAnimations),
        FParamSchemaBuilder()
    ...
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&HandleGetAnimationDetails),
        FParamSchemaBuilder()
            .RequiredAssetPath(TEXT("asset_path"), TEXT("Widget Blueprint asset path"))
    ...
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&HandleCreateAnimation),
        FParamSchemaBuilder()
            .RequiredAssetPath(TEXT("asset_path"), TEXT("Widget Blueprint asset path"))
    ...
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&HandleAddAnimationKeyframe),
        FParamSchemaBuilder()
            .RequiredAssetPath(TEXT("asset_path"), TEXT("Widget Blueprint asset path"))
            .Required(TEXT("animation_name"), TEXT("string"), TEXT("Name of the UWidgetAnimation"))
    ...
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&HandleRemoveAnimation),
        FParamSchemaBuilder()
            .RequiredAssetPath(TEXT("asset_path"), TEXT("Widget Blueprint asset path"))
...
// --- list_animations ---
FMegalithActionResult FMegalithUIAnimationActions::HandleListAnimations(const TSharedPtr<FJsonObject>& Params)
{
...
FMegalithActionResult FMegalithUIAnimationActions::HandleGetAnimationDetails(const TSharedPtr<FJsonObject>& Params)
{
    FString AssetPath = Params->GetStringField(TEXT("asset_path"));
    ...
    if (!MovieScene)
    {
        return FMegalithActionResult::Error(TEXT("Animation has no MovieScene"));
    }
...
// --- create_animation ---
FMegalithActionResult FMegalithUIAnimationActions::HandleCreateAnimation(const TSharedPtr<FJsonObject>& Params)
{
    FString AssetPath = Params->GetStringField(TEXT("asset_path"));
    FString AnimationName = Params->GetStringField(TEXT("animation_name"));
    ...
    {
        return FMegalithActionResult::Error(TEXT("Missing required param: animation_name"));
    }
    if (Duration <= 0.0)
    {
    ...
    MegalithUIInternal::RegisterVariableName(WBP, NewAnim->GetFName());
...
FMegalithActionResult FMegalithUIAnimationActions::HandleAddAnimationKeyframe(const TSharedPtr<FJsonObject>& Params)
{
    FString AssetPath = Params->GetStringField(TEXT("asset_path"));
    FString AnimationName = Params->GetStringField(TEXT("animation_name"));
...
// --- remove_animation ---
FMegalithActionResult FMegalithUIAnimationActions::HandleRemoveAnimation(const TSharedPtr<FJsonObject>& Params)
{
    FString AssetPath = Params->GetStringField(TEXT("asset_path"));
    FString AnimationName = Params->GetStringField(TEXT("animation_name"));
