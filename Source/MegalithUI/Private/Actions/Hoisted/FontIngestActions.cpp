...
namespace MegalithUI::FontIngestInternal
{
    /**
...
FMegalithActionResult MegalithUI::FFontIngestActions::HandleImportFontFamily(const TSharedPtr<FJsonObject>& Params)
{
    using namespace MegalithUI::FontIngestInternal;
    ...
    {
        return FMegalithActionResult::Error(TEXT("Missing or empty required param: family_name"), -32602);
    }
    ...
    {
        return FMegalithActionResult::Error(TEXT("faces must be a non-empty array"), -32602);
    }
    ...
    if (!FamilyFont)
    {
        return FMegalithActionResult::Error(TEXT("NewObject<UFont> failed for family asset"), -32603);
    }
...
void MegalithUI::FFontIngestActions::Register(FMegalithToolRegistry& Registry)
{
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&MegalithUI::FFontIngestActions::HandleImportFontFamily));
}
