...
namespace MegalithUI::AnimationInternal
{
...
// -----------------------------------------------------------------------------
// Phase I — public-to-MegalithUI helper surface.
//
...
FMegalithActionResult MegalithUI::FAnimationCoreActions::HandleCreateAnimationV2(
    const TSharedPtr<FJsonObject>& Params)
{
    using namespace MegalithUI::AnimationInternal;

    if (!Params.IsValid())
    {
        return FMegalithActionResult::Error(TEXT("Missing params object"), -32602);
    }

    FString AssetPath;
    if (!Params->TryGetStringField(TEXT("asset_path"), AssetPath) || AssetPath.IsEmpty())
    {
        return FMegalithActionResult::Error(TEXT("Missing or empty required param: asset_path"), -32602);
    }
    FString AnimName;
    if (!Params->TryGetStringField(TEXT("animation_name"), AnimName) || AnimName.IsEmpty())
    {
        return FMegalithActionResult::Error(TEXT("Missing or empty required param: animation_name"), -32602);
    }
    double DurationSec = 0.0;
    if (!Params->TryGetNumberField(TEXT("duration_sec"), DurationSec) || DurationSec <= 0.0)
    {
        return FMegalithActionResult::Error(TEXT("duration_sec must be a positive number"), -32602);
    }
    ...
    {
        return FMegalithActionResult::Error(TEXT("tracks must be a non-empty array"), -32602);
    }
    ...
    {
        return FMegalithActionResult::Error(TEXT("Failed to create UWidgetAnimation or MovieScene"), -32603);
    }
...
#else
    return FMegalithActionResult::Error(TEXT("Animation authoring requires editor (WITH_EDITORONLY_DATA)"), -32603);
#endif
}


FMegalithActionResult MegalithUI::FAnimationCoreActions::HandleAddBezierEasedSegment(
    const TSharedPtr<FJsonObject>& Params)
{
    using namespace MegalithUI::AnimationInternal;
    ...
    {
        return FMegalithActionResult::Error(TEXT("Missing or empty required param: widget_name"), -32602);
    }
    FString PropertyName;
    if (!Params->TryGetStringField(TEXT("property"), PropertyName) || PropertyName.IsEmpty())
    {
        return FMegalithActionResult::Error(TEXT("Missing or empty required param: property"), -32602);
    }

    double FromValue = 0.0, ToValue = 0.0;
    if (!Params->TryGetNumberField(TEXT("from_value"), FromValue))
    {
        return FMegalithActionResult::Error(TEXT("Missing required param: from_value"), -32602);
    }
    if (!Params->TryGetNumberField(TEXT("to_value"), ToValue))
    {
        return FMegalithActionResult::Error(TEXT("Missing required param: to_value"), -32602);
    }

    double StartTime = 0.0, EndTime = 0.0;
    if (!Params->TryGetNumberField(TEXT("start_time"), StartTime))
    {
        return FMegalithActionResult::Error(TEXT("Missing required param: start_time"), -32602);
    }
    if (!Params->TryGetNumberField(TEXT("end_time"), EndTime))
    {
        return FMegalithActionResult::Error(TEXT("Missing required param: end_time"), -32602);
    }
    if (EndTime <= StartTime)
    {
        return FMegalithActionResult::Error(TEXT("end_time must be greater than start_time"), -32602);
    }
    ...
    {
        return FMegalithActionResult::Error(TEXT("bezier must be an array of exactly 4 numbers [x1, y1, x2, y2]"), -32602);
    }
...
FMegalithActionResult MegalithUI::FAnimationCoreActions::HandleBakeSpringAnimation(
    const TSharedPtr<FJsonObject>& Params)
{
    using namespace MegalithUI::AnimationInternal;
    ...
    {
        return FMegalithActionResult::Error(TEXT("stiffness must be a positive number"), -32602);
    }
    if (!Params->TryGetNumberField(TEXT("damping"), Damping) || Damping < 0.0)
    {
        return FMegalithActionResult::Error(TEXT("damping must be a non-negative number"), -32602);
    }
    if (!Params->TryGetNumberField(TEXT("mass"), Mass) || Mass <= 0.0)
    {
        return FMegalithActionResult::Error(TEXT("mass must be a positive number"), -32602);
    }
    ...
    if (Fps <= 0.0)
    {
        return FMegalithActionResult::Error(TEXT("fps must be a positive number"), -32602);
    }
    ...
    if (DurationSec <= 0.0)
    {
        return FMegalithActionResult::Error(TEXT("duration must be a positive number"), -32602);
    }
...
void MegalithUI::FAnimationCoreActions::Register(FMegalithToolRegistry& Registry)
{
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&MegalithUI::FAnimationCoreActions::HandleCreateAnimationV2));
    ...
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&MegalithUI::FAnimationCoreActions::HandleAddBezierEasedSegment));
    ...
    Registry.RegisterAction(
        ...
        TEXT("Bakes a damped harmonic spring simulation into dense linear keyframes on a WBP animation. "
             ...
             "compile_once (bool, optional, default true)."),
        FMegalithActionHandler::CreateStatic(&MegalithUI::FAnimationCoreActions::HandleBakeSpringAnimation));
}
