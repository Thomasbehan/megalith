...
// MegalithUI shared color parser.
#include "MegalithUICommon.h"

namespace MegalithUI::RoundedCornerInternal
{
    /**
...
FMegalithActionResult MegalithUI::FRoundedCornerActions::HandleSetRoundedCorners(const TSharedPtr<FJsonObject>& Params)
{
    using namespace MegalithUI::RoundedCornerInternal;
    ...
    if (bHasOutlineColor && !MegalithUI::TryParseColor(OutlineColorStr, OutlineColor))
    {
        return FMegalithActionResult::Error(
    ...
    if (bHasFillColor && !MegalithUI::TryParseColor(FillColorStr, FillColor))
    {
        return FMegalithActionResult::Error(
...
void MegalithUI::FRoundedCornerActions::Register(FMegalithToolRegistry& Registry)
{
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&MegalithUI::FRoundedCornerActions::HandleSetRoundedCorners));
}
