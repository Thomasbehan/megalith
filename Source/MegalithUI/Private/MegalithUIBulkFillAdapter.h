...
// Pattern: mirrors Phase 1 Plugins/Megalith/Source/MegalithBlueprint/Private/MegalithBlueprintBulkFillAdapter.h,
// Phase 2 Plugins/Megalith/Source/MegalithGAS/Private/MegalithGASBulkFillAdapter.h,
// and the per-namespace adapters in the other Megalith modules.
//
// H5 stub-adapter invariant: Register() ALWAYS runs from FMegalithUIModule::StartupModule,
 ...
 * Self-registers with FMegalithBulkFillRegistry from FMegalithUIModule::StartupModule.
 *
 ...
 */
class FMegalithUIBulkFillAdapter
{
public:
	/** Register the adapter pair with FMegalithBulkFillRegistry under namespace "ui". */
	static void Register();

	/** Unregister (called from FMegalithUIModule::ShutdownModule). */
