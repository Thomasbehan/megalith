...
FString FMegalithUISettingsActions::ResolveSourceDir(const FString& ModuleName, FMegalithActionResult& OutError)
{
...
bool FMegalithUISettingsActions::WriteSourceFiles(const FString& Dir, const FString& ClassName,
...
void FMegalithUISettingsActions::RegisterActions(FMegalithToolRegistry& Registry)
{
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&HandleScaffoldGameUserSettings),
        FParamSchemaBuilder()
    ...
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&HandleScaffoldSaveGame),
        FParamSchemaBuilder()
    ...
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&HandleScaffoldSaveSubsystem),
        FParamSchemaBuilder()
    ...
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&HandleScaffoldAudioSettings),
        FParamSchemaBuilder()
    ...
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&HandleScaffoldInputRemapping),
        FParamSchemaBuilder()
...
FMegalithActionResult FMegalithUISettingsActions::HandleScaffoldGameUserSettings(const TSharedPtr<FJsonObject>& Params)
{
    ...
    {
        return FMegalithActionResult::Error(TEXT("Missing required params: class_name, module_name"));
    }
    ...
    // ---- Header ----
    FString Header;
    Header += TEXT("// Auto-generated by Megalith scaffold_game_user_settings\n");
    ...
    // ---- Cpp ----
    FString Cpp;
    Cpp += TEXT("// Auto-generated by Megalith scaffold_game_user_settings\n");
...
FMegalithActionResult FMegalithUISettingsActions::HandleScaffoldSaveGame(const TSharedPtr<FJsonObject>& Params)
{
    FString ClassName = Params->GetStringField(TEXT("class_name"));
    FString ModuleName = Params->GetStringField(TEXT("module_name"));
    if (ClassName.IsEmpty() || ModuleName.IsEmpty())
    ...
    // ---- Header ----
    FString Header;
    Header += TEXT("// Auto-generated by Megalith scaffold_save_game\n");
    Header += TEXT("#pragma once\n\n");
    Header += TEXT("#include \"CoreMinimal.h\"\n");
    ...
    // ---- Cpp ----
    FString Cpp;
    Cpp += TEXT("// Auto-generated by Megalith scaffold_save_game\n");
    Cpp += FString::Printf(TEXT("#include \"%s.h\"\n\n"), *CleanName);
...
FMegalithActionResult FMegalithUISettingsActions::HandleScaffoldSaveSubsystem(const TSharedPtr<FJsonObject>& Params)
{
    FString ClassName = Params->GetStringField(TEXT("class_name"));
    FString ModuleName = Params->GetStringField(TEXT("module_name"));
    ...
    {
        return FMegalithActionResult::Error(TEXT("Missing required params: class_name, module_name, save_game_class"));
    }
    ...
    // ---- Header ----
    FString Header;
    Header += TEXT("// Auto-generated by Megalith scaffold_save_subsystem\n");
    Header += TEXT("#pragma once\n\n");
    Header += TEXT("#include \"CoreMinimal.h\"\n");
    ...
    // ---- Cpp ----
    FString Cpp;
    Cpp += TEXT("// Auto-generated by Megalith scaffold_save_subsystem\n");
    Cpp += FString::Printf(TEXT("#include \"%s.h\"\n"), *CleanName);
    Cpp += FString::Printf(TEXT("#include \"%s.h\"\n"), *CleanSaveClass);
    Cpp += TEXT("#include \"Kismet/GameplayStatics.h\"\n\n");
...
FMegalithActionResult FMegalithUISettingsActions::HandleScaffoldAudioSettings(const TSharedPtr<FJsonObject>& Params)
{
    // Parse categories
...
FMegalithActionResult FMegalithUISettingsActions::HandleScaffoldInputRemapping(const TSharedPtr<FJsonObject>& Params)
{
    // Parse actions
