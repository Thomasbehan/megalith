...
namespace MegalithCommonUI
{
	 ...
	 */
	MEGALITHUI_API FMegalithActionResult CreateAsset(
		UClass* AssetClass,
	 ...
	 */
	MEGALITHUI_API FMegalithActionResult LoadWidgetForMutation(
	 ...
	 */
	MEGALITHUI_API FMegalithActionResult CompileAndSaveWidgetBlueprint(UWidgetBlueprint* Wbp);
	 ...
	 */
	MEGALITHUI_API FMegalithActionResult InvokeRuntimeFunction(
		UObject* Target,
	 ...
	 */
	MEGALITHUI_API bool SetPropertyFromJson(
		UObject* Container,
		FProperty* Property,
	 ...
	 * Use at handler entry for [RUNTIME] actions: nullptr → FMegalithActionResult::Error(...).
	 */
	MEGALITHUI_API UWorld* GetPIEWorld();
}
