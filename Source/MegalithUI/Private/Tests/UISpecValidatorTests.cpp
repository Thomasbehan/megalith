...
/**
 * MegalithUI.SpecValidator.Empty
 *
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUISpecValidatorEmptyTest,
    "MegalithUI.SpecValidator.Empty",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUISpecValidatorEmptyTest::RunTest(const FString& /*Parameters*/)
{
...
/**
 * MegalithUI.SpecValidator.MalformedJson
 *
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUISpecValidatorMalformedJsonTest,
    "MegalithUI.SpecValidator.MalformedJson",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUISpecValidatorMalformedJsonTest::RunTest(const FString& /*Parameters*/)
{
