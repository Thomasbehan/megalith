...
/**
 * MegalithUI.Cache.GetPopulatesAndHits (C1)
 *
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUICacheGetPopulatesAndHitsTest,
    "MegalithUI.Cache.GetPopulatesAndHits",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUICacheGetPopulatesAndHitsTest::RunTest(const FString& /*Parameters*/)
{
...
/**
 * MegalithUI.Cache.NestedPathResolves
 *
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUICacheNestedPathTest,
    "MegalithUI.Cache.NestedPathResolves",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUICacheNestedPathTest::RunTest(const FString& /*Parameters*/)
{
    FUIPropertyPathCache LocalCache;
...
/**
 * MegalithUI.Cache.InvalidPathReturnsInvalidChain
 *
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUICacheInvalidPathTest,
    "MegalithUI.Cache.InvalidPathReturnsInvalidChain",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUICacheInvalidPathTest::RunTest(const FString& /*Parameters*/)
{
    FUIPropertyPathCache LocalCache;
...
/**
 * MegalithUI.Cache.UnknownRootStructReturnsInvalid
 *
 * Asking for a root struct name that doesn't resolve via FindObject must
 * return an invalid chain rather than crash.
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUICacheUnknownRootTest,
    "MegalithUI.Cache.UnknownRootStructReturnsInvalid",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUICacheUnknownRootTest::RunTest(const FString& /*Parameters*/)
{
    FUIPropertyPathCache LocalCache;
...
/**
 * MegalithUI.Cache.LRUEvictionAtCapacity
 *
 * With a cap of 2, inserting 3 distinct entries must evict the
 * least-recently-used one. EvictionCount increments by 1.
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUICacheLRUEvictionTest,
    "MegalithUI.Cache.LRUEvictionAtCapacity",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUICacheLRUEvictionTest::RunTest(const FString& /*Parameters*/)
{
...
/**
 * MegalithUI.Cache.ResetClearsEntriesAndKeepsCounters
 *
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUICacheResetTest,
    "MegalithUI.Cache.ResetClearsEntriesAndKeepsCounters",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUICacheResetTest::RunTest(const FString& /*Parameters*/)
{
    FUIPropertyPathCache LocalCache;
...
/**
 * MegalithUI.Cache.SubsystemHasCache
 *
 * The registry subsystem owns a cache instance — verify the accessor surface
 * that downstream callers (action handlers) rely on.
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUICacheSubsystemAccessTest,
    "MegalithUI.Cache.SubsystemHasCache",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUICacheSubsystemAccessTest::RunTest(const FString& /*Parameters*/)
{
...
/**
 * MegalithUI.Cache.NestedPathOnScriptPackageClassResolves (regression)
 *
 ...
 * `/Script/UMG/`, `/Script/MegalithUI/`, etc. Net effect: every nested-path
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUICacheNestedPathOnScriptPackageClassTest,
    "MegalithUI.Cache.NestedPathOnScriptPackageClassResolves",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUICacheNestedPathOnScriptPackageClassTest::RunTest(const FString& /*Parameters*/)
{
    FUIPropertyPathCache LocalCache;
