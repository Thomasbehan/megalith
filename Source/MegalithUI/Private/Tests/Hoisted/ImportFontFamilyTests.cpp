...
/**
 * MegalithUI.ImportFontFamily.Basic
 *
 ...
 *
 * Test-asset convention: /Game/Tests/Megalith/UI/Fonts/TestFamily/
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIImportFontFamilyBasicTest,
    "MegalithUI.ImportFontFamily.Basic",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIImportFontFamilyBasicTest::RunTest(const FString& Parameters)
{
    ...
    const FString Destination = TEXT("/Game/Tests/Megalith/UI/Fonts/TestFamily");
...
/**
 * MegalithUI.ImportFontFamily.InvalidParams
 *
 * Negative-path coverage -- does NOT require any on-disk TTF.
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIImportFontFamilyInvalidParamsTest,
    "MegalithUI.ImportFontFamily.InvalidParams",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIImportFontFamilyInvalidParamsTest::RunTest(const FString& Parameters)
{
    {
...

    {
        ...
        P->SetStringField(TEXT("destination"),
            TEXT("/Game/Tests/Megalith/UI/Fonts/AllFailTest"));
