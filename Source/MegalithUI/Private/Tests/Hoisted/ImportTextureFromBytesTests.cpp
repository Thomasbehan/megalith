...
/**
 * MegalithUI.ImportTextureFromBytes.BasicPNG
 *
 * Dispatches `ui.import_texture_from_bytes` through the Megalith registry with
 ...
 *
 * Test fixture path: /Game/Tests/Megalith/UI/Textures/T_ImportBytesTest
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIImportTextureFromBytesBasicTest,
    "MegalithUI.ImportTextureFromBytes.BasicPNG",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIImportTextureFromBytesBasicTest::RunTest(const FString& Parameters)
{
    ...
    Params->SetStringField(TEXT("destination"),
        TEXT("/Game/Tests/Megalith/UI/Textures/T_ImportBytesTest"));
