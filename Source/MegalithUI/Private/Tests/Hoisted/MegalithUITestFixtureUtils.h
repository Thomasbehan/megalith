...
/**
 * MegalithUI test-fixture helpers.
 *
 * Throwaway-WBP construction primitives used by the MegalithUI automation
 * suite. Tests drop disposable assets under /Game/Tests/Megalith/ per
 ...
 */
namespace MegalithUI::TestUtils
{
    /**
     ...
     *
     * @param AssetPath         Long package name (e.g. "/Game/Tests/Megalith/UI/WBP_Foo")
