...
#include "Tests/Hoisted/MegalithUITestFixtureUtils.h"
...
/**
 * MegalithUI.ApplyBoxShadow.Basic
 *
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIApplyBoxShadowBasicTest,
    "MegalithUI.ApplyBoxShadow.Basic",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

namespace MegalithUI::ApplyBoxShadowTests
{
...
bool FMegalithUIApplyBoxShadowBasicTest::RunTest(const FString& Parameters)
{
    using namespace MegalithUI::TestUtils;
    using namespace MegalithUI::ApplyBoxShadowTests;
    ...
    const FString WBPPath = TEXT("/Game/Tests/Megalith/UI/WBP_ShadowTest");
    ...
    const FMegalithActionResult Result = FMegalithToolRegistry::Get().ExecuteAction(
...
/**
 * MegalithUI.ApplyBoxShadow.SizeBoxParent
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIApplyBoxShadowSizeBoxParentTest,
    "MegalithUI.ApplyBoxShadow.SizeBoxParent",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIApplyBoxShadowSizeBoxParentTest::RunTest(const FString& Parameters)
{
    using namespace MegalithUI::TestUtils;
    using namespace MegalithUI::ApplyBoxShadowTests;
    ...
    const FString WBPPath = TEXT("/Game/Tests/Megalith/UI/WBP_ShadowSizeBoxParentTest");
    FString FixtureError;
...
/**
 * MegalithUI.ApplyBoxShadow.NestedSingleChildWrappers
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIApplyBoxShadowNestedSingleChildWrappersTest,
    "MegalithUI.ApplyBoxShadow.NestedSingleChildWrappers",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIApplyBoxShadowNestedSingleChildWrappersTest::RunTest(const FString& Parameters)
{
    using namespace MegalithUI::TestUtils;
    using namespace MegalithUI::ApplyBoxShadowTests;
    ...
    const FString WBPPath = TEXT("/Game/Tests/Megalith/UI/WBP_ShadowNestedSingleChildWrapperTest");
    FString FixtureError;
    if (!CreateOrReuseTestWidgetBlueprint(WBPPath, NAME_None, nullptr, FixtureError))
    {
        AddError(FString::Printf(TEXT("Fixture build failed: %s"), *FixtureError));
...
/**
 * MegalithUI.ApplyBoxShadow.MultiLayerCap
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIApplyBoxShadowMultiLayerCapTest,
    "MegalithUI.ApplyBoxShadow.MultiLayerCap",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIApplyBoxShadowMultiLayerCapTest::RunTest(const FString& Parameters)
{
    using namespace MegalithUI::TestUtils;
    using namespace MegalithUI::ApplyBoxShadowTests;
    ...
    const FString WBPPath = TEXT("/Game/Tests/Megalith/UI/WBP_ShadowMultiTest");
    FString FixtureError;
...
/**
 * MegalithUI.ApplyBoxShadow.TargetIsRoot
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIApplyBoxShadowTargetIsRootTest,
    "MegalithUI.ApplyBoxShadow.TargetIsRoot",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIApplyBoxShadowTargetIsRootTest::RunTest(const FString& Parameters)
{
    using namespace MegalithUI::TestUtils;

    const FString WBPPath = TEXT("/Game/Tests/Megalith/UI/WBP_ShadowRootTest");
    FString FixtureError;
    if (!CreateOrReuseTestWidgetBlueprint(WBPPath, FName(TEXT("Target")), nullptr, FixtureError))
    {
        AddError(FString::Printf(TEXT("Fixture build failed: %s"), *FixtureError));
...
/**
 * MegalithUI.ApplyBoxShadow.InvalidParams
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIApplyBoxShadowInvalidParamsTest,
    "MegalithUI.ApplyBoxShadow.InvalidParams",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIApplyBoxShadowInvalidParamsTest::RunTest(const FString& Parameters)
{
    {
...
/**
 * MegalithUI.ApplyBoxShadow.IncompatibleParent
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIApplyBoxShadowIncompatibleParentTest,
    "MegalithUI.ApplyBoxShadow.IncompatibleParent",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIApplyBoxShadowIncompatibleParentTest::RunTest(const FString& Parameters)
{
    using namespace MegalithUI::TestUtils;
    ...
    const FString WBPPath = TEXT("/Game/Tests/Megalith/UI/WBP_ShadowIncompatTest");
    FString FixtureError;
    if (!CreateOrReuseTestWidgetBlueprint(WBPPath, FName(TEXT("Target")), nullptr, FixtureError))
    {
        AddError(FString::Printf(TEXT("Fixture build failed: %s"), *FixtureError));
