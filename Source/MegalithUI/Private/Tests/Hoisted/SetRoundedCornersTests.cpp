...
/**
 * MegalithUI.SetRoundedCorners.Basic
 *
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUISetRoundedCornersBasicTest,
    "MegalithUI.SetRoundedCorners.Basic",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

namespace MegalithUI::SetRoundedCornersTests
{
...
bool FMegalithUISetRoundedCornersBasicTest::RunTest(const FString& Parameters)
{
    using namespace MegalithUI::SetRoundedCornersTests;
    ...
    const FString TestWBPPath = TEXT("/Game/Tests/Megalith/UI/WBP_SetRoundedCornersTest");

    FString FixtureError;
    if (!MegalithUI::TestUtils::CreateOrReuseTestWidgetBlueprint(
...
/**
 * MegalithUI.SetRoundedCorners.InvalidParams
 *
 * Validates the -32602 error path. No fixture needed.
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUISetRoundedCornersInvalidParamsTest,
    "MegalithUI.SetRoundedCorners.InvalidParams",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUISetRoundedCornersInvalidParamsTest::RunTest(const FString& Parameters)
{
    {
