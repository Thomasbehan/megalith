...
/**
 * MegalithUI.CreateGradientMidFromSpec.Basic
 *
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUICreateGradientMidBasicTest,
    "MegalithUI.CreateGradientMidFromSpec.Basic",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

namespace MegalithUI::GradientMidTests
{
...
bool FMegalithUICreateGradientMidBasicTest::RunTest(const FString& Parameters)
{
    using namespace MegalithUI::GradientMidTests;
    ...
    const FString Destination = TEXT("/Game/Tests/Megalith/UI/MI_GradientBasicTest");
...
/**
 * MegalithUI.CreateGradientMidFromSpec.IncompatibleParent
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUICreateGradientMidIncompatibleParentTest,
    "MegalithUI.CreateGradientMidFromSpec.IncompatibleParent",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUICreateGradientMidIncompatibleParentTest::RunTest(const FString& Parameters)
{
    ...
    Params->SetStringField(TEXT("destination"),
        TEXT("/Game/Tests/Megalith/UI/MI_GradientIncompatibleTest"));
    {
        TSharedPtr<FJsonObject> Spec = MakeShared<FJsonObject>();
        TArray<TSharedPtr<FJsonValue>> Stops;
        TSharedPtr<FJsonObject> S0 = MakeShared<FJsonObject>();
...
/**
 * MegalithUI.CreateGradientMidFromSpec.InvalidParams
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUICreateGradientMidInvalidParamsTest,
    "MegalithUI.CreateGradientMidFromSpec.InvalidParams",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUICreateGradientMidInvalidParamsTest::RunTest(const FString& Parameters)
{
    {
...

    {
        ...
        P->SetStringField(TEXT("destination"),
            TEXT("/Game/Tests/Megalith/UI/MI_GradientNoParentTest"));
        TSharedPtr<FJsonObject> Spec = MakeShared<FJsonObject>();
        TArray<TSharedPtr<FJsonValue>> Stops;
        TSharedPtr<FJsonObject> S0 = MakeShared<FJsonObject>();
        S0->SetNumberField(TEXT("pos"), 0.0);
