...
namespace MegalithUI::AnimationCoreTests
{
    static const FString GTestAssetPath = TEXT("/Game/Tests/Megalith/UI/WBP_AnimCoreTest");
} // namespace MegalithUI::AnimationCoreTests


/**
 * MegalithUI.CreateAnimationV2.Basic
 *
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUICreateAnimationV2BasicTest,
    "MegalithUI.CreateAnimationV2.Basic",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUICreateAnimationV2BasicTest::RunTest(const FString& Parameters)
{
    using namespace MegalithUI::AnimationCoreTests;
    using MegalithUI::TestUtils::CreateOrReuseTestWidgetBlueprint;
...
/**
 * MegalithUI.AddBezierEasedSegment.Basic
 *
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIAddBezierEasedSegmentBasicTest,
    "MegalithUI.AddBezierEasedSegment.Basic",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIAddBezierEasedSegmentBasicTest::RunTest(const FString& Parameters)
{
    using MegalithUI::TestUtils::CreateOrReuseTestWidgetBlueprint;

    const FString BezierTestPath = TEXT("/Game/Tests/Megalith/UI/WBP_BezierSegTest");
...
/**
 * MegalithUI.BakeSpringAnimation.Basic
 *
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIBakeSpringAnimationBasicTest,
    "MegalithUI.BakeSpringAnimation.Basic",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIBakeSpringAnimationBasicTest::RunTest(const FString& Parameters)
{
    using MegalithUI::TestUtils::CreateOrReuseTestWidgetBlueprint;

    const FString SpringTestPath = TEXT("/Game/Tests/Megalith/UI/WBP_SpringTest");
...
/**
 * MegalithUI.AddAnimationEventTrack.Basic
 *
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIAddAnimationEventTrackBasicTest,
    "MegalithUI.AddAnimationEventTrack.Basic",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIAddAnimationEventTrackBasicTest::RunTest(const FString& Parameters)
{
    using MegalithUI::TestUtils::CreateOrReuseTestWidgetBlueprint;

    const FString EventTestPath = TEXT("/Game/Tests/Megalith/UI/WBP_EventTrackTest");
...

    {
        ...
        const FMegalithActionResult CreateResult = FMegalithToolRegistry::Get().ExecuteAction(
...
/**
 * MegalithUI.BindAnimationToEvent.Basic
 *
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIBindAnimationToEventBasicTest,
    "MegalithUI.BindAnimationToEvent.Basic",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIBindAnimationToEventBasicTest::RunTest(const FString& Parameters)
{
    using MegalithUI::TestUtils::CreateOrReuseTestWidgetBlueprint;

    const FString BindTestPath = TEXT("/Game/Tests/Megalith/UI/WBP_BindAnimTest");
