...
//   I1: MegalithUI.AnimationBuilder.MovieSceneOpacityTrack
//   I7: MegalithUI.AnimationBuilder.PreserveNamedSurvivesRebuild
//
// The original I4 (FUIAnimationRuntimeDriver.FadeInPlays) belongs with the
// optional runtime provider, not MegalithUI.
//
// Test-fixture WBPs land under /Game/Tests/Megalith/UI/ per the throwaway-asset rule.
...
namespace MegalithUI::AnimationBuilderTests
{
    static const FString GAssetPath_MovieScene =
        TEXT("/Game/Tests/Megalith/UI/WBP_AnimBuilder_MovieScene");
    static const FString GAssetPath_Preserve   =
        TEXT("/Game/Tests/Megalith/UI/WBP_AnimBuilder_Preserve");
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIAnimationBuilderMovieSceneOpacityTrackTest,
    "MegalithUI.AnimationBuilder.MovieSceneOpacityTrack",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIAnimationBuilderMovieSceneOpacityTrackTest::RunTest(const FString& Parameters)
{
    using namespace MegalithUI::AnimationBuilderTests;
...
// -----------------------------------------------------------------------------
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIAnimationBuilderPreserveNamedSurvivesRebuildTest,
    "MegalithUI.AnimationBuilder.PreserveNamedSurvivesRebuild",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIAnimationBuilderPreserveNamedSurvivesRebuildTest::RunTest(const FString& Parameters)
{
    using namespace MegalithUI::AnimationBuilderTests;
    using MegalithUI::TestUtils::CreateOrReuseTestWidgetBlueprint;
