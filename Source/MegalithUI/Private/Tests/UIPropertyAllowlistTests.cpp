...
/**
 * MegalithUI.Allowlist.VerticalBoxSlotPaddingAllowed (B4)
 *
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIAllowlistVerticalBoxSlotPaddingTest,
    "MegalithUI.Allowlist.VerticalBoxSlotPaddingAllowed",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIAllowlistVerticalBoxSlotPaddingTest::RunTest(const FString& /*Parameters*/)
{
...
/**
 * MegalithUI.Allowlist.UnknownTypeDenied
 *
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIAllowlistUnknownTypeDeniedTest,
    "MegalithUI.Allowlist.UnknownTypeDenied",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIAllowlistUnknownTypeDeniedTest::RunTest(const FString& /*Parameters*/)
{
    UMegalithUIRegistrySubsystem* Sub = UMegalithUIRegistrySubsystem::Get();
    if (!TestNotNull(TEXT("UMegalithUIRegistrySubsystem available"), Sub))
    {
...
/**
 * MegalithUI.Allowlist.TextBlockTextAllowed
 *
 * TextBlock.Text is a curated mapping — should be allowed. Sanity-check on
 * the leaf-widget mapping path.
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIAllowlistTextBlockTextTest,
    "MegalithUI.Allowlist.TextBlockTextAllowed",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIAllowlistTextBlockTextTest::RunTest(const FString& /*Parameters*/)
{
    UMegalithUIRegistrySubsystem* Sub = UMegalithUIRegistrySubsystem::Get();
    if (!TestNotNull(TEXT("UMegalithUIRegistrySubsystem available"), Sub))
    {
...
/**
 * MegalithUI.Allowlist.RoundedBorderCuratedMappings (B6)
 *
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIAllowlistRoundedBorderTest,
    "MegalithUI.Allowlist.RoundedBorderCuratedMappings",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIAllowlistRoundedBorderTest::RunTest(const FString& /*Parameters*/)
{
    UMegalithUIRegistrySubsystem* Sub = UMegalithUIRegistrySubsystem::Get();
    if (!TestNotNull(TEXT("UMegalithUIRegistrySubsystem available"), Sub))
    {
...
/**
 * MegalithUI.Allowlist.InvalidationDropsCache
 *
 * `Invalidate()` should drop the cache; subsequent IsAllowed call should
 * rebuild and still return the correct answer.
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIAllowlistInvalidationTest,
    "MegalithUI.Allowlist.InvalidationDropsCache",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIAllowlistInvalidationTest::RunTest(const FString& /*Parameters*/)
{
    UMegalithUIRegistrySubsystem* Sub = UMegalithUIRegistrySubsystem::Get();
    if (!TestNotNull(TEXT("UMegalithUIRegistrySubsystem available"), Sub))
    {
