...
/**
 * MegalithUI.Reflection.SetVisibilityHidden (C3)
 *
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIReflectionSetVisibilityTest,
    "MegalithUI.Reflection.SetVisibilityHidden",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIReflectionSetVisibilityTest::RunTest(const FString& /*Parameters*/)
{
    UMegalithUIRegistrySubsystem* Sub = UMegalithUIRegistrySubsystem::Get();
    if (!TestNotNull(TEXT("UMegalithUIRegistrySubsystem available"), Sub))
    {
        return false;
    }
...
/**
 * MegalithUI.Reflection.SetTextOnTextBlock (C3 — allowlist-honoured)
 *
 * `Text` IS curated for TextBlock (see RegisterCuratedMappings). Default
 * (non-raw) mode must succeed.
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIReflectionSetTextTest,
    "MegalithUI.Reflection.SetTextOnTextBlock",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIReflectionSetTextTest::RunTest(const FString& /*Parameters*/)
{
    UMegalithUIRegistrySubsystem* Sub = UMegalithUIRegistrySubsystem::Get();
    if (!TestNotNull(TEXT("UMegalithUIRegistrySubsystem available"), Sub))
    {
...
/**
 * MegalithUI.Reflection.SetTextBlockLineHeight
 *
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIReflectionSetTextBlockLineHeightTest,
    "MegalithUI.Reflection.SetTextBlockLineHeight",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIReflectionSetTextBlockLineHeightTest::RunTest(const FString& /*Parameters*/)
{
    UMegalithUIRegistrySubsystem* Sub = UMegalithUIRegistrySubsystem::Get();
    if (!TestNotNull(TEXT("UMegalithUIRegistrySubsystem available"), Sub))
    {
...
/**
 * MegalithUI.Reflection.GateRejectsUnlistedPath (C3 / C8)
 *
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIReflectionGateRejectsTest,
    "MegalithUI.Reflection.GateRejectsUnlistedPath",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIReflectionGateRejectsTest::RunTest(const FString& /*Parameters*/)
{
    UMegalithUIRegistrySubsystem* Sub = UMegalithUIRegistrySubsystem::Get();
    if (!TestNotNull(TEXT("UMegalithUIRegistrySubsystem available"), Sub))
    {
...
/**
 * MegalithUI.Reflection.RawModeBypassesGate
 *
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIReflectionRawModeTest,
    "MegalithUI.Reflection.RawModeBypassesGate",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIReflectionRawModeTest::RunTest(const FString& /*Parameters*/)
{
    UTextBlock* Widget = MakeScratchTextBlock();
    if (!TestNotNull(TEXT("scratch TextBlock created"), Widget))
    {
...
/**
 * MegalithUI.Reflection.ParseLinearColorHex (C4 — struct parser)
 *
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIReflectionLinearColorHexTest,
    "MegalithUI.Reflection.ParseLinearColorHex",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIReflectionLinearColorHexTest::RunTest(const FString& /*Parameters*/)
{
...
/**
 * MegalithUI.Reflection.ParseLinearColorArray (C4 — struct parser)
 *
 * Writes a [r,g,b,a] array shape.
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIReflectionLinearColorArrayTest,
    "MegalithUI.Reflection.ParseLinearColorArray",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIReflectionLinearColorArrayTest::RunTest(const FString& /*Parameters*/)
{
    UImage* Widget = MakeScratchImage();
    if (!TestNotNull(TEXT("scratch Image created"), Widget))
    {
...
/**
 * MegalithUI.Reflection.ParseMarginScalar (C4 — struct parser)
 *
 * Scalar JSON number applies uniform Margin to all four sides.
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIReflectionMarginScalarTest,
    "MegalithUI.Reflection.ParseMarginScalar",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIReflectionMarginScalarTest::RunTest(const FString& /*Parameters*/)
{
...
/**
 * MegalithUI.Reflection.ParseMarginObject (C4 — struct parser)
 *
 * Object form {left,top,right,bottom}.
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIReflectionMarginObjectTest,
    "MegalithUI.Reflection.ParseMarginObject",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIReflectionMarginObjectTest::RunTest(const FString& /*Parameters*/)
{
    UBorder* Widget = MakeScratchBorder();
    if (!TestNotNull(TEXT("scratch Border created"), Widget))
    {
...
/**
 * MegalithUI.Reflection.NullRootRejected
 *
 * Defensive — null Root must not crash; returns PropertyNotFound.
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIReflectionNullRootTest,
    "MegalithUI.Reflection.NullRootRejected",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIReflectionNullRootTest::RunTest(const FString& /*Parameters*/)
{
    FUIReflectionHelper Helper = MakeSubsystemHelper();
...
/**
 * MegalithUI.Reflection.UnknownPropertyRejected
 *
 * In raw mode (no allowlist gate), an unresolved path returns
 * PropertyNotFound — distinguishes from NotInAllowlist failures.
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIReflectionUnknownPropertyTest,
    "MegalithUI.Reflection.UnknownPropertyRejected",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIReflectionUnknownPropertyTest::RunTest(const FString& /*Parameters*/)
{
    UTextBlock* Widget = MakeScratchTextBlock();
    if (!TestNotNull(TEXT("scratch TextBlock created"), Widget))
    {
