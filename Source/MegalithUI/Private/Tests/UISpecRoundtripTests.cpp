...
//        Border).
//
//   Plus: MegalithUI.SpecSerializer.PublicFields
...
//
// Throwaway WBPs land under /Game/Tests/Megalith/UI/Roundtrip/ per the
// test-asset rule.
...
namespace MegalithUI::SpecRoundtripTests
{
    /** Common test asset path. Each test scopes its WBP under a sub-name. */
    static FString MakeTestPath(const FString& Suffix)
    {
        return FString::Printf(TEXT("/Game/Tests/Megalith/UI/Roundtrip/WBP_%s"), *Suffix);
    }
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUISpecSerializerSupportedFieldsTest,
    "MegalithUI.SpecSerializer.SupportedFields",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUISpecSerializerSupportedFieldsTest::RunTest(const FString& /*Parameters*/)
{
    using namespace MegalithUI::SpecRoundtripTests;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUISpecSerializerBoxSlotFillTest,
    "MegalithUI.SpecSerializer.BoxSlotFill",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUISpecSerializerBoxSlotFillTest::RunTest(const FString& /*Parameters*/)
{
    using namespace MegalithUI::SpecRoundtripTests;
...
// =============================================================================
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUISpecRoundtripIdentityTest,
    "MegalithUI.SpecSerializer.RoundtripIdentity",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUISpecRoundtripIdentityTest::RunTest(const FString& /*Parameters*/)
{
    using namespace MegalithUI::SpecRoundtripTests;
...
// =============================================================================
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUISpecSerializerPublicFieldsTest,
    "MegalithUI.SpecSerializer.PublicFields",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUISpecSerializerPublicFieldsTest::RunTest(const FString& /*Parameters*/)
{
    using namespace MegalithUI::SpecRoundtripTests;
...
// =============================================================================
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUISpecRoundtripCorpusTest,
    "MegalithUI.SpecSerializer.RoundtripCorpus",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUISpecRoundtripCorpusTest::RunTest(const FString& /*Parameters*/)
{
    using namespace MegalithUI::SpecRoundtripTests;
...
// =============================================================================
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUISpecSerializerSlotCoverageTest,
    "MegalithUI.SpecSerializer.SlotCoverage",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUISpecSerializerSlotCoverageTest::RunTest(const FString& /*Parameters*/)
{
    using namespace MegalithUI::SpecRoundtripTests;
