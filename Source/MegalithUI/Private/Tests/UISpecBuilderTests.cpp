...
//   H1     MegalithUI.SpecBuilder.OneNodeOneWidget
//   H2.1   MegalithUI.SpecBuilder.RollbackOnMidWalkFailure
//   H4     MegalithUI.SpecBuilder.InvalidSpecYieldsNoAsset
//   H6     MegalithUI.SpecBuilder.DryRunYieldsDiffNoCommit
//   H8     MegalithUI.SpecBuilder.StrictModeFailsOnWarning
//   H10    MegalithUI.SpecBuilder.PreCreateStylesRunsBeforeWidgets
//   H12    MegalithUI.SpecBuilder.AnimationsBindAfterCompile
//   H13.5  MegalithUI.SpecBuilder.CycleRejected
//   H13.6  MegalithUI.SpecBuilder.MaxDepthRejected
//   H13.7  MegalithUI.SpecBuilder.PathCacheSurvivesHotReload
//
// Throwaway WBPs land under /Game/Tests/Megalith/UI/ per the test-asset rule.
...
namespace MegalithUI::SpecBuilderTests
{
    /**
    ...
    {
        return FString::Printf(TEXT("/Game/Tests/Megalith/UI/SpecBuilder/WBP_%s"), *Suffix);
    }
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUISpecBuilderOneNodeOneWidgetTest,
    "MegalithUI.SpecBuilder.OneNodeOneWidget",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUISpecBuilderOneNodeOneWidgetTest::RunTest(const FString& /*Parameters*/)
{
    using namespace MegalithUI::SpecBuilderTests;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUISpecBuilderSizeAndBoxSlotPrimitivesTest,
    "MegalithUI.SpecBuilder.SizeAndBoxSlotPrimitives",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUISpecBuilderSizeAndBoxSlotPrimitivesTest::RunTest(const FString& /*Parameters*/)
{
    using namespace MegalithUI::SpecBuilderTests;
...
// =============================================================================
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUISpecBuilderRollbackOnMidWalkFailureTest,
    "MegalithUI.SpecBuilder.RollbackOnMidWalkFailure",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUISpecBuilderRollbackOnMidWalkFailureTest::RunTest(const FString& /*Parameters*/)
{
    using namespace MegalithUI::SpecBuilderTests;
...
// =============================================================================
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUISpecBuilderInvalidSpecYieldsNoAssetTest,
    "MegalithUI.SpecBuilder.InvalidSpecYieldsNoAsset",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUISpecBuilderInvalidSpecYieldsNoAssetTest::RunTest(const FString& /*Parameters*/)
{
    using namespace MegalithUI::SpecBuilderTests;
...
// =============================================================================
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUISpecBuilderDryRunYieldsDiffNoCommitTest,
    "MegalithUI.SpecBuilder.DryRunYieldsDiffNoCommit",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUISpecBuilderDryRunYieldsDiffNoCommitTest::RunTest(const FString& /*Parameters*/)
{
    using namespace MegalithUI::SpecBuilderTests;
...
// =============================================================================
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUISpecBuilderStrictModeFailsOnWarningTest,
    "MegalithUI.SpecBuilder.StrictModeFailsOnWarning",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUISpecBuilderStrictModeFailsOnWarningTest::RunTest(const FString& /*Parameters*/)
{
    using namespace MegalithUI::SpecBuilderTests;
...
// =============================================================================
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUISpecBuilderPreCreateStylesRunsBeforeWidgetsTest,
    "MegalithUI.SpecBuilder.PreCreateStylesRunsBeforeWidgets",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUISpecBuilderPreCreateStylesRunsBeforeWidgetsTest::RunTest(const FString& /*Parameters*/)
{
    using namespace MegalithUI::SpecBuilderTests;
...
// =============================================================================
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUISpecBuilderAnimationsBindAfterCompileTest,
    "MegalithUI.SpecBuilder.AnimationsBindAfterCompile",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUISpecBuilderAnimationsBindAfterCompileTest::RunTest(const FString& /*Parameters*/)
{
    using namespace MegalithUI::SpecBuilderTests;
...
// =============================================================================
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUISpecBuilderCycleRejectedTest,
    "MegalithUI.SpecBuilder.CycleRejected",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUISpecBuilderCycleRejectedTest::RunTest(const FString& /*Parameters*/)
{
    using namespace MegalithUI::SpecBuilderTests;
...
// =============================================================================
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUISpecBuilderMaxDepthRejectedTest,
    "MegalithUI.SpecBuilder.MaxDepthRejected",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUISpecBuilderMaxDepthRejectedTest::RunTest(const FString& /*Parameters*/)
{
    using namespace MegalithUI::SpecBuilderTests;

    const FString AssetPath = MakeTestPath(TEXT("TooDeep"));

    const int32 MaxDepth = 32; // matches UMegalithUISettings::MaxNestingDepth default
...
// =============================================================================
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUISpecBuilderPathCacheSurvivesHotReloadTest,
    "MegalithUI.SpecBuilder.PathCacheSurvivesHotReload",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUISpecBuilderPathCacheSurvivesHotReloadTest::RunTest(const FString& /*Parameters*/)
{
    using namespace MegalithUI::SpecBuilderTests;
