...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUISetWidgetPropertyMicrobenchTest,
    "MegalithUI.Performance.SetWidgetPropertyMicrobench",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::PerfFilter)

bool FMegalithUISetWidgetPropertyMicrobenchTest::RunTest(const FString& /*Parameters*/)
{
