...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIStyleServiceHashDedupTest,
    "MegalithUI.StyleService.HashDedup",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIStyleServiceHashDedupTest::RunTest(const FString& /*Parameters*/)
{
    ...
    const uint32 HashA = FMegalithUIStyleService::ComputeContentHash(StyleCls, A);
    const uint32 HashB = FMegalithUIStyleService::ComputeContentHash(StyleCls, B);
    ...
    const uint32 HashC = FMegalithUIStyleService::ComputeContentHash(StyleCls, C);
    ...
    const uint32 HashAonText = FMegalithUIStyleService::ComputeContentHash(
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIStyleServiceStatsRollupTest,
    "MegalithUI.StyleService.StatsRollupAfterReset",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIStyleServiceStatsRollupTest::RunTest(const FString& /*Parameters*/)
{
    FMegalithUIStyleService& Service = FMegalithUIStyleService::Get();
    Service.Reset();
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUISettingsNormalizePathTest,
    "MegalithUI.StyleService.NormalizeFolderPath",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUISettingsNormalizePathTest::RunTest(const FString& /*Parameters*/)
{
    TestEqual(TEXT("Trailing slash trimmed"),
        UMegalithUISettings::NormalizeFolderPath(TEXT("/Game/UI/Styles/")),
    ...
    TestEqual(TEXT("Already-normalised path passes through"),
        UMegalithUISettings::NormalizeFolderPath(TEXT("/Game/UI")),
        FString(TEXT("/Game/UI")));

    TestEqual(TEXT("Empty stays empty"),
        UMegalithUISettings::NormalizeFolderPath(FString()),
        FString());
