...
//   K1   MegalithUI.ErrorFormatting.LLMReportIncludesPathAndOptions
...
//
//   K3   MegalithUI.ErrorFormatting.RequestIdEchoes
...
//
//   K5a  MegalithUI.ErrorFormatting.SetWidgetPropertyBadPathSurfacesValidOptions
...
//
//   K5b  MegalithUI.ErrorFormatting.SetAnchorPresetBadPresetEnumeratesValidOptions
//        set_anchor_preset with an unknown preset name returns an error whose
//        body lists every legal preset token in valid_options.
//
//   K5c  MegalithUI.ErrorFormatting.SetBrushBadDrawTypeEnumeratesValidOptions
...
//
//   K5d  MegalithUI.ErrorFormatting.AggregateValidationReportEmbedsPerFinding
...
//
// Throwaway WBPs land under /Game/Tests/Megalith/UI/ErrorFormatting/ per the
...
namespace MegalithUI::ErrorFormattingTests
{
    ...
    {
        return FString::Printf(TEXT("/Game/Tests/Megalith/UI/ErrorFormatting/WBP_%s"), *Suffix);
    }
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIErrorFormattingLLMReportIncludesPathAndOptionsTest,
    "MegalithUI.ErrorFormatting.LLMReportIncludesPathAndOptions",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIErrorFormattingLLMReportIncludesPathAndOptionsTest::RunTest(const FString& /*Parameters*/)
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIErrorFormattingRequestIdEchoesTest,
    "MegalithUI.ErrorFormatting.RequestIdEchoes",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIErrorFormattingRequestIdEchoesTest::RunTest(const FString& /*Parameters*/)
{
    using namespace MegalithUI::ErrorFormattingTests;
    ...
    // failure. The response must still echo request_id.
    {
        ...
        const FMegalithActionResult R = FMegalithToolRegistry::Get().ExecuteAction(
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUISetWidgetPropertyBadPathSurfacesValidOptionsTest,
    "MegalithUI.ErrorFormatting.SetWidgetPropertyBadPathSurfacesValidOptions",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUISetWidgetPropertyBadPathSurfacesValidOptionsTest::RunTest(const FString& /*Parameters*/)
{
    using namespace MegalithUI::ErrorFormattingTests;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUISetAnchorPresetBadPresetEnumeratesValidOptionsTest,
    "MegalithUI.ErrorFormatting.SetAnchorPresetBadPresetEnumeratesValidOptions",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUISetAnchorPresetBadPresetEnumeratesValidOptionsTest::RunTest(const FString& /*Parameters*/)
{
    using namespace MegalithUI::ErrorFormattingTests;
    ...
    // Guard against drift: the canonical list in MegalithUIInternal::
    // GetAnchorPresetNames() and the runtime map in MegalithUI::GetAnchorPreset
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUISetBrushBadDrawTypeEnumeratesValidOptionsTest,
    "MegalithUI.ErrorFormatting.SetBrushBadDrawTypeEnumeratesValidOptions",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUISetBrushBadDrawTypeEnumeratesValidOptionsTest::RunTest(const FString& /*Parameters*/)
{
    using namespace MegalithUI::ErrorFormattingTests;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIAggregateValidationReportEmbedsPerFindingTest,
    "MegalithUI.ErrorFormatting.AggregateValidationReportEmbedsPerFinding",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIAggregateValidationReportEmbedsPerFindingTest::RunTest(const FString& /*Parameters*/)
{
