...
/**
 * MegalithUI.Registry.KnowsVerticalBox
 *
 ...
 *
 * Subsystem retrieval: `UMegalithUIRegistrySubsystem::Get()` returns null in
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIRegistryKnowsVerticalBoxTest,
    "MegalithUI.Registry.KnowsVerticalBox",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIRegistryKnowsVerticalBoxTest::RunTest(const FString& /*Parameters*/)
{
    UMegalithUIRegistrySubsystem* Sub = UMegalithUIRegistrySubsystem::Get();
    if (!TestNotNull(TEXT("UMegalithUIRegistrySubsystem available in editor context"), Sub))
    {
        return false;
    }
...
/**
 * MegalithUI.Registry.AbstractClassesFiltered (B10a)
 *
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIRegistryAbstractFilteredTest,
    "MegalithUI.Registry.AbstractClassesFiltered",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIRegistryAbstractFilteredTest::RunTest(const FString& /*Parameters*/)
{
    UMegalithUIRegistrySubsystem* Sub = UMegalithUIRegistrySubsystem::Get();
...
/**
 * MegalithUI.Registry.ContentWidgetSingleChild
 *
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIRegistryContentWidgetSingleChildTest,
    "MegalithUI.Registry.ContentWidgetSingleChild",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIRegistryContentWidgetSingleChildTest::RunTest(const FString& /*Parameters*/)
{
    UMegalithUIRegistrySubsystem* Sub = UMegalithUIRegistrySubsystem::Get();
    if (!TestNotNull(TEXT("UMegalithUIRegistrySubsystem available"), Sub))
    {
...
/**
 * MegalithUI.Registry.LeafWidgetClassified
 *
 * UTextBlock — leaf widget, no children. ContainerKind = Leaf, MaxChildren = 0.
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIRegistryLeafClassifiedTest,
    "MegalithUI.Registry.LeafWidgetClassified",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIRegistryLeafClassifiedTest::RunTest(const FString& /*Parameters*/)
{
    UMegalithUIRegistrySubsystem* Sub = UMegalithUIRegistrySubsystem::Get();
    if (!TestNotNull(TEXT("UMegalithUIRegistrySubsystem available"), Sub))
    {
...
/**
 * MegalithUI.Registry.RescanIdempotent (B10b prep)
 *
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIRegistryRescanIdempotentTest,
    "MegalithUI.Registry.RescanIdempotent",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIRegistryRescanIdempotentTest::RunTest(const FString& /*Parameters*/)
{
    UMegalithUIRegistrySubsystem* Sub = UMegalithUIRegistrySubsystem::Get();
    if (!TestNotNull(TEXT("UMegalithUIRegistrySubsystem available"), Sub))
    {
...
/**
 * MegalithUI.Registry.LateLoadedClassPickedUp (B10b — synthetic proxy)
 *
 ...
 * itself — that lambda lives in `FMegalithUIModule::StartupModule` and is
 * exercised once per editor launch, not by automation.
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIRegistryLateLoadProxyTest,
    "MegalithUI.Registry.LateLoadedClassPickedUp",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIRegistryLateLoadProxyTest::RunTest(const FString& /*Parameters*/)
{
    UMegalithUIRegistrySubsystem* Sub = UMegalithUIRegistrySubsystem::Get();
    if (!TestNotNull(TEXT("UMegalithUIRegistrySubsystem available"), Sub))
    {
...
/**
 * MegalithUI.Registry.HotReloadRefresh (B10c)
 *
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMegalithUIRegistryHotReloadRefreshTest,
    "MegalithUI.Registry.HotReloadRefresh",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithUIRegistryHotReloadRefreshTest::RunTest(const FString& /*Parameters*/)
{
    UMegalithUIRegistrySubsystem* Sub = UMegalithUIRegistrySubsystem::Get();
    if (!TestNotNull(TEXT("UMegalithUIRegistrySubsystem available"), Sub))
    {
