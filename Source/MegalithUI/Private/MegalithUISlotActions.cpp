...
void FMegalithUISlotActions::RegisterActions(FMegalithToolRegistry& Registry)
{
    Registry.RegisterAction(
        TEXT("ui"), TEXT("set_slot_property"),
        TEXT("Set a slot property on a widget (anchors, offsets, padding, alignment, z-order)"),
        FMegalithActionHandler::CreateStatic(&HandleSetSlotProperty),
        FParamSchemaBuilder()
    ...
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&HandleSetAnchorPreset),
        FParamSchemaBuilder()
            .RequiredAssetPath(TEXT("asset_path"), TEXT("Widget Blueprint asset path"))
            .Required(TEXT("widget_name"), TEXT("string"), TEXT("Target widget name"))
    ...
    Registry.RegisterAction(
        ...
        FMegalithActionHandler::CreateStatic(&HandleMoveWidget),
        FParamSchemaBuilder()
            .RequiredAssetPath(TEXT("asset_path"), TEXT("Widget Blueprint asset path"))
...
// --- set_slot_property ---
FMegalithActionResult FMegalithUISlotActions::HandleSetSlotProperty(const TSharedPtr<FJsonObject>& Params)
{
...
// --- set_anchor_preset ---
FMegalithActionResult FMegalithUISlotActions::HandleSetAnchorPreset(const TSharedPtr<FJsonObject>& Params)
{
    FString AssetPath = Params->GetStringField(TEXT("asset_path"));
    FString WidgetName = Params->GetStringField(TEXT("widget_name"));
    ...
    const TArray<FString>& KnownPresets = MegalithUIInternal::GetAnchorPresetNames();
    ...
    FAnchors Anchors = MegalithUIInternal::GetAnchorPreset(Preset);
...
// --- move_widget ---
FMegalithActionResult FMegalithUISlotActions::HandleMoveWidget(const TSharedPtr<FJsonObject>& Params)
{
    FString AssetPath = Params->GetStringField(TEXT("asset_path"));
    FString WidgetName = Params->GetStringField(TEXT("widget_name"));
