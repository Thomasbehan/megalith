...
public class MegalithUI : ModuleRules
{
    public MegalithUI(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        PublicDependencyModuleNames.AddRange(new string[]
        {
            ...
            // EditorSubsystem is Public because UMegalithUIRegistrySubsystem
        ...
        {
            "MegalithCore", "UnrealEd", "UMG", "UMGEditor",
            ...
            "Kismet",
            "MaterialEditor",
            // Phase G: UMegalithUISettings derives from UDeveloperSettings,
        ...
        // public Megalith free release can ship without hard-requiring CommonUI:
        ...
        // Set MEGALITH_RELEASE_BUILD=1 to force detection off (validates WITH_COMMONUI=0 path).
        //
        // IMPORTANT: Even if CommonUI exists in the engine, we must also verify that
        // Megalith's own CommonUI source files are present. The public release zip
        ...
        bool bHasOurCommonUISources = Directory.Exists(OurCommonUIDir)
            && File.Exists(Path.Combine(OurCommonUIDir, "MegalithCommonUIActions.h"));
