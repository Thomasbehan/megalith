...
//
// What is LOSSY (documented in SPEC_MegalithUI.md "Spec Serializer (M5 -- J)"):
...
// box-model first principles + the existing MegalithUI action surface.
 ...
 */
struct MEGALITHUI_API FUISpecSerializerInputs
{
 ...
 */
struct MEGALITHUI_API FUISpecSerializerResult
{
 ...
 */
class MEGALITHUI_API FUISpecSerializer
{
public:
    /**
