...
struct MEGALITHUI_API FUISpecError
{
    ...
    // ToLLMReport() to populate FMegalithActionResult::Error's message field.
 ...
 */
USTRUCT(BlueprintType)
struct MEGALITHUI_API FUISpecValidationResult
{
    GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct MEGALITHUI_API FUISpecMetadata
{
    GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct MEGALITHUI_API FUISpecSlot
{
    GENERATED_BODY()

    /** Anchor preset name (one of the curated set in `MegalithUICommon::GetAnchorPreset`). */
    UPROPERTY(BlueprintReadWrite, Category = "MegalithUI|Spec")
    FName AnchorPreset;
 ...
 */
USTRUCT(BlueprintType)
struct MEGALITHUI_API FUISpecStyle
{
    GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct MEGALITHUI_API FUISpecContent
{
    GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct MEGALITHUI_API FUISpecEffectShadow
{
    GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct MEGALITHUI_API FUISpecEffect
{
    GENERATED_BODY()
 ...
 * v1 stores tokens; the builder resolves them via `UMegalithUIStyleService`.
 */
USTRUCT(BlueprintType)
struct MEGALITHUI_API FUISpecCommonUI
{
    GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct MEGALITHUI_API FUISpecKeyframe
{
    GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct MEGALITHUI_API FUISpecAnimation
{
    GENERATED_BODY()
 ...
 */
USTRUCT()
struct MEGALITHUI_API FUISpecNode
{
    GENERATED_BODY()
 ...
 */
USTRUCT()
struct MEGALITHUI_API FUISpecDocument
{
    GENERATED_BODY()
