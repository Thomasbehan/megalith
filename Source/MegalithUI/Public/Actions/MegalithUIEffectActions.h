...
namespace MegalithUI
{
    struct FEffectSurfaceActions
    {
        ...
        static FMegalithActionResult HandleSetCorners       (const TSharedPtr<FJsonObject>& Params);
        static FMegalithActionResult HandleSetFill          (const TSharedPtr<FJsonObject>& Params);
        static FMegalithActionResult HandleSetBorder        (const TSharedPtr<FJsonObject>& Params);
        static FMegalithActionResult HandleSetDropShadow    (const TSharedPtr<FJsonObject>& Params);
        static FMegalithActionResult HandleSetInnerShadow   (const TSharedPtr<FJsonObject>& Params);
        static FMegalithActionResult HandleSetGlow          (const TSharedPtr<FJsonObject>& Params);
        static FMegalithActionResult HandleSetFilter        (const TSharedPtr<FJsonObject>& Params);
        static FMegalithActionResult HandleSetBackdropBlur  (const TSharedPtr<FJsonObject>& Params);
        static FMegalithActionResult HandleSetInsetHighlight(const TSharedPtr<FJsonObject>& Params);
        static FMegalithActionResult HandleApplyPreset      (const TSharedPtr<FJsonObject>& Params);
    };
}
