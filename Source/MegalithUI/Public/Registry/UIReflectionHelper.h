...
// `UMegalithUIRegistrySubsystem`; nothing in this helper acquires locks.
//
 ...
 */
struct MEGALITHUI_API FUIReflectionApplyResult
{
    bool bSuccess = false;
 ...
 */
class MEGALITHUI_API FUIReflectionHelper
{
public:
    /**
