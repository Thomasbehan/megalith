...
//      `FMegalithUIModule::StartupModule` rather than from this subsystem's
...
#include "MegalithUIRegistrySubsystem.generated.h"

// UE 5.7: declared without underlying type at UObject/UObjectGlobals.h:3216 — match exactly.
enum class EReloadCompleteReason;

UCLASS()
class MEGALITHUI_API UMegalithUIRegistrySubsystem : public UEditorSubsystem
{
    GENERATED_BODY()
...
public:
     ...
     */
    static UMegalithUIRegistrySubsystem* Get();
     ...
     * re-seed. Called by `FMegalithUIModule::StartupModule` from the
