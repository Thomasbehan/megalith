...
// Populated by `UMegalithUIRegistrySubsystem` via a TObjectIterator walk; not
// hand-maintained.
//
...
// of truth.
//
// Thread safety: read-only after `UMegalithUIRegistrySubsystem::Initialize`.
 ...
 */
struct MEGALITHUI_API FUIPropertyMapping
{
 ...
 */
struct MEGALITHUI_API FUITypeRegistryEntry
{
...
/**
 * Catalogue of registered widget types. Owned by `UMegalithUIRegistrySubsystem`.
 *
 ...
 */
class MEGALITHUI_API FUITypeRegistry
{
public:
