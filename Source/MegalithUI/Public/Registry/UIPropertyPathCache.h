...
//
// Thread safety: the cache is owned by `UMegalithUIRegistrySubsystem` (an
...
// in MegalithUI, NOT from any reference plugin.
 ...
 */
struct MEGALITHUI_API FUIPropertyPathChain
{
 ...
 *
 * Lifetime: owned by `UMegalithUIRegistrySubsystem` (held via TUniquePtr,
 ...
 */
class MEGALITHUI_API FUIPropertyPathCache
{
public:
    /**
