...
struct MEGALITHUI_API FUIAnimationBuildOptions
{
    GENERATED_BODY()

    /** Reconciliation policy. */
    UPROPERTY(BlueprintReadWrite, Category = "MegalithUI|Animation")
 ...
 */
USTRUCT(BlueprintType)
struct MEGALITHUI_API FUIAnimationRebuildResult
{
    GENERATED_BODY()
