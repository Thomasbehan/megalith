...
#include "MegalithBehaviorTreeAIController.generated.h"
 ...
 */
UCLASS(Blueprintable, meta = (DisplayName = "Megalith Behavior Tree AI Controller"))
class MEGALITHAI_API AMegalithBehaviorTreeAIController : public AAIController
{
	GENERATED_BODY()
