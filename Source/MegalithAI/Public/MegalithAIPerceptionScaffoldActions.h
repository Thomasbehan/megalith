// MegalithAIPerceptionScaffoldActions.h
// Phase F8 (J-phase) — author-time perception scaffolding for ANY actor
// Blueprint (not just AIControllers). The existing
// FMegalithAIPerceptionActions::HandleAddPerceptionComponent is restricted to
...
class FMegalithAIPerceptionScaffoldActions
{
public:
	static void RegisterActions(FMegalithToolRegistry& Registry);

	static FMegalithActionResult HandleAddPerceptionToActor(const TSharedPtr<FJsonObject>& Params);
};
