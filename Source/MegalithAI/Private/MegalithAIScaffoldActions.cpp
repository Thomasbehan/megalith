...
FMegalithActionResult FMegalithAIScaffoldActions::Dispatch(
	const FString& Namespace, const FString& Action, const TSharedPtr<FJsonObject>& Params)
{
	return FMegalithToolRegistry::Get().ExecuteAction(Namespace, Action, Params);
}

bool FMegalithAIScaffoldActions::DispatchOrWarn(
	const FString& Namespace, const FString& Action,
	const TSharedPtr<FJsonObject>& Params, TArray<FString>& Warnings, FString StepName)
{
	FMegalithActionResult R = Dispatch(Namespace, Action, Params);
	if (!R.bSuccess)
	{
...
TArray<TSharedPtr<FJsonValue>> FMegalithAIScaffoldActions::BuildBBKeysForTemplate(const FString& TemplateName)
{
...
TSharedPtr<FJsonObject> FMegalithAIScaffoldActions::BuildBTTemplateSpec(const FString& TemplateName, const FString& BBPath)
{
...
void FMegalithAIScaffoldActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	// 180b. hello_world_ai
	Registry.RegisterAction(TEXT("ai"), TEXT("hello_world_ai"),
		...
		FMegalithActionHandler::CreateStatic(&HandleHelloWorldAI),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("scaffold_complete_ai_character"),
		...
		FMegalithActionHandler::CreateStatic(&HandleScaffoldCompleteAICharacter),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("scaffold_perception_to_blackboard"),
		...
		FMegalithActionHandler::CreateStatic(&HandleScaffoldPerceptionToBlackboard),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("scaffold_team_system"),
		...
		FMegalithActionHandler::CreateStatic(&HandleScaffoldTeamSystem),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("scaffold_patrol_investigate_ai"),
		...
		FMegalithActionHandler::CreateStatic(&HandleScaffoldPatrolInvestigateAI),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("scaffold_enemy_ai"),
		...
		FMegalithActionHandler::CreateStatic(&HandleScaffoldEnemyAI),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("save_path"), TEXT("Base directory for assets"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("scaffold_eqs_move_sequence"),
		...
		FMegalithActionHandler::CreateStatic(&HandleScaffoldEQSMoveSequence),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("create_bt_from_template"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateBTFromTemplate),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("create_st_from_template"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateSTFromTemplate),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("batch_validate_ai_assets"),
		...
		FMegalithActionHandler::CreateStatic(&HandleBatchValidateAIAssets),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("validate_ai_controller"),
		...
		FMegalithActionHandler::CreateStatic(&HandleValidateAIController),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("scaffold_ai_controller_blueprint"),
		...
		FMegalithActionHandler::CreateStatic(&HandleScaffoldAIControllerBlueprint),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("scaffold_companion_ai"),
		...
		FMegalithActionHandler::CreateStatic(&HandleScaffoldCompanionAI),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("save_path"), TEXT("Base directory for assets"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("scaffold_boss_ai"),
		...
		FMegalithActionHandler::CreateStatic(&HandleScaffoldBossAI),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("save_path"), TEXT("Base directory for assets"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("scaffold_ambient_npc"),
		...
		FMegalithActionHandler::CreateStatic(&HandleScaffoldAmbientNPC),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("save_path"), TEXT("Base directory for assets"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("scaffold_horror_stalker"),
		...
		FMegalithActionHandler::CreateStatic(&HandleScaffoldHorrorStalker),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("save_path"), TEXT("Base directory for assets"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("scaffold_horror_ambush"),
		...
		FMegalithActionHandler::CreateStatic(&HandleScaffoldHorrorAmbush),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("save_path"), TEXT("Base directory for assets"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("scaffold_horror_presence"),
		...
		FMegalithActionHandler::CreateStatic(&HandleScaffoldHorrorPresence),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("save_path"), TEXT("Base directory for assets"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("scaffold_horror_mimic"),
		...
		FMegalithActionHandler::CreateStatic(&HandleScaffoldHorrorMimic),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("save_path"), TEXT("Base directory for assets"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("scaffold_stealth_game_ai"),
		...
		FMegalithActionHandler::CreateStatic(&HandleScaffoldStealthGameAI),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("save_path"), TEXT("Base directory for assets"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("scaffold_turret_ai"),
		...
		FMegalithActionHandler::CreateStatic(&HandleScaffoldTurretAI),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("save_path"), TEXT("Base directory for assets"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("scaffold_group_coordinator"),
		...
		FMegalithActionHandler::CreateStatic(&HandleScaffoldGroupCoordinator),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("save_path"), TEXT("Base directory for assets"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("scaffold_flying_ai"),
		...
		FMegalithActionHandler::CreateStatic(&HandleScaffoldFlyingAI),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("save_path"), TEXT("Base directory for assets"))
...
FMegalithActionResult FMegalithAIScaffoldActions::HandleHelloWorldAI(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath;
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Hello World AI")));
	...
	// 1. Create Blackboard
	{
		...
		FMegalithActionResult R = Dispatch(TEXT("ai"), TEXT("create_blackboard"), P);
		if (!R.bSuccess)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create Blackboard: %s"), *R.ErrorMessage));
		}
	...
	// 2. Create BT from patrol template
	{
		...
		if (!Spec.IsValid())
		{
			return FMegalithActionResult::Error(TEXT("Failed to build patrol BT spec"));
		}

		TSharedPtr<FJsonObject> P = MakeShared<FJsonObject>();
		P->SetStringField(TEXT("save_path"), BTPath);
		P->SetObjectField(TEXT("spec"), Spec);
		FMegalithActionResult R = Dispatch(TEXT("ai"), TEXT("build_behavior_tree_from_spec"), P);
		if (!R.bSuccess)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create BT: %s"), *R.ErrorMessage));
		}
		...
		FMegalithActionResult LinkResult = Dispatch(TEXT("ai"), TEXT("set_bt_blackboard"), SetBBParams);
		if (!LinkResult.bSuccess)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to link BT to Blackboard: %s"), *LinkResult.ErrorMessage));
		}
	}
	...
	// 3. Create AI Controller
	{
		...
		FMegalithActionResult R = Dispatch(TEXT("ai"), TEXT("create_ai_controller"), P);
		if (!R.bSuccess)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create AI Controller: %s"), *R.ErrorMessage));
		}
	...
	// 7. Create Character Blueprint
	{
		...
		FString PathError;
		if (!MegalithAI::EnsureAssetPathFree(CharacterPath, CharAssetName, PathError))
		{
		...
		{
			FString PkgError;
			UPackage* Package = MegalithAI::GetOrCreatePackage(CharacterPath, PkgError);
			if (Package)
			{
...
FMegalithActionResult FMegalithAIScaffoldActions::HandleScaffoldCompleteAICharacter(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (!MegalithAI::RequireStringParam(Params, TEXT("name"), Name, ErrResult))
	{
		return ErrResult;
	}
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Scaffold Complete AI Character")));
	...
	// 1. Create BB with template keys
	{
		...
		if (!R.bSuccess)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create BB: %s"), *R.ErrorMessage));
		}
		CreatedAssets.Add(BBPath);
	...
	// 2. Create BT from template
	{
		...
		if (!Spec.IsValid())
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Unknown BT template: %s"), *BTTemplate));
		}
	...
	// 3. Create AI Controller via scaffold
	{
		...
		FMegalithActionResult R = Dispatch(TEXT("ai"), TEXT("scaffold_ai_controller_blueprint"), P);
		if (!R.bSuccess)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create AI Controller: %s"), *R.ErrorMessage));
		}
...
FMegalithActionResult FMegalithAIScaffoldActions::HandleScaffoldPerceptionToBlackboard(const TSharedPtr<FJsonObject>& Params)
{
	FString ControllerPath, BBPath;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("controller_path"), ControllerPath, ErrResult))
	{
		return ErrResult;
	}
	if (!MegalithAI::RequireStringParam(Params, TEXT("bb_path"), BBPath, ErrResult))
	{
		return ErrResult;
	}
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Scaffold Perception→BB")));
	TArray<FString> Warnings;
...
FMegalithActionResult FMegalithAIScaffoldActions::HandleScaffoldTeamSystem(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("save_path"), SavePath, ErrResult))
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: teams (non-empty array)"));
	}
	...
	if (Teams.Num() < 2)
	{
		return FMegalithActionResult::Error(TEXT("Need at least 2 teams"));
	}
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Scaffold Team System")));
...
FMegalithActionResult FMegalithAIScaffoldActions::HandleScaffoldPatrolInvestigateAI(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath, Name;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("save_path"), SavePath, ErrResult))
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Scaffold Patrol+Investigate AI")));
	...
	// 3. Create controller
	{
		...
		if (!R.bSuccess)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create controller: %s"), *R.ErrorMessage));
		}
		CreatedAssets.Add(ControllerPath);
	}
		...
		if (MegalithAI::EnsureAssetPathFree(CharacterPath, CharAssetName, PathError))
		{
			...
			if (Package)
			{
				UBlueprint* CharBP = FKismetEditorUtilities::CreateBlueprint(
					...
					BPTYPE_Normal, FName(TEXT("MegalithAI")));
				if (CharBP)
				{
					FAssetRegistryModule::AssetCreated(CharBP);
					CharBP->MarkPackageDirty();
...
FMegalithActionResult FMegalithAIScaffoldActions::HandleScaffoldEnemyAI(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (!MegalithAI::RequireStringParam(Params, TEXT("archetype"), Archetype, ErrResult)) return ErrResult;

	Archetype = Archetype.ToLower();
	if (Archetype != TEXT("melee") && Archetype != TEXT("ranged") && Archetype != TEXT("charger"))
	{
		return FMegalithActionResult::Error(TEXT("archetype must be: melee, ranged, or charger"));
	}
	...
	FMegalithActionResult R = Dispatch(TEXT("ai"), TEXT("scaffold_complete_ai_character"), P);
...
FMegalithActionResult FMegalithAIScaffoldActions::HandleScaffoldEQSMoveSequence(const TSharedPtr<FJsonObject>& Params)
{
	FString BTPath, EQSPath, BBKey;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("bt_path"), BTPath, ErrResult)) return ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("eqs_path"), EQSPath, ErrResult)) return ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("bb_key"), BBKey, ErrResult)) return ErrResult;

	FString ParentId = Params->GetStringField(TEXT("parent_id"));

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Scaffold EQS Move Sequence")));
	...
	FString SequenceId;
	{
		...
		FMegalithActionResult R = Dispatch(TEXT("ai"), TEXT("add_bt_node"), P);
		if (!R.bSuccess)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to add Sequence node: %s"), *R.ErrorMessage));
		}
		if (R.Result.IsValid())
		{
	...
	// 2. Add RunEQS task under the sequence
	{
		...
		FMegalithActionResult R = Dispatch(TEXT("ai"), TEXT("add_bt_run_eqs_task"), P);
		if (!R.bSuccess)
		{
		...
		else
		{
			if (R.Result.IsValid())
			{
				...
				if (!NodeId.IsEmpty())
				{
					...
					FMegalithActionResult PropR = Dispatch(TEXT("ai"), TEXT("set_bt_node_property"), PropP);
					if (!PropR.bSuccess)
					{
...
FMegalithActionResult FMegalithAIScaffoldActions::HandleCreateBTFromTemplate(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath, TemplateName;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("save_path"), SavePath, ErrResult)) return ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("template"), TemplateName, ErrResult)) return ErrResult;
	...
	if (!R.bSuccess)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to build BT: %s"), *R.ErrorMessage));
	}
...
FMegalithActionResult FMegalithAIScaffoldActions::HandleCreateSTFromTemplate(const TSharedPtr<FJsonObject>& Params)
{
#if WITH_STATETREE
	FString SavePath, TemplateName;
	FMegalithActionResult ErrResult;
	...
	{
		return FMegalithActionResult::Error(TEXT("Unknown template. Valid: patrol, combat, investigation, ambient"));
	}
	...
	// Step 1: Create the State Tree
	{
		TSharedPtr<FJsonObject> P = MakeShared<FJsonObject>();
		P->SetStringField(TEXT("save_path"), SavePath);
		FMegalithActionResult R = Dispatch(TEXT("ai"), TEXT("create_state_tree"), P);
		if (!R.bSuccess)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create State Tree: %s"), *R.ErrorMessage));
		}
	}
	...
	// Step 2: Set schema to AI (standard for AI State Trees)
	{
		...
		FMegalithActionResult SchemaR = Dispatch(TEXT("ai"), TEXT("set_st_schema"), P);
		if (!SchemaR.bSuccess)
		{
			return FMegalithActionResult::Error(FString::Printf(
	...
	if (TemplateName == TEXT("patrol"))
	{
		...
		for (const FString& StateName : { TEXT("Patrol"), TEXT("Investigate"), TEXT("Chase") })
		{
			...
			FMegalithActionResult AddR = Dispatch(TEXT("ai"), TEXT("add_st_state"), P);
			if (!AddR.bSuccess)
			{
				return FMegalithActionResult::Error(FString::Printf(
	...
	return FMegalithActionResult::Success(Result);
#else
	return FMegalithActionResult::Error(TEXT("StateTree plugin is not available. Enable the StateTree plugin and rebuild."));
#endif
}
...
FMegalithActionResult FMegalithAIScaffoldActions::HandleBatchValidateAIAssets(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (Params->TryGetArrayField(TEXT("asset_paths"), AssetPathsArr) && AssetPathsArr && AssetPathsArr->Num() > 0)
	{
		...
		auto DispatchOne = [&](const FString& AssetPath, const FString& TypeName, const FString& ActionName)
		{
			...
			FMegalithActionResult R = Dispatch(TEXT("ai"), ActionName, P);
			++TotalAssets;
	...
	// Validate AI Controllers (Blueprints with AIController parent)
	{
		...
		for (const FAssetData& Asset : AllBPs)
		{
			...
			TSharedPtr<FJsonObject> P = MakeShared<FJsonObject>();
			P->SetStringField(TEXT("asset_path"), AssetPath);
			FMegalithActionResult R = Dispatch(TEXT("ai"), TEXT("validate_ai_controller"), P);
			++ControllerCount;
			++TotalAssets;
...
FMegalithActionResult FMegalithAIScaffoldActions::HandleValidateAIController(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UBlueprint* BP = MegalithAI::LoadAIControllerFromParams(Params, AssetPath, Error);
	if (!BP)
	{
...
FMegalithActionResult FMegalithAIScaffoldActions::HandleScaffoldAIControllerBlueprint(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath, BTPath, BBPath;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("save_path"), SavePath, ErrResult)) return ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("bt_path"), BTPath, ErrResult)) return ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("bb_path"), BBPath, ErrResult)) return ErrResult;
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Scaffold AI Controller Blueprint")));
...
FMegalithActionResult FMegalithAIScaffoldActions::HandleScaffoldCompanionAI(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath, Name;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("save_path"), SavePath, ErrResult)) return ErrResult;
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Scaffold Companion AI")));
	...
	// 1. Create Blackboard with companion-specific keys
	{
		...
		{
			return FMegalithActionResult::Error(TEXT("Failed to create Blackboard"));
		}
		CreatedAssets.Add(BBPath);
	...
	// Selector -> [Combat Sequence (if aggressive/defensive), Follow Sequence, Idle]
	{
		...
		P->SetObjectField(TEXT("spec"), Spec);
		FMegalithActionResult R = Dispatch(TEXT("ai"), TEXT("build_behavior_tree_from_spec"), P);
		if (!R.bSuccess) return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create BT: %s"), *R.ErrorMessage));
		CreatedAssets.Add(BTPath);
		...
		SetBBParams->SetStringField(TEXT("blackboard_path"), BBPath);
		FMegalithActionResult LinkResult = Dispatch(TEXT("ai"), TEXT("set_bt_blackboard"), SetBBParams);
		if (!LinkResult.bSuccess) return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to link BT to Blackboard: %s"), *LinkResult.ErrorMessage));
	}
	...
	return FMegalithActionResult::Success(BuildGenreScaffoldResult(Name, TEXT("Companion AI"), CreatedAssets, Warnings, NextSteps));
}
...
FMegalithActionResult FMegalithAIScaffoldActions::HandleScaffoldBossAI(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath, Name;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("save_path"), SavePath, ErrResult)) return ErrResult;
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Scaffold Boss AI")));
...
FMegalithActionResult FMegalithAIScaffoldActions::HandleScaffoldAmbientNPC(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath, Name;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("save_path"), SavePath, ErrResult)) return ErrResult;
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Scaffold Ambient NPC")));
	...
	return FMegalithActionResult::Success(BuildGenreScaffoldResult(Name, TEXT("Ambient NPC"), CreatedAssets, Warnings, NextSteps));
}
...
FMegalithActionResult FMegalithAIScaffoldActions::HandleScaffoldHorrorStalker(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath, Name;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("save_path"), SavePath, ErrResult)) return ErrResult;
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Scaffold Horror Stalker")));
	...
	return FMegalithActionResult::Success(BuildGenreScaffoldResult(Name, TEXT("Horror Stalker"), CreatedAssets, Warnings, NextSteps));
}
...
FMegalithActionResult FMegalithAIScaffoldActions::HandleScaffoldHorrorAmbush(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath, Name;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("save_path"), SavePath, ErrResult)) return ErrResult;
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Scaffold Horror Ambush")));
	TArray<FString> CreatedAssets, Warnings;
	FString BBPath = SavePath / TEXT("BB_") + Name;
	FString BTPath = SavePath / TEXT("BT_") + Name;
	...
	return FMegalithActionResult::Success(BuildGenreScaffoldResult(Name, TEXT("Horror Ambush"), CreatedAssets, Warnings, NextSteps));
}
...
FMegalithActionResult FMegalithAIScaffoldActions::HandleScaffoldHorrorPresence(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath, Name;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("save_path"), SavePath, ErrResult)) return ErrResult;
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Scaffold Horror Presence")));
	TArray<FString> CreatedAssets, Warnings;
	FString BBPath = SavePath / TEXT("BB_") + Name;
	FString BTPath = SavePath / TEXT("BT_") + Name;
	...
	return FMegalithActionResult::Success(BuildGenreScaffoldResult(Name, TEXT("Horror Presence"), CreatedAssets, Warnings, NextSteps));
}
...
FMegalithActionResult FMegalithAIScaffoldActions::HandleScaffoldHorrorMimic(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath, Name;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("save_path"), SavePath, ErrResult)) return ErrResult;
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Scaffold Horror Mimic")));
	TArray<FString> CreatedAssets, Warnings;
	FString BBPath = SavePath / TEXT("BB_") + Name;
	FString BTPath = SavePath / TEXT("BT_") + Name;
	...
	return FMegalithActionResult::Success(BuildGenreScaffoldResult(Name, TEXT("Horror Mimic"), CreatedAssets, Warnings, NextSteps));
}
...
FMegalithActionResult FMegalithAIScaffoldActions::HandleScaffoldStealthGameAI(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath, Name;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("save_path"), SavePath, ErrResult)) return ErrResult;
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Scaffold Stealth Game AI")));
	TArray<FString> CreatedAssets, Warnings;
	FString BBPath = SavePath / TEXT("BB_") + Name;
	FString BTPath = SavePath / TEXT("BT_") + Name;
	...
	return FMegalithActionResult::Success(BuildGenreScaffoldResult(Name, TEXT("Stealth Game AI"), CreatedAssets, Warnings, NextSteps));
}
...
FMegalithActionResult FMegalithAIScaffoldActions::HandleScaffoldTurretAI(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath, Name;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("save_path"), SavePath, ErrResult)) return ErrResult;
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Scaffold Turret AI")));
	TArray<FString> CreatedAssets, Warnings;
	FString BBPath = SavePath / TEXT("BB_") + Name;
	FString BTPath = SavePath / TEXT("BT_") + Name;
	...
	return FMegalithActionResult::Success(BuildGenreScaffoldResult(Name, TEXT("Turret AI"), CreatedAssets, Warnings, NextSteps));
}
...
FMegalithActionResult FMegalithAIScaffoldActions::HandleScaffoldGroupCoordinator(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath, Name;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("save_path"), SavePath, ErrResult)) return ErrResult;
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Scaffold Group Coordinator")));
	TArray<FString> CreatedAssets, Warnings;
	FString BBPath = SavePath / TEXT("BB_") + Name;
	FString BTPath = SavePath / TEXT("BT_") + Name;
...
FMegalithActionResult FMegalithAIScaffoldActions::HandleScaffoldFlyingAI(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath, Name;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("save_path"), SavePath, ErrResult)) return ErrResult;
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Scaffold Flying AI")));
	TArray<FString> CreatedAssets, Warnings;
	FString BBPath = SavePath / TEXT("BB_") + Name;
	FString BTPath = SavePath / TEXT("BT_") + Name;
	...
	return FMegalithActionResult::Success(BuildGenreScaffoldResult(Name, TEXT("Flying AI"), CreatedAssets, Warnings, NextSteps));
}
