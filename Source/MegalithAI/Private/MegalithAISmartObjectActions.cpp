...
void FMegalithAISmartObjectActions::RegisterActions(FMegalithToolRegistry& Registry)
{
#if WITH_SMARTOBJECTS
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("create_smart_object_definition"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateSmartObjectDefinition),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("get_smart_object_definition"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetSmartObjectDefinition),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("list_smart_object_definitions"),
		...
		FMegalithActionHandler::CreateStatic(&HandleListSmartObjectDefinitions),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("delete_smart_object_definition"),
		...
		FMegalithActionHandler::CreateStatic(&HandleDeleteSmartObjectDefinition),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("add_so_slot"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddSOSlot),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Smart Object Definition asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("remove_so_slot"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveSOSlot),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Smart Object Definition asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("configure_so_slot"),
		...
		FMegalithActionHandler::CreateStatic(&HandleConfigureSOSlot),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Smart Object Definition asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("add_so_behavior_definition"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddSOBehaviorDefinition),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Smart Object Definition asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("remove_so_behavior_definition"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveSOBehaviorDefinition),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Smart Object Definition asset path"))
			.Required(TEXT("slot_index"), TEXT("integer"), TEXT("Index of the slot"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("set_so_tags"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetSOTags),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Smart Object Definition asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("add_smart_object_component"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddSmartObjectComponent),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("place_smart_object_actor"),
		...
		FMegalithActionHandler::CreateStatic(&HandlePlaceSmartObjectActor),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("find_smart_objects_in_level"),
		...
		FMegalithActionHandler::CreateStatic(&HandleFindSmartObjectsInLevel),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("validate_smart_object_definition"),
		...
		FMegalithActionHandler::CreateStatic(&HandleValidateSmartObjectDefinition),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Smart Object Definition asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("create_so_from_template"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateSOFromTemplate),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("duplicate_smart_object_definition"),
		...
		FMegalithActionHandler::CreateStatic(&HandleDuplicateSmartObjectDefinition),
		FParamSchemaBuilder()
...
USmartObjectDefinition* FMegalithAISmartObjectActions::LoadSODefinition(
	const TSharedPtr<FJsonObject>& Params, FString& OutAssetPath, FString& OutError)
{
	...
	UObject* Asset = FMegalithAssetUtils::LoadAssetByPath(USmartObjectDefinition::StaticClass(), OutAssetPath);
...
namespace
{
	 ...
	 * emit a "warnings" array on the response (model: MegalithLogicDriverNodeActions::set_node_tags / Phase B B5).
	 *
	 * The header-declared FMegalithAISmartObjectActions::ParseTagContainer one-arg overload is preserved
		...
		TArray<FString>& OutSkipped)
	{
		...
		TArray<FString> TagStrings = MegalithAI::ParseStringArray(Params, FieldName);
		for (const FString& TagStr : TagStrings)
		{
			...
			{
				UE_LOG(LogMegalithAI, Warning, TEXT("Gameplay tag not found: '%s' (field=%s)"), *TagStr, *FieldName);
...
void FMegalithAISmartObjectActions::ParseTagContainer(
...
TSharedPtr<FJsonObject> FMegalithAISmartObjectActions::SlotToJson(
...
TSharedPtr<FJsonObject> FMegalithAISmartObjectActions::DefinitionToJson(
...
FMegalithActionResult FMegalithAISmartObjectActions::HandleCreateSmartObjectDefinition(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath;
	...
	if (!Def)
	{
		return FMegalithActionResult::Error(TEXT("Failed to create USmartObjectDefinition object"));
	}

	FAssetRegistryModule::AssetCreated(Def);
	Def->MarkPackageDirty();

	TSharedPtr<FJsonObject> Result = MegalithAI::MakeAssetResult(PackagePath, TEXT("Smart Object Definition created"));
...
FMegalithActionResult FMegalithAISmartObjectActions::HandleGetSmartObjectDefinition(const TSharedPtr<FJsonObject>& Params)
{
	...
	return FMegalithActionResult::Success(DefinitionToJson(Def, AssetPath));
}
...
FMegalithActionResult FMegalithAISmartObjectActions::HandleListSmartObjectDefinitions(const TSharedPtr<FJsonObject>& Params)
{
...
FMegalithActionResult FMegalithAISmartObjectActions::HandleDeleteSmartObjectDefinition(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	FMegalithActionResult ErrResult;
	...
	UObject* Asset = FMegalithAssetUtils::LoadAssetByPath(USmartObjectDefinition::StaticClass(), AssetPath);
	if (!Asset)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Asset not found: %s"), *AssetPath));
	}
...
FMegalithActionResult FMegalithAISmartObjectActions::HandleAddSOSlot(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	USmartObjectDefinition* Def = LoadSODefinition(Params, AssetPath, Error);
	if (!Def)
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Add Smart Object Slot")));
	Def->Modify();
	...
	TSharedPtr<FJsonObject> Result = MegalithAI::MakeAssetResult(AssetPath, TEXT("Slot added"));
...
FMegalithActionResult FMegalithAISmartObjectActions::HandleRemoveSOSlot(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	USmartObjectDefinition* Def = LoadSODefinition(Params, AssetPath, Error);
	if (!Def)
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Remove Smart Object Slot")));
	Def->Modify();
	...
	if (!SlotsProp)
	{
		return FMegalithActionResult::Error(TEXT("Internal error: could not find Slots property on USmartObjectDefinition"));
	}

	FArrayProperty* ArrayProp = CastField<FArrayProperty>(SlotsProp);
	if (!ArrayProp)
	{
		return FMegalithActionResult::Error(TEXT("Internal error: Slots property is not an array"));
	}
	...
	TSharedPtr<FJsonObject> Result = MegalithAI::MakeAssetResult(AssetPath, TEXT("Slot removed"));
...
FMegalithActionResult FMegalithAISmartObjectActions::HandleConfigureSOSlot(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	USmartObjectDefinition* Def = LoadSODefinition(Params, AssetPath, Error);
	if (!Def)
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Configure Smart Object Slot")));
	Def->Modify();
	...
	TSharedPtr<FJsonObject> Result = MegalithAI::MakeAssetResult(AssetPath, TEXT("Slot configured"));
	Result->SetNumberField(TEXT("slot_index"), SlotIndex);
...
FMegalithActionResult FMegalithAISmartObjectActions::HandleAddSOBehaviorDefinition(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	USmartObjectDefinition* Def = LoadSODefinition(Params, AssetPath, Error);
	if (!Def)
	...
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("behavior_class"), BehaviorClassName, ErrResult))
	{
		return ErrResult;
	}
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Add SO Behavior Definition")));
	Def->Modify();
	...
	if (!NewBehavior)
	{
		return FMegalithActionResult::Error(TEXT("Failed to create behavior definition object"));
	}
	...
	TSharedPtr<FJsonObject> Result = MegalithAI::MakeAssetResult(AssetPath, TEXT("Behavior definition added"));
	Result->SetNumberField(TEXT("slot_index"), SlotIndex);
...
FMegalithActionResult FMegalithAISmartObjectActions::HandleRemoveSOBehaviorDefinition(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	USmartObjectDefinition* Def = LoadSODefinition(Params, AssetPath, Error);
	if (!Def)
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Remove SO Behavior Definition")));
	Def->Modify();

	Slot.BehaviorDefinitions.RemoveAt(BehaviorIndex);
	Def->MarkPackageDirty();

	TSharedPtr<FJsonObject> Result = MegalithAI::MakeAssetResult(AssetPath, TEXT("Behavior definition removed"));
	Result->SetNumberField(TEXT("slot_index"), SlotIndex);
...
FMegalithActionResult FMegalithAISmartObjectActions::HandleSetSOTags(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	USmartObjectDefinition* Def = LoadSODefinition(Params, AssetPath, Error);
	if (!Def)
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Set SO Tags")));
	Def->Modify();
	...
	TSharedPtr<FJsonObject> Result = MegalithAI::MakeAssetResult(AssetPath, TEXT("Tags updated"));
...
FMegalithActionResult FMegalithAISmartObjectActions::HandleAddSmartObjectComponent(const TSharedPtr<FJsonObject>& Params)
{
	FString BlueprintPath;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("blueprint_path"), BlueprintPath, ErrResult))
	{
		return ErrResult;
	}

	FString DefinitionPath;
	if (!MegalithAI::RequireStringParam(Params, TEXT("definition_path"), DefinitionPath, ErrResult))
	{
		return ErrResult;
	}
	...
	// Load the Blueprint
	FString LoadError;
	UObject* BPObj = MegalithAI::LoadAssetFromPath(BlueprintPath, LoadError);
	if (!BPObj)
	{
	...
	if (!BP)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("'%s' is not a Blueprint"), *BlueprintPath));
	}

	if (!BP->SimpleConstructionScript)
	{
		return FMegalithActionResult::Error(TEXT("Blueprint has no SimpleConstructionScript — is it an Actor Blueprint?"));
	}

	// Load the SO definition
	USmartObjectDefinition* SODef = Cast<USmartObjectDefinition>(
		FMegalithAssetUtils::LoadAssetByPath(USmartObjectDefinition::StaticClass(), DefinitionPath));
	if (!SODef)
	{
		return FMegalithActionResult::Error(FString::Printf(
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Add SmartObject Component")));
	...
	if (!NewNode)
	{
		...
		return FMegalithActionResult::Error(TEXT("Failed to create SmartObjectComponent SCS node"));
	}
	...
	TSharedPtr<FJsonObject> Result = MegalithAI::MakeAssetResult(BlueprintPath, TEXT("SmartObjectComponent added"));
...
FMegalithActionResult FMegalithAISmartObjectActions::HandlePlaceSmartObjectActor(const TSharedPtr<FJsonObject>& Params)
{
	FString DefinitionPath;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("definition_path"), DefinitionPath, ErrResult))
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: location {x, y, z}"));
	}
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Place Smart Object Actor")));
	...
	if (!NewActor)
	{
		return FMegalithActionResult::Error(TEXT("Failed to spawn actor"));
	}
...
FMegalithActionResult FMegalithAISmartObjectActions::HandleFindSmartObjectsInLevel(const TSharedPtr<FJsonObject>& Params)
{
	UWorld* World = GEditor ? GEditor->GetEditorWorldContext().World() : nullptr;
	if (!World)
	{
...
FMegalithActionResult FMegalithAISmartObjectActions::HandleValidateSmartObjectDefinition(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	USmartObjectDefinition* Def = LoadSODefinition(Params, AssetPath, Error);
	if (!Def)
...
FMegalithActionResult FMegalithAISmartObjectActions::HandleCreateSOFromTemplate(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("save_path"), SavePath, ErrResult))
	...
	if (!Def)
	{
		return FMegalithActionResult::Error(TEXT("Failed to create USmartObjectDefinition"));
	}
	...
	TSharedPtr<FJsonObject> Result = MegalithAI::MakeAssetResult(PackagePath,
...
FMegalithActionResult FMegalithAISmartObjectActions::HandleDuplicateSmartObjectDefinition(const TSharedPtr<FJsonObject>& Params)
{
	...
	USmartObjectDefinition* SourceDef = Cast<USmartObjectDefinition>(
		FMegalithAssetUtils::LoadAssetByPath(USmartObjectDefinition::StaticClass(), SourcePath));
	if (!SourceDef)
	{
		return FMegalithActionResult::Error(FString::Printf(
