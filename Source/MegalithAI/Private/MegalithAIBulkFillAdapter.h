 ...
 * Self-registers with FMegalithBulkFillRegistry from FMegalithAIModule::StartupModule.
 *
 * No optional-dep gate — MegalithAI is core (AIModule + GameplayTasks + NavigationSystem
 ...
 */
class FMegalithAIBulkFillAdapter
{
public:
	/** Register the adapter pair with FMegalithBulkFillRegistry under namespace "ai". */
	static void Register();

	/** Unregister (called from FMegalithAIModule::ShutdownModule). */
