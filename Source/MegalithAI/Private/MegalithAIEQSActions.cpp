...
namespace
{
	...
	UEnvQuery* LoadEQSFromParams(const TSharedPtr<FJsonObject>& Params, FString& OutAssetPath, FString& OutError)
	{
		...
		UObject* Obj = FMegalithAssetUtils::LoadAssetByPath(UEnvQuery::StaticClass(), OutAssetPath);
	...
	void ApplyEQSProperties(UObject* Obj, const TSharedPtr<FJsonObject>& PropsObj, TArray<FString>& OutErrors)
	{
		...
		{
			FString Error;
			if (!SetEQSPropertyValue(Obj, MegalithKeyToString(Pair.Key), Pair.Value, Error))
			{
				OutErrors.Add(Error);
			}
		}
...
void FMegalithAIEQSActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	// 71. create_eqs_query
	Registry.RegisterAction(TEXT("ai"), TEXT("create_eqs_query"),
		TEXT("Create an empty UEnvQuery data asset"),
		FMegalithActionHandler::CreateStatic(&HandleCreateEQSQuery),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("get_eqs_query"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetEQSQuery),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("list_eqs_queries"),
		...
		FMegalithActionHandler::CreateStatic(&HandleListEQSQueries),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("delete_eqs_query"),
		...
		FMegalithActionHandler::CreateStatic(&HandleDeleteEQSQuery),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("duplicate_eqs_query"),
		...
		FMegalithActionHandler::CreateStatic(&HandleDuplicateEQSQuery),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("add_eqs_generator"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddEQSGenerator),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("EQS query asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("remove_eqs_generator"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveEQSGenerator),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("EQS query asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("configure_eqs_generator"),
		...
		FMegalithActionHandler::CreateStatic(&HandleConfigureEQSGenerator),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("EQS query asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("add_eqs_test"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddEQSTest),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("EQS query asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("remove_eqs_test"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveEQSTest),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("EQS query asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("configure_eqs_test"),
		...
		FMegalithActionHandler::CreateStatic(&HandleConfigureEQSTest),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("EQS query asset path"))
			.Required(TEXT("option_index"), TEXT("number"), TEXT("Index of the option"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("configure_eqs_scoring"),
		...
		FMegalithActionHandler::CreateStatic(&HandleConfigureEQSScoring),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("EQS query asset path"))
			.Required(TEXT("option_index"), TEXT("number"), TEXT("Index of the option"))
			.Required(TEXT("test_index"), TEXT("number"), TEXT("Index of the test"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("configure_eqs_filter"),
		...
		FMegalithActionHandler::CreateStatic(&HandleConfigureEQSFilter),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("EQS query asset path"))
			.Required(TEXT("option_index"), TEXT("number"), TEXT("Index of the option"))
			.Required(TEXT("test_index"), TEXT("number"), TEXT("Index of the test"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("list_eqs_generator_types"),
		...
		FMegalithActionHandler::CreateStatic(&HandleListEQSGeneratorTypes),
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("validate_eqs_query"),
		...
		FMegalithActionHandler::CreateStatic(&HandleValidateEQSQuery),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("EQS query asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("reorder_eqs_tests"),
		...
		FMegalithActionHandler::CreateStatic(&HandleReorderEQSTests),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("EQS query asset path"))
			.Required(TEXT("option_index"), TEXT("number"), TEXT("Index of the option"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("build_eqs_query_from_spec"),
		...
		FMegalithActionHandler::CreateStatic(&HandleBuildEQSQueryFromSpec),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("create_eqs_from_template"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateEQSFromTemplate),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("save_path"), TEXT("Asset save path for the new EQS query"))
...
FMegalithActionResult FMegalithAIEQSActions::HandleCreateEQSQuery(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath;
	...
	if (!Query)
	{
		return FMegalithActionResult::Error(TEXT("Failed to create UEnvQuery object"));
	}

	FAssetRegistryModule::AssetCreated(Query);
	Query->MarkPackageDirty();

	TSharedPtr<FJsonObject> Result = MegalithAI::MakeAssetResult(PackagePath, TEXT("EQS query created"));
...
FMegalithActionResult FMegalithAIEQSActions::HandleGetEQSQuery(const TSharedPtr<FJsonObject>& Params)
{
...
FMegalithActionResult FMegalithAIEQSActions::HandleListEQSQueries(const TSharedPtr<FJsonObject>& Params)
{
...
FMegalithActionResult FMegalithAIEQSActions::HandleDeleteEQSQuery(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	FMegalithActionResult ErrResult;
	...
	UObject* Asset = FMegalithAssetUtils::LoadAssetByPath(UEnvQuery::StaticClass(), AssetPath);
	if (!Asset)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("EQS query not found: %s"), *AssetPath));
	}
...
FMegalithActionResult FMegalithAIEQSActions::HandleDuplicateEQSQuery(const TSharedPtr<FJsonObject>& Params)
{
	...
	UEnvQuery* SourceQuery = Cast<UEnvQuery>(FMegalithAssetUtils::LoadAssetByPath(UEnvQuery::StaticClass(), SourcePath));
	if (!SourceQuery)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Source EQS query not found: %s"), *SourcePath));
	}
...
FMegalithActionResult FMegalithAIEQSActions::HandleAddEQSGenerator(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UEnvQuery* Query = LoadEQSFromParams(Params, AssetPath, Error);
	if (!Query)
	...
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("generator_class"), GeneratorClassName, ErrResult))
	{
		return ErrResult;
	}
	...
	if (!GenClass)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Generator class not found: %s. Use list_eqs_generator_types to see available classes."), *GeneratorClassName));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Add EQS Generator")));
	Query->Modify();
...
FMegalithActionResult FMegalithAIEQSActions::HandleRemoveEQSGenerator(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UEnvQuery* Query = LoadEQSFromParams(Params, AssetPath, Error);
	if (!Query)
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Remove EQS Generator")));
	Query->Modify();
...
FMegalithActionResult FMegalithAIEQSActions::HandleConfigureEQSGenerator(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UEnvQuery* Query = LoadEQSFromParams(Params, AssetPath, Error);
	if (!Query)
	...
	if (!Option->Generator)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Option %d has no generator"), OptionIndex));
	}

	const TSharedPtr<FJsonObject>* PropsObj = nullptr;
	if (!Params->TryGetObjectField(TEXT("properties"), PropsObj) || !PropsObj->IsValid())
	{
		return FMegalithActionResult::Error(TEXT("Missing required param: properties"));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Configure EQS Generator")));
	Query->Modify();
...
FMegalithActionResult FMegalithAIEQSActions::HandleAddEQSTest(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UEnvQuery* Query = LoadEQSFromParams(Params, AssetPath, Error);
	if (!Query)
	...
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("test_class"), TestClassName, ErrResult))
	{
		return ErrResult;
	}
	...
	if (!TestClass)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Test class not found: %s. Use list_eqs_test_types to see available classes."), *TestClassName));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Add EQS Test")));
	Query->Modify();
...
FMegalithActionResult FMegalithAIEQSActions::HandleRemoveEQSTest(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UEnvQuery* Query = LoadEQSFromParams(Params, AssetPath, Error);
	if (!Query)
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Remove EQS Test")));
	Query->Modify();
...
FMegalithActionResult FMegalithAIEQSActions::HandleConfigureEQSTest(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UEnvQuery* Query = LoadEQSFromParams(Params, AssetPath, Error);
	if (!Query)
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Configure EQS Test")));
	Query->Modify();
...
FMegalithActionResult FMegalithAIEQSActions::HandleConfigureEQSScoring(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UEnvQuery* Query = LoadEQSFromParams(Params, AssetPath, Error);
	if (!Query)
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Configure EQS Scoring")));
	Query->Modify();
	...
	if (!PurposeStr.IsEmpty())
	{
		...
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Invalid purpose: '%s'. Use: Filter, Score, FilterAndScore"), *PurposeStr));
		}
	}
	...
	if (!EquationStr.IsEmpty())
	{
		...
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Invalid equation: '%s'. Use: Linear, InverseLinear, Square, Constant"), *EquationStr));
		}
	}
...
FMegalithActionResult FMegalithAIEQSActions::HandleConfigureEQSFilter(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UEnvQuery* Query = LoadEQSFromParams(Params, AssetPath, Error);
	if (!Query)
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Configure EQS Filter")));
	Query->Modify();
	...
	if (!FilterTypeStr.IsEmpty())
	{
		...
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Invalid filter_type: '%s'. Use: Minimum, Maximum, Range, Match"), *FilterTypeStr));
		}
	}
...
FMegalithActionResult FMegalithAIEQSActions::HandleListEQSGeneratorTypes(const TSharedPtr<FJsonObject>& Params)
{
...
FMegalithActionResult FMegalithAIEQSActions::HandleListEQSTestTypes(const TSharedPtr<FJsonObject>& Params)
{
...
FMegalithActionResult FMegalithAIEQSActions::HandleListEQSContexts(const TSharedPtr<FJsonObject>& Params)
{
...
FMegalithActionResult FMegalithAIEQSActions::HandleValidateEQSQuery(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UEnvQuery* Query = LoadEQSFromParams(Params, AssetPath, Error);
	if (!Query)
...
FMegalithActionResult FMegalithAIEQSActions::HandleReorderEQSTests(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UEnvQuery* Query = LoadEQSFromParams(Params, AssetPath, Error);
	if (!Query)
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required param: new_order (array of test indices)"));
	}
	...
	for (const TSharedPtr<FJsonValue>& Val : *NewOrderArr)
	{
		...
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Test index %d out of range [0, %d)"), Idx, TestCount));
		}
		if (Seen.Contains(Idx))
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Duplicate test index %d in new_order"), Idx));
		}
		Seen.Add(Idx);
		NewOrder.Add(Idx);
	}
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("new_order has %d elements but option has %d tests — must include all indices exactly once"), NewOrder.Num(), TestCount));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Reorder EQS Tests")));
	Query->Modify();
...
FMegalithActionResult FMegalithAIEQSActions::HandleBuildEQSQueryFromSpec(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("save_path"), SavePath, ErrResult))
	...
	{
		return FMegalithActionResult::Error(TEXT("Spec must contain 'options' array with at least one option"));
	}
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Build EQS From Spec")));
...
FMegalithActionResult FMegalithAIEQSActions::HandleCreateEQSFromTemplate(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("save_path"), SavePath, ErrResult))
	...
	if (!MegalithAI::RequireStringParam(Params, TEXT("template"), TemplateName, ErrResult))
	{
		return ErrResult;
	}
	...
	FMegalithActionResult SpecResult = HandleBuildEQSQueryFromSpec(SpecParams);
