...
UWorld* FMegalithAINavigationActions::GetNavWorld()
{
	UWorld* World = MegalithAI::GetPIEWorld();
	if (!World)
	{
...
FVector FMegalithAINavigationActions::ParseVector(const TSharedPtr<FJsonObject>& Params, const FString& FieldName, bool& bOutFound)
{
	bOutFound = false;
...
TArray<TSharedPtr<FJsonValue>> FMegalithAINavigationActions::VectorToJsonArray(const FVector& V)
{
...
void FMegalithAINavigationActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("get_nav_system_config"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetNavSystemConfig),
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("get_navmesh_config"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetNavMeshConfig),
		FParamSchemaBuilder().Build());
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("set_navmesh_config"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetNavMeshConfig),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("get_navmesh_stats"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetNavMeshStats),
		FParamSchemaBuilder().Build());
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("add_nav_bounds_volume"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddNavBoundsVolume),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("list_nav_bounds_volumes"),
		...
		FMegalithActionHandler::CreateStatic(&HandleListNavBoundsVolumes),
		FParamSchemaBuilder().Build());
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("build_navigation"),
		...
		FMegalithActionHandler::CreateStatic(&HandleBuildNavigation),
		FParamSchemaBuilder().Build());
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("add_nav_modifier_volume"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddNavModifierVolume),
		FParamSchemaBuilder()
			.Required(TEXT("location"), TEXT("object"), TEXT("World position {x, y, z} or [x, y, z]"))
			.Required(TEXT("extent"), TEXT("object"), TEXT("Half-extents {x, y, z} or [x, y, z]"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("add_nav_link_proxy"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddNavLinkProxy),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("configure_nav_link"),
		...
		FMegalithActionHandler::CreateStatic(&HandleConfigureNavLink),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("list_nav_links"),
		...
		FMegalithActionHandler::CreateStatic(&HandleListNavLinks),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("find_path"),
		...
		FMegalithActionHandler::CreateStatic(&HandleFindPath),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("test_path"),
		...
		FMegalithActionHandler::CreateStatic(&HandleTestPath),
		FParamSchemaBuilder()
			.Required(TEXT("start"), TEXT("object"), TEXT("Start position {x, y, z} or [x, y, z]"))
			.Required(TEXT("end"), TEXT("object"), TEXT("End position {x, y, z} or [x, y, z]"))
			.Build());
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("project_point_to_navigation"),
		...
		FMegalithActionHandler::CreateStatic(&HandleProjectPointToNavigation),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("get_random_navigable_point"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetRandomNavigablePoint),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("navigation_raycast"),
		...
		FMegalithActionHandler::CreateStatic(&HandleNavigationRaycast),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("configure_nav_agent"),
		...
		FMegalithActionHandler::CreateStatic(&HandleConfigureNavAgent),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("add_nav_invoker_component"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddNavInvokerComponent),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("get_crowd_manager_config"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetCrowdManagerConfig),
		FParamSchemaBuilder().Build());
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("set_crowd_manager_config"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetCrowdManagerConfig),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("analyze_navigation_coverage"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAnalyzeNavigationCoverage),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("rebuild_navigation"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRebuildNavigation),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("validate_nav_points"),
		...
		FMegalithActionHandler::CreateStatic(&HandleValidateNavPoints),
		FParamSchemaBuilder()
...
FMegalithActionResult FMegalithAINavigationActions::HandleGetNavSystemConfig(const TSharedPtr<FJsonObject>& Params)
{
	UWorld* World = GetNavWorld();
	if (!World)
	{
		return FMegalithActionResult::Error(TEXT("No world available"));
	}

	UNavigationSystemV1* NavSys = FNavigationSystem::GetCurrent<UNavigationSystemV1>(World);
	if (!NavSys)
	{
		return FMegalithActionResult::Error(TEXT("NavigationSystemV1 not found in world"));
	}
...
FMegalithActionResult FMegalithAINavigationActions::HandleGetNavMeshConfig(const TSharedPtr<FJsonObject>& Params)
{
	UWorld* World = GetNavWorld();
	if (!World)
	{
	...
	if (!NavSys)
	{
		return FMegalithActionResult::Error(TEXT("NavigationSystemV1 not found"));
	}
	...
	if (!NavMesh)
	{
		return FMegalithActionResult::Error(TEXT("No ARecastNavMesh found. Ensure a NavMeshBoundsVolume exists and nav data has been created."));
	}
...
FMegalithActionResult FMegalithAINavigationActions::HandleSetNavMeshConfig(const TSharedPtr<FJsonObject>& Params)
{
	UWorld* World = GetNavWorld();
	if (!World)
	{
	...
	if (!NavMesh)
	{
		return FMegalithActionResult::Error(TEXT("No ARecastNavMesh found"));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Set NavMesh Config")));
	NavMesh->Modify();
...
FMegalithActionResult FMegalithAINavigationActions::HandleGetNavMeshStats(const TSharedPtr<FJsonObject>& Params)
{
	UWorld* World = GetNavWorld();
	if (!World)
	{
...
FMegalithActionResult FMegalithAINavigationActions::HandleAddNavBoundsVolume(const TSharedPtr<FJsonObject>& Params)
{
	UWorld* World = GetNavWorld();
	if (!World)
	{
	...
	if (!bLocFound)
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: location"));
	}
	if (!bExtFound)
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: extent"));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Add NavMeshBoundsVolume")));
	...
	if (!NavVol)
	{
		return FMegalithActionResult::Error(TEXT("Failed to spawn NavMeshBoundsVolume"));
	}
...
FMegalithActionResult FMegalithAINavigationActions::HandleListNavBoundsVolumes(const TSharedPtr<FJsonObject>& Params)
{
	UWorld* World = GetNavWorld();
	if (!World)
	{
...
FMegalithActionResult FMegalithAINavigationActions::HandleBuildNavigation(const TSharedPtr<FJsonObject>& Params)
{
	UWorld* World = GetNavWorld();
	if (!World)
	{
...
FMegalithActionResult FMegalithAINavigationActions::HandleGetNavBuildStatus(const TSharedPtr<FJsonObject>& Params)
{
	UWorld* World = GetNavWorld();
	if (!World)
	{
...
FMegalithActionResult FMegalithAINavigationActions::HandleListNavAreas(const TSharedPtr<FJsonObject>& Params)
{
...
FMegalithActionResult FMegalithAINavigationActions::HandleCreateNavArea(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath, Name;
	FMegalithActionResult Err;
	if (!MegalithAI::RequireStringParam(Params, TEXT("save_path"), SavePath, Err)) return Err;
	if (!MegalithAI::RequireStringParam(Params, TEXT("name"), Name, Err)) return Err;

	FString Error;
	if (!MegalithAI::EnsureAssetPathFree(SavePath, Name, Error))
	{
		return FMegalithActionResult::Error(Error);
	}

	UPackage* Package = MegalithAI::GetOrCreatePackage(SavePath, Error);
	if (!Package)
	{
		return FMegalithActionResult::Error(Error);
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Create NavArea")));

	UNavArea* NewArea = NewObject<UNavArea>(Package, *Name, RF_Public | RF_Standalone);
	if (!NewArea)
	{
		return FMegalithActionResult::Error(TEXT("Failed to create UNavArea"));
	}
	...
	auto Result = MegalithAI::MakeAssetResult(SavePath + TEXT(".") + Name, TEXT("NavArea created"));
...
FMegalithActionResult FMegalithAINavigationActions::HandleAddNavModifierVolume(const TSharedPtr<FJsonObject>& Params)
{
	UWorld* World = GetNavWorld();
	if (!World)
	{
	...
	if (!bLocFound) return FMegalithActionResult::Error(TEXT("Missing required parameter: location"));
	if (!bExtFound) return FMegalithActionResult::Error(TEXT("Missing required parameter: extent"));

	FString AreaClassName = Params->GetStringField(TEXT("area_class"));
	if (AreaClassName.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: area_class"));
	}
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Nav area class not found: %s"), *AreaClassName));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Add NavModifierVolume")));
	...
	if (!ModVol)
	{
		return FMegalithActionResult::Error(TEXT("Failed to spawn NavModifierVolume"));
	}
...
FMegalithActionResult FMegalithAINavigationActions::HandleAddNavLinkProxy(const TSharedPtr<FJsonObject>& Params)
{
	UWorld* World = GetNavWorld();
	if (!World)
	{
	...
	if (!bStartFound) return FMegalithActionResult::Error(TEXT("Missing required parameter: start_location"));
	if (!bEndFound) return FMegalithActionResult::Error(TEXT("Missing required parameter: end_location"));

	FString LinkType = Params->GetStringField(TEXT("link_type"));
	bool bSmartLink = LinkType.Equals(TEXT("smart"), ESearchCase::IgnoreCase);

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Add NavLinkProxy")));
	...
	if (!LinkActor)
	{
		return FMegalithActionResult::Error(TEXT("Failed to spawn NavLinkProxy"));
	}
...
FMegalithActionResult FMegalithAINavigationActions::HandleConfigureNavLink(const TSharedPtr<FJsonObject>& Params)
{
	FString ActorPath = Params->GetStringField(TEXT("actor_path"));
	if (ActorPath.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: actor_path"));
	}
	...
	if (!LinkActor)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("NavLinkProxy not found: %s"), *ActorPath));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Configure NavLink")));
	LinkActor->Modify();
...
FMegalithActionResult FMegalithAINavigationActions::HandleListNavLinks(const TSharedPtr<FJsonObject>& Params)
{
	UWorld* World = GetNavWorld();
	if (!World)
	{
...
FMegalithActionResult FMegalithAINavigationActions::HandleFindPath(const TSharedPtr<FJsonObject>& Params)
{
	UWorld* World = GetNavWorld();
	if (!World)
	{
	...
	if (!bStartFound) return FMegalithActionResult::Error(TEXT("Missing required parameter: start"));
	if (!bEndFound) return FMegalithActionResult::Error(TEXT("Missing required parameter: end"));

	ANavigationData* NavData = NavSys->GetDefaultNavDataInstance();
	if (!NavData)
	{
		return FMegalithActionResult::Error(TEXT("No navigation data available. Build navigation first."));
	}
...
FMegalithActionResult FMegalithAINavigationActions::HandleTestPath(const TSharedPtr<FJsonObject>& Params)
{
	UWorld* World = GetNavWorld();
	if (!World)
	{
...
FMegalithActionResult FMegalithAINavigationActions::HandleProjectPointToNavigation(const TSharedPtr<FJsonObject>& Params)
{
	UWorld* World = GetNavWorld();
	if (!World)
	{
	...
	if (!bPointFound)
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: point"));
	}
...
FMegalithActionResult FMegalithAINavigationActions::HandleGetRandomNavigablePoint(const TSharedPtr<FJsonObject>& Params)
{
	UWorld* World = GetNavWorld();
	if (!World)
	{
...
FMegalithActionResult FMegalithAINavigationActions::HandleNavigationRaycast(const TSharedPtr<FJsonObject>& Params)
{
	UWorld* World = GetNavWorld();
	if (!World)
	{
...
FMegalithActionResult FMegalithAINavigationActions::HandleConfigureNavAgent(const TSharedPtr<FJsonObject>& Params)
{
	UWorld* World = GetNavWorld();
	if (!World)
	{
	...
	if (!AgentsProp)
	{
		return FMegalithActionResult::Error(TEXT("Could not find SupportedAgents property on NavigationSystem"));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Configure Nav Agent")));
	NavSys->Modify();
	...
	{
		return FMegalithActionResult::Error(TEXT("Agent index out of bounds"));
	}
...
FMegalithActionResult FMegalithAINavigationActions::HandleAddNavInvokerComponent(const TSharedPtr<FJsonObject>& Params)
{
	FString BlueprintPath = Params->GetStringField(TEXT("blueprint_path"));
	if (BlueprintPath.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: blueprint_path"));
	}

	FString Error;
	UObject* Obj = MegalithAI::LoadAssetFromPath(BlueprintPath, Error);
	if (!Obj)
	{
		return FMegalithActionResult::Error(Error);
	}
	...
	if (!BP)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Asset is not a Blueprint: %s"), *BlueprintPath));
	}

	if (!BP->SimpleConstructionScript)
	{
		return FMegalithActionResult::Error(TEXT("Blueprint has no SimpleConstructionScript"));
	}
	...
	if (!InvokerClass)
	{
		return FMegalithActionResult::Error(TEXT("UNavigationInvokerComponent class not found. Ensure NavigationSystem module is loaded."));
	}
	...
	for (USCS_Node* Node : BP->SimpleConstructionScript->GetAllNodes())
	{
		...
		{
			return FMegalithActionResult::Error(TEXT("Blueprint already has a NavigationInvokerComponent"));
		}
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Add NavInvokerComponent")));

	USCS_Node* NewNode = BP->SimpleConstructionScript->CreateNode(InvokerClass, TEXT("NavInvoker"));
	if (!NewNode)
	{
		return FMegalithActionResult::Error(TEXT("Failed to create SCS node"));
	}
...
FMegalithActionResult FMegalithAINavigationActions::HandleGetCrowdManagerConfig(const TSharedPtr<FJsonObject>& Params)
{
	UWorld* World = GetNavWorld();
	if (!World)
	{
...
FMegalithActionResult FMegalithAINavigationActions::HandleSetCrowdManagerConfig(const TSharedPtr<FJsonObject>& Params)
{
	UWorld* World = GetNavWorld();
	if (!World)
	{
	...
	if (!CrowdMgr)
	{
		return FMegalithActionResult::Error(TEXT("No CrowdManager active. Start a PIE session with crowd-following AI agents first."));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Set CrowdManager Config")));
	CrowdMgr->Modify();
...
FMegalithActionResult FMegalithAINavigationActions::HandleAnalyzeNavigationCoverage(const TSharedPtr<FJsonObject>& Params)
{
	UWorld* World = GetNavWorld();
	if (!World)
	{
	...
	if (!SampleBounds.IsValid)
	{
		return FMegalithActionResult::Error(TEXT("No valid bounds found. Add NavMeshBoundsVolumes or provide custom bounds."));
	}
...
bool FMegalithAINavigationActions::WaitForNavGenerationComplete(UWorld* World, UNavigationSystemV1* NavSys, double TimeoutSeconds, int32& OutTicks)
{
	OutTicks = 0;
	if (!World || !NavSys)
	{
...
FMegalithActionResult FMegalithAINavigationActions::HandleRebuildNavigation(const TSharedPtr<FJsonObject>& Params)
{
	UWorld* World = GetNavWorld();
	if (!World)
	{
...
FMegalithActionResult FMegalithAINavigationActions::HandleValidateNavPoints(const TSharedPtr<FJsonObject>& Params)
{
	UWorld* World = GetNavWorld();
	if (!World)
	{
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing or empty required parameter: points"));
	}
	...
	for (const TSharedPtr<FJsonValue>& Val : *PointsArr)
	{
		...
		{
			return FMegalithActionResult::Error(TEXT("Each point requires a non-empty 'name' field"));
		}
		...
		if (!bLocFound)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Point '%s' is missing a valid 'location'"), *Name));
		}
