...
namespace
{
	...
	{
		OutBT = MegalithAI::LoadBehaviorTreeFromParams(Params, OutAssetPath, OutError);
		if (!OutBT)
		{
			return false;
		}
	...
	bool SetPropertyValue(UObject* Obj, const FString& PropName, const TSharedPtr<FJsonValue>& Value, UBehaviorTree* BT, FString& OutError)
	{
		...
		if (FObjectProperty* ObjProp = CastField<FObjectProperty>(Prop))
		{
			...
			UObject* RefObj = FMegalithAssetUtils::LoadAssetByPath(ObjProp->PropertyClass, ObjPath);
			if (!RefObj)
			{
	...
	void ApplyProperties(UObject* Obj, const TSharedPtr<FJsonObject>& PropsObj, UBehaviorTree* BT, TArray<FString>& OutErrors)
	{
		...
		{
			FString Error;
			if (!SetPropertyValue(Obj, MegalithKeyToString(Pair.Key), Pair.Value, BT, Error))
			{
				OutErrors.Add(Error);
			}
		}
	...
	UBlackboardData* CreateInlineBB(const FString& BTSavePath, const TSharedPtr<FJsonObject>& BBSpec, FString& OutError)
	{
		...
		FString PkgError;
		UPackage* BBPackage = MegalithAI::GetOrCreatePackage(BBPath, PkgError);
		if (!BBPackage)
		{
...
void FMegalithAIBehaviorTreeActions::RegisterActions(FMegalithToolRegistry& Registry)
{
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("create_behavior_tree"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateBehaviorTree),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("get_behavior_tree"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetBehaviorTree),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("list_behavior_trees"),
		...
		FMegalithActionHandler::CreateStatic(&HandleListBehaviorTrees),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("delete_behavior_tree"),
		...
		FMegalithActionHandler::CreateStatic(&HandleDeleteBehaviorTree),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("duplicate_behavior_tree"),
		...
		FMegalithActionHandler::CreateStatic(&HandleDuplicateBehaviorTree),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("set_bt_blackboard"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetBTBlackboard),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Behavior Tree asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("list_bt_node_classes"),
		...
		FMegalithActionHandler::CreateStatic(&HandleListBTNodeClasses),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("add_bt_node"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddBTNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Behavior Tree asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("remove_bt_node"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveBTNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Behavior Tree asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("move_bt_node"),
		...
		FMegalithActionHandler::CreateStatic(&HandleMoveBTNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Behavior Tree asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("add_bt_decorator"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddBTDecorator),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Behavior Tree asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("remove_bt_decorator"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveBTDecorator),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Behavior Tree asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("add_bt_service"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddBTService),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Behavior Tree asset path"))
			.Required(TEXT("node_id"), TEXT("string"), TEXT("GUID of the target node"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("remove_bt_service"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveBTService),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Behavior Tree asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("set_bt_node_property"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetBTNodeProperty),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Behavior Tree asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("get_bt_node_properties"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetBTNodeProperties),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Behavior Tree asset path"))
			.Required(TEXT("node_id"), TEXT("string"), TEXT("GUID of the node"))
			.Build());
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("reorder_bt_children"),
		...
		FMegalithActionHandler::CreateStatic(&HandleReorderBTChildren),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Behavior Tree asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("add_bt_run_eqs_task"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddBTRunEQSTask),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Behavior Tree asset path"))
			.Optional(TEXT("parent_id"), TEXT("string"), TEXT("GUID of parent composite node (null = root)"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("add_bt_smart_object_task"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddBTSmartObjectTask),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Behavior Tree asset path"))
			.Optional(TEXT("parent_id"), TEXT("string"), TEXT("GUID of parent composite node (null = root)"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("add_bt_use_ability_task"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddBTUseAbilityTask),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Behavior Tree asset path"))
			.Optional(TEXT("parent_id"), TEXT("string"), TEXT("GUID of parent composite node (null = root)"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("build_behavior_tree_from_spec"),
		...
		FMegalithActionHandler::CreateStatic(&HandleBuildBTFromSpec),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("save_path"), TEXT("Asset save path (e.g. /Game/AI/BT_Enemy)"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("export_bt_spec"),
		...
		FMegalithActionHandler::CreateStatic(&HandleExportBTSpec),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Behavior Tree asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("import_bt_spec"),
		...
		FMegalithActionHandler::CreateStatic(&HandleImportBTSpec),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("validate_behavior_tree"),
		...
		FMegalithActionHandler::CreateStatic(&HandleValidateBehaviorTree),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Behavior Tree asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("clone_bt_subtree"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCloneBTSubtree),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("auto_arrange_bt"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAutoArrangeBT),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Behavior Tree asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("compare_behavior_trees"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCompareBehaviorTrees),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("create_bt_task_blueprint"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateBTTaskBlueprint),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("create_bt_decorator_blueprint"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateBTDecoratorBlueprint),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("create_bt_service_blueprint"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateBTServiceBlueprint),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("save_path"), TEXT("Asset save path"))
			.Required(TEXT("name"), TEXT("string"), TEXT("Blueprint name"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("generate_bt_diagram"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGenerateBTDiagram),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Behavior Tree asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("get_bt_graph"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetBTGraph),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Behavior Tree asset path"))
			.Build());
}
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleCreateBehaviorTree(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("save_path"), SavePath, ErrResult))
	{
		return ErrResult;
	}
	...
	// Check path is free
	FString PathError;
	if (!MegalithAI::EnsureAssetPathFree(PackagePath, AssetName, PathError))
	{
		return FMegalithActionResult::Error(PathError);
	}

	FString PkgError;
	UPackage* Package = MegalithAI::GetOrCreatePackage(PackagePath, PkgError);
	if (!Package)
	{
		return FMegalithActionResult::Error(PkgError);
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Create Behavior Tree")));

	UBehaviorTree* BT = NewObject<UBehaviorTree>(Package, *AssetName, RF_Public | RF_Standalone);
	if (!BT)
	{
		return FMegalithActionResult::Error(TEXT("Failed to create UBehaviorTree object"));
	}
	...
	if (!BBPath.IsEmpty())
	{
		UBlackboardData* BB = Cast<UBlackboardData>(FMegalithAssetUtils::LoadAssetByPath(UBlackboardData::StaticClass(), BBPath));
		if (!BB)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Blackboard not found: %s"), *BBPath));
		}
	...
	TSharedPtr<FJsonObject> Result = MegalithAI::MakeAssetResult(PackagePath, TEXT("Behavior Tree created"));
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleGetBehaviorTree(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UBehaviorTree* BT = MegalithAI::LoadBehaviorTreeFromParams(Params, AssetPath, Error);
	if (!BT)
	{
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleListBehaviorTrees(const TSharedPtr<FJsonObject>& Params)
{
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleDeleteBehaviorTree(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("asset_path"), AssetPath, ErrResult))
	{
		return ErrResult;
	}

	UObject* Asset = FMegalithAssetUtils::LoadAssetByPath(UBehaviorTree::StaticClass(), AssetPath);
	if (!Asset)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Behavior Tree not found: %s"), *AssetPath));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Delete Behavior Tree")));
	...
	if (NumDeleted == 0)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to delete: %s"), *AssetPath));
	}
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleDuplicateBehaviorTree(const TSharedPtr<FJsonObject>& Params)
{
	FString SourcePath, DestPath;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("source_path"), SourcePath, ErrResult))
	{
		return ErrResult;
	}
	if (!MegalithAI::RequireStringParam(Params, TEXT("dest_path"), DestPath, ErrResult))
	{
		return ErrResult;
	}

	UBehaviorTree* SourceBT = Cast<UBehaviorTree>(FMegalithAssetUtils::LoadAssetByPath(UBehaviorTree::StaticClass(), SourcePath));
	if (!SourceBT)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Source Behavior Tree not found: %s"), *SourcePath));
	}

	FString DestAssetName = FPackageName::GetShortName(DestPath);
	FString PkgError;
	UPackage* DestPackage = MegalithAI::GetOrCreatePackage(DestPath, PkgError);
	if (!DestPackage)
	{
		return FMegalithActionResult::Error(PkgError);
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Duplicate Behavior Tree")));
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleSetBTBlackboard(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UBehaviorTree* BT = MegalithAI::LoadBehaviorTreeFromParams(Params, AssetPath, Error);
	if (!BT)
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Set BT Blackboard")));
	...
	TSharedPtr<FJsonObject> Result = MegalithAI::MakeAssetResult(AssetPath, TEXT("Blackboard reference updated"));
	if (BT->BlackboardAsset)
	{
		Result->SetStringField(TEXT("blackboard"), BT->BlackboardAsset->GetPathName());
	}
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleListBTNodeClasses(const TSharedPtr<FJsonObject>& Params)
{
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleAddBTNode(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	...
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("node_class"), NodeClassName, ErrResult))
	{
		return ErrResult;
	}
	...
	if (!BTNodeClass)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("BT node class not found: %s"), *NodeClassName));
	}
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("'%s' is not a composite or task node class"), *NodeClassName));
	}
	...
	if (ParentIdStr.IsEmpty())
	{
		...
		if (!ParentGraphNode)
		{
			return FMegalithActionResult::Error(TEXT("Root node not found in BT graph"));
		}
	}
	else
	{
		...
		{
			return FMegalithActionResult::Error(MoveTemp(GuidErr));
		}
	}
	...
	if (BTNodeClass->IsChildOf(UBTTaskNode::StaticClass()))
	{
		...
		{
			return FMegalithActionResult::Error(MoveTemp(*ParentErr));
		}
	}
	...
	if (!GraphNodeClass)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("No graph node class for: %s"), *NodeClassName));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Add BT Node")));
	BTGraph->Modify();
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleRemoveBTNode(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UBehaviorTree* BT = nullptr;
	UBehaviorTreeGraph* BTGraph = nullptr;
	...
	FString NodeId;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("node_id"), NodeId, ErrResult))
	{
		return ErrResult;
	}
	...
	{
		return FMegalithActionResult::Error(TEXT("Cannot remove the root node"));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Remove BT Node")));
	BTGraph->Modify();
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleMoveBTNode(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UBehaviorTree* BT = nullptr;
	UBehaviorTreeGraph* BTGraph = nullptr;
	...
	if (!MegalithAI::RequireStringParam(Params, TEXT("new_parent_id"), NewParentId, ErrResult))
	{
		return ErrResult;
	}
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Move BT Node")));
	BTGraph->Modify();
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleAddBTDecorator(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UBehaviorTree* BT = nullptr;
	UBehaviorTreeGraph* BTGraph = nullptr;
	...
	if (!MegalithAI::RequireStringParam(Params, TEXT("decorator_class"), DecoratorClassName, ErrResult))
	{
		return ErrResult;
	}
	...
	if (!DecClass || !DecClass->IsChildOf(UBTDecorator::StaticClass()))
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Decorator class not found or invalid: %s"), *DecoratorClassName));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Add BT Decorator")));
	BTGraph->Modify();
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleRemoveBTDecorator(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UBehaviorTree* BT = nullptr;
	UBehaviorTreeGraph* BTGraph = nullptr;
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Decorator index %d out of range [0, %d)"), DecoratorIndex, TargetNode->Decorators.Num()));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Remove BT Decorator")));
	BTGraph->Modify();
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleAddBTService(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UBehaviorTree* BT = nullptr;
	UBehaviorTreeGraph* BTGraph = nullptr;
	...
	if (!MegalithAI::RequireStringParam(Params, TEXT("service_class"), ServiceClassName, ErrResult))
	{
		return ErrResult;
	}
	...
	if (!SvcClass || !SvcClass->IsChildOf(UBTService::StaticClass()))
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Service class not found or invalid: %s"), *ServiceClassName));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Add BT Service")));
	BTGraph->Modify();
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleRemoveBTService(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UBehaviorTree* BT = nullptr;
	UBehaviorTreeGraph* BTGraph = nullptr;
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Service index %d out of range [0, %d)"), ServiceIndex, TargetNode->Services.Num()));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Remove BT Service")));
	BTGraph->Modify();
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleSetBTNodeProperty(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UBehaviorTree* BT = nullptr;
	UBehaviorTreeGraph* BTGraph = nullptr;
	...
	if (!MegalithAI::RequireStringParam(Params, TEXT("property_name"), PropertyName, ErrResult))
	{
		return ErrResult;
	}
	...
	if (!BTNode)
	{
		return FMegalithActionResult::Error(TEXT("Node has no BT node instance"));
	}

	TSharedPtr<FJsonValue> Value = Params->TryGetField(TEXT("value"));
	if (!Value.IsValid())
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: value"));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Set BT Node Property")));
	BTNode->Modify();

	FString PropError;
	if (!SetPropertyValue(BTNode, PropertyName, Value, BT, PropError))
	{
		return FMegalithActionResult::Error(PropError);
	}
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleGetBTNodeProperties(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UBehaviorTree* BT = nullptr;
	UBehaviorTreeGraph* BTGraph = nullptr;
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleReorderBTChildren(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UBehaviorTree* BT = nullptr;
	UBehaviorTreeGraph* BTGraph = nullptr;
	...
	FString ParentId;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("parent_id"), ParentId, ErrResult))
	{
		return ErrResult;
	}
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: new_order (array of node GUIDs)"));
	}
	...
	for (const TSharedPtr<FJsonValue>& Val : *NewOrderArr)
	{
		...
		if (!Found)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Child GUID not found under parent: %s"), *ChildGuid));
		}
		NewOrder.Add(*Found);
	}
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Reorder BT Children")));
	BTGraph->Modify();
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleAddBTRunEQSTask(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UBehaviorTree* BT = nullptr;
	UBehaviorTreeGraph* BTGraph = nullptr;
	...
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("eqs_path"), EQSPath, ErrResult))
	{
		return ErrResult;
	}
	if (!MegalithAI::RequireStringParam(Params, TEXT("bb_result_key"), BBResultKey, ErrResult))
	{
		return ErrResult;
	}

	// Verify the EQS asset exists
	UEnvQuery* EQSQuery = Cast<UEnvQuery>(FMegalithAssetUtils::LoadAssetByPath(UEnvQuery::StaticClass(), EQSPath));
	if (!EQSQuery)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("EQS query not found: %s"), *EQSPath));
	}
	...
	if (!RunEQSClass)
	{
		return FMegalithActionResult::Error(TEXT("BTTask_RunEQSQuery class not found — ensure AIModule is loaded"));
	}
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Add RunEQSQuery Task")));
	BTGraph->Modify();
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleAddBTSmartObjectTask(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UBehaviorTree* BT = nullptr;
	UBehaviorTreeGraph* BTGraph = nullptr;
	...
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("activity_tags"), ActivityTags, ErrResult))
	{
		return ErrResult;
	}
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Add Smart Object Task")));
	BTGraph->Modify();
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleAddBTUseAbilityTask(const TSharedPtr<FJsonObject>& Params)
{
#if !WITH_GAMEPLAYABILITIES
	return FMegalithActionResult::Error(TEXT(
		"add_bt_use_ability_task requires the GameplayAbilities engine plugin. "
		"Enable Edit > Plugins > Gameplay > Gameplay Abilities and rebuild MegalithAI."));
#else
	// 1. Load BT + graph
	FString AssetPath, Error;
	UBehaviorTree* BT = nullptr;
	...
	if (bHasAbilityClass)
	{
		...
		{
			UObject* Loaded = FMegalithAssetUtils::LoadAssetByPath(UObject::StaticClass(), AbilityClassPath);
	...
	if (ParentIdStr.IsEmpty())
	{
		...
		if (!ParentGraphNode)
		{
			return FMegalithActionResult::Error(TEXT("add_bt_use_ability_task: Root node not found in BT graph"));
		}
	}
	else
	{
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Add TryActivateAbility Task")));
	BTGraph->Modify();
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleBuildBTFromSpec(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("save_path"), SavePath, ErrResult))
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required parameter: spec (JSON object)"));
	}
	...
	{
		return FMegalithActionResult::Error(TEXT("Spec missing 'root' field"));
	}
	...
	// =====================================================================
	{
		...
		if (RootType.IsEmpty())
		{
			return FMegalithActionResult::Error(TEXT("Spec root missing 'type' field — refusing to create empty BT"));
		}
	...
	if (bStrictMode)
	{
		...
		if (StrictErrors.Num() > 0)
		{
			...
			return FMegalithActionResult::Error(Msg);
		}
	}
	...
	// Check path is free
	FString PathError;
	if (!MegalithAI::EnsureAssetPathFree(SavePath, AssetName, PathError))
	{
		return FMegalithActionResult::Error(PathError);
	}
	...
	// Create package
	FString PkgError;
	UPackage* Package = MegalithAI::GetOrCreatePackage(SavePath, PkgError);
	if (!Package)
	{
		return FMegalithActionResult::Error(PkgError);
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Build BT From Spec")));
	...
	if (!BBPath.IsEmpty())
	{
		ResolvedBB = Cast<UBlackboardData>(FMegalithAssetUtils::LoadAssetByPath(UBlackboardData::StaticClass(), BBPath));
		if (!ResolvedBB)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Blackboard not found: %s"), *BBPath));
		}
	...
	else
	{
		...
		if (Spec->TryGetObjectField(TEXT("blackboard"), BBSpecPtr) && BBSpecPtr && (*BBSpecPtr).IsValid())
		{
			...
			if (!ResolvedBB)
			{
				return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create inline BB: %s"), *BBError));
			}
		}
	}
	...
	if (!BTGraph)
	{
		return FMegalithActionResult::Error(TEXT("Failed to create BT editor graph"));
	}
	...
	if (!RootGraphNode)
	{
		return FMegalithActionResult::Error(TEXT("Root graph node not found in freshly created BT"));
	}
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleExportBTSpec(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UBehaviorTree* BT = nullptr;
	UBehaviorTreeGraph* BTGraph = nullptr;
	...
	if (!RootGraphNode)
	{
		return FMegalithActionResult::Error(TEXT("Root graph node not found"));
	}
	...
	{
		return FMegalithActionResult::Error(TEXT("Behavior Tree is empty — no nodes under root"));
	}
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleImportBTSpec(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UBehaviorTree* BT = nullptr;
	UBehaviorTreeGraph* BTGraph = nullptr;
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Import BT Spec")));
	BTGraph->Modify();
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleValidateBehaviorTree(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UBehaviorTree* BT = nullptr;
	UBehaviorTreeGraph* BTGraph = nullptr;
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleCloneBTSubtree(const TSharedPtr<FJsonObject>& Params)
{
	FString SourcePath, DestPath, NodeIdStr;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("source_path"), SourcePath, ErrResult)) return ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("node_id"), NodeIdStr, ErrResult)) return ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("dest_path"), DestPath, ErrResult)) return ErrResult;
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Source BT: %s"), *SrcError));
	}
	...
	{
		return FMegalithActionResult::Error(TEXT("Failed to export subtree to spec"));
	}
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Dest BT: %s"), *DestError));
	}
	...
	else
	{
		...
		if (!DestParent)
		{
			return FMegalithActionResult::Error(TEXT("Dest BT has no root node"));
		}
	}
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Clone BT Subtree")));
	...
	struct FCloneHelper
	{
		static bool CloneNode(
			...
			FMegalithAIBehaviorTreeActions* /*unused*/)
		{
			...
			FMegalithActionResult R = FMegalithToolRegistry::Get().ExecuteAction(TEXT("ai"), TEXT("add_bt_node"), AddP);
			if (!R.bSuccess)
			{
			...
			if (NodeSpec->TryGetArrayField(TEXT("decorators"), DecoratorsArr) && DecoratorsArr)
			{
				for (const TSharedPtr<FJsonValue>& DecVal : *DecoratorsArr)
				{
					...
					if (DecVal->TryGetObject(DecObj) && DecObj && (*DecObj).IsValid())
					{
						...
						FMegalithToolRegistry::Get().ExecuteAction(TEXT("ai"), TEXT("add_bt_decorator"), DecP);
					}
				}
			}
			...
			if (NodeSpec->TryGetArrayField(TEXT("services"), ServicesArr) && ServicesArr)
			{
				for (const TSharedPtr<FJsonValue>& SvcVal : *ServicesArr)
				{
					...
					if (SvcVal->TryGetObject(SvcObj) && SvcObj && (*SvcObj).IsValid())
					{
						...
						FMegalithToolRegistry::Get().ExecuteAction(TEXT("ai"), TEXT("add_bt_service"), SvcP);
					}
				}
			}
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleAutoArrangeBT(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UBehaviorTree* BT = nullptr;
	UBehaviorTreeGraph* BTGraph = nullptr;
	...
	{
		if (IMegalithGraphFormatter::IsAvailable())
		{
			IMegalithGraphFormatter& Formatter = IMegalithGraphFormatter::Get();
			if (Formatter.SupportsGraph(BTGraph))
			{
				FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Auto Arrange BT (BA)")));
				...
				else if (FormatterPref == TEXT("blueprint_assist"))
				{
					...
					return FMegalithActionResult::Error(FString::Printf(TEXT("Blueprint Assist formatter failed: %s"), *FormatterError));
				}
			}
		}
		else if (FormatterPref == TEXT("blueprint_assist"))
		{
			return FMegalithActionResult::Error(TEXT("Blueprint Assist formatter not available — is the plugin loaded?"));
		}
	}
	...
	if (!bUsedBA)
	{
		FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Auto Arrange BT (builtin)")));

		UBehaviorTreeGraphNode_Root* RootNode = FindRootNode(BTGraph);
		if (!RootNode)
		{
			return FMegalithActionResult::Error(TEXT("No root node found in BT graph"));
		}
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleCompareBehaviorTrees(const TSharedPtr<FJsonObject>& Params)
{
	FString PathA, PathB;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("path_a"), PathA, ErrResult)) return ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("path_b"), PathB, ErrResult)) return ErrResult;
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("BT A: %s"), *ErrorA));
	}
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("BT B: %s"), *ErrorB));
	}
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleCreateBTTaskBlueprint(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath, Name;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("save_path"), SavePath, ErrResult)) return ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("name"), Name, ErrResult)) return ErrResult;
	...
	if (!ParentClassName.IsEmpty())
	{
		...
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Parent class '%s' not found or not a BTTask"), *ParentClassName));
		}
	}

	FString PathError;
	if (!MegalithAI::EnsureAssetPathFree(SavePath, Name, PathError))
	{
		return FMegalithActionResult::Error(PathError);
	}
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Create BTTask Blueprint")));

	UBlueprint* NewBP = FKismetEditorUtilities::CreateBlueprint(
		ParentClass, Package, *Name, BPTYPE_Normal, FName(TEXT("MegalithAI")));

	if (!NewBP)
	{
		return FMegalithActionResult::Error(TEXT("Failed to create BTTask Blueprint"));
	}

	FAssetRegistryModule::AssetCreated(NewBP);
	NewBP->MarkPackageDirty();

	TSharedPtr<FJsonObject> Result = MegalithAI::MakeAssetResult(SavePath, TEXT("BTTask Blueprint created"));
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleCreateBTDecoratorBlueprint(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath, Name;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("save_path"), SavePath, ErrResult)) return ErrResult;
	...
	if (!ParentClassName.IsEmpty())
	{
		...
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Parent class '%s' not found or not a BTDecorator"), *ParentClassName));
		}
	}
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Create BTDecorator Blueprint")));
	...
	if (!NewBP)
	{
		return FMegalithActionResult::Error(TEXT("Failed to create BTDecorator Blueprint"));
	}

	FAssetRegistryModule::AssetCreated(NewBP);
	NewBP->MarkPackageDirty();

	TSharedPtr<FJsonObject> Result = MegalithAI::MakeAssetResult(SavePath, TEXT("BTDecorator Blueprint created"));
	Result->SetStringField(TEXT("name"), Name);
	Result->SetStringField(TEXT("parent_class"), ParentClass->GetName());
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleCreateBTServiceBlueprint(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath, Name;
	FMegalithActionResult ErrResult;
	if (!MegalithAI::RequireStringParam(Params, TEXT("save_path"), SavePath, ErrResult)) return ErrResult;
	...
	if (!ParentClassName.IsEmpty())
	{
		...
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Parent class '%s' not found or not a BTService"), *ParentClassName));
		}
	}
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Create BTService Blueprint")));
	...
	if (!NewBP)
	{
		return FMegalithActionResult::Error(TEXT("Failed to create BTService Blueprint"));
	}

	FAssetRegistryModule::AssetCreated(NewBP);
	NewBP->MarkPackageDirty();

	TSharedPtr<FJsonObject> Result = MegalithAI::MakeAssetResult(SavePath, TEXT("BTService Blueprint created"));
	Result->SetStringField(TEXT("name"), Name);
	Result->SetStringField(TEXT("parent_class"), ParentClass->GetName());
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleGenerateBTDiagram(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UBehaviorTree* BT = nullptr;
	UBehaviorTreeGraph* BTGraph = nullptr;
	...
	if (RootChildren.Num() == 0)
	{
		return FMegalithActionResult::Error(TEXT("Behavior Tree is empty"));
	}
...
FMegalithActionResult FMegalithAIBehaviorTreeActions::HandleGetBTGraph(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UBehaviorTree* BT = MegalithAI::LoadBehaviorTreeFromParams(Params, AssetPath, Error);
	if (!BT)
...
#else
	// Runtime/non-editor builds — Megalith is editor-only, but keep the symbol
