...
namespace
{
	...
	UStateTree* LoadStateTreeFromParams(const TSharedPtr<FJsonObject>& Params, FString& OutAssetPath, FString& OutError)
	{
		...
		OutAssetPath = FMegalithAssetUtils::ResolveAssetPath(OutAssetPath);

		UStateTree* ST = FMegalithAssetUtils::LoadAssetByPath<UStateTree>(OutAssetPath);
		if (!ST)
		{
...
void FMegalithAIStateTreeActions::RegisterActions(FMegalithToolRegistry& Registry)
{
#if WITH_STATETREE
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("create_state_tree"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCreateStateTree),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("get_state_tree"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetStateTree),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("list_state_trees"),
		...
		FMegalithActionHandler::CreateStatic(&HandleListStateTrees),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("delete_state_tree"),
		...
		FMegalithActionHandler::CreateStatic(&HandleDeleteStateTree),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("duplicate_state_tree"),
		...
		FMegalithActionHandler::CreateStatic(&HandleDuplicateStateTree),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("compile_state_tree"),
		...
		FMegalithActionHandler::CreateStatic(&HandleCompileStateTree),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("set_st_schema"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetSTSchema),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("StateTree asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("add_st_state"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddSTState),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("StateTree asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("remove_st_state"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveSTState),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("StateTree asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("rename_st_state"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRenameSTState),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("StateTree asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("move_st_state"),
		...
		FMegalithActionHandler::CreateStatic(&HandleMoveSTState),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("StateTree asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("set_st_state_properties"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetSTStateProperties),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("StateTree asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("add_st_task"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddSTTask),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("StateTree asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("remove_st_task"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveSTTask),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("StateTree asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("set_st_task_property"),
		...
		FMegalithActionHandler::CreateStatic(&HandleSetSTTaskProperty),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("StateTree asset path"))
			.Required(TEXT("state_id"), TEXT("string"), TEXT("GUID of the state owning the task"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("add_st_enter_condition"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddSTEnterCondition),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("StateTree asset path"))
			.Required(TEXT("state_id"), TEXT("string"), TEXT("GUID of the target state"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("remove_st_enter_condition"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveSTEnterCondition),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("StateTree asset path"))
			.Required(TEXT("state_id"), TEXT("string"), TEXT("GUID of the state"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("add_st_transition"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddSTTransition),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("StateTree asset path"))
			.Required(TEXT("state_id"), TEXT("string"), TEXT("GUID of the state"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("remove_st_transition"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveSTTransition),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("StateTree asset path"))
			.Required(TEXT("state_id"), TEXT("string"), TEXT("GUID of the state"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("add_st_property_binding"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddSTPropertyBinding),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("StateTree asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("remove_st_property_binding"),
		...
		FMegalithActionHandler::CreateStatic(&HandleRemoveSTPropertyBinding),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("StateTree asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("get_st_bindings"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetSTBindings),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("StateTree asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("get_st_bindable_properties"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGetSTBindableProperties),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("StateTree asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("list_st_task_types"),
		...
		FMegalithActionHandler::CreateStatic(&HandleListSTTaskTypes),
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("list_st_condition_types"),
		...
		FMegalithActionHandler::CreateStatic(&HandleListSTConditionTypes),
		FParamSchemaBuilder().Build());
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("add_st_transition_condition"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddSTTransitionCondition),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("StateTree asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("add_st_consideration"),
		...
		FMegalithActionHandler::CreateStatic(&HandleAddSTConsideration),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("StateTree asset path"))
			.Required(TEXT("state_id"), TEXT("string"), TEXT("GUID of the target state"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("configure_st_consideration"),
		...
		FMegalithActionHandler::CreateStatic(&HandleConfigureSTConsideration),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("StateTree asset path"))
			.Required(TEXT("state_id"), TEXT("string"), TEXT("GUID of the state"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("validate_state_tree"),
		...
		FMegalithActionHandler::CreateStatic(&HandleValidateStateTree),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("StateTree asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("list_st_extension_types"),
		...
		FMegalithActionHandler::CreateStatic(&HandleListSTExtensionTypes),
		FParamSchemaBuilder().Build());

	// 76. add_st_extension
	Registry.RegisterAction(TEXT("ai"), TEXT("add_st_extension"),
		TEXT("Add an extension to a StateTree asset"),
		FMegalithActionHandler::CreateStatic(&HandleAddSTExtension),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("StateTree asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("build_state_tree_from_spec"),
		...
		FMegalithActionHandler::CreateStatic(&HandleBuildStateTreeFromSpec),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("save_path"), TEXT("Asset save path (e.g. /Game/AI/ST_Enemy)"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("export_st_spec"),
		...
		FMegalithActionHandler::CreateStatic(&HandleExportSTSpec),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("StateTree asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("generate_st_diagram"),
		...
		FMegalithActionHandler::CreateStatic(&HandleGenerateSTDiagram),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("StateTree asset path"))
	...
	Registry.RegisterAction(TEXT("ai"), TEXT("auto_arrange_st"),
		TEXT("Auto-layout a StateTree graph via IMegalithGraphFormatter or built-in fallback"),
		FMegalithActionHandler::CreateStatic(&HandleAutoArrangeST),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("StateTree asset path"))
...
// 43. create_state_tree
FMegalithActionResult FMegalithAIStateTreeActions::HandleCreateStateTree(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath = Params->GetStringField(TEXT("save_path"));
	if (SavePath.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("Missing required param 'save_path'"));
	}
	SavePath = FMegalithAssetUtils::ResolveAssetPath(SavePath);
	...
	// Check path is free
	FString PathErr;
	if (!MegalithAI::EnsureAssetPathFree(PackagePath, AssetName, PathErr))
	{
		return FMegalithActionResult::Error(PathErr);
	}

	UPackage* Package = CreatePackage(*PackagePath);
	if (!Package)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create package at '%s'"), *PackagePath));
	}
	...
	if (!SchemaClass)
	{
		...
		return FMegalithActionResult::Error(FString::Printf(TEXT("Schema class '%s' not found or not a UStateTreeSchema"), *MissingName));
	}
	Factory->SetSchemaClass(SchemaClass);

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Create StateTree")));
	...
	if (!NewST)
	{
		return FMegalithActionResult::Error(TEXT("UStateTreeFactory::FactoryCreateNew failed"));
	}
...
// 44. get_state_tree
FMegalithActionResult FMegalithAIStateTreeActions::HandleGetStateTree(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);

	UStateTreeEditorData* EditorData = GetEditorData(ST, Error);
	if (!EditorData) return FMegalithActionResult::Error(Error);
...
// 45. list_state_trees
FMegalithActionResult FMegalithAIStateTreeActions::HandleListStateTrees(const TSharedPtr<FJsonObject>& Params)
{
...
// 46. delete_state_tree
FMegalithActionResult FMegalithAIStateTreeActions::HandleDeleteStateTree(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Delete StateTree")));
	...
	if (Deleted == 0)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to delete StateTree at '%s'"), *AssetPath));
	}
...
// 47. duplicate_state_tree
FMegalithActionResult FMegalithAIStateTreeActions::HandleDuplicateStateTree(const TSharedPtr<FJsonObject>& Params)
{
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required params 'source_path' and 'dest_path'"));
	}

	SourcePath = FMegalithAssetUtils::ResolveAssetPath(SourcePath);
	DestPath = FMegalithAssetUtils::ResolveAssetPath(DestPath);

	FString Error;
	UStateTree* SourceST = FMegalithAssetUtils::LoadAssetByPath<UStateTree>(SourcePath);
	if (!SourceST)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Source StateTree not found at '%s'"), *SourcePath));
	}

	FString DestName = FPackageName::GetShortName(DestPath);

	FString PathErr;
	if (!MegalithAI::EnsureAssetPathFree(DestPath, DestName, PathErr))
	{
		return FMegalithActionResult::Error(PathErr);
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Duplicate StateTree")));
	...
	if (!NewST)
	{
		return FMegalithActionResult::Error(TEXT("StaticDuplicateObject failed"));
	}
...
// 48. compile_state_tree
FMegalithActionResult FMegalithAIStateTreeActions::HandleCompileStateTree(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);
...
// 49. set_st_schema
FMegalithActionResult FMegalithAIStateTreeActions::HandleSetSTSchema(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required param 'schema_class'"));
	}
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Schema class '%s' not found or not a UStateTreeSchema subclass"), *SchemaClassName));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Set ST Schema")));
...
// 50. add_st_state
FMegalithActionResult FMegalithAIStateTreeActions::HandleAddSTState(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Add ST State")));
	...
	{
		UStateTree* LinkedST = FMegalithAssetUtils::LoadAssetByPath<UStateTree>(FMegalithAssetUtils::ResolveAssetPath(LinkedAssetPath));
		if (LinkedST)
		{
...
// 51. remove_st_state
FMegalithActionResult FMegalithAIStateTreeActions::HandleRemoveSTState(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);
	...
	if (StateId.IsEmpty())
	{
		return FMegalithActionResult::Error(TEXT("Missing required param 'state_id'"));
	}

	UStateTreeState* State = FindStateByGuid(EditorData, StateId);
	if (!State)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("State '%s' not found"), *StateId));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Remove ST State")));

	FString RemovedName = State->Name.ToString();
	if (!RemoveStateFromParent(State, EditorData))
	{
		return FMegalithActionResult::Error(TEXT("Failed to remove state from parent"));
	}
...
// 52. rename_st_state
FMegalithActionResult FMegalithAIStateTreeActions::HandleRenameSTState(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required params 'state_id' and 'new_name'"));
	}
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Rename ST State")));
...
// 53. move_st_state
FMegalithActionResult FMegalithAIStateTreeActions::HandleMoveSTState(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Move ST State")));
	...
	else
	{
		...
		if (!NewParent)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("New parent state '%s' not found"), *NewParentId));
		}
...
// 54. set_st_state_properties
FMegalithActionResult FMegalithAIStateTreeActions::HandleSetSTStateProperties(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Set ST State Properties")));
...
// 55. add_st_task
FMegalithActionResult FMegalithAIStateTreeActions::HandleAddSTTask(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required params 'state_id' and 'task_class'"));
	}
	...
	if (!TaskStruct)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Task struct '%s' not found"), *TaskClassName));
	}

	// Verify it's a task base subclass
	if (!TaskStruct->IsChildOf(FStateTreeTaskBase::StaticStruct()))
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("'%s' is not a FStateTreeTaskBase subclass"), *TaskClassName));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Add ST Task")));
...
// 56. remove_st_task
FMegalithActionResult FMegalithAIStateTreeActions::HandleRemoveSTTask(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Task index %d out of range (0-%d)"), TaskIndex, State->Tasks.Num() - 1));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Remove ST Task")));
...
// 57. set_st_task_property
FMegalithActionResult FMegalithAIStateTreeActions::HandleSetSTTaskProperty(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required params"));
	}
	...
	if (!State->Tasks.IsValidIndex(TaskIndex))
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Task index %d out of range"), TaskIndex));
	}

	FStateTreeEditorNode& TaskNode = State->Tasks[TaskIndex];
	if (!TaskNode.Node.IsValid())
	{
		return FMegalithActionResult::Error(TEXT("Task node has no valid struct data"));
	}
	...
	if (!Prop)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Property '%s' not found on %s"), *PropertyName, *StructType->GetName()));
	}
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Set ST Task Property")));

	void* PropAddr = Prop->ContainerPtrToValuePtr<void>(Memory);
	if (!Prop->ImportText_Direct(*ValueStr, PropAddr, nullptr, PPF_None))
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to set '%s' to '%s'"), *PropertyName, *ValueStr));
	}
...
// 58. add_st_enter_condition
FMegalithActionResult FMegalithAIStateTreeActions::HandleAddSTEnterCondition(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required params 'state_id' and 'condition_class'"));
	}
	...
	if (!CondStruct)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Condition struct '%s' not found"), *CondClassName));
	}

	if (!CondStruct->IsChildOf(FStateTreeConditionBase::StaticStruct()))
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("'%s' is not a FStateTreeConditionBase subclass"), *CondClassName));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Add ST Enter Condition")));
...
// 59. remove_st_enter_condition
FMegalithActionResult FMegalithAIStateTreeActions::HandleRemoveSTEnterCondition(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Condition index %d out of range (0-%d)"), CondIndex, State->EnterConditions.Num() - 1));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Remove ST Enter Condition")));
...
// 60. add_st_transition
FMegalithActionResult FMegalithAIStateTreeActions::HandleAddSTTransition(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required params 'state_id', 'trigger', and 'target_state'"));
	}
	...
	else
	{
		...
		if (!TargetState)
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Target state '%s' not found — use a GUID or: Succeeded, Failed, NextState, NextSelectableState"), *TargetStr));
		}
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Add ST Transition")));
...
// 61. remove_st_transition
FMegalithActionResult FMegalithAIStateTreeActions::HandleRemoveSTTransition(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Transition index %d out of range (0-%d)"), TransIndex, State->Transitions.Num() - 1));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Remove ST Transition")));
...
// 65. add_st_property_binding
FMegalithActionResult FMegalithAIStateTreeActions::HandleAddSTPropertyBinding(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required params 'source_path' and 'target_path'"));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Add ST Property Binding")));

	FStateTreeEditorPropertyBindings* Bindings = EditorData->GetPropertyEditorBindings();
	if (!Bindings)
	{
		return FMegalithActionResult::Error(TEXT("Could not access property bindings on editor data"));
	}
...
// 66. remove_st_property_binding
FMegalithActionResult FMegalithAIStateTreeActions::HandleRemoveSTPropertyBinding(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);
	...
	if (!Bindings)
	{
		return FMegalithActionResult::Error(TEXT("Could not access property bindings"));
	}

	TConstArrayView<FStateTreePropertyPathBinding> AllBindings = Bindings->GetBindings();
	if (!AllBindings.IsValidIndex(BindingIndex))
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Binding index %d out of range (0-%d)"), BindingIndex, AllBindings.Num() - 1));
	}
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Remove ST Property Binding")));
...
// 67. get_st_bindings
FMegalithActionResult FMegalithAIStateTreeActions::HandleGetSTBindings(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);
...
// 68. get_st_bindable_properties
FMegalithActionResult FMegalithAIStateTreeActions::HandleGetSTBindableProperties(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);
...
// 69. list_st_task_types
FMegalithActionResult FMegalithAIStateTreeActions::HandleListSTTaskTypes(const TSharedPtr<FJsonObject>& Params)
{
...
// 70. list_st_condition_types
FMegalithActionResult FMegalithAIStateTreeActions::HandleListSTConditionTypes(const TSharedPtr<FJsonObject>& Params)
{
	TArray<TSharedPtr<FJsonValue>> TypeArr;
...
FMegalithActionResult FMegalithAIStateTreeActions::HandleAddSTTransitionCondition(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required param 'condition_class'"));
	}

	UScriptStruct* CondStruct = FindStructByName(CondClassName);
	if (!CondStruct || !CondStruct->IsChildOf(FStateTreeConditionBase::StaticStruct()))
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Condition class '%s' not found or not a FStateTreeConditionBase"), *CondClassName));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Add ST Transition Condition")));
...
FMegalithActionResult FMegalithAIStateTreeActions::HandleAddSTConsideration(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required param 'consideration_class'"));
	}
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Consideration class '%s' not found or not a FStateTreeConsiderationBase"), *ConsClassName));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Add ST Consideration")));
...
FMegalithActionResult FMegalithAIStateTreeActions::HandleConfigureSTConsideration(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Consideration index %d out of range (0-%d)"), ConsIndex, State->Considerations.Num() - 1));
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Configure ST Consideration")));
	...
	if (Params->TryGetObjectField(TEXT("properties"), PropsObj) && PropsObj->IsValid())
	{
		...
		{
			return FMegalithActionResult::Error(PropErr);
		}
	}
	...
	if (Params->TryGetObjectField(TEXT("instance_properties"), InstPropsObj) && InstPropsObj->IsValid())
	{
		...
		{
			return FMegalithActionResult::Error(TEXT("Consideration has no instance data to configure"));
		}
		FString PropErr;
...
FMegalithActionResult FMegalithAIStateTreeActions::HandleValidateStateTree(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);
...
FMegalithActionResult FMegalithAIStateTreeActions::HandleListSTExtensionTypes(const TSharedPtr<FJsonObject>& Params)
{
	TArray<TSharedPtr<FJsonValue>> TypeArr;
...
FMegalithActionResult FMegalithAIStateTreeActions::HandleAddSTExtension(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required param 'extension_class'"));
	}
	...
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Extension class '%s' not found or not a UStateTreeExtension subclass"), *ExtClassName));
	}
	if (ExtClass->HasAnyClassFlags(CLASS_Abstract))
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Extension class '%s' is abstract"), *ExtClassName));
	}
	...
	for (const UStateTreeExtension* Existing : ST->GetExtensions())
	{
		...
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Extension '%s' already exists on this StateTree"), *ExtClassName));
		}
	}

	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Add ST Extension")));
	ST->Modify();

	UStateTreeExtension* NewExt = NewObject<UStateTreeExtension>(ST, ExtClass);
	if (!NewExt)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create extension '%s'"), *ExtClassName));
	}
	...
	// Extensions is private — access via FProperty reflection
	{
		...
		{
			return FMegalithActionResult::Error(TEXT("Could not find Extensions property on UStateTree"));
		}
	}
...
FMegalithActionResult FMegalithAIStateTreeActions::HandleBuildStateTreeFromSpec(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath = Params->GetStringField(TEXT("save_path"));
	if (SavePath.IsEmpty())
	{
	...
	{
		return FMegalithActionResult::Error(TEXT("Missing required param 'spec'"));
	}
	...
	FString PathErr;
	if (!MegalithAI::EnsureAssetPathFree(SavePath, AssetName, PathErr))
	{
		return FMegalithActionResult::Error(PathErr);
	}
	...
	if (!Package)
	{
		return FMegalithActionResult::Error(FString::Printf(TEXT("Failed to create package at '%s'"), *SavePath));
	}
	...
	FScopedTransaction Transaction(FText::FromString(TEXT("Megalith: Build StateTree From Spec")));
	...
	if (Spec->TryGetObjectField(TEXT("root"), RootPtr) && RootPtr && RootPtr->IsValid())
	{
		...
		{
			return FMegalithActionResult::Error(FString::Printf(TEXT("Build failed: %s"), *Error));
		}
	}
...
FMegalithActionResult FMegalithAIStateTreeActions::HandleExportSTSpec(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);
...
FMegalithActionResult FMegalithAIStateTreeActions::HandleGenerateSTDiagram(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);
...
FMegalithActionResult FMegalithAIStateTreeActions::HandleAutoArrangeST(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath, Error;
	UStateTree* ST = LoadStateTreeFromParams(Params, AssetPath, Error);
	if (!ST) return FMegalithActionResult::Error(Error);
	...
	if (FormatterPref != TEXT("builtin") && IMegalithGraphFormatter::IsAvailable())
	{
	...
	return FMegalithActionResult::Success(Result);
#else
	return FMegalithActionResult::Error(TEXT("Editor data not available in non-editor builds"));
#endif
}
