...
public:
	...
	void SetLogCapture(FMegalithLogCapture* InCapture) { LogCapture = InCapture; }
	FMegalithLogCapture* GetLogCapture() const { return LogCapture; }
...
private:
	...
	FMegalithLogCapture* LogCapture = nullptr;
