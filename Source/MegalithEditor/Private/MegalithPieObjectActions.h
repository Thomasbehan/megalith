...
namespace MegalithPieObject
{
	...
	// MegalithAnimation ReadResolvedValue conventions: common scalars directly,
	...
	// resolving via the shared MegalithStructField resolver. Null when unresolved
...
class FMegalithPieObjectActions
{
public:
	static void RegisterActions(FMegalithToolRegistry& Registry);

	static FMegalithActionResult HandleGetObjectProperties(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult HandleCallFunction(const TSharedPtr<FJsonObject>& Params);
};
