...
class FMegalithPieInputActions
{
public:
	...
	static FMegalithActionResult HandleSetControlRotation(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult HandleInjectInputAction(const TSharedPtr<FJsonObject>& Params);
	static FMegalithActionResult HandlePossessSpectatorFree(const TSharedPtr<FJsonObject>& Params);
};
