...
// =============================================================================
// MegalithEditorPreviewTests.cpp
//
// Phase 1 regression tests for the editor::capture_scene_preview asset_type
// expansion (plan: 2026-05-26-megalith-editor-preview-expansion.md).
//
// Covers the three new branches:
//   - static_mesh   (Megalith.Editor.Preview.CaptureStaticMesh)
//   - skeletal_mesh (Megalith.Editor.Preview.CaptureSkeletalMesh)
//   - widget        (Megalith.Editor.Preview.CaptureWidget)
//
...
// is out of scope.
//
// Test PNGs are written under Saved/Tests/Megalith/EditorPreview/ and deleted
...
#include "MegalithToolRegistry.h" // FMegalithActionResult

namespace MegalithEditorPreviewTests
{
	/** Test output directory under Saved/Tests/Megalith/EditorPreview/. */
	static FString GetTestOutputDir()
	{
		return FPaths::ProjectDir() / TEXT("Saved/Tests/Megalith/EditorPreview");
	}
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithEditorPreviewCaptureStaticMeshTest,
	"Megalith.Editor.Preview.CaptureStaticMesh",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithEditorPreviewCaptureStaticMeshTest::RunTest(const FString& /*Parameters*/)
{
	...
	const FString OutputPath = MegalithEditorPreviewTests::GetTestOutputDir() / TEXT("static_mesh.png");
	MegalithEditorPreviewTests::CleanupPng(OutputPath); // pre-clean stale artifact

	TSharedPtr<FJsonObject> Params = MegalithEditorPreviewTests::MakeParams(
		TEXT("static_mesh"), TEXT("/Engine/BasicShapes/Cube"), OutputPath);

	FMegalithActionResult Result = FMegalithEditorActions::HandleCaptureScenePreview(Params);
	...
	MegalithEditorPreviewTests::CleanupPng(OutputPath);
	return true;
}
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithEditorPreviewCaptureSkeletalMeshTest,
	"Megalith.Editor.Preview.CaptureSkeletalMesh",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithEditorPreviewCaptureSkeletalMeshTest::RunTest(const FString& /*Parameters*/)
{
	if (!FApp::CanEverRender())
	{
		AddInfo(TEXT("Skipped — FApp::CanEverRender() is false (headless / nullrhi)"));
	...
	const FString OutputPath = MegalithEditorPreviewTests::GetTestOutputDir() / TEXT("skeletal_mesh.png");
	MegalithEditorPreviewTests::CleanupPng(OutputPath);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithEditorPreviewCaptureWidgetTest,
	"Megalith.Editor.Preview.CaptureWidget",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithEditorPreviewCaptureWidgetTest::RunTest(const FString& /*Parameters*/)
{
	if (!FApp::CanEverRender())
	{
		AddInfo(TEXT("Skipped — FApp::CanEverRender() is false (headless / nullrhi). "
	...
	const FString OutputPath = MegalithEditorPreviewTests::GetTestOutputDir() / TEXT("widget.png");
	MegalithEditorPreviewTests::CleanupPng(OutputPath);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithEditorInspectMaterialPBRTest,
	"Megalith.Editor.Inspect.MaterialPBR",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithEditorInspectMaterialPBRTest::RunTest(const FString& /*Parameters*/)
{
	...
	FMegalithActionResult Result = FMegalithEditorActions::HandleInspectMaterialPBR(Params);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithEditorInspectTextureChannelsTest,
	"Megalith.Editor.Inspect.TextureChannels",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithEditorInspectTextureChannelsTest::RunTest(const FString& /*Parameters*/)
{
	...
	FMegalithActionResult Result = FMegalithEditorActions::HandleInspectTextureChannels(Params);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithEditorPreviewCaptureMaterialGridTest,
	"Megalith.Editor.Preview.CaptureMaterialGrid",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithEditorPreviewCaptureMaterialGridTest::RunTest(const FString& /*Parameters*/)
{
	if (!FApp::CanEverRender())
	{
		AddInfo(TEXT("Skipped — FApp::CanEverRender() is false (headless / nullrhi)"));
	...
	const FString OutputPath = MegalithEditorPreviewTests::GetTestOutputDir() / TEXT("material_grid.png");
	MegalithEditorPreviewTests::CleanupPng(OutputPath);

	TSharedPtr<FJsonObject> Params = MegalithEditorPreviewTests::MakeGridParams(Resolved, OutputPath);

	FMegalithActionResult Result = FMegalithEditorActions::HandleCaptureMaterialGrid(Params);
...
namespace MegalithEditorPreviewTests
{
		...
		const FString& OutputFileBaseName)
	{
		...
		const FString OutputPath = MegalithEditorPreviewTests::GetTestOutputDir() / OutputFileBaseName;
		MegalithEditorPreviewTests::CleanupPng(OutputPath);

		TSharedPtr<FJsonObject> Params = MegalithEditorPreviewTests::MakeOverlayParams(Mode, OutputPath);

		FMegalithActionResult Result = FMegalithEditorActions::HandleCaptureWithOverlay(Params);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithEditorPreviewCaptureWithOverlayWireframeTest,
	"Megalith.Editor.Preview.CaptureWithOverlay.Wireframe",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithEditorPreviewCaptureWithOverlayWireframeTest::RunTest(const FString& /*Parameters*/)
{
	return MegalithEditorPreviewTests::RunOverlayModeSmokeTest(
		*this, TEXT("wireframe"), TEXT("overlay_wireframe.png"));
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithEditorPreviewCaptureWithOverlayNormalsTest,
	"Megalith.Editor.Preview.CaptureWithOverlay.Normals",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithEditorPreviewCaptureWithOverlayNormalsTest::RunTest(const FString& /*Parameters*/)
{
	return MegalithEditorPreviewTests::RunOverlayModeSmokeTest(
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithEditorPreviewCaptureWithOverlayUVDensityTest,
	"Megalith.Editor.Preview.CaptureWithOverlay.UVDensity",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithEditorPreviewCaptureWithOverlayUVDensityTest::RunTest(const FString& /*Parameters*/)
{
	return MegalithEditorPreviewTests::RunOverlayModeSmokeTest(
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithEditorPreviewCaptureWithOverlayLightmapDensityTest,
	"Megalith.Editor.Preview.CaptureWithOverlay.LightmapDensity",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithEditorPreviewCaptureWithOverlayLightmapDensityTest::RunTest(const FString& /*Parameters*/)
{
	return MegalithEditorPreviewTests::RunOverlayModeSmokeTest(
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithEditorPreviewCaptureWithOverlayShaderComplexityTest,
	"Megalith.Editor.Preview.CaptureWithOverlay.ShaderComplexity",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithEditorPreviewCaptureWithOverlayShaderComplexityTest::RunTest(const FString& /*Parameters*/)
{
	return MegalithEditorPreviewTests::RunOverlayModeSmokeTest(
