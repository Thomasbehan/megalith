...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMegalithFixHintsAdditiveTest,
	"Megalith.Editor.FixHints.Additive",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMegalithFixHintsAdditiveTest::RunTest(const FString& /*Parameters*/)
{
	using namespace MegalithFixHintsTests;
	...
	TArray<TSharedPtr<FJsonValue>> Hints = FMegalithEditorActions::BuildFixHints(ErrorVals);
